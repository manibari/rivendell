...
agents.conf:   /var/folders/_7/b47kjvx506s_zl1r2wxjx6d40000gn/T/sk-agents-conf.XXXXXX.wy4bYYDbuL
...
[0;31mTotal drift: 3[0m
```

## Raw JSON

```json
{"total_drift":3,"agents_conf_only":[{"project":"rivendell","agent":"facts"},{"project":"rivendell","agent":"mail-triage"},{"project":"rivendell","agent":"token-analysis"}],"projects_json_only":[]}
```
