...
# Disk Capacity Report — 2026-09-08
...
used:   398G / 460G    avail: 22.9G
usage:  95% (warn ≥90%, crit ≥95%) → crit
```

## Raw JSON

```json
{"volume":"/dev/disk3s5","mount":"/System/Volumes/Data","size_gb":460,"used_gb":398,"avail_gb":22.9,"percent":95,"status":"crit","warn_threshold":90,"crit_threshold":95}
```
