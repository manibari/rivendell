...
**agents/**
- agent-observability — 2 次修訂, 6天前
- agent-persona — 2 次修訂, 6天前

**backend/**
- imap-smtp-integration — 2 次修訂, 6天前
- markdown-file-ssot — 2 次修訂, 6天前
- oauth-token-vault — 2 次修訂, 6天前
- spine-auth — 2 次修訂, 12天前

**business/**
- customer-intel — 2 次修訂, 6天前
- investment-research — 2 次修訂, 6天前

**docs/**
- office-pptx — 4 次修訂, 5天前
- pitch-deck — 4 次修訂, 5天前
- slide-workflow — 5 次修訂, 5天前
- subsidy-writer — 3 次修訂, 4天前

**git/**
- concurrent-session-git — 2 次修訂, 6天前

**media/**
- video-transcript — 5 次修訂, 9天前

**quality/**
- de-slopify — 4 次修訂, 6天前
- say-it-plain — 2 次修訂, 12天前

**workflow/**
- autoresearch — 3 次修訂, 6天前
- gdrive-to-skills — 3 次修訂, 6天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 116天前 (2026-04-07)
- db-migration — 1 次, 142天前 (2026-03-12)
- doc-to-structured-data — 1 次, 128天前 (2026-03-26)
- docker-compose-setup — 2 次, 106天前 (2026-04-17)
- rbac-permissions — 1 次, 116天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 139天前 (2026-03-15)
- vector-search-setup — 1 次, 124天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 116天前 (2026-04-07)
- office-docx — 4 次, 115天前 (2026-04-08)
- office-pdf — 3 次, 144天前 (2026-03-10)
- office-xlsx — 3 次, 144天前 (2026-03-10)
- rfq-writer — 1 次, 115天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 145天前 (2026-03-09)
- ios-integration — 1 次, 146天前 (2026-03-08)
- swiftui-patterns — 1 次, 146天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 144天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 128天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 142天前 (2026-03-12)
- ci-pipeline — 1 次, 142天前 (2026-03-12)
- deploy — 1 次, 142天前 (2026-03-12)
- dev-process-gate — 4 次, 116天前 (2026-04-07)
- init-project — 2 次, 145天前 (2026-03-09)
- knowledge-graph — 1 次, 139天前 (2026-03-15)
- plan-check-style — 3 次, 142天前 (2026-03-12)
- session-wrap — 1 次, 109天前 (2026-04-14)
- setup-permissions — 3 次, 142天前 (2026-03-12)
- skill-creator — 4 次, 106天前 (2026-04-17)
- skill-scout — 2 次, 94天前 (2026-04-29)
- sync-readme — 1 次, 123天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 110天前 (2026-04-13)
- large-file-refactor — 1 次, 124天前 (2026-03-30)
- qa-auto — 1 次, 139天前 (2026-03-15)
- qa-planner — 1 次, 139天前 (2026-03-15)
- qa-testing — 1 次, 144天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 139天前 (2026-03-15)
- context-recovery — 1 次, 139天前 (2026-03-15)
- settings-audit — 1 次, 129天前 (2026-03-25)

<details><summary>✅ 穩定 (61)</summary>

**agents/**
- agent-dispatch — 1 次, 9天前
- agent-headless — 1 次, 9天前
- agent-launchd — 1 次, 9天前

**backend/**
- ai-vision-extract — 1 次, 33天前
- backend-async-jobs — 3 次, 19天前
- firebase-backend — 3 次, 85天前
- ic-lot-normalization — 1 次, 38天前
- mcp-builder — 1 次, 9天前
- ml-eval-quality — 2 次, 19天前
- ml-model-registry — 2 次, 19天前
- odb-dfm-reference — 1 次, 38天前
- spine-rbac — 1 次, 34天前
- spine-schema-sync — 1 次, 34天前
- spine-versioning — 1 次, 33天前
- sqlite-to-postgres — 2 次, 85天前
- telegram-bot — 1 次, 9天前

**business/**
- candidate-analysis — 1 次, 9天前
- client-kickoff-docs — 1 次, 9天前
- crm-projection — 1 次, 9天前
- jd-writer — 1 次, 9天前
- keyword-discovery — 1 次, 9天前
- material-health — 1 次, 9天前
- mops-financial-scraper — 1 次, 9天前
- presales-pipeline — 1 次, 9天前
- sales-material — 1 次, 9天前
- subsidy-scraper — 1 次, 9天前
- tender-scraper — 1 次, 9天前
- tw-company-lookup — 1 次, 9天前

**docs/**
- chart-design — 1 次, 75天前
- doc-coauthoring — 2 次, 85天前
- excalidraw-diagram — 2 次, 77天前
- gdoc-report-builder — 2 次, 85天前
- internal-comms — 2 次, 85天前
- iot-factory-report — 2 次, 85天前
- mermaid-diagram — 1 次, 78天前
- metadata-workshop — 2 次, 85天前
- slide-office-hours — 2 次, 85天前
- slide-template-extractor — 2 次, 85天前
- sow-writer — 2 次, 85天前

**frontend/**
- chimesflow-design — 1 次, 51天前
...
- subtitle-file — 1 次, 9天前
- video-clip-extract — 1 次, 9天前

**meta/**
- learnings-promotion-sprint — 1 次, 78天前
- self-improving-agent — 3 次, 77天前
- session-harvest — 3 次, 85天前
- task-brief — 1 次, 46天前
- workflow-retro — 2 次, 85天前

**planning/**
- app-ops-baseline — 1 次, 9天前
- executing-plans — 1 次, 9天前
- mockup — 1 次, 9天前
- planning-with-files — 1 次, 9天前
- requirement — 1 次, 9天前
- user-flow — 1 次, 9天前
- writing-plans — 1 次, 9天前

**quality/**
- protect-secrets — 3 次, 85天前
- qa-journey — 1 次, 6天前

**workflow/**
- context-journal — 1 次, 12天前
- env-doctor — 3 次, 46天前
- repro-exam — 3 次, 46天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 5 個 commit（本週）, 15 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 3830 dirty, 1 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-26", "07-27", "07-28", "07-29", "07-30", "07-31", "08-01"]
    y-axis "USD" 0 --> 2000
    bar [1135, 457, 1879, 1928, 1188, 213, 0]
~~~
...
| 2026-08-01 (Sat) | 0 | 0 | 0 | $0.00 |
| **Total** | | | **2697.3M** | **$6799.10** |
...
| -Users-manibari-code-PTI-ARES | 1,437 | 517.2M | $1201.11 |
| -Users-manibari-code-vantage-3dgs | 1,077 | 404.0M | $925.15 |
| -Users-manibari-code-Verdandi-AutoML | 686 | 300.9M | $728.07 |
| -Users-manibari-code-mops-dbs | 709 | 225.9M | $629.41 |
| -Users-manibari-code-rivendell | 717 | 149.6M | $566.98 |
| -Users-manibari-code-IC-YMS | 492 | 223.5M | $556.87 |
| -Users-manibari-code-MingOS | 372 | 140.6M | $381.92 |
| -Users-manibari-code | 515 | 95.8M | $234.34 |
| -Users-manibari-code-MingOS-engine | 111 | 50.3M | $158.27 |
| -Users-manibari-code-sales-assistant | 321 | 21.2M | $64.71 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-Urd-BI | 127 | 11.3M | $26.93 |
| -Users-manibari-code-resume-pool | 36 | 3.0M | $21.07 |
| -Users-manibari-code-ChimesFlow | 15 | 3.6M | $17.42 |
...
*由以下工具產生 `./bin/sk audit` — 2026-08-01 — 116 skills, 63 issue(s)*
