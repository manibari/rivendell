...
**backend/**
- youtube-transcript — 尚未 commit

### 🔧 開發中

**backend/**
- backend-async-jobs — 3 次修訂, 8天前
- ml-eval-quality — 2 次修訂, 8天前
- ml-model-registry — 2 次修訂, 8天前
- spine-auth — 2 次修訂, 1天前

**quality/**
- say-it-plain — 2 次修訂, 1天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 105天前 (2026-04-07)
- db-migration — 1 次, 131天前 (2026-03-12)
- doc-to-structured-data — 1 次, 117天前 (2026-03-26)
- docker-compose-setup — 2 次, 95天前 (2026-04-17)
- imap-smtp-integration — 1 次, 119天前 (2026-03-24)
- markdown-file-ssot — 1 次, 119天前 (2026-03-24)
- oauth-token-vault — 1 次, 119天前 (2026-03-24)
- rbac-permissions — 1 次, 105天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 128天前 (2026-03-15)
- tw-company-lookup — 2 次, 127天前 (2026-03-16)
- vector-search-setup — 1 次, 113天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 105天前 (2026-04-07)
- mcp-builder — 3 次, 133天前 (2026-03-10)
- office-docx — 4 次, 104天前 (2026-04-08)
- office-pdf — 3 次, 133天前 (2026-03-10)
- office-pptx — 3 次, 133天前 (2026-03-10)
- office-xlsx — 3 次, 133天前 (2026-03-10)
- rfq-writer — 1 次, 104天前 (2026-04-08)
- telegram-bot — 1 次, 128天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 134天前 (2026-03-09)
- ios-integration — 1 次, 135天前 (2026-03-08)
- swiftui-patterns — 1 次, 135天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 133天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 117天前 (2026-03-26)

**meta/**
- agent-persona — 1 次, 99天前 (2026-04-13)
- audit-fix — 1 次, 131天前 (2026-03-12)
- ci-pipeline — 1 次, 131天前 (2026-03-12)
- deploy — 1 次, 131天前 (2026-03-12)
- dev-process-gate — 4 次, 105天前 (2026-04-07)
- init-project — 2 次, 134天前 (2026-03-09)
- knowledge-graph — 1 次, 128天前 (2026-03-15)
- plan-check-style — 3 次, 131天前 (2026-03-12)
- session-wrap — 1 次, 98天前 (2026-04-14)
- setup-permissions — 3 次, 131天前 (2026-03-12)
- skill-creator — 4 次, 95天前 (2026-04-17)
- sync-readme — 1 次, 112天前 (2026-03-31)

**quality/**
- de-slopify — 2 次, 95天前 (2026-04-17)
- github-repo-audit — 1 次, 99天前 (2026-04-13)
- large-file-refactor — 1 次, 113天前 (2026-03-30)
- qa-auto — 1 次, 128天前 (2026-03-15)
- qa-planner — 1 次, 128天前 (2026-03-15)
- qa-testing — 1 次, 133天前 (2026-03-10)

**workflow/**
- agent-observability — 2 次, 105天前 (2026-04-07)
- candidate-analysis — 1 次, 117天前 (2026-03-26)
- claude-to-telegram — 1 次, 128天前 (2026-03-15)
- context-recovery — 1 次, 128天前 (2026-03-15)
- crm-projection — 1 次, 127天前 (2026-03-16)
- dispatching-parallel-agents — 4 次, 95天前 (2026-04-17)
- executing-plans — 3 次, 133天前 (2026-03-10)
- gdrive-to-skills — 2 次, 134天前 (2026-03-09)
- headless-agent — 6 次, 119天前 (2026-03-24)
- jd-writer — 1 次, 99天前 (2026-04-13)
- keyword-discovery — 1 次, 119天前 (2026-03-24)
- material-health — 1 次, 127天前 (2026-03-16)
- mockup — 1 次, 135天前 (2026-03-08)
- planning-with-files — 5 次, 105天前 (2026-04-07)
- requirement — 2 次, 105天前 (2026-04-07)
- sales-material — 3 次, 91天前 (2026-04-21)
- settings-audit — 1 次, 118天前 (2026-03-25)
- subsidy-scraper — 1 次, 127天前 (2026-03-16)
- tender-scraper — 3 次, 119天前 (2026-03-24)
- writing-plans — 3 次, 133天前 (2026-03-10)

<details><summary>✅ 穩定 (43)</summary>

**backend/**
- ai-vision-extract — 1 次, 22天前
- firebase-backend — 3 次, 74天前
- ic-lot-normalization — 1 次, 27天前
- odb-dfm-reference — 1 次, 27天前
- spine-rbac — 1 次, 23天前
- spine-schema-sync — 1 次, 23天前
- spine-versioning — 1 次, 22天前
- sqlite-to-postgres — 2 次, 74天前

**docs/**
- chart-design — 1 次, 64天前
- doc-coauthoring — 2 次, 74天前
- excalidraw-diagram — 2 次, 66天前
- gdoc-report-builder — 2 次, 74天前
- internal-comms — 2 次, 74天前
- iot-factory-report — 2 次, 74天前
- mermaid-diagram — 1 次, 67天前
- metadata-workshop — 2 次, 74天前
- pitch-deck — 3 次, 74天前
- slide-office-hours — 2 次, 74天前
- slide-template-extractor — 2 次, 74天前
- slide-workflow — 4 次, 74天前
- sow-writer — 2 次, 74天前

**frontend/**
- chimesflow-design — 1 次, 40天前

**git/**
- auto-stage — 3 次, 74天前
- concurrent-session-git — 1 次, 34天前

**meta/**
- learnings-promotion-sprint — 1 次, 67天前
- self-improving-agent — 3 次, 66天前
- session-harvest — 3 次, 74天前
- skill-scout — 2 次, 83天前
- task-brief — 1 次, 35天前
- workflow-retro — 2 次, 74天前

**quality/**
- protect-secrets — 3 次, 74天前

**workflow/**
- app-ops-baseline — 1 次, 40天前
- autoresearch — 2 次, 74天前
- client-kickoff-docs — 2 次, 35天前
- context-journal — 1 次, 1天前
- customer-intel — 5 次, 74天前
- env-doctor — 3 次, 35天前
- investment-research — 4 次, 74天前
- launchd-agent — 6 次, 74天前
- mops-financial-scraper — 3 次, 35天前
- presales-pipeline — 3 次, 35天前
- repro-exam — 3 次, 35天前
- user-flow — 2 次, 67天前
...
| Skill | 功能 |
|-------|------|
| ai-vision-extract | The pattern for "photo → AI does the OCR/extraction → structured data", learned from iihi (孕 app) prod: a cost-... |
...
| ml-eval-quality | Markdown + YAML frontmatter 作為半結構化資料 SSOT |
| ml-model-registry | Markdown + YAML frontmatter 作為半結構化資料 SSOT |
...
| youtube-transcript | FastAPI 向量搜尋知識庫建置：embedding 套件選型、資料模型、語意搜尋 API、索引管理 |
...
| Skill | 功能 |
|-------|------|
| chimesflow-design | Telegram bot 開發指南：grammY (TS) / python-telegram-bot (Python) |
...
| Skill | 功能 |
|-------|------|
| app-ops-baseline | Agent 可觀測性：exec-lib 整合、執行歷史、即時 log 串流、timeline 事件 |
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 3 個 commit（本週）, 73 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/scan-card-qa-flow` (6 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
1175e65 feat(scan-card): 一問一答式掃名片，支援客戶／合作夥伴分支 — v1.33.46
a872809 fix(config): fail loud in prod on missing/placeholder SECRET_KEY
96306f5 fix(ocr): feed codex prompt via stdin so business-card scan works
...
```
b8c43b4 fix(auth): fail-fast on missing/placeholder SECRET_KEY
7b80e23 feat(api): host-local /api/health status probe for ops monitor
a15a4e4 docs(learnings): summary-aggregation bug + host-side password revert
aa93cf4 fix(summary): overview loan totals undercounted + mixed currencies
9571c97 docs(progress): version+roadmap shipped & verified on prod
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 54 個 commit（本週）, 60 個（本月） |
| **技術棧** |  Python |
| **分支** | `main` (4 total) |
| **Git** | 3 dirty, 60 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
| **Config** | OK | **權限** | OK (12 rules) |
...
```
ddc82e1 docs(agents): add art/assets worktree lane + portrait registry seam
e8fb65e chore: pre-split integration baseline for concurrent worktrees
4980e1e refactor(game): 平衡常數數據化 balance.yaml(引擎/內容分離,Clausewitz 式)
43800c0 feat(game): LLM 聚光燈 — 只給當下最相關的少數人 LLM 深度(注意力經濟)
acbeb79 feat(game): 直轄 vs 封邑(具名封君持城 + 家勢/尾大不掉)玩家版
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 137 個 commit（本週）, 240 個（本月） |
| **技術棧** |  Node.js Python |
...
131a49c fix(projects): 契約 D1 邊緣正規化（後端）— 路徑洩漏/500/契約不一致
0431226 feat(projects): 契約 B2 破壞性 DELETE + ingest 失敗 409 死路解除
266e5e0 fix(coverage/home): 契約 B1 單一真相源 — 覆蓋表計數只計一次、分桶/就緒燈讀權威狀態
```
</details>
...
```
1b4dd7b feat(phase-d): --apply 工具 backup+rollback（1102 驗證）— v0.18.13
6d54e8e docs(phase-d): 111 changed 全量 triage — 全屬選值修正、--apply 綠燈
496843d feat(shareholders): Tier2 掃描型 F17 用 claude 文字解析 + 日期西元修正 — v0.18.12
02e871f feat(monitor): 大股東顯示分層 — 負責人縮排、只主股東排名 — v0.18.11
2aec399 feat(shareholders): parser 硬化 — 負責人標記+日期容錯 (Tier1 86%) — v0.18.10
```
</details>
...
4ff1929 chore(materials): crm-projection refresh 2026-07-15
339df86 chore(materials): crm-projection refresh 2026-07-13
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-15", "07-16", "07-17", "07-18", "07-19", "07-20", "07-21"]
    y-axis "USD" 0 --> 2700
    bar [1346, 903, 1653, 1214, 954, 2648, 1483]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-07-15 (Wed) | 10 | 927 | 610.3M | $1346.49 |
| 2026-07-16 (Thu) | 15 | 1,183 | 289.4M | $902.66 |
...
| 2026-07-21 (Tue) | 28 | 1,572 | 699.1M | $1482.77 |
| **Total** | | | **4198.4M** | **$10201.29** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-PTI-ARES | 4,894 | 1779.1M | $3840.09 |
| -Users-manibari-code-MingOS | 2,050 | 887.6M | $2221.13 |
| -Users-manibari-code-mops-dbs | 1,680 | 642.3M | $1530.20 |
| -Users-manibari-Vault-Peter-Work | 1,246 | 383.2M | $975.39 |
| -Users-manibari-code-rivendell | 1,037 | 203.6M | $723.13 |
| -Users-manibari-code-ChimesFlow | 673 | 171.1M | $429.27 |
| -Users-manibari-code-IC-YMS | 265 | 84.0M | $284.03 |
| -Users-manibari-code-Verdandi-AutoML | 257 | 26.4M | $84.88 |
| -Users-manibari-code-sales-assistant | 234 | 13.8M | $46.67 |
...
| -Users-manibari-code-MingOS-engine | 18 | 1.0M | $6.47 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-21 — 111 skills, 82 issue(s)*
