...
**agents/**
- agent-dispatch — 2 次修訂, 9天前
- agent-headless — 2 次修訂, 9天前
- agent-launchd — 3 次修訂, 7天前
- agent-observability — 3 次修訂, 9天前
- agent-persona — 4 次修訂, 7天前

**backend/**
- ai-vision-extract — 2 次修訂, 9天前
- audio-transcription-flow — 3 次修訂, 7天前
- backend-async-jobs — 4 次修訂, 9天前
- cloudflare-tunnel-ops — 2 次修訂, 9天前
- cloudflare-tunnel-provision — 3 次修訂, 7天前
- db-migration — 2 次修訂, 9天前
- doc-to-structured-data — 2 次修訂, 9天前
- docker-compose-setup — 4 次修訂, 7天前
- firebase-backend — 4 次修訂, 9天前
- ic-lot-normalization — 2 次修訂, 9天前
- imap-smtp-integration — 3 次修訂, 9天前
- markdown-file-ssot — 3 次修訂, 9天前
- mcp-builder — 2 次修訂, 9天前
- ml-eval-quality — 3 次修訂, 9天前
- ml-model-registry — 3 次修訂, 9天前
- oauth-token-vault — 3 次修訂, 9天前
- odb-dfm-reference — 3 次修訂, 9天前
- rbac-permissions — 3 次修訂, 7天前
- spine-auth — 3 次修訂, 9天前
- spine-rbac — 2 次修訂, 9天前
- spine-schema-sync — 2 次修訂, 9天前
- spine-versioning — 2 次修訂, 9天前
- sqlite-to-postgres — 3 次修訂, 9天前
- telegram-bot — 2 次修訂, 9天前
- tunnel-proxy-deploy — 3 次修訂, 9天前
- vector-search-setup — 2 次修訂, 9天前

**docs/**
- chart-design — 4 次修訂, 7天前
- discovery-interview — 3 次修訂, 7天前
- doc-coauthoring — 6 次修訂, 9天前
- excalidraw-diagram — 5 次修訂, 9天前
- gdoc-report-builder — 4 次修訂, 7天前
- internal-comms — 6 次修訂, 9天前
- iot-factory-report — 4 次修訂, 7天前
- mermaid-diagram — 3 次修訂, 9天前
- metadata-workshop — 4 次修訂, 7天前
- office-docx — 5 次修訂, 9天前
- office-pdf — 4 次修訂, 9天前
- office-pptx — 5 次修訂, 9天前
- office-xlsx — 4 次修訂, 9天前
- pitch-deck — 8 次修訂, 7天前
- slide-office-hours — 4 次修訂, 7天前
- slide-template-extractor — 4 次修訂, 7天前
- slide-workflow — 10 次修訂, 7天前
- sow-writer — 4 次修訂, 7天前

**frontend/**
- chimesflow-design — 3 次修訂, 7天前
- frontend-design — 3 次修訂, 9天前
- ios-integration — 2 次修訂, 9天前
- swiftui-patterns — 2 次修訂, 9天前
- ui-ux-pro-max — 4 次修訂, 9天前

**git/**
- auto-stage — 4 次修訂, 9天前
- concurrent-session-git — 3 次修訂, 9天前
- repo-rename — 2 次修訂, 9天前
- resolving-merge-conflicts — 2 次修訂, 9天前

**gov/**
- gov-rfq-writer — 2 次修訂, 7天前

**hr/**
- hr-jd-writer — 2 次修訂, 7天前

**knowledge/**
- local-media-transcribe — 2 次修訂, 7天前
- subtitle-file — 2 次修訂, 7天前
- video-clip-extract — 2 次修訂, 7天前
- video-transcript — 2 次修訂, 7天前
- yt-channel-scraper — 2 次修訂, 7天前

**planning/**
- app-ops-baseline — 3 次修訂, 7天前
- executing-plans — 2 次修訂, 9天前
- mockup — 2 次修訂, 9天前
- planning-with-files — 3 次修訂, 7天前
- requirement — 3 次修訂, 7天前
- user-flow — 4 次修訂, 9天前
- writing-plans — 2 次修訂, 9天前

**platform/**
- session-wrap — 2 次修訂, 7天前

**qa/**
- qa-auto — 2 次修訂, 9天前
- qa-dataflow — 7 次修訂, 7天前
- qa-journey — 2 次修訂, 9天前
- qa-planner — 2 次修訂, 9天前
- qa-testing — 2 次修訂, 9天前

**quality/**
- de-slopify — 7 次修訂, 9天前
- github-repo-audit — 3 次修訂, 7天前
- large-file-refactor — 2 次修訂, 9天前
- protect-secrets — 4 次修訂, 9天前
- say-it-plain — 4 次修訂, 9天前

**sales/**
- sales-customer-intel — 2 次修訂, 13天前
- sales-material — 2 次修訂, 13天前
- tw-company-lookup — 2 次修訂, 13天前

**workflow/**
- autoresearch — 5 次修訂, 9天前
- ci-pipeline — 2 次修訂, 9天前
- claude-to-telegram — 2 次修訂, 9天前
- context-journal — 2 次修訂, 9天前
- context-recovery — 2 次修訂, 9天前
- deploy — 2 次修訂, 9天前
- dev-process-gate — 3 次修訂, 7天前
- env-doctor — 4 次修訂, 9天前
- gdrive-to-skills — 4 次修訂, 9天前
- init-project — 2 次修訂, 9天前
- plan-check-style — 2 次修訂, 9天前
- repro-exam — 4 次修訂, 9天前
- settings-audit — 2 次修訂, 9天前
- setup-permissions — 2 次修訂, 9天前
- task-brief — 3 次修訂, 9天前

<details><summary>✅ 穩定 (24)</summary>

**gov/**
- gov-subsidy-scraper — 1 次, 13天前
- gov-subsidy-writer — 1 次, 13天前
- gov-tender-scraper — 1 次, 13天前

**hr/**
- hr-candidate-analysis — 1 次, 13天前

**invest/**
- invest-research — 1 次, 13天前
...
**planning/**
- system-design — 1 次, 7天前

**platform/**
- audit-fix — 1 次, 13天前
- doc-drift-sync — 1 次, 13天前
- learnings-promotion-sprint — 1 次, 13天前
- self-improving-agent — 1 次, 13天前
- session-harvest — 1 次, 13天前
- skill-apply — 1 次, 13天前
- skill-creator — 1 次, 13天前
- skill-scout — 1 次, 13天前
- sync-readme — 1 次, 13天前
- workflow-retro — 1 次, 13天前
- writing-great-skills — 1 次, 13天前

**sales/**
- presales-pipeline — 1 次, 13天前
- sales-client-kickoff-docs — 1 次, 13天前
- sales-crm-projection — 1 次, 13天前
- sales-keyword-discovery — 1 次, 13天前
- sales-material-health — 1 次, 13天前
...
| system-design | 定義結構化需求：user story + acceptance criteria + scope |
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 106 個 commit（本週）, 218 個（本月） |
| **技術棧** |  Node.js Python |
| **分支** | `dev-Peter-fix-startup-seed` (2 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
9638256 docs(changelog): 記錄 0ed78fc 的全新部署 seed 修復
0ed78fc fix(startup): 全新部署建不出 admin 與參考資料
f692c52 Merge pull request #35 from manibari/dev-Peter-next-wave-handoff
ef555e8 docs(plans): handoff reflects 1.4.1 and the merged audit fixes
8675d29 Merge remote-tracking branch 'origin/main' into dev-Peter-next-wave-handoff
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 283 個 commit（本週）, 608 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `master` (1 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
| **Config** | no CLAUDE.md | **權限** | OK (3 rules) |

<details><summary>近期 commits</summary>

```
eaf1d20 Merge origin/master：Pro に 2026-09-10 から溜まっていた調査データを合流させる
6b059e5 県覆蓋率まわりの道具：check-hours-coverage / check-pref-coverage を新設、根目錄の複本を片付け
bf19428 営業時間と班距データ：47 県分の hours.json、7 県の新規パッケージ、headway/navitime の再計測
6e26874 自動一巡：
36ec7be 低い県 18 県ぶん、**建線で直る件数**を数えた（投資先はこれで決まる）
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["09-10", "09-11", "09-12", "09-13", "09-14", "09-15", "09-16"]
    y-axis "USD" 0 --> 250
    bar [0, 0, 0, 22, 0, 0, 178]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-09-10 (Thu) | 0 | 0 | 0 | $0.00 |
| 2026-09-11 (Fri) | 0 | 0 | 0 | $0.00 |
| 2026-09-12 (Sat) | 0 | 0 | 0 | $0.00 |
| 2026-09-13 (Sun) | 1 | 77 | 7.1M | $22.38 |
| 2026-09-14 (Mon) | 0 | 0 | 0 | $0.00 |
| 2026-09-15 (Tue) | 3 | 4 | 0 | $0.00 |
| 2026-09-16 (Wed) | 8 | 717 | 68.8M | $178.17 |
| **Total** | | | **75.9M** | **$200.55** |
...
|---------|-----------|--------|-----------|
| Code | 448 | 46.8M | $115.50 |
| Code-rivendell | 179 | 14.1M | $48.88 |
| Code-PTI-ARES | 169 | 15.0M | $36.17 |
...
*由以下工具產生 `./bin/sk audit` — 2026-09-16 — 125 skills, 5 issue(s)*
