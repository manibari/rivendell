...
# Disk Capacity Report — 2026-08-27
...
used:   389G / 460G    avail: 47.3G
usage:  90% (warn ≥90%, crit ≥95%) → warn
```

## Raw JSON

```json
{"volume":"/dev/disk3s5","mount":"/System/Volumes/Data","size_gb":460,"used_gb":389,"avail_gb":47.3,"percent":90,"status":"warn","warn_threshold":90,"crit_threshold":95}
```
