...
# Disk Capacity Report — 2026-07-24
...
used:   382G / 460G    avail: 32.0G
usage:  93% (warn ≥90%, crit ≥95%) → warn
```

## Raw JSON

```json
{"volume":"/dev/disk3s5","mount":"/System/Volumes/Data","size_gb":460,"used_gb":382,"avail_gb":32.0,"percent":93,"status":"warn","warn_threshold":90,"crit_threshold":95}
```
