...
| gstack-autoplan |  |
| gstack-autoplan | Auto-review pipeline — reads the full CEO, design, eng, and DX review skills from disk and runs them sequentially wit... |
| gstack-benchmark |  |
...
| gstack.bak |  |
| pre-ship-review | Commit / push / merge 前的最後一道檢查:讀 diff、只報有 code 佐證的問題、 機械式的直接修。刻意做小(<90 行、不派 subagent、不讀外部檔),因為它被需要的 時機是 session 尾端 co... |
| sales-deck-design | Design system + structure for B2B **sales / 提案型** decks that look like a real enterprise proposal (not "AI slop / 小學生"). |
...
xychart-beta
    ...
    y-axis "USD" 0 --> 2050
    bar [1687, 1955, 323, 1367, 798, 1711, 434]
~~~
...
| 2026-08-17 (Mon) | 9 | 604 | 159.1M | $434.14 |
| **Total** | | | **3655.2M** | **$8275.21** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| PTI-ARES | 3,012 | 1540.1M | $3121.48 |
| Verdandi-AutoML | 1,560 | 743.2M | $1621.42 |
| Vault-Peter-Work | 1,232 | 436.2M | $1130.29 |
| ChimesFlow | 1,612 | 415.0M | $982.74 |
| rivendell | 1,102 | 274.0M | $824.73 |
| Urd-ETL | 514 | 176.2M | $405.81 |
| Norns-Skuld-CAD | 249 | 36.0M | $76.53 |
...
*由以下工具產生 `./bin/sk audit` — 2026-08-17 — 124 skills, 79 issue(s)*
