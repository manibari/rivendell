...
# Disk Capacity Report — 2026-07-21
...
used:   377G / 460G    avail: 39.0G
usage:  91% (warn ≥90%, crit ≥95%) → warn
```

## Raw JSON

```json
{"volume":"/dev/disk3s5","mount":"/System/Volumes/Data","size_gb":460,"used_gb":377,"avail_gb":39.0,"percent":91,"status":"warn","warn_threshold":90,"crit_threshold":95}
```
