...
**backend/**
- firebase-backend — 3 次修訂, 11天前
- sqlite-to-postgres — 2 次修訂, 11天前

**docs/**
- doc-coauthoring — 2 次修訂, 11天前
- excalidraw-diagram — 2 次修訂, 3天前
- gdoc-report-builder — 2 次修訂, 11天前
- internal-comms — 2 次修訂, 11天前
- iot-factory-report — 2 次修訂, 11天前
- metadata-workshop — 2 次修訂, 11天前
- pitch-deck — 3 次修訂, 11天前
- slide-office-hours — 2 次修訂, 11天前
- slide-template-extractor — 2 次修訂, 11天前
- slide-workflow — 4 次修訂, 11天前
- sow-writer — 2 次修訂, 11天前

**git/**
- auto-stage — 3 次修訂, 11天前

**meta/**
- self-improving-agent — 3 次修訂, 3天前
- session-harvest — 3 次修訂, 11天前
- workflow-retro — 2 次修訂, 11天前

**quality/**
- protect-secrets — 3 次修訂, 11天前

**workflow/**
- autoresearch — 2 次修訂, 11天前
- customer-intel — 5 次修訂, 11天前
- investment-research — 4 次修訂, 11天前
- launchd-agent — 6 次修訂, 11天前
- user-flow — 2 次修訂, 4天前

<details><summary>✅ 穩定 (71)</summary>

**backend/**
- audio-transcription-flow — 1 次, 42天前
- db-migration — 1 次, 68天前
- doc-to-structured-data — 1 次, 54天前
- docker-compose-setup — 2 次, 32天前
- imap-smtp-integration — 1 次, 56天前
- markdown-file-ssot — 1 次, 56天前
- oauth-token-vault — 1 次, 56天前
- rbac-permissions — 1 次, 42天前
- tunnel-proxy-deploy — 1 次, 65天前
- tw-company-lookup — 2 次, 64天前
- vector-search-setup — 1 次, 50天前

**docs/**
- chart-design — 1 次, 1天前
- discovery-interview — 1 次, 42天前
- mcp-builder — 3 次, 70天前
- mermaid-diagram — 1 次, 4天前
- office-docx — 4 次, 41天前
- office-pdf — 3 次, 70天前
- office-pptx — 3 次, 70天前
- office-xlsx — 3 次, 70天前
- rfq-writer — 1 次, 41天前
- telegram-bot — 1 次, 65天前

**frontend/**
- frontend-design — 2 次, 71天前
- ios-integration — 1 次, 72天前
- swiftui-patterns — 1 次, 72天前
- ui-ux-pro-max — 3 次, 70天前

**git/**
- repo-rename — 1 次, 54天前

**meta/**
- agent-persona — 1 次, 36天前
- audit-fix — 1 次, 68天前
- ci-pipeline — 1 次, 68天前
- deploy — 1 次, 68天前
- dev-process-gate — 4 次, 42天前
- init-project — 2 次, 71天前
- knowledge-graph — 1 次, 65天前
- learnings-promotion-sprint — 1 次, 4天前
- plan-check-style — 3 次, 68天前
- session-wrap — 1 次, 35天前
- setup-permissions — 3 次, 68天前
- skill-creator — 4 次, 32天前
- skill-scout — 2 次, 20天前
- sync-readme — 1 次, 49天前

**quality/**
- de-slopify — 2 次, 32天前
- github-repo-audit — 1 次, 36天前
- large-file-refactor — 1 次, 50天前
- qa-auto — 1 次, 65天前
- qa-planner — 1 次, 65天前
- qa-testing — 1 次, 70天前
...
- candidate-analysis — 1 次, 54天前
- claude-to-telegram — 1 次, 65天前
- client-kickoff-docs — 1 次, 27天前
- context-recovery — 1 次, 65天前
- crm-projection — 1 次, 64天前
- dispatching-parallel-agents — 4 次, 32天前
- env-doctor — 1 次, 27天前
- executing-plans — 3 次, 70天前
- gdrive-to-skills — 2 次, 71天前
- headless-agent — 6 次, 56天前
- jd-writer — 1 次, 36天前
- keyword-discovery — 1 次, 56天前
- material-health — 1 次, 64天前
- mockup — 1 次, 72天前
- mops-financial-scraper — 1 次, 27天前
- planning-with-files — 5 次, 42天前
- presales-pipeline — 1 次, 27天前
- repro-exam — 1 次, 27天前
- requirement — 2 次, 42天前
- sales-material — 3 次, 28天前
- settings-audit — 1 次, 55天前
- subsidy-scraper — 1 次, 64天前
- tender-scraper — 3 次, 56天前
- writing-plans — 3 次, 70天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 11 個 commit（本週）, 32 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 2 dirty, 2 unpushed |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
f3b2995 feat(backend): user_feedback model + pydantic schemas
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-13", "05-14", "05-15", "05-16", "05-17", "05-18", "05-19"]
    y-axis "USD" 0 --> 850
    bar [522, 743, 761, 3, 56, 549, 281]
~~~
...
| 2026-05-18 (Mon) | 12 | 1,226 | 196.5M | $548.86 |
| 2026-05-19 (Tue) | 7 | 585 | 84.8M | $280.79 |
| **Total** | | | **1130.8M** | **$2915.59** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 1,585 | 347.7M | $943.13 |
| rivendell | 1,395 | 370.4M | $826.75 |
| ChimesFlow | 909 | 278.4M | $703.46 |
| -Users-manibari-Documents-Projects | 333 | 66.9M | $189.07 |
| news-stock | 328 | 31.0M | $131.88 |
| -Users-manibari-Documents-Peter | 100 | 20.6M | $69.08 |
| sales-assistant | 245 | 15.9M | $52.23 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-19 — 94 skills, 19 issue(s)*
