...
**backend/**
- firebase-backend — 3 次修訂, 5天前
- sqlite-to-postgres — 2 次修訂, 5天前

**docs/**
- doc-coauthoring — 2 次修訂, 5天前
- gdoc-report-builder — 2 次修訂, 5天前
- internal-comms — 2 次修訂, 5天前
- iot-factory-report — 2 次修訂, 5天前
- metadata-workshop — 2 次修訂, 5天前
- pitch-deck — 3 次修訂, 5天前
- slide-office-hours — 2 次修訂, 5天前
- slide-template-extractor — 2 次修訂, 5天前
- slide-workflow — 4 次修訂, 5天前
- sow-writer — 2 次修訂, 5天前

**git/**
- auto-stage — 3 次修訂, 5天前

**meta/**
- session-harvest — 3 次修訂, 5天前
- skill-scout — 2 次修訂, 14天前
- workflow-retro — 2 次修訂, 5天前

**quality/**
- protect-secrets — 3 次修訂, 5天前

**workflow/**
- autoresearch — 2 次修訂, 5天前
- customer-intel — 5 次修訂, 5天前
- investment-research — 4 次修訂, 5天前
- launchd-agent — 6 次修訂, 5天前

<details><summary>✅ 穩定 (69)</summary>

**backend/**
- audio-transcription-flow — 1 次, 36天前
- db-migration — 1 次, 62天前
- doc-to-structured-data — 1 次, 48天前
- docker-compose-setup — 2 次, 26天前
- imap-smtp-integration — 1 次, 50天前
- markdown-file-ssot — 1 次, 50天前
- oauth-token-vault — 1 次, 50天前
- rbac-permissions — 1 次, 36天前
- tunnel-proxy-deploy — 1 次, 59天前
- tw-company-lookup — 2 次, 58天前
- vector-search-setup — 1 次, 44天前

**docs/**
- discovery-interview — 1 次, 36天前
- mcp-builder — 3 次, 64天前
- office-docx — 4 次, 35天前
- office-pdf — 3 次, 64天前
- office-pptx — 3 次, 64天前
- office-xlsx — 3 次, 64天前
- rfq-writer — 1 次, 35天前
- telegram-bot — 1 次, 59天前

**frontend/**
- frontend-design — 2 次, 65天前
- ios-integration — 1 次, 66天前
- swiftui-patterns — 1 次, 66天前
- ui-ux-pro-max — 3 次, 64天前

**git/**
- repo-rename — 1 次, 48天前

**meta/**
- agent-persona — 1 次, 30天前
- audit-fix — 1 次, 62天前
- ci-pipeline — 1 次, 62天前
- deploy — 1 次, 62天前
- dev-process-gate — 4 次, 36天前
- init-project — 2 次, 65天前
- knowledge-graph — 1 次, 59天前
- plan-check-style — 3 次, 62天前
- self-improving-agent — 2 次, 44天前
- session-wrap — 1 次, 29天前
- setup-permissions — 3 次, 62天前
- skill-creator — 4 次, 26天前
- sync-readme — 1 次, 43天前

**quality/**
- de-slopify — 2 次, 26天前
- github-repo-audit — 1 次, 30天前
- large-file-refactor — 1 次, 44天前
- qa-auto — 1 次, 59天前
- qa-planner — 1 次, 59天前
- qa-testing — 1 次, 64天前
...
- candidate-analysis — 1 次, 48天前
- claude-to-telegram — 1 次, 59天前
- client-kickoff-docs — 1 次, 21天前
- context-recovery — 1 次, 59天前
- crm-projection — 1 次, 58天前
- dispatching-parallel-agents — 4 次, 26天前
- env-doctor — 1 次, 21天前
- executing-plans — 3 次, 64天前
- gdrive-to-skills — 2 次, 65天前
- headless-agent — 6 次, 50天前
- jd-writer — 1 次, 30天前
- keyword-discovery — 1 次, 50天前
- material-health — 1 次, 58天前
- mockup — 1 次, 66天前
- mops-financial-scraper — 1 次, 21天前
- planning-with-files — 5 次, 36天前
- presales-pipeline — 1 次, 21天前
- repro-exam — 1 次, 21天前
- requirement — 2 次, 36天前
- sales-material — 3 次, 22天前
- settings-audit — 1 次, 49天前
- subsidy-scraper — 1 次, 58天前
- tender-scraper — 3 次, 50天前
- user-flow — 1 次, 66天前
- writing-plans — 3 次, 64天前
...
```
fab78f5 feat(frontend): inline-edit opportunity name; retire deprecated antd List
c0b1d83 docs: design system + planning artifacts for personalized dashboard
1899e19 refactor(frontend): migrate antd v6 Timeline items.children → content + dot → icon
3a61207 feat(frontend): personalized dashboard with view-mode toggle and 我的提醒 card
88d7c97 feat(backend): GET /api/stage-gates/misses with RBAC and bounded queries
```
</details>
...
514fcb2 chore(agent): research-agent-daily run 2026-05-12
36fe7c6 chore(agent): research-agent-daily run 2026-05-11
b77a970 chore(agent): research-agent-weekly run 2026-05-10
8053652 chore(agent): research-agent-daily run 2026-05-10
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-07", "05-08", "05-09", "05-10", "05-11", "05-12", "05-13"]
    y-axis "USD" 0 --> 1100
    bar [1018, 846, 38, 80, 454, 471, 383]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-07 (Thu) | 13 | 2,046 | 431.5M | $1017.73 |
| 2026-05-08 (Fri) | 10 | 1,058 | 338.5M | $846.12 |
...
| 2026-05-13 (Wed) | 10 | 542 | 111.6M | $383.43 |
| **Total** | | | **1228.2M** | **$3290.15** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 2,290 | 541.6M | $1436.28 |
| ChimesFlow | 1,195 | 263.1M | $640.77 |
| rivendell | 862 | 244.1M | $613.48 |
| news-stock | 581 | 58.9M | $223.44 |
| -Users-manibari-Documents-Peter-Family | 374 | 75.2M | $208.88 |
| resume-pool | 108 | 21.7M | $68.23 |
| sales-assistant | 271 | 16.2M | $59.96 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter | 64 | 4.8M | $30.81 |
| -Users-manibari-Documents-Projects | 42 | 2.7M | $8.30 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-13 — 90 skills, 20 issue(s)*
