...
**backend/**
- firebase-backend — 3 次修訂, 4天前
- sqlite-to-postgres — 2 次修訂, 4天前

**docs/**
- doc-coauthoring — 2 次修訂, 4天前
- gdoc-report-builder — 2 次修訂, 4天前
- internal-comms — 2 次修訂, 4天前
- iot-factory-report — 2 次修訂, 4天前
- metadata-workshop — 2 次修訂, 4天前
- pitch-deck — 3 次修訂, 4天前
- slide-office-hours — 2 次修訂, 4天前
- slide-template-extractor — 2 次修訂, 4天前
- slide-workflow — 4 次修訂, 4天前
- sow-writer — 2 次修訂, 4天前

**git/**
- auto-stage — 3 次修訂, 4天前

**meta/**
- session-harvest — 3 次修訂, 4天前
- skill-scout — 2 次修訂, 13天前
- workflow-retro — 2 次修訂, 4天前

**quality/**
- protect-secrets — 3 次修訂, 4天前

**workflow/**
- autoresearch — 2 次修訂, 4天前
- customer-intel — 5 次修訂, 4天前
- investment-research — 4 次修訂, 4天前
- launchd-agent — 6 次修訂, 4天前

<details><summary>✅ 穩定 (69)</summary>

**backend/**
- audio-transcription-flow — 1 次, 35天前
- db-migration — 1 次, 61天前
- doc-to-structured-data — 1 次, 47天前
- docker-compose-setup — 2 次, 25天前
- imap-smtp-integration — 1 次, 49天前
- markdown-file-ssot — 1 次, 49天前
- oauth-token-vault — 1 次, 49天前
- rbac-permissions — 1 次, 35天前
- tunnel-proxy-deploy — 1 次, 58天前
- tw-company-lookup — 2 次, 57天前
- vector-search-setup — 1 次, 43天前

**docs/**
- discovery-interview — 1 次, 35天前
- mcp-builder — 3 次, 63天前
- office-docx — 4 次, 34天前
- office-pdf — 3 次, 63天前
- office-pptx — 3 次, 63天前
- office-xlsx — 3 次, 63天前
- rfq-writer — 1 次, 34天前
- telegram-bot — 1 次, 58天前

**frontend/**
- frontend-design — 2 次, 64天前
- ios-integration — 1 次, 65天前
- swiftui-patterns — 1 次, 65天前
- ui-ux-pro-max — 3 次, 63天前

**git/**
- repo-rename — 1 次, 47天前

**meta/**
- agent-persona — 1 次, 29天前
- audit-fix — 1 次, 61天前
- ci-pipeline — 1 次, 61天前
- deploy — 1 次, 61天前
- dev-process-gate — 4 次, 35天前
- init-project — 2 次, 64天前
- knowledge-graph — 1 次, 58天前
- plan-check-style — 3 次, 61天前
- self-improving-agent — 2 次, 43天前
- session-wrap — 1 次, 28天前
- setup-permissions — 3 次, 61天前
- skill-creator — 4 次, 25天前
- sync-readme — 1 次, 42天前

**quality/**
- de-slopify — 2 次, 25天前
- github-repo-audit — 1 次, 29天前
- large-file-refactor — 1 次, 43天前
- qa-auto — 1 次, 58天前
- qa-planner — 1 次, 58天前
- qa-testing — 1 次, 63天前
...
- candidate-analysis — 1 次, 47天前
- claude-to-telegram — 1 次, 58天前
- client-kickoff-docs — 1 次, 20天前
- context-recovery — 1 次, 58天前
- crm-projection — 1 次, 57天前
- dispatching-parallel-agents — 4 次, 25天前
- env-doctor — 1 次, 20天前
- executing-plans — 3 次, 63天前
- gdrive-to-skills — 2 次, 64天前
- headless-agent — 6 次, 49天前
- jd-writer — 1 次, 29天前
- keyword-discovery — 1 次, 49天前
- material-health — 1 次, 57天前
- mockup — 1 次, 65天前
- mops-financial-scraper — 1 次, 20天前
- planning-with-files — 5 次, 35天前
- presales-pipeline — 1 次, 20天前
- repro-exam — 1 次, 20天前
- requirement — 2 次, 35天前
- sales-material — 3 次, 21天前
- settings-audit — 1 次, 48天前
- subsidy-scraper — 1 次, 57天前
- tender-scraper — 3 次, 49天前
- user-flow — 1 次, 65天前
- writing-plans — 3 次, 63天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-06", "05-07", "05-08", "05-09", "05-10", "05-11", "05-12"]
    y-axis "USD" 0 --> 1100
    bar [793, 1018, 846, 38, 80, 454, 441]
~~~
...
| 2026-05-12 (Tue) | 10 | 735 | 151.6M | $440.94 |
| **Total** | | | **1423.0M** | **$3670.12** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 2,811 | 745.2M | $1913.98 |
| rivendell | 679 | 223.7M | $577.58 |
| ChimesFlow | 1,149 | 227.2M | $506.02 |
| -Users-manibari-Documents-Peter-Family | 374 | 75.2M | $208.88 |
| news-stock | 541 | 53.9M | $202.17 |
|  | 138 | 56.6M | $108.18 |
| resume-pool | 108 | 21.7M | $68.23 |
| sales-assistant | 256 | 15.4M | $57.08 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter | 54 | 4.1M | $27.99 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-12 — 90 skills, 19 issue(s)*
