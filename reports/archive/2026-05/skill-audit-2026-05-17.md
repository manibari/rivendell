...
**backend/**
- firebase-backend — 3 次修訂, 9天前
- sqlite-to-postgres — 2 次修訂, 9天前

**docs/**
- doc-coauthoring — 2 次修訂, 9天前
- excalidraw-diagram — 2 次修訂, 1天前
- gdoc-report-builder — 2 次修訂, 9天前
- internal-comms — 2 次修訂, 9天前
- iot-factory-report — 2 次修訂, 9天前
- metadata-workshop — 2 次修訂, 9天前
- pitch-deck — 3 次修訂, 9天前
- slide-office-hours — 2 次修訂, 9天前
- slide-template-extractor — 2 次修訂, 9天前
- slide-workflow — 4 次修訂, 9天前
- sow-writer — 2 次修訂, 9天前

**git/**
- auto-stage — 3 次修訂, 9天前

**meta/**
- self-improving-agent — 3 次修訂, 1天前
- session-harvest — 3 次修訂, 9天前
- workflow-retro — 2 次修訂, 9天前

**quality/**
- protect-secrets — 3 次修訂, 9天前

**workflow/**
- autoresearch — 2 次修訂, 9天前
- customer-intel — 5 次修訂, 9天前
- investment-research — 4 次修訂, 9天前
- launchd-agent — 6 次修訂, 9天前
- user-flow — 2 次修訂, 2天前

<details><summary>✅ 穩定 (70)</summary>

**backend/**
- audio-transcription-flow — 1 次, 40天前
- db-migration — 1 次, 66天前
- doc-to-structured-data — 1 次, 52天前
- docker-compose-setup — 2 次, 30天前
- imap-smtp-integration — 1 次, 54天前
- markdown-file-ssot — 1 次, 54天前
- oauth-token-vault — 1 次, 54天前
- rbac-permissions — 1 次, 40天前
- tunnel-proxy-deploy — 1 次, 63天前
- tw-company-lookup — 2 次, 62天前
- vector-search-setup — 1 次, 48天前

**docs/**
- discovery-interview — 1 次, 40天前
- mcp-builder — 3 次, 68天前
- mermaid-diagram — 1 次, 2天前
- office-docx — 4 次, 39天前
- office-pdf — 3 次, 68天前
- office-pptx — 3 次, 68天前
- office-xlsx — 3 次, 68天前
- rfq-writer — 1 次, 39天前
- telegram-bot — 1 次, 63天前

**frontend/**
- frontend-design — 2 次, 69天前
- ios-integration — 1 次, 70天前
- swiftui-patterns — 1 次, 70天前
- ui-ux-pro-max — 3 次, 68天前

**git/**
- repo-rename — 1 次, 52天前

**meta/**
- agent-persona — 1 次, 34天前
- audit-fix — 1 次, 66天前
- ci-pipeline — 1 次, 66天前
- deploy — 1 次, 66天前
- dev-process-gate — 4 次, 40天前
- init-project — 2 次, 69天前
- knowledge-graph — 1 次, 63天前
- learnings-promotion-sprint — 1 次, 2天前
- plan-check-style — 3 次, 66天前
- session-wrap — 1 次, 33天前
- setup-permissions — 3 次, 66天前
- skill-creator — 4 次, 30天前
- skill-scout — 2 次, 18天前
- sync-readme — 1 次, 47天前

**quality/**
- de-slopify — 2 次, 30天前
- github-repo-audit — 1 次, 34天前
- large-file-refactor — 1 次, 48天前
- qa-auto — 1 次, 63天前
- qa-planner — 1 次, 63天前
- qa-testing — 1 次, 68天前
...
- candidate-analysis — 1 次, 52天前
- claude-to-telegram — 1 次, 63天前
- client-kickoff-docs — 1 次, 25天前
- context-recovery — 1 次, 63天前
- crm-projection — 1 次, 62天前
- dispatching-parallel-agents — 4 次, 30天前
- env-doctor — 1 次, 25天前
- executing-plans — 3 次, 68天前
- gdrive-to-skills — 2 次, 69天前
- headless-agent — 6 次, 54天前
- jd-writer — 1 次, 34天前
- keyword-discovery — 1 次, 54天前
- material-health — 1 次, 62天前
- mockup — 1 次, 70天前
- mops-financial-scraper — 1 次, 25天前
- planning-with-files — 5 次, 40天前
- presales-pipeline — 1 次, 25天前
- repro-exam — 1 次, 25天前
- requirement — 2 次, 40天前
- sales-material — 3 次, 26天前
- settings-audit — 1 次, 53天前
- subsidy-scraper — 1 次, 62天前
- tender-scraper — 3 次, 54天前
- writing-plans — 3 次, 68天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-11", "05-12", "05-13", "05-14", "05-15", "05-16", "05-17"]
    y-axis "USD" 0 --> 850
    bar [454, 471, 522, 743, 761, 3, 33]
~~~
...
| 2026-05-16 (Sat) | 2 | 11 | 500K | $2.93 |
| 2026-05-17 (Sun) | 3 | 28 | 9.9M | $33.38 |
| **Total** | | | **1164.7M** | **$2988.56** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 1,744 | 393.3M | $1150.33 |
| ChimesFlow | 871 | 304.3M | $670.21 |
| rivendell | 1,072 | 310.9M | $629.52 |
| -Users-manibari-Documents-Projects | 333 | 66.9M | $189.07 |
| news-stock | 293 | 27.2M | $119.48 |
| -Users-manibari-Documents-Peter | 134 | 23.3M | $85.44 |
| resume-pool | 108 | 21.7M | $68.23 |
| sales-assistant | 213 | 13.5M | $46.72 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-17 — 93 skills, 21 issue(s)*
