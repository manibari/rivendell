...
**docs/**
- slide-workflow — 2 次修訂, 0天前

**git/**
- auto-stage — 2 次修訂, 7天前

**meta/**
- skill-scout — 2 次修訂, 6天前

**quality/**
- protect-secrets — 2 次修訂, 7天前

**workflow/**
- launchd-agent — 5 次修訂, 6天前
- sales-material — 3 次修訂, 14天前

<details><summary>✅ 穩定 (84)</summary>

**backend/**
- audio-transcription-flow — 1 次, 28天前
- db-migration — 1 次, 54天前
- doc-to-structured-data — 1 次, 40天前
- docker-compose-setup — 2 次, 18天前
- firebase-backend — 2 次, 18天前
- imap-smtp-integration — 1 次, 42天前
- markdown-file-ssot — 1 次, 42天前
- oauth-token-vault — 1 次, 42天前
- rbac-permissions — 1 次, 28天前
- sqlite-to-postgres — 1 次, 51天前
- tunnel-proxy-deploy — 1 次, 51天前
- tw-company-lookup — 2 次, 50天前
- vector-search-setup — 1 次, 36天前

**docs/**
- discovery-interview — 1 次, 28天前
- doc-coauthoring — 1 次, 7天前
- gdoc-report-builder — 1 次, 22天前
- internal-comms — 1 次, 7天前
- iot-factory-report — 1 次, 22天前
- mcp-builder — 3 次, 56天前
- metadata-workshop — 1 次, 27天前
- office-docx — 4 次, 27天前
- office-pdf — 3 次, 56天前
- office-pptx — 3 次, 56天前
- office-xlsx — 3 次, 56天前
- pitch-deck — 2 次, 25天前
- rfq-writer — 1 次, 27天前
- slide-office-hours — 1 次, 0天前
- slide-template-extractor — 1 次, 25天前
- sow-writer — 1 次, 28天前
- telegram-bot — 1 次, 51天前

**frontend/**
- frontend-design — 2 次, 57天前
- ios-integration — 1 次, 58天前
- swiftui-patterns — 1 次, 58天前
- ui-ux-pro-max — 3 次, 56天前

**git/**
- repo-rename — 1 次, 40天前

**meta/**
- agent-persona — 1 次, 22天前
- audit-fix — 1 次, 54天前
- ci-pipeline — 1 次, 54天前
- deploy — 1 次, 54天前
- dev-process-gate — 4 次, 28天前
- init-project — 2 次, 57天前
- knowledge-graph — 1 次, 51天前
- plan-check-style — 3 次, 54天前
- self-improving-agent — 2 次, 36天前
- session-harvest — 2 次, 25天前
- session-wrap — 1 次, 21天前
- setup-permissions — 3 次, 54天前
- skill-creator — 4 次, 18天前
- sync-readme — 1 次, 35天前
- workflow-retro — 1 次, 8天前

**quality/**
- de-slopify — 2 次, 18天前
- github-repo-audit — 1 次, 22天前
- large-file-refactor — 1 次, 36天前
- qa-auto — 1 次, 51天前
- qa-planner — 1 次, 51天前
- qa-testing — 1 次, 56天前
...
- autoresearch — 1 次, 42天前
- candidate-analysis — 1 次, 40天前
- claude-to-telegram — 1 次, 51天前
- client-kickoff-docs — 1 次, 13天前
- context-recovery — 1 次, 51天前
- crm-projection — 1 次, 50天前
- customer-intel — 4 次, 50天前
- dispatching-parallel-agents — 4 次, 18天前
- env-doctor — 1 次, 13天前
- executing-plans — 3 次, 56天前
- gdrive-to-skills — 2 次, 57天前
- headless-agent — 6 次, 42天前
- investment-research — 3 次, 51天前
- jd-writer — 1 次, 22天前
- keyword-discovery — 1 次, 42天前
- material-health — 1 次, 50天前
- mockup — 1 次, 58天前
- mops-financial-scraper — 1 次, 13天前
- planning-with-files — 5 次, 28天前
- presales-pipeline — 1 次, 13天前
- repro-exam — 1 次, 13天前
- requirement — 2 次, 28天前
- settings-audit — 1 次, 41天前
- subsidy-scraper — 1 次, 50天前
- tender-scraper — 3 次, 42天前
- user-flow — 1 次, 58天前
- writing-plans — 3 次, 56天前
...
```
f32626e fix: upgrade Next.js 16.1.6 → 16.2.4 (route group manifest bug)
f75a206 feat: per-request access log + summary CLI + Postgres slow query log
bb67795 fix: API_BASE fallback + same-origin uploads + sidebar logo path
e96f85c fix: company_settings.updated_at uses TIMESTAMPTZ to accept tz-aware times
4048d06 fix: proxy /uploads/* to backend so company logo/stamp images render
```
</details>
...
8e4a227 feat(backtest/ui): per-symbol attribution table
e4bcf91 feat(strategy): MomentumHeatmap drill-through to trading page
70b7bf5 feat(search): CommandPalette searches beyond watchlist
fb9073b feat(trading,ai-chain): free-text symbol entry + heatmap drill-through
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-29", "04-30", "05-01", "05-02", "05-03", "05-04", "05-05"]
    y-axis "USD" 0 --> 1050
    bar [731, 660, 4, 0, 407, 763, 961]
~~~
...
| 2026-05-01 (Fri) | 2 | 17 | 1.3M | $3.58 |
| 2026-05-02 (Sat) | 3 | 3 | 0 | $0.00 |
| 2026-05-03 (Sun) | 14 | 1,165 | 155.0M | $407.44 |
| 2026-05-04 (Mon) | 10 | 1,089 | 292.8M | $763.24 |
| 2026-05-05 (Tue) | 18 | 1,732 | 488.2M | $961.33 |
| **Total** | | | **1497.6M** | **$3526.49** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 1,656 | 546.2M | $1393.55 |
| ChimesFlow | 1,554 | 417.8M | $779.12 |
| news-stock | 1,163 | 242.4M | $563.67 |
| rivendell | 585 | 123.9M | $360.26 |
|  | 595 | 122.8M | $289.61 |
| sales-johnson | 228 | 31.5M | $88.75 |
| sales-assistant | 190 | 12.7M | $47.95 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-05 — 90 skills, 18 issue(s)*
