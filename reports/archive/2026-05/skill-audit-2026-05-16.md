...
**backend/**
- firebase-backend — 3 次修訂, 8天前
- sqlite-to-postgres — 2 次修訂, 8天前

**docs/**
- doc-coauthoring — 2 次修訂, 8天前
- excalidraw-diagram — 2 次修訂, 0天前
- gdoc-report-builder — 2 次修訂, 8天前
- internal-comms — 2 次修訂, 8天前
- iot-factory-report — 2 次修訂, 8天前
- metadata-workshop — 2 次修訂, 8天前
- pitch-deck — 3 次修訂, 8天前
- slide-office-hours — 2 次修訂, 8天前
- slide-template-extractor — 2 次修訂, 8天前
- slide-workflow — 4 次修訂, 8天前
- sow-writer — 2 次修訂, 8天前

**git/**
- auto-stage — 3 次修訂, 8天前

**meta/**
- self-improving-agent — 3 次修訂, 0天前
- session-harvest — 3 次修訂, 8天前
- workflow-retro — 2 次修訂, 8天前

**quality/**
- protect-secrets — 3 次修訂, 8天前

**workflow/**
- autoresearch — 2 次修訂, 8天前
- customer-intel — 5 次修訂, 8天前
- investment-research — 4 次修訂, 8天前
- launchd-agent — 6 次修訂, 8天前
- user-flow — 2 次修訂, 1天前

<details><summary>✅ 穩定 (70)</summary>

**backend/**
- audio-transcription-flow — 1 次, 39天前
- db-migration — 1 次, 65天前
- doc-to-structured-data — 1 次, 51天前
- docker-compose-setup — 2 次, 29天前
- imap-smtp-integration — 1 次, 53天前
- markdown-file-ssot — 1 次, 53天前
- oauth-token-vault — 1 次, 53天前
- rbac-permissions — 1 次, 39天前
- tunnel-proxy-deploy — 1 次, 62天前
- tw-company-lookup — 2 次, 61天前
- vector-search-setup — 1 次, 47天前

**docs/**
- discovery-interview — 1 次, 39天前
- mcp-builder — 3 次, 67天前
- mermaid-diagram — 1 次, 1天前
- office-docx — 4 次, 38天前
- office-pdf — 3 次, 67天前
- office-pptx — 3 次, 67天前
- office-xlsx — 3 次, 67天前
- rfq-writer — 1 次, 38天前
- telegram-bot — 1 次, 62天前

**frontend/**
- frontend-design — 2 次, 68天前
- ios-integration — 1 次, 69天前
- swiftui-patterns — 1 次, 69天前
- ui-ux-pro-max — 3 次, 67天前

**git/**
- repo-rename — 1 次, 51天前

**meta/**
- agent-persona — 1 次, 33天前
- audit-fix — 1 次, 65天前
- ci-pipeline — 1 次, 65天前
- deploy — 1 次, 65天前
- dev-process-gate — 4 次, 39天前
- init-project — 2 次, 68天前
- knowledge-graph — 1 次, 62天前
- learnings-promotion-sprint — 1 次, 1天前
- plan-check-style — 3 次, 65天前
- session-wrap — 1 次, 32天前
- setup-permissions — 3 次, 65天前
- skill-creator — 4 次, 29天前
- skill-scout — 2 次, 17天前
- sync-readme — 1 次, 46天前

**quality/**
- de-slopify — 2 次, 29天前
- github-repo-audit — 1 次, 33天前
- large-file-refactor — 1 次, 47天前
- qa-auto — 1 次, 62天前
- qa-planner — 1 次, 62天前
- qa-testing — 1 次, 67天前

**workflow/**
- agent-observability — 2 次, 39天前
- candidate-analysis — 1 次, 51天前
- claude-to-telegram — 1 次, 62天前
- client-kickoff-docs — 1 次, 24天前
- context-recovery — 1 次, 62天前
- crm-projection — 1 次, 61天前
- dispatching-parallel-agents — 4 次, 29天前
- env-doctor — 1 次, 24天前
- executing-plans — 3 次, 67天前
- gdrive-to-skills — 2 次, 68天前
- headless-agent — 6 次, 53天前
- jd-writer — 1 次, 33天前
- keyword-discovery — 1 次, 53天前
- material-health — 1 次, 61天前
- mockup — 1 次, 69天前
- mops-financial-scraper — 1 次, 24天前
- planning-with-files — 5 次, 39天前
- presales-pipeline — 1 次, 24天前
- repro-exam — 1 次, 24天前
- requirement — 2 次, 39天前
- sales-material — 3 次, 25天前
- settings-audit — 1 次, 52天前
- subsidy-scraper — 1 次, 61天前
- tender-scraper — 3 次, 53天前
- writing-plans — 3 次, 67天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-10", "05-11", "05-12", "05-13", "05-14", "05-15", "05-16"]
    y-axis "USD" 0 --> 850
    bar [80, 454, 471, 522, 743, 761, 3]
~~~
...
| 2026-05-15 (Fri) | 10 | 1,288 | 348.5M | $761.47 |
| 2026-05-16 (Sat) | 1 | 10 | 500K | $2.93 |
| **Total** | | | **1175.2M** | **$3035.48** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 1,719 | 383.5M | $1118.66 |
| ChimesFlow | 923 | 307.1M | $675.84 |
| rivendell | 1,133 | 315.4M | $649.96 |
| -Users-manibari-Documents-Projects | 333 | 66.9M | $189.07 |
| news-stock | 389 | 36.1M | $152.67 |
| -Users-manibari-Documents-Peter | 136 | 23.5M | $88.57 |
| resume-pool | 108 | 21.7M | $68.23 |
| sales-assistant | 277 | 17.5M | $62.92 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter-Family | 40 | 3.5M | $29.55 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-16 — 93 skills, 19 issue(s)*
