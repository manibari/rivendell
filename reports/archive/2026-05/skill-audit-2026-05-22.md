...
**backend/**
- firebase-backend — 3 次修訂, 14天前
- sqlite-to-postgres — 2 次修訂, 14天前

**docs/**
- doc-coauthoring — 2 次修訂, 14天前
- excalidraw-diagram — 2 次修訂, 6天前
- gdoc-report-builder — 2 次修訂, 14天前
- internal-comms — 2 次修訂, 14天前
- iot-factory-report — 2 次修訂, 14天前
- metadata-workshop — 2 次修訂, 14天前
- pitch-deck — 3 次修訂, 14天前
- slide-office-hours — 2 次修訂, 14天前
- slide-template-extractor — 2 次修訂, 14天前
- slide-workflow — 4 次修訂, 14天前
- sow-writer — 2 次修訂, 14天前

**git/**
- auto-stage — 3 次修訂, 14天前

**meta/**
- self-improving-agent — 3 次修訂, 6天前
- session-harvest — 3 次修訂, 14天前
- workflow-retro — 2 次修訂, 14天前

**quality/**
- protect-secrets — 3 次修訂, 14天前

**workflow/**
- autoresearch — 2 次修訂, 14天前
- customer-intel — 5 次修訂, 14天前
- investment-research — 4 次修訂, 14天前
- launchd-agent — 6 次修訂, 14天前
- user-flow — 2 次修訂, 7天前

<details><summary>✅ 穩定 (71)</summary>

**backend/**
- audio-transcription-flow — 1 次, 45天前
- db-migration — 1 次, 71天前
- doc-to-structured-data — 1 次, 57天前
- docker-compose-setup — 2 次, 35天前
- imap-smtp-integration — 1 次, 59天前
- markdown-file-ssot — 1 次, 59天前
- oauth-token-vault — 1 次, 59天前
- rbac-permissions — 1 次, 45天前
- tunnel-proxy-deploy — 1 次, 68天前
- tw-company-lookup — 2 次, 67天前
- vector-search-setup — 1 次, 53天前

**docs/**
- chart-design — 1 次, 4天前
- discovery-interview — 1 次, 45天前
- mcp-builder — 3 次, 73天前
- mermaid-diagram — 1 次, 7天前
- office-docx — 4 次, 44天前
- office-pdf — 3 次, 73天前
- office-pptx — 3 次, 73天前
- office-xlsx — 3 次, 73天前
- rfq-writer — 1 次, 44天前
- telegram-bot — 1 次, 68天前

**frontend/**
- frontend-design — 2 次, 74天前
- ios-integration — 1 次, 75天前
- swiftui-patterns — 1 次, 75天前
- ui-ux-pro-max — 3 次, 73天前

**git/**
- repo-rename — 1 次, 57天前

**meta/**
- agent-persona — 1 次, 39天前
- audit-fix — 1 次, 71天前
- ci-pipeline — 1 次, 71天前
- deploy — 1 次, 71天前
- dev-process-gate — 4 次, 45天前
- init-project — 2 次, 74天前
- knowledge-graph — 1 次, 68天前
- learnings-promotion-sprint — 1 次, 7天前
- plan-check-style — 3 次, 71天前
- session-wrap — 1 次, 38天前
- setup-permissions — 3 次, 71天前
- skill-creator — 4 次, 35天前
- skill-scout — 2 次, 23天前
- sync-readme — 1 次, 52天前

**quality/**
- de-slopify — 2 次, 35天前
- github-repo-audit — 1 次, 39天前
- large-file-refactor — 1 次, 53天前
- qa-auto — 1 次, 68天前
- qa-planner — 1 次, 68天前
- qa-testing — 1 次, 73天前

**workflow/**
- agent-observability — 2 次, 45天前
- candidate-analysis — 1 次, 57天前
- claude-to-telegram — 1 次, 68天前
- client-kickoff-docs — 1 次, 30天前
- context-recovery — 1 次, 68天前
- crm-projection — 1 次, 67天前
- dispatching-parallel-agents — 4 次, 35天前
- env-doctor — 1 次, 30天前
- executing-plans — 3 次, 73天前
- gdrive-to-skills — 2 次, 74天前
- headless-agent — 6 次, 59天前
- jd-writer — 1 次, 39天前
- keyword-discovery — 1 次, 59天前
- material-health — 1 次, 67天前
- mockup — 1 次, 75天前
- mops-financial-scraper — 1 次, 30天前
- planning-with-files — 5 次, 45天前
- presales-pipeline — 1 次, 30天前
- repro-exam — 1 次, 30天前
- requirement — 2 次, 45天前
- sales-material — 3 次, 31天前
- settings-audit — 1 次, 58天前
- subsidy-scraper — 1 次, 67天前
- tender-scraper — 3 次, 59天前
- writing-plans — 3 次, 73天前
...
```
220b27a feat: alembic race escape hatch + pipeline product filter + manual v0.2
0d1ca0f fix(backend): RBAC scope for 4 reports endpoints leaking company data
dd04c18 feat(frontend): partner contacts UI + opportunity contact assignment
5686430 feat(backend): partner_contacts + opp contact FKs (backend phase 1)
c8aecae fix(frontend): show product_ids in opportunity read-only Descriptions
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-16", "05-17", "05-18", "05-19", "05-20", "05-21", "05-22"]
    y-axis "USD" 0 --> 950
    bar [3, 56, 549, 871, 245, 58, 742]
~~~
...
| 2026-05-22 (Fri) | 3 | 601 | 399.5M | $741.70 |
| **Total** | | | **1063.9M** | **$2523.36** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| ChimesFlow | 1,872 | 772.8M | $1669.03 |
| -Users-manibari-Documents-Peter-Work | 765 | 156.9M | $394.71 |
| rivendell | 523 | 103.3M | $340.68 |
| news-stock | 191 | 22.0M | $86.31 |
| news_stock | 28 | 603K | $40.77 |
| sales-assistant | 143 | 9.0M | $32.62 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-22 — 94 skills, 20 issue(s)*
