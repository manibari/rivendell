...
**docs/**
- excalidraw-diagram — 2 次修訂, 7天前

**meta/**
- self-improving-agent — 3 次修訂, 7天前
...
**backend/**
- audio-transcription-flow — 1 次, 46天前
- db-migration — 1 次, 72天前
- doc-to-structured-data — 1 次, 58天前
- docker-compose-setup — 2 次, 36天前
- firebase-backend — 3 次, 15天前
- imap-smtp-integration — 1 次, 60天前
- markdown-file-ssot — 1 次, 60天前
- oauth-token-vault — 1 次, 60天前
- rbac-permissions — 1 次, 46天前
- sqlite-to-postgres — 2 次, 15天前
- tunnel-proxy-deploy — 1 次, 69天前
- tw-company-lookup — 2 次, 68天前
- vector-search-setup — 1 次, 54天前

**docs/**
- chart-design — 1 次, 5天前
- discovery-interview — 1 次, 46天前
- doc-coauthoring — 2 次, 15天前
- gdoc-report-builder — 2 次, 15天前
- internal-comms — 2 次, 15天前
- iot-factory-report — 2 次, 15天前
- mcp-builder — 3 次, 74天前
- mermaid-diagram — 1 次, 8天前
- metadata-workshop — 2 次, 15天前
- office-docx — 4 次, 45天前
- office-pdf — 3 次, 74天前
- office-pptx — 3 次, 74天前
- office-xlsx — 3 次, 74天前
- pitch-deck — 3 次, 15天前
- rfq-writer — 1 次, 45天前
- slide-office-hours — 2 次, 15天前
- slide-template-extractor — 2 次, 15天前
- slide-workflow — 4 次, 15天前
- sow-writer — 2 次, 15天前
- telegram-bot — 1 次, 69天前

**frontend/**
- frontend-design — 2 次, 75天前
- ios-integration — 1 次, 76天前
- swiftui-patterns — 1 次, 76天前
- ui-ux-pro-max — 3 次, 74天前

**git/**
- auto-stage — 3 次, 15天前
- repo-rename — 1 次, 58天前

**meta/**
- agent-persona — 1 次, 40天前
- audit-fix — 1 次, 72天前
- ci-pipeline — 1 次, 72天前
- deploy — 1 次, 72天前
- dev-process-gate — 4 次, 46天前
- init-project — 2 次, 75天前
- knowledge-graph — 1 次, 69天前
- learnings-promotion-sprint — 1 次, 8天前
- plan-check-style — 3 次, 72天前
- session-harvest — 3 次, 15天前
- session-wrap — 1 次, 39天前
- setup-permissions — 3 次, 72天前
- skill-creator — 4 次, 36天前
- skill-scout — 2 次, 24天前
- sync-readme — 1 次, 53天前
- workflow-retro — 2 次, 15天前

**quality/**
- de-slopify — 2 次, 36天前
- github-repo-audit — 1 次, 40天前
- large-file-refactor — 1 次, 54天前
- protect-secrets — 3 次, 15天前
- qa-auto — 1 次, 69天前
- qa-planner — 1 次, 69天前
- qa-testing — 1 次, 74天前

**workflow/**
- agent-observability — 2 次, 46天前
- autoresearch — 2 次, 15天前
- candidate-analysis — 1 次, 58天前
- claude-to-telegram — 1 次, 69天前
- client-kickoff-docs — 1 次, 31天前
- context-recovery — 1 次, 69天前
- crm-projection — 1 次, 68天前
- customer-intel — 5 次, 15天前
- dispatching-parallel-agents — 4 次, 36天前
- env-doctor — 1 次, 31天前
- executing-plans — 3 次, 74天前
- gdrive-to-skills — 2 次, 75天前
- headless-agent — 6 次, 60天前
- investment-research — 4 次, 15天前
- jd-writer — 1 次, 40天前
- keyword-discovery — 1 次, 60天前
- launchd-agent — 6 次, 15天前
- material-health — 1 次, 68天前
- mockup — 1 次, 76天前
- mops-financial-scraper — 1 次, 31天前
- planning-with-files — 5 次, 46天前
- presales-pipeline — 1 次, 31天前
- repro-exam — 1 次, 31天前
- requirement — 2 次, 46天前
- sales-material — 3 次, 32天前
- settings-audit — 1 次, 59天前
- subsidy-scraper — 1 次, 68天前
- tender-scraper — 3 次, 60天前
- writing-plans — 3 次, 74天前
...
```
b4e40e7 docs: post-sale project management planning artifacts (requirement + user flow + design)
106818a feat(frontend): admin user + department management pages
5be2900 feat(rbac): Day-1 boundaries — departments + manager-dept scope + finance financial-only
90bb885 fix(security): row-level RBAC for quotes/contracts/invoices/billing/collection/activities
37b24f7 feat: 3K role extension — Champion / Detractor / Blocker (H)
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-17", "05-18", "05-19", "05-20", "05-21", "05-22", "05-23"]
    y-axis "USD" 0 --> 1200
    bar [56, 549, 871, 245, 58, 1127, 477]
~~~
...
| 2026-05-23 (Sat) | 8 | 867 | 235.7M | $477.37 |
| **Total** | | | **1470.5M** | **$3383.20** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 2,407 | 1021.9M | $2102.28 |
| -Users-manibari-code-rivendell | 741 | 152.9M | $543.72 |
| -Users-manibari-Documents-Peter-Work | 765 | 156.9M | $394.71 |
| -Users-manibari-code-news-stock | 235 | 26.5M | $108.57 |
| rivendell | 97 | 47.1M | $96.69 |
| ChimesFlow | 96 | 42.6M | $70.47 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-sales-assistant | 152 | 9.5M | $35.48 |
| -Users-manibari-code | 158 | 13.1M | $31.29 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-23 — 94 skills, 18 issue(s)*
