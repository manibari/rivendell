...
**docs/**
- slide-workflow — 2 次修訂, 1天前

**git/**
- auto-stage — 2 次修訂, 8天前

**meta/**
- skill-scout — 2 次修訂, 7天前

**quality/**
- protect-secrets — 2 次修訂, 8天前

**workflow/**
- launchd-agent — 5 次修訂, 7天前

<details><summary>✅ 穩定 (85)</summary>

**backend/**
- audio-transcription-flow — 1 次, 29天前
- db-migration — 1 次, 55天前
- doc-to-structured-data — 1 次, 41天前
- docker-compose-setup — 2 次, 19天前
- firebase-backend — 2 次, 19天前
- imap-smtp-integration — 1 次, 43天前
- markdown-file-ssot — 1 次, 43天前
- oauth-token-vault — 1 次, 43天前
- rbac-permissions — 1 次, 29天前
- sqlite-to-postgres — 1 次, 52天前
- tunnel-proxy-deploy — 1 次, 52天前
- tw-company-lookup — 2 次, 51天前
- vector-search-setup — 1 次, 37天前

**docs/**
- discovery-interview — 1 次, 29天前
- doc-coauthoring — 1 次, 8天前
- gdoc-report-builder — 1 次, 23天前
- internal-comms — 1 次, 8天前
- iot-factory-report — 1 次, 23天前
- mcp-builder — 3 次, 57天前
- metadata-workshop — 1 次, 28天前
- office-docx — 4 次, 28天前
- office-pdf — 3 次, 57天前
- office-pptx — 3 次, 57天前
- office-xlsx — 3 次, 57天前
- pitch-deck — 2 次, 26天前
- rfq-writer — 1 次, 28天前
- slide-office-hours — 1 次, 1天前
- slide-template-extractor — 1 次, 26天前
- sow-writer — 1 次, 29天前
- telegram-bot — 1 次, 52天前

**frontend/**
- frontend-design — 2 次, 58天前
- ios-integration — 1 次, 59天前
- swiftui-patterns — 1 次, 59天前
- ui-ux-pro-max — 3 次, 57天前

**git/**
- repo-rename — 1 次, 41天前

**meta/**
- agent-persona — 1 次, 23天前
- audit-fix — 1 次, 55天前
- ci-pipeline — 1 次, 55天前
- deploy — 1 次, 55天前
- dev-process-gate — 4 次, 29天前
- init-project — 2 次, 58天前
- knowledge-graph — 1 次, 52天前
- plan-check-style — 3 次, 55天前
- self-improving-agent — 2 次, 37天前
- session-harvest — 2 次, 26天前
- session-wrap — 1 次, 22天前
- setup-permissions — 3 次, 55天前
- skill-creator — 4 次, 19天前
- sync-readme — 1 次, 36天前
- workflow-retro — 1 次, 9天前

**quality/**
- de-slopify — 2 次, 19天前
- github-repo-audit — 1 次, 23天前
- large-file-refactor — 1 次, 37天前
- qa-auto — 1 次, 52天前
- qa-planner — 1 次, 52天前
- qa-testing — 1 次, 57天前
...
- autoresearch — 1 次, 43天前
- candidate-analysis — 1 次, 41天前
- claude-to-telegram — 1 次, 52天前
- client-kickoff-docs — 1 次, 14天前
- context-recovery — 1 次, 52天前
- crm-projection — 1 次, 51天前
- customer-intel — 4 次, 51天前
- dispatching-parallel-agents — 4 次, 19天前
- env-doctor — 1 次, 14天前
- executing-plans — 3 次, 57天前
- gdrive-to-skills — 2 次, 58天前
- headless-agent — 6 次, 43天前
- investment-research — 3 次, 52天前
- jd-writer — 1 次, 23天前
- keyword-discovery — 1 次, 43天前
- material-health — 1 次, 51天前
- mockup — 1 次, 59天前
- mops-financial-scraper — 1 次, 14天前
- planning-with-files — 5 次, 29天前
- presales-pipeline — 1 次, 14天前
- repro-exam — 1 次, 14天前
- requirement — 2 次, 29天前
- sales-material — 3 次, 15天前
- settings-audit — 1 次, 42天前
- subsidy-scraper — 1 次, 51天前
- tender-scraper — 3 次, 43天前
- user-flow — 1 次, 59天前
- writing-plans — 3 次, 57天前
...
| **Total** | | | **1551.2M** | **$3687.09** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 1,817 | 653.6M | $1670.22 |
| ChimesFlow | 1,345 | 382.2M | $734.20 |
| news-stock | 1,209 | 246.9M | $587.56 |
|  | 635 | 154.4M | $345.03 |
| rivendell | 517 | 100.4M | $294.42 |
| sales-assistant | 198 | 13.0M | $45.40 |
| news_stock | 28 | 603K | $40.77 |
| sales-johnson | 2 | 382K | $6.65 |
| -----backend | 8 | 335K | $3.59 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-06 — 90 skills, 18 issue(s)*
