...
**docs/**
- excalidraw-diagram — 2 次修訂, 10天前

**meta/**
- self-improving-agent — 3 次修訂, 10天前

**workflow/**
- user-flow — 2 次修訂, 11天前

<details><summary>✅ 穩定 (91)</summary>

**backend/**
- audio-transcription-flow — 1 次, 49天前
- db-migration — 1 次, 75天前
- doc-to-structured-data — 1 次, 61天前
- docker-compose-setup — 2 次, 39天前
- firebase-backend — 3 次, 18天前
- imap-smtp-integration — 1 次, 63天前
- markdown-file-ssot — 1 次, 63天前
- oauth-token-vault — 1 次, 63天前
- rbac-permissions — 1 次, 49天前
- sqlite-to-postgres — 2 次, 18天前
- tunnel-proxy-deploy — 1 次, 72天前
- tw-company-lookup — 2 次, 71天前
- vector-search-setup — 1 次, 57天前

**docs/**
- chart-design — 1 次, 8天前
- discovery-interview — 1 次, 49天前
- doc-coauthoring — 2 次, 18天前
- gdoc-report-builder — 2 次, 18天前
- internal-comms — 2 次, 18天前
- iot-factory-report — 2 次, 18天前
- mcp-builder — 3 次, 77天前
- mermaid-diagram — 1 次, 11天前
- metadata-workshop — 2 次, 18天前
- office-docx — 4 次, 48天前
- office-pdf — 3 次, 77天前
- office-pptx — 3 次, 77天前
- office-xlsx — 3 次, 77天前
- pitch-deck — 3 次, 18天前
- rfq-writer — 1 次, 48天前
- slide-office-hours — 2 次, 18天前
- slide-template-extractor — 2 次, 18天前
- slide-workflow — 4 次, 18天前
- sow-writer — 2 次, 18天前
- telegram-bot — 1 次, 72天前

**frontend/**
- frontend-design — 2 次, 78天前
- ios-integration — 1 次, 79天前
- swiftui-patterns — 1 次, 79天前
- ui-ux-pro-max — 3 次, 77天前

**git/**
- auto-stage — 3 次, 18天前
- repo-rename — 1 次, 61天前

**meta/**
- agent-persona — 1 次, 43天前
- audit-fix — 1 次, 75天前
- ci-pipeline — 1 次, 75天前
- deploy — 1 次, 75天前
- dev-process-gate — 4 次, 49天前
- init-project — 2 次, 78天前
- knowledge-graph — 1 次, 72天前
- learnings-promotion-sprint — 1 次, 11天前
- plan-check-style — 3 次, 75天前
- session-harvest — 3 次, 18天前
- session-wrap — 1 次, 42天前
- setup-permissions — 3 次, 75天前
- skill-creator — 4 次, 39天前
- skill-scout — 2 次, 27天前
- sync-readme — 1 次, 56天前
- workflow-retro — 2 次, 18天前

**quality/**
- de-slopify — 2 次, 39天前
- github-repo-audit — 1 次, 43天前
- large-file-refactor — 1 次, 57天前
- protect-secrets — 3 次, 18天前
- qa-auto — 1 次, 72天前
- qa-planner — 1 次, 72天前
- qa-testing — 1 次, 77天前

**workflow/**
- agent-observability — 2 次, 49天前
- autoresearch — 2 次, 18天前
- candidate-analysis — 1 次, 61天前
- claude-to-telegram — 1 次, 72天前
- client-kickoff-docs — 1 次, 34天前
- context-recovery — 1 次, 72天前
- crm-projection — 1 次, 71天前
- customer-intel — 5 次, 18天前
- dispatching-parallel-agents — 4 次, 39天前
- env-doctor — 1 次, 34天前
- executing-plans — 3 次, 77天前
- gdrive-to-skills — 2 次, 78天前
- headless-agent — 6 次, 63天前
- investment-research — 4 次, 18天前
- jd-writer — 1 次, 43天前
- keyword-discovery — 1 次, 63天前
- launchd-agent — 6 次, 18天前
- material-health — 1 次, 71天前
- mockup — 1 次, 79天前
- mops-financial-scraper — 1 次, 34天前
- planning-with-files — 5 次, 49天前
- presales-pipeline — 1 次, 34天前
- repro-exam — 1 次, 34天前
- requirement — 2 次, 49天前
- sales-material — 3 次, 35天前
- settings-audit — 1 次, 62天前
- subsidy-scraper — 1 次, 71天前
- tender-scraper — 3 次, 63天前
- writing-plans — 3 次, 77天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 108 個 commit（本週）, 141 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 9 個 commit（本週）, 9 個（本月） |
| **技術棧** |  Python |
| **分支** | `phase1-rout-to-copper` (2 total) |
| **Git** | 3 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
94df99d fix: POWER_GROUND/MIXED copper layers misclassified as document
501d293 Phase 1.1: real board-edge/rout geometry in the IR
daebbc2 Rule catalog: 61 PTI V3 rules categorized (+ codex corrections)
1f0466b Phase 1.0: Valor ground truth vs current engine (PB0009)
c05efac Revise Phase 1: focused Rout-to-Copper, correct US-8 misdiagnosis
```
</details>
...
xychart-beta
    ...
    y-axis "USD" 0 --> 1350
    bar [245, 58, 1127, 867, 547, 1144, 1288]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-20 (Wed) | 3 | 223 | 105.8M | $245.18 |
...
| 2026-05-26 (Tue) | 3 | 1,557 | 710.4M | $1287.60 |
| **Total** | | | **2636.1M** | **$5275.45** |
...
| -Users-manibari-code-ChimesFlow | 1,351 | 755.1M | $1436.88 |
| -Users-manibari-code-rivendell | 853 | 217.7M | $637.65 |
| -Users-manibari-code-odb-dfm | 501 | 122.8M | $288.11 |
| rivendell | 97 | 47.1M | $96.69 |
| ChimesFlow | 96 | 42.6M | $70.47 |
| -Users-manibari-code-resume-pool | 89 | 10.8M | $65.05 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-sales-assistant | 121 | 6.1M | $28.80 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-26 — 94 skills, 20 issue(s)*
