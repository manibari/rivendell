...
**backend/**
- docker-compose-setup — 2 次修訂, 14天前
- firebase-backend — 2 次修訂, 14天前

**git/**
- auto-stage — 2 次修訂, 3天前

**meta/**
- skill-creator — 4 次修訂, 14天前
- skill-scout — 2 次修訂, 2天前

**quality/**
- de-slopify — 2 次修訂, 14天前
- protect-secrets — 2 次修訂, 3天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 14天前
- launchd-agent — 5 次修訂, 2天前
- sales-material — 3 次修訂, 10天前

<details><summary>✅ 穩定 (79)</summary>

**backend/**
- audio-transcription-flow — 1 次, 24天前
- db-migration — 1 次, 50天前
- doc-to-structured-data — 1 次, 36天前
- imap-smtp-integration — 1 次, 38天前
- markdown-file-ssot — 1 次, 38天前
- oauth-token-vault — 1 次, 38天前
- rbac-permissions — 1 次, 24天前
- sqlite-to-postgres — 1 次, 47天前
- tunnel-proxy-deploy — 1 次, 47天前
- tw-company-lookup — 2 次, 46天前
- vector-search-setup — 1 次, 32天前

**docs/**
- discovery-interview — 1 次, 24天前
- doc-coauthoring — 1 次, 3天前
- gdoc-report-builder — 1 次, 18天前
- internal-comms — 1 次, 3天前
- iot-factory-report — 1 次, 18天前
- mcp-builder — 3 次, 52天前
- metadata-workshop — 1 次, 23天前
- office-docx — 4 次, 23天前
- office-pdf — 3 次, 52天前
- office-pptx — 3 次, 52天前
- office-xlsx — 3 次, 52天前
- pitch-deck — 2 次, 21天前
- rfq-writer — 1 次, 23天前
- slide-template-extractor — 1 次, 21天前
- slide-workflow — 1 次, 17天前
- sow-writer — 1 次, 24天前
- telegram-bot — 1 次, 47天前

**frontend/**
- frontend-design — 2 次, 53天前
- ios-integration — 1 次, 54天前
- swiftui-patterns — 1 次, 54天前
- ui-ux-pro-max — 3 次, 52天前

**git/**
- repo-rename — 1 次, 36天前

**meta/**
- agent-persona — 1 次, 18天前
- audit-fix — 1 次, 50天前
- ci-pipeline — 1 次, 50天前
- deploy — 1 次, 50天前
- dev-process-gate — 4 次, 24天前
- init-project — 2 次, 53天前
- knowledge-graph — 1 次, 47天前
- plan-check-style — 3 次, 50天前
- self-improving-agent — 2 次, 32天前
- session-harvest — 2 次, 21天前
- session-wrap — 1 次, 17天前
- setup-permissions — 3 次, 50天前
- sync-readme — 1 次, 31天前
- workflow-retro — 1 次, 4天前

**quality/**
- github-repo-audit — 1 次, 18天前
- large-file-refactor — 1 次, 32天前
- qa-auto — 1 次, 47天前
- qa-planner — 1 次, 47天前
- qa-testing — 1 次, 52天前
...
- autoresearch — 1 次, 38天前
- candidate-analysis — 1 次, 36天前
- claude-to-telegram — 1 次, 47天前
- client-kickoff-docs — 1 次, 9天前
- context-recovery — 1 次, 47天前
- crm-projection — 1 次, 46天前
- customer-intel — 4 次, 46天前
- env-doctor — 1 次, 9天前
- executing-plans — 3 次, 52天前
- gdrive-to-skills — 2 次, 53天前
- headless-agent — 6 次, 38天前
- investment-research — 3 次, 47天前
- jd-writer — 1 次, 18天前
- keyword-discovery — 1 次, 38天前
- material-health — 1 次, 46天前
- mockup — 1 次, 54天前
- mops-financial-scraper — 1 次, 9天前
- planning-with-files — 5 次, 24天前
- presales-pipeline — 1 次, 9天前
- repro-exam — 1 次, 9天前
- requirement — 2 次, 24天前
- settings-audit — 1 次, 37天前
- subsidy-scraper — 1 次, 46天前
- tender-scraper — 3 次, 38天前
- user-flow — 1 次, 54天前
- writing-plans — 3 次, 52天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-25", "04-26", "04-27", "04-28", "04-29", "04-30", "05-01"]
    y-axis "USD" 0 --> 1850
    bar [385, 71, 1755, 929, 731, 660, 4]
~~~
...
| 2026-04-30 (Thu) | 9 | 694 | 282.6M | $659.66 |
| 2026-05-01 (Fri) | 1 | 17 | 1.3M | $3.58 |
| **Total** | | | **1898.0M** | **$4533.84** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| news-stock | 1,957 | 673.2M | $1424.72 |
...
| -Users-manibari-Documents | 70 | 34.4M | $100.09 |
| ChimesFlow | 267 | 42.0M | $88.55 |
| sales-assistant | 326 | 22.9M | $81.72 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-01 — 89 skills, 19 issue(s)*
