...
**backend/**
- firebase-backend — 3 次修訂, 13天前
- sqlite-to-postgres — 2 次修訂, 13天前

**docs/**
- doc-coauthoring — 2 次修訂, 13天前
- excalidraw-diagram — 2 次修訂, 5天前
- gdoc-report-builder — 2 次修訂, 13天前
- internal-comms — 2 次修訂, 13天前
- iot-factory-report — 2 次修訂, 13天前
- metadata-workshop — 2 次修訂, 13天前
- pitch-deck — 3 次修訂, 13天前
- slide-office-hours — 2 次修訂, 13天前
- slide-template-extractor — 2 次修訂, 13天前
- slide-workflow — 4 次修訂, 13天前
- sow-writer — 2 次修訂, 13天前

**git/**
- auto-stage — 3 次修訂, 13天前

**meta/**
- self-improving-agent — 3 次修訂, 5天前
- session-harvest — 3 次修訂, 13天前
- workflow-retro — 2 次修訂, 13天前

**quality/**
- protect-secrets — 3 次修訂, 13天前

**workflow/**
- autoresearch — 2 次修訂, 13天前
- customer-intel — 5 次修訂, 13天前
- investment-research — 4 次修訂, 13天前
- launchd-agent — 6 次修訂, 13天前
- user-flow — 2 次修訂, 6天前

<details><summary>✅ 穩定 (71)</summary>

**backend/**
- audio-transcription-flow — 1 次, 44天前
- db-migration — 1 次, 70天前
- doc-to-structured-data — 1 次, 56天前
- docker-compose-setup — 2 次, 34天前
- imap-smtp-integration — 1 次, 58天前
- markdown-file-ssot — 1 次, 58天前
- oauth-token-vault — 1 次, 58天前
- rbac-permissions — 1 次, 44天前
- tunnel-proxy-deploy — 1 次, 67天前
- tw-company-lookup — 2 次, 66天前
- vector-search-setup — 1 次, 52天前

**docs/**
- chart-design — 1 次, 3天前
- discovery-interview — 1 次, 44天前
- mcp-builder — 3 次, 72天前
- mermaid-diagram — 1 次, 6天前
- office-docx — 4 次, 43天前
- office-pdf — 3 次, 72天前
- office-pptx — 3 次, 72天前
- office-xlsx — 3 次, 72天前
- rfq-writer — 1 次, 43天前
- telegram-bot — 1 次, 67天前

**frontend/**
- frontend-design — 2 次, 73天前
- ios-integration — 1 次, 74天前
- swiftui-patterns — 1 次, 74天前
- ui-ux-pro-max — 3 次, 72天前

**git/**
- repo-rename — 1 次, 56天前

**meta/**
- agent-persona — 1 次, 38天前
- audit-fix — 1 次, 70天前
- ci-pipeline — 1 次, 70天前
- deploy — 1 次, 70天前
- dev-process-gate — 4 次, 44天前
- init-project — 2 次, 73天前
- knowledge-graph — 1 次, 67天前
- learnings-promotion-sprint — 1 次, 6天前
- plan-check-style — 3 次, 70天前
- session-wrap — 1 次, 37天前
- setup-permissions — 3 次, 70天前
- skill-creator — 4 次, 34天前
- skill-scout — 2 次, 22天前
- sync-readme — 1 次, 51天前

**quality/**
- de-slopify — 2 次, 34天前
- github-repo-audit — 1 次, 38天前
- large-file-refactor — 1 次, 52天前
- qa-auto — 1 次, 67天前
- qa-planner — 1 次, 67天前
- qa-testing — 1 次, 72天前

**workflow/**
- agent-observability — 2 次, 44天前
- candidate-analysis — 1 次, 56天前
- claude-to-telegram — 1 次, 67天前
- client-kickoff-docs — 1 次, 29天前
- context-recovery — 1 次, 67天前
- crm-projection — 1 次, 66天前
- dispatching-parallel-agents — 4 次, 34天前
- env-doctor — 1 次, 29天前
- executing-plans — 3 次, 72天前
- gdrive-to-skills — 2 次, 73天前
- headless-agent — 6 次, 58天前
- jd-writer — 1 次, 38天前
- keyword-discovery — 1 次, 58天前
- material-health — 1 次, 66天前
- mockup — 1 次, 74天前
- mops-financial-scraper — 1 次, 29天前
- planning-with-files — 5 次, 44天前
- presales-pipeline — 1 次, 29天前
- repro-exam — 1 次, 29天前
- requirement — 2 次, 44天前
- sales-material — 3 次, 30天前
- settings-audit — 1 次, 57天前
- subsidy-scraper — 1 次, 66天前
- tender-scraper — 3 次, 58天前
- writing-plans — 3 次, 72天前
...
```
b088976 feat: admin logs viewer at /admin/logs (5th child of 管理 group)
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-15", "05-16", "05-17", "05-18", "05-19", "05-20", "05-21"]
    y-axis "USD" 0 --> 950
    bar [761, 3, 56, 549, 871, 245, 54]
~~~
...
| 2026-05-21 (Thu) | 5 | 37 | 8.1M | $53.50 |
| **Total** | | | **1010.8M** | **$2539.00** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| ChimesFlow | 1,322 | 381.0M | $963.59 |
| rivendell | 1,274 | 376.4M | $849.16 |
| -Users-manibari-Documents-Peter-Work | 1,055 | 209.0M | $543.65 |
| news-stock | 323 | 31.7M | $137.68 |
| sales-assistant | 203 | 12.8M | $44.92 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-21 — 94 skills, 20 issue(s)*
