...
**git/**
- auto-stage — 2 次修訂, 5天前

**meta/**
- skill-scout — 2 次修訂, 4天前

**quality/**
- protect-secrets — 2 次修訂, 5天前

**workflow/**
- launchd-agent — 5 次修訂, 4天前
- sales-material — 3 次修訂, 12天前

<details><summary>✅ 穩定 (84)</summary>

**backend/**
- audio-transcription-flow — 1 次, 26天前
- db-migration — 1 次, 52天前
- doc-to-structured-data — 1 次, 38天前
- docker-compose-setup — 2 次, 16天前
- firebase-backend — 2 次, 16天前
- imap-smtp-integration — 1 次, 40天前
- markdown-file-ssot — 1 次, 40天前
- oauth-token-vault — 1 次, 40天前
- rbac-permissions — 1 次, 26天前
- sqlite-to-postgres — 1 次, 49天前
- tunnel-proxy-deploy — 1 次, 49天前
- tw-company-lookup — 2 次, 48天前
- vector-search-setup — 1 次, 34天前

**docs/**
- discovery-interview — 1 次, 26天前
- doc-coauthoring — 1 次, 5天前
- gdoc-report-builder — 1 次, 20天前
- internal-comms — 1 次, 5天前
- iot-factory-report — 1 次, 20天前
- mcp-builder — 3 次, 54天前
- metadata-workshop — 1 次, 25天前
- office-docx — 4 次, 25天前
- office-pdf — 3 次, 54天前
- office-pptx — 3 次, 54天前
- office-xlsx — 3 次, 54天前
- pitch-deck — 2 次, 23天前
- rfq-writer — 1 次, 25天前
- slide-template-extractor — 1 次, 23天前
- slide-workflow — 1 次, 19天前
- sow-writer — 1 次, 26天前
- telegram-bot — 1 次, 49天前

**frontend/**
- frontend-design — 2 次, 55天前
- ios-integration — 1 次, 56天前
- swiftui-patterns — 1 次, 56天前
- ui-ux-pro-max — 3 次, 54天前

**git/**
- repo-rename — 1 次, 38天前

**meta/**
- agent-persona — 1 次, 20天前
- audit-fix — 1 次, 52天前
- ci-pipeline — 1 次, 52天前
- deploy — 1 次, 52天前
- dev-process-gate — 4 次, 26天前
- init-project — 2 次, 55天前
- knowledge-graph — 1 次, 49天前
- plan-check-style — 3 次, 52天前
- self-improving-agent — 2 次, 34天前
- session-harvest — 2 次, 23天前
- session-wrap — 1 次, 19天前
- setup-permissions — 3 次, 52天前
- skill-creator — 4 次, 16天前
- sync-readme — 1 次, 33天前
- workflow-retro — 1 次, 6天前

**quality/**
- de-slopify — 2 次, 16天前
- github-repo-audit — 1 次, 20天前
- large-file-refactor — 1 次, 34天前
- qa-auto — 1 次, 49天前
- qa-planner — 1 次, 49天前
- qa-testing — 1 次, 54天前
...
- autoresearch — 1 次, 40天前
- candidate-analysis — 1 次, 38天前
- claude-to-telegram — 1 次, 49天前
- client-kickoff-docs — 1 次, 11天前
- context-recovery — 1 次, 49天前
- crm-projection — 1 次, 48天前
- customer-intel — 4 次, 48天前
- dispatching-parallel-agents — 4 次, 16天前
- env-doctor — 1 次, 11天前
- executing-plans — 3 次, 54天前
- gdrive-to-skills — 2 次, 55天前
- headless-agent — 6 次, 40天前
- investment-research — 3 次, 49天前
- jd-writer — 1 次, 20天前
- keyword-discovery — 1 次, 40天前
- material-health — 1 次, 48天前
- mockup — 1 次, 56天前
- mops-financial-scraper — 1 次, 11天前
- planning-with-files — 5 次, 26天前
- presales-pipeline — 1 次, 11天前
- repro-exam — 1 次, 11天前
- requirement — 2 次, 26天前
- settings-audit — 1 次, 39天前
- subsidy-scraper — 1 次, 48天前
- tender-scraper — 3 次, 40天前
- user-flow — 1 次, 56天前
- writing-plans — 3 次, 54天前
...
```
a463773 chore(ai-chain): align config with DB pool — add SNDK + WOLF
d7931ff feat(strategy): calendar + multi-horizon adaptive momentum variants
cb44934 feat(collection): per-symbol progress for stock collectors
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-27", "04-28", "04-29", "04-30", "05-01", "05-02", "05-03"]
    y-axis "USD" 0 --> 1850
    bar [1755, 929, 731, 660, 4, 0, 268]
~~~
...
| 2026-05-03 (Sun) | 10 | 839 | 95.5M | $268.49 |
| **Total** | | | **1816.1M** | **$4346.65** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| news-stock | 2,280 | 723.3M | $1533.04 |
| -Users-manibari-Documents-Peter-Work | 1,747 | 520.6M | $1334.72 |
| -Users-manibari-Documents-Peter | 762 | 257.7M | $585.13 |
| rivendell | 576 | 116.1M | $374.54 |
|  | 574 | 95.2M | $243.61 |
| sales-johnson | 358 | 39.8M | $110.89 |
| ChimesFlow | 288 | 42.9M | $92.37 |
| sales-assistant | 279 | 20.4M | $72.35 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-03 — 90 skills, 18 issue(s)*
