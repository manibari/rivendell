...
**docs/**
- excalidraw-diagram — 2 次修訂, 11天前

**meta/**
- self-improving-agent — 3 次修訂, 11天前

**workflow/**
- user-flow — 2 次修訂, 12天前

<details><summary>✅ 穩定 (91)</summary>

**backend/**
- audio-transcription-flow — 1 次, 50天前
- db-migration — 1 次, 76天前
- doc-to-structured-data — 1 次, 62天前
- docker-compose-setup — 2 次, 40天前
- firebase-backend — 3 次, 19天前
- imap-smtp-integration — 1 次, 64天前
- markdown-file-ssot — 1 次, 64天前
- oauth-token-vault — 1 次, 64天前
- rbac-permissions — 1 次, 50天前
- sqlite-to-postgres — 2 次, 19天前
- tunnel-proxy-deploy — 1 次, 73天前
- tw-company-lookup — 2 次, 72天前
- vector-search-setup — 1 次, 58天前

**docs/**
- chart-design — 1 次, 9天前
- discovery-interview — 1 次, 50天前
- doc-coauthoring — 2 次, 19天前
- gdoc-report-builder — 2 次, 19天前
- internal-comms — 2 次, 19天前
- iot-factory-report — 2 次, 19天前
- mcp-builder — 3 次, 78天前
- mermaid-diagram — 1 次, 12天前
- metadata-workshop — 2 次, 19天前
- office-docx — 4 次, 49天前
- office-pdf — 3 次, 78天前
- office-pptx — 3 次, 78天前
- office-xlsx — 3 次, 78天前
- pitch-deck — 3 次, 19天前
- rfq-writer — 1 次, 49天前
- slide-office-hours — 2 次, 19天前
- slide-template-extractor — 2 次, 19天前
- slide-workflow — 4 次, 19天前
- sow-writer — 2 次, 19天前
- telegram-bot — 1 次, 73天前

**frontend/**
- frontend-design — 2 次, 79天前
- ios-integration — 1 次, 80天前
- swiftui-patterns — 1 次, 80天前
- ui-ux-pro-max — 3 次, 78天前

**git/**
- auto-stage — 3 次, 19天前
- repo-rename — 1 次, 62天前

**meta/**
- agent-persona — 1 次, 44天前
- audit-fix — 1 次, 76天前
- ci-pipeline — 1 次, 76天前
- deploy — 1 次, 76天前
- dev-process-gate — 4 次, 50天前
- init-project — 2 次, 79天前
- knowledge-graph — 1 次, 73天前
- learnings-promotion-sprint — 1 次, 12天前
- plan-check-style — 3 次, 76天前
- session-harvest — 3 次, 19天前
- session-wrap — 1 次, 43天前
- setup-permissions — 3 次, 76天前
- skill-creator — 4 次, 40天前
- skill-scout — 2 次, 28天前
- sync-readme — 1 次, 57天前
- workflow-retro — 2 次, 19天前

**quality/**
- de-slopify — 2 次, 40天前
- github-repo-audit — 1 次, 44天前
- large-file-refactor — 1 次, 58天前
- protect-secrets — 3 次, 19天前
- qa-auto — 1 次, 73天前
- qa-planner — 1 次, 73天前
- qa-testing — 1 次, 78天前

**workflow/**
- agent-observability — 2 次, 50天前
- autoresearch — 2 次, 19天前
- candidate-analysis — 1 次, 62天前
- claude-to-telegram — 1 次, 73天前
- client-kickoff-docs — 1 次, 35天前
- context-recovery — 1 次, 73天前
- crm-projection — 1 次, 72天前
- customer-intel — 5 次, 19天前
- dispatching-parallel-agents — 4 次, 40天前
- env-doctor — 1 次, 35天前
- executing-plans — 3 次, 78天前
- gdrive-to-skills — 2 次, 79天前
- headless-agent — 6 次, 64天前
- investment-research — 4 次, 19天前
- jd-writer — 1 次, 44天前
- keyword-discovery — 1 次, 64天前
- launchd-agent — 6 次, 19天前
- material-health — 1 次, 72天前
- mockup — 1 次, 80天前
- mops-financial-scraper — 1 次, 35天前
- planning-with-files — 5 次, 50天前
- presales-pipeline — 1 次, 35天前
- repro-exam — 1 次, 35天前
- requirement — 2 次, 50天前
- sales-material — 3 次, 36天前
- settings-audit — 1 次, 63天前
- subsidy-scraper — 1 次, 72天前
- tender-scraper — 3 次, 64天前
- writing-plans — 3 次, 78天前
...
```
f9d2449 chore(roles): wire admin/roadmap through lib/roles too
5f1e2e7 feat(rbac): partner_contact as standalone permission entity
12de872 feat(rbac+ux): grouped permissions matrix; soft-deleted blocker count; ROLE consts
728c102 fix(accounts): friendly error when delete blocked by related records
a6fbb42 feat(quotes): bill-to partner shown on detail + carried into PDF/DOCX export
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 37 個 commit（本週）, 37 個（本月） |
| **技術棧** |  Python |
| **分支** | `physical-component-model` (4 total) |
| **Git** | 2 dirty, 3 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
83a9530 viewers: real copper pours, component-edge measure, connection-point flip, real comp pads
169d00d footprint: outline matches real prototype — OC arcs + NO_BODY suppression
468461f lib viewer: real on-board footprints + related DFM rules; layer viewer polish
8f755e5 tools(layer_view): drill/via taxonomy, SMT point hover, viaplug, PTI lib id
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-21", "05-22", "05-23", "05-24", "05-25", "05-26", "05-27"]
    y-axis "USD" 0 --> 2050
    bar [58, 1127, 867, 547, 1144, 1964, 1497]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-21 (Thu) | 6 | 41 | 10.2M | $57.63 |
| 2026-05-22 (Fri) | 5 | 902 | 570.9M | $1127.10 |
...
| 2026-05-27 (Wed) | 2 | 1,517 | 797.3M | $1496.65 |
| **Total** | | | **3656.9M** | **$7203.65** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code | 3,007 | 1427.7M | $2621.28 |
| -Users-manibari-code-odb-dfm | 2,858 | 1245.5M | $2424.21 |
| -Users-manibari-code-ChimesFlow | 1,137 | 649.7M | $1193.61 |
| -Users-manibari-code-rivendell | 887 | 221.6M | $674.92 |
| rivendell | 97 | 47.1M | $96.69 |
| ChimesFlow | 96 | 42.6M | $70.47 |
| -Users-manibari-code-resume-pool | 89 | 10.8M | $65.05 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-sales-assistant | 113 | 5.7M | $26.88 |
| -Users-manibari-code-news-stock | 44 | 4.6M | $22.25 |
| -Users-manibari-Documents-Peter-Work | 27 | 1.5M | $8.28 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-27 — 94 skills, 20 issue(s)*
