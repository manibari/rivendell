...
**backend/**
- firebase-backend — 3 次修訂, 7天前
- sqlite-to-postgres — 2 次修訂, 7天前

**docs/**
- doc-coauthoring — 2 次修訂, 7天前
- gdoc-report-builder — 2 次修訂, 7天前
- internal-comms — 2 次修訂, 7天前
- iot-factory-report — 2 次修訂, 7天前
- metadata-workshop — 2 次修訂, 7天前
- pitch-deck — 3 次修訂, 7天前
- slide-office-hours — 2 次修訂, 7天前
- slide-template-extractor — 2 次修訂, 7天前
- slide-workflow — 4 次修訂, 7天前
- sow-writer — 2 次修訂, 7天前

**git/**
- auto-stage — 3 次修訂, 7天前

**meta/**
- session-harvest — 3 次修訂, 7天前
- workflow-retro — 2 次修訂, 7天前

**quality/**
- protect-secrets — 3 次修訂, 7天前

**workflow/**
- autoresearch — 2 次修訂, 7天前
- customer-intel — 5 次修訂, 7天前
- investment-research — 4 次修訂, 7天前
- launchd-agent — 6 次修訂, 7天前
- user-flow — 2 次修訂, 0天前

<details><summary>✅ 穩定 (72)</summary>

**backend/**
- audio-transcription-flow — 1 次, 38天前
- db-migration — 1 次, 64天前
- doc-to-structured-data — 1 次, 50天前
- docker-compose-setup — 2 次, 28天前
- imap-smtp-integration — 1 次, 52天前
- markdown-file-ssot — 1 次, 52天前
- oauth-token-vault — 1 次, 52天前
- rbac-permissions — 1 次, 38天前
- tunnel-proxy-deploy — 1 次, 61天前
- tw-company-lookup — 2 次, 60天前
- vector-search-setup — 1 次, 46天前

**docs/**
- discovery-interview — 1 次, 38天前
- excalidraw-diagram — 1 次, 0天前
- mcp-builder — 3 次, 66天前
- mermaid-diagram — 1 次, 0天前
- office-docx — 4 次, 37天前
- office-pdf — 3 次, 66天前
- office-pptx — 3 次, 66天前
- office-xlsx — 3 次, 66天前
- rfq-writer — 1 次, 37天前
- telegram-bot — 1 次, 61天前

**frontend/**
- frontend-design — 2 次, 67天前
- ios-integration — 1 次, 68天前
- swiftui-patterns — 1 次, 68天前
- ui-ux-pro-max — 3 次, 66天前

**git/**
- repo-rename — 1 次, 50天前

**meta/**
- agent-persona — 1 次, 32天前
- audit-fix — 1 次, 64天前
- ci-pipeline — 1 次, 64天前
- deploy — 1 次, 64天前
- dev-process-gate — 4 次, 38天前
- init-project — 2 次, 67天前
- knowledge-graph — 1 次, 61天前
- learnings-promotion-sprint — 1 次, 0天前
- plan-check-style — 3 次, 64天前
- self-improving-agent — 2 次, 46天前
- session-wrap — 1 次, 31天前
- setup-permissions — 3 次, 64天前
- skill-creator — 4 次, 28天前
- skill-scout — 2 次, 16天前
- sync-readme — 1 次, 45天前

**quality/**
- de-slopify — 2 次, 28天前
- github-repo-audit — 1 次, 32天前
- large-file-refactor — 1 次, 46天前
- qa-auto — 1 次, 61天前
- qa-planner — 1 次, 61天前
- qa-testing — 1 次, 66天前
...
- candidate-analysis — 1 次, 50天前
- claude-to-telegram — 1 次, 61天前
- client-kickoff-docs — 1 次, 23天前
- context-recovery — 1 次, 61天前
- crm-projection — 1 次, 60天前
- dispatching-parallel-agents — 4 次, 28天前
- env-doctor — 1 次, 23天前
- executing-plans — 3 次, 66天前
- gdrive-to-skills — 2 次, 67天前
- headless-agent — 6 次, 52天前
- jd-writer — 1 次, 32天前
- keyword-discovery — 1 次, 52天前
- material-health — 1 次, 60天前
- mockup — 1 次, 68天前
- mops-financial-scraper — 1 次, 23天前
- planning-with-files — 5 次, 38天前
- presales-pipeline — 1 次, 23天前
- repro-exam — 1 次, 23天前
- requirement — 2 次, 38天前
- sales-material — 3 次, 24天前
- settings-audit — 1 次, 51天前
- subsidy-scraper — 1 次, 60天前
- tender-scraper — 3 次, 52天前
- writing-plans — 3 次, 66天前
...
```
70833e5 chore(cloudflared): force protocol: http2 for tunnel resilience
ad82760 feat(backend): Phase 3+4 — trash list + restore + permanent delete endpoints
a7388f0 feat(backend): Phase 2 — exclude soft-deleted from all read paths via active_opps() helper
c5cd863 feat(backend): Phase 1 — soft-delete + cascade on DELETE /api/opportunities/{id}
5de5a0e docs(plans): record ENG CLEARED status in business-card-import + mobile-redesign progress.md
```
</details>
...
fcff5f6 chore(agent): research-agent-daily run 2026-05-14
a406c5c refactor(collection): unified HTTP layer + incremental skip (Phase 0-2)
f4178c4 docs(scraping): add scraping architecture doc + Streamlit retirement plan
aca7875 chore(agent): research-agent-daily run 2026-05-13
```
</details>
...
```
7982713 PCBGeneral0041 outline filter: degenerate-only (4 → 12 violations)
a15aaa3 R3.2: tolerance framework — CP0011/CP0030 exact match vs Carol 2026
bf77481 CP0011 rotation-aware pad axis (removes J3 false positives)
d982cc0 R3.1: calibrate violation counts against Valor 2022 baseline
c879d6c R3: PCBGeneral0041 + fix INCH layer unit normalization bug
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-09", "05-10", "05-11", "05-12", "05-13", "05-14", "05-15"]
    y-axis "USD" 0 --> 800
    bar [38, 80, 454, 471, 522, 743, 546]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-09 (Sat) | 5 | 97 | 7.9M | $37.52 |
| 2026-05-10 (Sun) | 9 | 279 | 20.4M | $80.30 |
| 2026-05-11 (Mon) | 11 | 961 | 159.4M | $454.20 |
| 2026-05-12 (Tue) | 12 | 804 | 158.9M | $470.86 |
| 2026-05-13 (Wed) | 12 | 847 | 169.1M | $522.44 |
| 2026-05-14 (Thu) | 9 | 869 | 318.5M | $743.28 |
| 2026-05-15 (Fri) | 7 | 989 | 248.3M | $546.04 |
| **Total** | | | **1082.6M** | **$2854.63** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 1,699 | 381.2M | $1110.21 |
| ChimesFlow | 891 | 305.5M | $669.61 |
| rivendell | 978 | 225.6M | $477.88 |
| -Users-manibari-Documents-Projects | 333 | 66.9M | $189.07 |
| news-stock | 379 | 37.0M | $154.97 |
| -Users-manibari-Documents-Peter | 138 | 23.7M | $91.51 |
| resume-pool | 108 | 21.7M | $68.23 |
| sales-assistant | 268 | 16.8M | $60.78 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter-Family | 52 | 4.1M | $32.37 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-15 — 93 skills, 20 issue(s)*
