...
**backend/**
- firebase-backend — 3 次修訂, 1天前
- sqlite-to-postgres — 2 次修訂, 1天前

**docs/**
- doc-coauthoring — 2 次修訂, 1天前
- gdoc-report-builder — 2 次修訂, 1天前
- internal-comms — 2 次修訂, 1天前
- iot-factory-report — 2 次修訂, 1天前
- metadata-workshop — 2 次修訂, 1天前
- pitch-deck — 3 次修訂, 1天前
- slide-office-hours — 2 次修訂, 1天前
- slide-template-extractor — 2 次修訂, 1天前
- slide-workflow — 4 次修訂, 1天前
- sow-writer — 2 次修訂, 1天前

**git/**
- auto-stage — 3 次修訂, 1天前

**meta/**
- session-harvest — 3 次修訂, 1天前
- skill-scout — 2 次修訂, 10天前
- workflow-retro — 2 次修訂, 1天前

**quality/**
- protect-secrets — 3 次修訂, 1天前

**workflow/**
- autoresearch — 2 次修訂, 1天前
- customer-intel — 5 次修訂, 1天前
- investment-research — 4 次修訂, 1天前
- launchd-agent — 6 次修訂, 1天前

<details><summary>✅ 穩定 (69)</summary>

**backend/**
- audio-transcription-flow — 1 次, 32天前
- db-migration — 1 次, 58天前
- doc-to-structured-data — 1 次, 44天前
- docker-compose-setup — 2 次, 22天前
- imap-smtp-integration — 1 次, 46天前
- markdown-file-ssot — 1 次, 46天前
- oauth-token-vault — 1 次, 46天前
- rbac-permissions — 1 次, 32天前
- tunnel-proxy-deploy — 1 次, 55天前
- tw-company-lookup — 2 次, 54天前
- vector-search-setup — 1 次, 40天前

**docs/**
- discovery-interview — 1 次, 32天前
- mcp-builder — 3 次, 60天前
- office-docx — 4 次, 31天前
- office-pdf — 3 次, 60天前
- office-pptx — 3 次, 60天前
- office-xlsx — 3 次, 60天前
- rfq-writer — 1 次, 31天前
- telegram-bot — 1 次, 55天前

**frontend/**
- frontend-design — 2 次, 61天前
- ios-integration — 1 次, 62天前
- swiftui-patterns — 1 次, 62天前
- ui-ux-pro-max — 3 次, 60天前

**git/**
- repo-rename — 1 次, 44天前

**meta/**
- agent-persona — 1 次, 26天前
- audit-fix — 1 次, 58天前
- ci-pipeline — 1 次, 58天前
- deploy — 1 次, 58天前
- dev-process-gate — 4 次, 32天前
- init-project — 2 次, 61天前
- knowledge-graph — 1 次, 55天前
- plan-check-style — 3 次, 58天前
- self-improving-agent — 2 次, 40天前
- session-wrap — 1 次, 25天前
- setup-permissions — 3 次, 58天前
- skill-creator — 4 次, 22天前
- sync-readme — 1 次, 39天前

**quality/**
- de-slopify — 2 次, 22天前
- github-repo-audit — 1 次, 26天前
- large-file-refactor — 1 次, 40天前
- qa-auto — 1 次, 55天前
- qa-planner — 1 次, 55天前
- qa-testing — 1 次, 60天前
...
- candidate-analysis — 1 次, 44天前
- claude-to-telegram — 1 次, 55天前
- client-kickoff-docs — 1 次, 17天前
- context-recovery — 1 次, 55天前
- crm-projection — 1 次, 54天前
- dispatching-parallel-agents — 4 次, 22天前
- env-doctor — 1 次, 17天前
- executing-plans — 3 次, 60天前
- gdrive-to-skills — 2 次, 61天前
- headless-agent — 6 次, 46天前
- jd-writer — 1 次, 26天前
- keyword-discovery — 1 次, 46天前
- material-health — 1 次, 54天前
- mockup — 1 次, 62天前
- mops-financial-scraper — 1 次, 17天前
- planning-with-files — 5 次, 32天前
- presales-pipeline — 1 次, 17天前
- repro-exam — 1 次, 17天前
- requirement — 2 次, 32天前
- sales-material — 3 次, 18天前
- settings-audit — 1 次, 45天前
- subsidy-scraper — 1 次, 54天前
- tender-scraper — 3 次, 46天前
- user-flow — 1 次, 62天前
- writing-plans — 3 次, 60天前
...
8b6dad5 feat(rbac): scope targets to self for sales and hide 業態管理 from non-admins
```
</details>
...
7108b75 chore(agent): research-agent-daily run 2026-05-07
5e5217d chore(mops): bump RATE_LIMIT_SLEEP 1.0s → 2.0s to ease throttling
ea15947 chore(agent): research-agent-daily run 2026-05-06
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-03", "05-04", "05-05", "05-06", "05-07", "05-08", "05-09"]
    y-axis "USD" 0 --> 1150
    bar [407, 763, 1060, 793, 1018, 846, 9]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-03 (Sun) | 14 | 1,165 | 155.0M | $407.44 |
| 2026-05-04 (Mon) | 10 | 1,089 | 292.8M | $763.24 |
...
| 2026-05-09 (Sat) | 3 | 26 | 1.4M | $8.72 |
| **Total** | | | **2038.8M** | **$4896.42** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 2,497 | 706.4M | $1817.54 |
| ChimesFlow | 1,958 | 525.8M | $1056.51 |
| rivendell | 972 | 290.1M | $746.47 |
| news-stock | 1,497 | 276.1M | $695.39 |
|  | 635 | 154.4M | $345.03 |
| -Users-manibari-Documents-Peter-Family | 334 | 71.7M | $179.33 |
| sales-assistant | 228 | 12.8M | $44.05 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter | 18 | 1.2M | $8.50 |
| -----backend | 8 | 335K | $3.59 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-09 — 90 skills, 19 issue(s)*
