...
**docs/**
- excalidraw-diagram — 2 次修訂, 14天前

**meta/**
- self-improving-agent — 3 次修訂, 14天前

<details><summary>✅ 穩定 (92)</summary>

**backend/**
- audio-transcription-flow — 1 次, 53天前
- db-migration — 1 次, 79天前
- doc-to-structured-data — 1 次, 65天前
- docker-compose-setup — 2 次, 43天前
- firebase-backend — 3 次, 22天前
- imap-smtp-integration — 1 次, 67天前
- markdown-file-ssot — 1 次, 67天前
- oauth-token-vault — 1 次, 67天前
- rbac-permissions — 1 次, 53天前
- sqlite-to-postgres — 2 次, 22天前
- tunnel-proxy-deploy — 1 次, 76天前
- tw-company-lookup — 2 次, 75天前
- vector-search-setup — 1 次, 61天前

**docs/**
- chart-design — 1 次, 12天前
- discovery-interview — 1 次, 53天前
- doc-coauthoring — 2 次, 22天前
- gdoc-report-builder — 2 次, 22天前
- internal-comms — 2 次, 22天前
- iot-factory-report — 2 次, 22天前
- mcp-builder — 3 次, 81天前
- mermaid-diagram — 1 次, 15天前
- metadata-workshop — 2 次, 22天前
- office-docx — 4 次, 52天前
- office-pdf — 3 次, 81天前
- office-pptx — 3 次, 81天前
- office-xlsx — 3 次, 81天前
- pitch-deck — 3 次, 22天前
- rfq-writer — 1 次, 52天前
- slide-office-hours — 2 次, 22天前
- slide-template-extractor — 2 次, 22天前
- slide-workflow — 4 次, 22天前
- sow-writer — 2 次, 22天前
- telegram-bot — 1 次, 76天前

**frontend/**
- frontend-design — 2 次, 82天前
- ios-integration — 1 次, 83天前
- swiftui-patterns — 1 次, 83天前
- ui-ux-pro-max — 3 次, 81天前

**git/**
- auto-stage — 3 次, 22天前
- repo-rename — 1 次, 65天前

**meta/**
- agent-persona — 1 次, 47天前
- audit-fix — 1 次, 79天前
- ci-pipeline — 1 次, 79天前
- deploy — 1 次, 79天前
- dev-process-gate — 4 次, 53天前
- init-project — 2 次, 82天前
- knowledge-graph — 1 次, 76天前
- learnings-promotion-sprint — 1 次, 15天前
- plan-check-style — 3 次, 79天前
- session-harvest — 3 次, 22天前
- session-wrap — 1 次, 46天前
- setup-permissions — 3 次, 79天前
- skill-creator — 4 次, 43天前
- skill-scout — 2 次, 31天前
- sync-readme — 1 次, 60天前
- workflow-retro — 2 次, 22天前

**quality/**
- de-slopify — 2 次, 43天前
- github-repo-audit — 1 次, 47天前
- large-file-refactor — 1 次, 61天前
- protect-secrets — 3 次, 22天前
- qa-auto — 1 次, 76天前
- qa-planner — 1 次, 76天前
- qa-testing — 1 次, 81天前

**workflow/**
- agent-observability — 2 次, 53天前
- autoresearch — 2 次, 22天前
- candidate-analysis — 1 次, 65天前
- claude-to-telegram — 1 次, 76天前
- client-kickoff-docs — 1 次, 38天前
- context-recovery — 1 次, 76天前
- crm-projection — 1 次, 75天前
- customer-intel — 5 次, 22天前
- dispatching-parallel-agents — 4 次, 43天前
- env-doctor — 1 次, 38天前
- executing-plans — 3 次, 81天前
- gdrive-to-skills — 2 次, 82天前
- headless-agent — 6 次, 67天前
- investment-research — 4 次, 22天前
- jd-writer — 1 次, 47天前
- keyword-discovery — 1 次, 67天前
- launchd-agent — 6 次, 22天前
- material-health — 1 次, 75天前
- mockup — 1 次, 83天前
- mops-financial-scraper — 1 次, 38天前
- planning-with-files — 5 次, 53天前
- presales-pipeline — 1 次, 38天前
- repro-exam — 1 次, 38天前
- requirement — 2 次, 53天前
- sales-material — 3 次, 39天前
- settings-audit — 1 次, 66天前
- subsidy-scraper — 1 次, 75天前
- tender-scraper — 3 次, 67天前
- user-flow — 2 次, 15天前
- writing-plans — 3 次, 81天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 107 個 commit（本週）, 172 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 3 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
a757774 fix(dashboard): widget hit 422 on page_size=200 — clamp to 100
98f1495 feat(partners): 從政府資料補齊 + capital column (mirror of accounts work)
96f832e feat(crm): accounts.capital column + fix dashboard widget stuck spinner
bc5b20d feat(crm): tax_id dedup warnings (form + bulk) + reports gate
f974e1d fix(crm): enrich now also standardizes 簡寫 → 全名
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-24", "05-25", "05-26", "05-27", "05-28", "05-29", "05-30"]
    y-axis "USD" 0 --> 2150
    bar [680, 1235, 2047, 1718, 1095, 2080, 1020]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-24 (Sun) | 7 | 812 | 317.1M | $680.47 |
| 2026-05-25 (Mon) | 8 | 1,243 | 592.5M | $1235.03 |
| 2026-05-26 (Tue) | 7 | 2,473 | 1059.2M | $2046.87 |
| 2026-05-27 (Wed) | 4 | 1,668 | 868.1M | $1718.08 |
| 2026-05-28 (Thu) | 15 | 1,671 | 452.5M | $1095.50 |
| 2026-05-29 (Fri) | 12 | 2,247 | 978.1M | $2079.88 |
| 2026-05-30 (Sat) | 7 | 335 | 122.9M | $1020.31 |
| **Total** | | | **4390.4M** | **$9876.15** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-odb-dfm | 3,349 | 1510.3M | $3070.43 |
| -Users-manibari-code | 2,556 | 1306.7M | $3015.37 |
| -Users-manibari-code-ChimesFlow | 1,625 | 837.8M | $1800.80 |
| -Users-manibari-code-rivendell | 887 | 292.0M | $927.90 |
| -Users-manibari-Vault-Peter | 1,071 | 298.3M | $626.40 |
| -Users-manibari-Vault-Peter-Work | 378 | 97.4M | $236.64 |
| -Users-manibari-code-sales-assistant | 244 | 15.7M | $67.57 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-30 — 94 skills, 21 issue(s)*
