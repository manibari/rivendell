...
**backend/**
- audio-transcription-flow — 1 次, 54天前
- db-migration — 1 次, 80天前
- doc-to-structured-data — 1 次, 66天前
- docker-compose-setup — 2 次, 44天前
- firebase-backend — 3 次, 23天前
- imap-smtp-integration — 1 次, 68天前
- markdown-file-ssot — 1 次, 68天前
- oauth-token-vault — 1 次, 68天前
- rbac-permissions — 1 次, 54天前
- sqlite-to-postgres — 2 次, 23天前
- tunnel-proxy-deploy — 1 次, 77天前
- tw-company-lookup — 2 次, 76天前
- vector-search-setup — 1 次, 62天前

**docs/**
- chart-design — 1 次, 13天前
- discovery-interview — 1 次, 54天前
- doc-coauthoring — 2 次, 23天前
- excalidraw-diagram — 2 次, 15天前
- gdoc-report-builder — 2 次, 23天前
- internal-comms — 2 次, 23天前
- iot-factory-report — 2 次, 23天前
- mcp-builder — 3 次, 82天前
- mermaid-diagram — 1 次, 16天前
- metadata-workshop — 2 次, 23天前
- office-docx — 4 次, 53天前
- office-pdf — 3 次, 82天前
- office-pptx — 3 次, 82天前
- office-xlsx — 3 次, 82天前
- pitch-deck — 3 次, 23天前
- rfq-writer — 1 次, 53天前
- slide-office-hours — 2 次, 23天前
- slide-template-extractor — 2 次, 23天前
- slide-workflow — 4 次, 23天前
- sow-writer — 2 次, 23天前
- telegram-bot — 1 次, 77天前

**frontend/**
- frontend-design — 2 次, 83天前
- ios-integration — 1 次, 84天前
- swiftui-patterns — 1 次, 84天前
- ui-ux-pro-max — 3 次, 82天前

**git/**
- auto-stage — 3 次, 23天前
- repo-rename — 1 次, 66天前

**meta/**
- agent-persona — 1 次, 48天前
- audit-fix — 1 次, 80天前
- ci-pipeline — 1 次, 80天前
- deploy — 1 次, 80天前
- dev-process-gate — 4 次, 54天前
- init-project — 2 次, 83天前
- knowledge-graph — 1 次, 77天前
- learnings-promotion-sprint — 1 次, 16天前
- plan-check-style — 3 次, 80天前
- self-improving-agent — 3 次, 15天前
- session-harvest — 3 次, 23天前
- session-wrap — 1 次, 47天前
- setup-permissions — 3 次, 80天前
- skill-creator — 4 次, 44天前
- skill-scout — 2 次, 32天前
- sync-readme — 1 次, 61天前
- workflow-retro — 2 次, 23天前

**quality/**
- de-slopify — 2 次, 44天前
- github-repo-audit — 1 次, 48天前
- large-file-refactor — 1 次, 62天前
- protect-secrets — 3 次, 23天前
- qa-auto — 1 次, 77天前
- qa-planner — 1 次, 77天前
- qa-testing — 1 次, 82天前

**workflow/**
- agent-observability — 2 次, 54天前
- autoresearch — 2 次, 23天前
- candidate-analysis — 1 次, 66天前
- claude-to-telegram — 1 次, 77天前
- client-kickoff-docs — 1 次, 39天前
- context-recovery — 1 次, 77天前
- crm-projection — 1 次, 76天前
- customer-intel — 5 次, 23天前
- dispatching-parallel-agents — 4 次, 44天前
- env-doctor — 1 次, 39天前
- executing-plans — 3 次, 82天前
- gdrive-to-skills — 2 次, 83天前
- headless-agent — 6 次, 68天前
- investment-research — 4 次, 23天前
- jd-writer — 1 次, 48天前
- keyword-discovery — 1 次, 68天前
- launchd-agent — 6 次, 23天前
- material-health — 1 次, 76天前
- mockup — 1 次, 84天前
- mops-financial-scraper — 1 次, 39天前
- planning-with-files — 5 次, 54天前
- presales-pipeline — 1 次, 39天前
- repro-exam — 1 次, 39天前
- requirement — 2 次, 54天前
- sales-material — 3 次, 40天前
- settings-audit — 1 次, 67天前
- subsidy-scraper — 1 次, 76天前
- tender-scraper — 3 次, 68天前
- user-flow — 2 次, 16天前
- writing-plans — 3 次, 82天前
...
```
5dcd014 fix(crm): capital stored but never returned — add to list serializers + list column
46c573a fix(opportunities): stage-gate Select dropdown clipped/broken inside Modal
a29fc7c fix(crm): 從政府資料補齊 returns blank for 分公司 — handle branch schema
a611792 feat(opps): 業務成績單 — sales × time scorecard tab
5749142 ui(opps): split list into 進行中 / 已成交 / 已輸單 tabs
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-25", "05-26", "05-27", "05-28", "05-29", "05-30", "05-31"]
    y-axis "USD" 0 --> 2150
    bar [1235, 2047, 1718, 1095, 2080, 1690, 0]
~~~
...
| 2026-05-30 (Sat) | 11 | 1,020 | 401.9M | $1689.59 |
| 2026-05-31 (Sun) | 1 | 1 | 0 | $0.00 |
| **Total** | | | **4352.3M** | **$9864.96** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-odb-dfm | 3,361 | 1512.7M | $3085.09 |
| -Users-manibari-code | 2,227 | 1116.7M | $2674.53 |
| -Users-manibari-code-ChimesFlow | 2,009 | 997.9M | $2137.68 |
| -Users-manibari-code-rivendell | 553 | 209.4M | $753.32 |
| -Users-manibari-Vault-Peter | 1,071 | 298.3M | $626.40 |
| -Users-manibari-Vault-Peter-Work | 528 | 171.5M | $402.53 |
| -Users-manibari-code-sales-assistant | 242 | 15.4M | $64.55 |
| -Users-manibari-code-resume-pool | 31 | 6.1M | $40.80 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter | 165 | 15.5M | $39.69 |
| -Users-manibari-code-news-stock | 120 | 8.0M | $35.00 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-31 — 94 skills, 22 issue(s)*
