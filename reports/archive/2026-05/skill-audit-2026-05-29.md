...
**docs/**
- excalidraw-diagram — 2 次修訂, 13天前

**meta/**
- self-improving-agent — 3 次修訂, 13天前

**workflow/**
- user-flow — 2 次修訂, 14天前

<details><summary>✅ 穩定 (91)</summary>

**backend/**
- audio-transcription-flow — 1 次, 52天前
- db-migration — 1 次, 78天前
- doc-to-structured-data — 1 次, 64天前
- docker-compose-setup — 2 次, 42天前
- firebase-backend — 3 次, 21天前
- imap-smtp-integration — 1 次, 66天前
- markdown-file-ssot — 1 次, 66天前
- oauth-token-vault — 1 次, 66天前
- rbac-permissions — 1 次, 52天前
- sqlite-to-postgres — 2 次, 21天前
- tunnel-proxy-deploy — 1 次, 75天前
- tw-company-lookup — 2 次, 74天前
- vector-search-setup — 1 次, 60天前

**docs/**
- chart-design — 1 次, 11天前
- discovery-interview — 1 次, 52天前
- doc-coauthoring — 2 次, 21天前
- gdoc-report-builder — 2 次, 21天前
- internal-comms — 2 次, 21天前
- iot-factory-report — 2 次, 21天前
- mcp-builder — 3 次, 80天前
- mermaid-diagram — 1 次, 14天前
- metadata-workshop — 2 次, 21天前
- office-docx — 4 次, 51天前
- office-pdf — 3 次, 80天前
- office-pptx — 3 次, 80天前
- office-xlsx — 3 次, 80天前
- pitch-deck — 3 次, 21天前
- rfq-writer — 1 次, 51天前
- slide-office-hours — 2 次, 21天前
- slide-template-extractor — 2 次, 21天前
- slide-workflow — 4 次, 21天前
- sow-writer — 2 次, 21天前
- telegram-bot — 1 次, 75天前

**frontend/**
- frontend-design — 2 次, 81天前
- ios-integration — 1 次, 82天前
- swiftui-patterns — 1 次, 82天前
- ui-ux-pro-max — 3 次, 80天前

**git/**
- auto-stage — 3 次, 21天前
- repo-rename — 1 次, 64天前

**meta/**
- agent-persona — 1 次, 46天前
- audit-fix — 1 次, 78天前
- ci-pipeline — 1 次, 78天前
- deploy — 1 次, 78天前
- dev-process-gate — 4 次, 52天前
- init-project — 2 次, 81天前
- knowledge-graph — 1 次, 75天前
- learnings-promotion-sprint — 1 次, 14天前
- plan-check-style — 3 次, 78天前
- session-harvest — 3 次, 21天前
- session-wrap — 1 次, 45天前
- setup-permissions — 3 次, 78天前
- skill-creator — 4 次, 42天前
- skill-scout — 2 次, 30天前
- sync-readme — 1 次, 59天前
- workflow-retro — 2 次, 21天前

**quality/**
- de-slopify — 2 次, 42天前
- github-repo-audit — 1 次, 46天前
- large-file-refactor — 1 次, 60天前
- protect-secrets — 3 次, 21天前
- qa-auto — 1 次, 75天前
- qa-planner — 1 次, 75天前
- qa-testing — 1 次, 80天前

**workflow/**
- agent-observability — 2 次, 52天前
- autoresearch — 2 次, 21天前
- candidate-analysis — 1 次, 64天前
- claude-to-telegram — 1 次, 75天前
- client-kickoff-docs — 1 次, 37天前
- context-recovery — 1 次, 75天前
- crm-projection — 1 次, 74天前
- customer-intel — 5 次, 21天前
- dispatching-parallel-agents — 4 次, 42天前
- env-doctor — 1 次, 37天前
- executing-plans — 3 次, 80天前
- gdrive-to-skills — 2 次, 81天前
- headless-agent — 6 次, 66天前
- investment-research — 4 次, 21天前
- jd-writer — 1 次, 46天前
- keyword-discovery — 1 次, 66天前
- launchd-agent — 6 次, 21天前
- material-health — 1 次, 74天前
- mockup — 1 次, 82天前
- mops-financial-scraper — 1 次, 37天前
- planning-with-files — 5 次, 52天前
- presales-pipeline — 1 次, 37天前
- repro-exam — 1 次, 37天前
- requirement — 2 次, 52天前
- sales-material — 3 次, 38天前
- settings-audit — 1 次, 65天前
- subsidy-scraper — 1 次, 74天前
- tender-scraper — 3 次, 66天前
- writing-plans — 3 次, 80天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 105 個 commit（本週）, 162 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 3 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
3f6928c fix(quotes): change-owner dropdown also include manager + admin
91b528c fix(quotes): change-owner modal showed UUID — load users on mount + filter to sales
b2ebc5f feat(crm): tw-company lookup — auto-fill account/partner from 統編 or 公司名
a2c186b feat(quotes): allow toggling distributor mode in edit form
782b026 feat(quotes): admin escape hatch — revert accepted/rejected quote to draft
```
</details>
...
```
7b4738bc v1.27.1.0 fix: anti-shortcut clause + gate-tier AskUserQuestion floor tests for all plan-* skills (#1354)
f44de365 v1.27.0.0 feat: /setup-gbrain Path 4 (remote MCP) + brain → artifacts rename (#1351)
c7aefc1a v1.26.5.0 fix wave: gbrain ingest writer (hybrid frontmatter) + gbrain-valid source ids (#1344)
19e699ab v1.26.4.0 fix: GSTACK REVIEW REPORT delete-then-append (no more mid-file leftovers) (#1335)
db9447c3 v1.26.3.0 feat: /sync-gbrain skill + native code-surface orchestrator (#1314)
```
</details>
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 1 個 commit（本週）, 29 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `feat/mops-scraper-fallback` (4 total) |
| **Git** | 19 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
37b99ad chore(agent): research-agent-daily run 2026-05-15
```
</details>
...
06081d6 DWG view: true-coord rendering, grouped panel, frame greyed (WIP — DWG errors flagged)
5cf85f2 dxg_json: DWG→JSON SoT; layered x-ray DWG view; ODB++/DWG/lib three-page nav
429a33c layer viewer: revert connection points to flip+2mm, GND fill, collapsible sub-groups
ee87324 layer viewer: connection points line-to-line, outline-true selection box, copper by net
```
</details>
...
93a31a1 feat: 競業圖譜、Side Panel UI、GCIS 強化、CLI process group 修正
f6a52e1 feat(ui): 官網搜尋進度條、PDF 欄位補齊、find-website turns 修正
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-23", "05-24", "05-25", "05-26", "05-27", "05-28", "05-29"]
    y-axis "USD" 0 --> 2050
    bar [867, 547, 1144, 1964, 1718, 1056, 1304]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-23 (Sat) | 10 | 1,684 | 429.4M | $867.40 |
| 2026-05-24 (Sun) | 6 | 637 | 259.4M | $546.96 |
| 2026-05-25 (Mon) | 7 | 1,142 | 550.0M | $1143.56 |
| 2026-05-26 (Tue) | 6 | 2,432 | 1039.6M | $1964.33 |
| 2026-05-27 (Wed) | 4 | 1,668 | 868.1M | $1718.08 |
| 2026-05-28 (Thu) | 14 | 1,656 | 444.9M | $1055.68 |
| 2026-05-29 (Fri) | 8 | 1,719 | 596.9M | $1303.57 |
| **Total** | | | **4188.3M** | **$8599.59** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-odb-dfm | 3,315 | 1504.6M | $3049.27 |
| -Users-manibari-code | 3,062 | 1434.2M | $2681.19 |
| -Users-manibari-code-ChimesFlow | 1,474 | 525.7M | $1124.78 |
| -Users-manibari-Vault-Peter | 1,058 | 295.9M | $603.30 |
| -Users-manibari-code-rivendell | 883 | 203.7M | $585.60 |
| -Users-manibari-Vault-Peter-Work | 349 | 85.3M | $184.91 |
| rivendell | 97 | 47.1M | $96.69 |
| -Users-manibari-code-sales-assistant | 265 | 16.9M | $72.34 |
| ChimesFlow | 96 | 42.6M | $70.47 |
| -Users-manibari-code-resume-pool | 89 | 10.8M | $65.05 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter | 165 | 15.5M | $39.69 |
| -Users-manibari-code-news-stock | 69 | 5.2M | $20.92 |
| -Users-manibari-Documents-Peter-Work | 16 | 816K | $5.37 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-29 — 94 skills, 21 issue(s)*
