...
**backend/**
- firebase-backend — 3 次修訂, 2天前
- sqlite-to-postgres — 2 次修訂, 2天前

**docs/**
- doc-coauthoring — 2 次修訂, 2天前
- gdoc-report-builder — 2 次修訂, 2天前
- internal-comms — 2 次修訂, 2天前
- iot-factory-report — 2 次修訂, 2天前
- metadata-workshop — 2 次修訂, 2天前
- pitch-deck — 3 次修訂, 2天前
- slide-office-hours — 2 次修訂, 2天前
- slide-template-extractor — 2 次修訂, 2天前
- slide-workflow — 4 次修訂, 2天前
- sow-writer — 2 次修訂, 2天前

**git/**
- auto-stage — 3 次修訂, 2天前

**meta/**
- session-harvest — 3 次修訂, 2天前
- skill-scout — 2 次修訂, 11天前
- workflow-retro — 2 次修訂, 2天前

**quality/**
- protect-secrets — 3 次修訂, 2天前

**workflow/**
- autoresearch — 2 次修訂, 2天前
- customer-intel — 5 次修訂, 2天前
- investment-research — 4 次修訂, 2天前
- launchd-agent — 6 次修訂, 2天前

<details><summary>✅ 穩定 (69)</summary>

**backend/**
- audio-transcription-flow — 1 次, 33天前
- db-migration — 1 次, 59天前
- doc-to-structured-data — 1 次, 45天前
- docker-compose-setup — 2 次, 23天前
- imap-smtp-integration — 1 次, 47天前
- markdown-file-ssot — 1 次, 47天前
- oauth-token-vault — 1 次, 47天前
- rbac-permissions — 1 次, 33天前
- tunnel-proxy-deploy — 1 次, 56天前
- tw-company-lookup — 2 次, 55天前
- vector-search-setup — 1 次, 41天前

**docs/**
- discovery-interview — 1 次, 33天前
- mcp-builder — 3 次, 61天前
- office-docx — 4 次, 32天前
- office-pdf — 3 次, 61天前
- office-pptx — 3 次, 61天前
- office-xlsx — 3 次, 61天前
- rfq-writer — 1 次, 32天前
- telegram-bot — 1 次, 56天前

**frontend/**
- frontend-design — 2 次, 62天前
- ios-integration — 1 次, 63天前
- swiftui-patterns — 1 次, 63天前
- ui-ux-pro-max — 3 次, 61天前

**git/**
- repo-rename — 1 次, 45天前

**meta/**
- agent-persona — 1 次, 27天前
- audit-fix — 1 次, 59天前
- ci-pipeline — 1 次, 59天前
- deploy — 1 次, 59天前
- dev-process-gate — 4 次, 33天前
- init-project — 2 次, 62天前
- knowledge-graph — 1 次, 56天前
- plan-check-style — 3 次, 59天前
- self-improving-agent — 2 次, 41天前
- session-wrap — 1 次, 26天前
- setup-permissions — 3 次, 59天前
- skill-creator — 4 次, 23天前
- sync-readme — 1 次, 40天前

**quality/**
- de-slopify — 2 次, 23天前
- github-repo-audit — 1 次, 27天前
- large-file-refactor — 1 次, 41天前
- qa-auto — 1 次, 56天前
- qa-planner — 1 次, 56天前
- qa-testing — 1 次, 61天前
...
- candidate-analysis — 1 次, 45天前
- claude-to-telegram — 1 次, 56天前
- client-kickoff-docs — 1 次, 18天前
- context-recovery — 1 次, 56天前
- crm-projection — 1 次, 55天前
- dispatching-parallel-agents — 4 次, 23天前
- env-doctor — 1 次, 18天前
- executing-plans — 3 次, 61天前
- gdrive-to-skills — 2 次, 62天前
- headless-agent — 6 次, 47天前
- jd-writer — 1 次, 27天前
- keyword-discovery — 1 次, 47天前
- material-health — 1 次, 55天前
- mockup — 1 次, 63天前
- mops-financial-scraper — 1 次, 18天前
- planning-with-files — 5 次, 33天前
- presales-pipeline — 1 次, 18天前
- repro-exam — 1 次, 18天前
- requirement — 2 次, 33天前
- sales-material — 3 次, 19天前
- settings-audit — 1 次, 46天前
- subsidy-scraper — 1 次, 55天前
- tender-scraper — 3 次, 47天前
- user-flow — 1 次, 63天前
- writing-plans — 3 次, 61天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-04", "05-05", "05-06", "05-07", "05-08", "05-09", "05-10"]
    y-axis "USD" 0 --> 1150
    bar [763, 1060, 793, 1018, 846, 38, 31]
~~~
...
| 2026-05-10 (Sun) | 3 | 96 | 7.7M | $31.27 |
| **Total** | | | **1898.0M** | **$4549.05** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 2,381 | 697.5M | $1782.53 |
| ChimesFlow | 1,937 | 524.8M | $1052.70 |
| rivendell | 844 | 278.8M | $697.20 |
| news-stock | 894 | 170.7M | $472.61 |
|  | 463 | 137.4M | $299.40 |
| -Users-manibari-Documents-Peter-Family | 334 | 71.7M | $179.33 |
| sales-assistant | 270 | 15.5M | $53.19 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-10 — 90 skills, 19 issue(s)*
