...
**backend/**
- firebase-backend — 3 次修訂, 3天前
- sqlite-to-postgres — 2 次修訂, 3天前

**docs/**
- doc-coauthoring — 2 次修訂, 3天前
- gdoc-report-builder — 2 次修訂, 3天前
- internal-comms — 2 次修訂, 3天前
- iot-factory-report — 2 次修訂, 3天前
- metadata-workshop — 2 次修訂, 3天前
- pitch-deck — 3 次修訂, 3天前
- slide-office-hours — 2 次修訂, 3天前
- slide-template-extractor — 2 次修訂, 3天前
- slide-workflow — 4 次修訂, 3天前
- sow-writer — 2 次修訂, 3天前

**git/**
- auto-stage — 3 次修訂, 3天前

**meta/**
- session-harvest — 3 次修訂, 3天前
- skill-scout — 2 次修訂, 12天前
- workflow-retro — 2 次修訂, 3天前

**quality/**
- protect-secrets — 3 次修訂, 3天前

**workflow/**
- autoresearch — 2 次修訂, 3天前
- customer-intel — 5 次修訂, 3天前
- investment-research — 4 次修訂, 3天前
- launchd-agent — 6 次修訂, 3天前

<details><summary>✅ 穩定 (69)</summary>

**backend/**
- audio-transcription-flow — 1 次, 34天前
- db-migration — 1 次, 60天前
- doc-to-structured-data — 1 次, 46天前
- docker-compose-setup — 2 次, 24天前
- imap-smtp-integration — 1 次, 48天前
- markdown-file-ssot — 1 次, 48天前
- oauth-token-vault — 1 次, 48天前
- rbac-permissions — 1 次, 34天前
- tunnel-proxy-deploy — 1 次, 57天前
- tw-company-lookup — 2 次, 56天前
- vector-search-setup — 1 次, 42天前

**docs/**
- discovery-interview — 1 次, 34天前
- mcp-builder — 3 次, 62天前
- office-docx — 4 次, 33天前
- office-pdf — 3 次, 62天前
- office-pptx — 3 次, 62天前
- office-xlsx — 3 次, 62天前
- rfq-writer — 1 次, 33天前
- telegram-bot — 1 次, 57天前

**frontend/**
- frontend-design — 2 次, 63天前
- ios-integration — 1 次, 64天前
- swiftui-patterns — 1 次, 64天前
- ui-ux-pro-max — 3 次, 62天前

**git/**
- repo-rename — 1 次, 46天前

**meta/**
- agent-persona — 1 次, 28天前
- audit-fix — 1 次, 60天前
- ci-pipeline — 1 次, 60天前
- deploy — 1 次, 60天前
- dev-process-gate — 4 次, 34天前
- init-project — 2 次, 63天前
- knowledge-graph — 1 次, 57天前
- plan-check-style — 3 次, 60天前
- self-improving-agent — 2 次, 42天前
- session-wrap — 1 次, 27天前
- setup-permissions — 3 次, 60天前
- skill-creator — 4 次, 24天前
- sync-readme — 1 次, 41天前

**quality/**
- de-slopify — 2 次, 24天前
- github-repo-audit — 1 次, 28天前
- large-file-refactor — 1 次, 42天前
- qa-auto — 1 次, 57天前
- qa-planner — 1 次, 57天前
- qa-testing — 1 次, 62天前
...
- candidate-analysis — 1 次, 46天前
- claude-to-telegram — 1 次, 57天前
- client-kickoff-docs — 1 次, 19天前
- context-recovery — 1 次, 57天前
- crm-projection — 1 次, 56天前
- dispatching-parallel-agents — 4 次, 24天前
- env-doctor — 1 次, 19天前
- executing-plans — 3 次, 62天前
- gdrive-to-skills — 2 次, 63天前
- headless-agent — 6 次, 48天前
- jd-writer — 1 次, 28天前
- keyword-discovery — 1 次, 48天前
- material-health — 1 次, 56天前
- mockup — 1 次, 64天前
- mops-financial-scraper — 1 次, 19天前
- planning-with-files — 5 次, 34天前
- presales-pipeline — 1 次, 19天前
- repro-exam — 1 次, 19天前
- requirement — 2 次, 34天前
- sales-material — 3 次, 20天前
- settings-audit — 1 次, 47天前
- subsidy-scraper — 1 次, 56天前
- tender-scraper — 3 次, 48天前
- user-flow — 1 次, 64天前
- writing-plans — 3 次, 62天前
...
5e0f031 chore(agent): research-agent-daily run 2026-05-09
a249af7 chore(agent): research-agent-daily run 2026-05-08
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-05", "05-06", "05-07", "05-08", "05-09", "05-10", "05-11"]
    y-axis "USD" 0 --> 1150
    bar [1060, 793, 1018, 846, 38, 80, 253]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-05 (Tue) | 20 | 1,829 | 505.9M | $1059.85 |
| 2026-05-06 (Wed) | 8 | 934 | 313.6M | $793.32 |
...
| 2026-05-11 (Mon) | 8 | 558 | 70.2M | $253.46 |
| **Total** | | | **1688.1M** | **$4088.30** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 2,144 | 592.2M | $1482.08 |
| ChimesFlow | 2,134 | 541.2M | $1093.37 |
| rivendell | 852 | 277.0M | $699.03 |
| news-stock | 576 | 55.9M | $226.46 |
|  | 303 | 106.2M | $223.83 |
| -Users-manibari-Documents-Peter-Family | 363 | 74.1M | $205.76 |
| resume-pool | 108 | 21.7M | $68.23 |
| sales-assistant | 276 | 16.3M | $61.39 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter | 37 | 3.2M | $24.56 |
| -----backend | 8 | 335K | $3.59 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-11 — 90 skills, 19 issue(s)*
