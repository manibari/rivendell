...
**backend/**
- firebase-backend — 3 次修訂, 0天前
- sqlite-to-postgres — 2 次修訂, 0天前

**docs/**
- doc-coauthoring — 2 次修訂, 0天前
- gdoc-report-builder — 2 次修訂, 0天前
- internal-comms — 2 次修訂, 0天前
- iot-factory-report — 2 次修訂, 0天前
- metadata-workshop — 2 次修訂, 0天前
- pitch-deck — 3 次修訂, 0天前
- slide-office-hours — 2 次修訂, 0天前
- slide-template-extractor — 2 次修訂, 0天前
- slide-workflow — 4 次修訂, 0天前
- sow-writer — 2 次修訂, 0天前

**git/**
- auto-stage — 3 次修訂, 0天前

**meta/**
- session-harvest — 3 次修訂, 0天前
- skill-scout — 2 次修訂, 9天前
- workflow-retro — 2 次修訂, 0天前

**quality/**
- protect-secrets — 3 次修訂, 0天前

**workflow/**
- autoresearch — 2 次修訂, 0天前
- customer-intel — 5 次修訂, 0天前
- investment-research — 4 次修訂, 0天前
- launchd-agent — 6 次修訂, 0天前

<details><summary>✅ 穩定 (69)</summary>

**backend/**
- audio-transcription-flow — 1 次, 31天前
- db-migration — 1 次, 57天前
- doc-to-structured-data — 1 次, 43天前
- docker-compose-setup — 2 次, 21天前
- imap-smtp-integration — 1 次, 45天前
- markdown-file-ssot — 1 次, 45天前
- oauth-token-vault — 1 次, 45天前
- rbac-permissions — 1 次, 31天前
- tunnel-proxy-deploy — 1 次, 54天前
- tw-company-lookup — 2 次, 53天前
- vector-search-setup — 1 次, 39天前

**docs/**
- discovery-interview — 1 次, 31天前
- mcp-builder — 3 次, 59天前
- office-docx — 4 次, 30天前
- office-pdf — 3 次, 59天前
- office-pptx — 3 次, 59天前
- office-xlsx — 3 次, 59天前
- rfq-writer — 1 次, 30天前
- telegram-bot — 1 次, 54天前

**frontend/**
- frontend-design — 2 次, 60天前
- ios-integration — 1 次, 61天前
- swiftui-patterns — 1 次, 61天前
- ui-ux-pro-max — 3 次, 59天前

**git/**
- repo-rename — 1 次, 43天前

**meta/**
- agent-persona — 1 次, 25天前
- audit-fix — 1 次, 57天前
- ci-pipeline — 1 次, 57天前
- deploy — 1 次, 57天前
- dev-process-gate — 4 次, 31天前
- init-project — 2 次, 60天前
- knowledge-graph — 1 次, 54天前
- plan-check-style — 3 次, 57天前
- self-improving-agent — 2 次, 39天前
- session-wrap — 1 次, 24天前
- setup-permissions — 3 次, 57天前
- skill-creator — 4 次, 21天前
- sync-readme — 1 次, 38天前

**quality/**
- de-slopify — 2 次, 21天前
- github-repo-audit — 1 次, 25天前
- large-file-refactor — 1 次, 39天前
- qa-auto — 1 次, 54天前
- qa-planner — 1 次, 54天前
- qa-testing — 1 次, 59天前
...
- candidate-analysis — 1 次, 43天前
- claude-to-telegram — 1 次, 54天前
- client-kickoff-docs — 1 次, 16天前
- context-recovery — 1 次, 54天前
- crm-projection — 1 次, 53天前
- dispatching-parallel-agents — 4 次, 21天前
- env-doctor — 1 次, 16天前
- executing-plans — 3 次, 59天前
- gdrive-to-skills — 2 次, 60天前
- headless-agent — 6 次, 45天前
- jd-writer — 1 次, 25天前
- keyword-discovery — 1 次, 45天前
- material-health — 1 次, 53天前
- mockup — 1 次, 61天前
- mops-financial-scraper — 1 次, 16天前
- planning-with-files — 5 次, 31天前
- presales-pipeline — 1 次, 16天前
- repro-exam — 1 次, 16天前
- requirement — 2 次, 31天前
- sales-material — 3 次, 17天前
- settings-audit — 1 次, 44天前
- subsidy-scraper — 1 次, 53天前
- tender-scraper — 3 次, 45天前
- user-flow — 1 次, 61天前
- writing-plans — 3 次, 59天前
...
c334c7c chore(agent): research-agent-daily run 2026-05-05
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-02", "05-03", "05-04", "05-05", "05-06", "05-07", "05-08"]
    y-axis "USD" 0 --> 1150
    bar [0, 407, 763, 1060, 793, 1018, 813]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-02 (Sat) | 3 | 3 | 0 | $0.00 |
...
| 2026-05-08 (Fri) | 7 | 976 | 331.5M | $812.66 |
| **Total** | | | **2030.3M** | **$4854.24** |
...
| rivendell | 960 | 289.5M | $743.51 |
| news-stock | 1,448 | 270.9M | $670.91 |
|  | 635 | 154.4M | $345.03 |
| -Users-manibari-Documents-Peter-Family | 322 | 71.1M | $176.51 |
| news_stock | 28 | 603K | $40.77 |
| sales-assistant | 214 | 11.9M | $40.63 |
| -----backend | 8 | 335K | $3.59 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-08 — 90 skills, 20 issue(s)*
