...
**docs/**
- excalidraw-diagram — 2 次修訂, 9天前

**meta/**
- self-improving-agent — 3 次修訂, 9天前

**workflow/**
- user-flow — 2 次修訂, 10天前

<details><summary>✅ 穩定 (91)</summary>

**backend/**
- audio-transcription-flow — 1 次, 48天前
- db-migration — 1 次, 74天前
- doc-to-structured-data — 1 次, 60天前
- docker-compose-setup — 2 次, 38天前
- firebase-backend — 3 次, 17天前
- imap-smtp-integration — 1 次, 62天前
- markdown-file-ssot — 1 次, 62天前
- oauth-token-vault — 1 次, 62天前
- rbac-permissions — 1 次, 48天前
- sqlite-to-postgres — 2 次, 17天前
- tunnel-proxy-deploy — 1 次, 71天前
- tw-company-lookup — 2 次, 70天前
- vector-search-setup — 1 次, 56天前

**docs/**
- chart-design — 1 次, 7天前
- discovery-interview — 1 次, 48天前
- doc-coauthoring — 2 次, 17天前
- gdoc-report-builder — 2 次, 17天前
- internal-comms — 2 次, 17天前
- iot-factory-report — 2 次, 17天前
- mcp-builder — 3 次, 76天前
- mermaid-diagram — 1 次, 10天前
- metadata-workshop — 2 次, 17天前
- office-docx — 4 次, 47天前
- office-pdf — 3 次, 76天前
- office-pptx — 3 次, 76天前
- office-xlsx — 3 次, 76天前
- pitch-deck — 3 次, 17天前
- rfq-writer — 1 次, 47天前
- slide-office-hours — 2 次, 17天前
- slide-template-extractor — 2 次, 17天前
- slide-workflow — 4 次, 17天前
- sow-writer — 2 次, 17天前
- telegram-bot — 1 次, 71天前

**frontend/**
- frontend-design — 2 次, 77天前
- ios-integration — 1 次, 78天前
- swiftui-patterns — 1 次, 78天前
- ui-ux-pro-max — 3 次, 76天前

**git/**
- auto-stage — 3 次, 17天前
- repo-rename — 1 次, 60天前

**meta/**
- agent-persona — 1 次, 42天前
- audit-fix — 1 次, 74天前
- ci-pipeline — 1 次, 74天前
- deploy — 1 次, 74天前
- dev-process-gate — 4 次, 48天前
- init-project — 2 次, 77天前
- knowledge-graph — 1 次, 71天前
- learnings-promotion-sprint — 1 次, 10天前
- plan-check-style — 3 次, 74天前
- session-harvest — 3 次, 17天前
- session-wrap — 1 次, 41天前
- setup-permissions — 3 次, 74天前
- skill-creator — 4 次, 38天前
- skill-scout — 2 次, 26天前
- sync-readme — 1 次, 55天前
- workflow-retro — 2 次, 17天前

**quality/**
- de-slopify — 2 次, 38天前
- github-repo-audit — 1 次, 42天前
- large-file-refactor — 1 次, 56天前
- protect-secrets — 3 次, 17天前
- qa-auto — 1 次, 71天前
- qa-planner — 1 次, 71天前
- qa-testing — 1 次, 76天前

**workflow/**
- agent-observability — 2 次, 48天前
- autoresearch — 2 次, 17天前
- candidate-analysis — 1 次, 60天前
- claude-to-telegram — 1 次, 71天前
- client-kickoff-docs — 1 次, 33天前
- context-recovery — 1 次, 71天前
- crm-projection — 1 次, 70天前
- customer-intel — 5 次, 17天前
- dispatching-parallel-agents — 4 次, 38天前
- env-doctor — 1 次, 33天前
- executing-plans — 3 次, 76天前
- gdrive-to-skills — 2 次, 77天前
- headless-agent — 6 次, 62天前
- investment-research — 4 次, 17天前
- jd-writer — 1 次, 42天前
- keyword-discovery — 1 次, 62天前
- launchd-agent — 6 次, 17天前
- material-health — 1 次, 70天前
- mockup — 1 次, 78天前
- mops-financial-scraper — 1 次, 33天前
- planning-with-files — 5 次, 48天前
- presales-pipeline — 1 次, 33天前
- repro-exam — 1 次, 33天前
- requirement — 2 次, 48天前
- sales-material — 3 次, 34天前
- settings-audit — 1 次, 61天前
- subsidy-scraper — 1 次, 70天前
- tender-scraper — 3 次, 62天前
- writing-plans — 3 次, 76天前
...
```
cd0a08f feat(rbac): add engineer role for IC delivery team
eba488b feat(stage-gate): P3→P4 requires presales 資料評估報告
e1532d6 feat(admin): dept hierarchy in 列表 + edit modal + user dropdowns
65dfed0 feat(products): tree view toggle showing platform → 子模組 hierarchy
28ef5bc feat(products): platform → sub-module hierarchy (parent_product_id)
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-19", "05-20", "05-21", "05-22", "05-23", "05-24", "05-25"]
    y-axis "USD" 0 --> 1200
    bar [871, 245, 58, 1127, 867, 547, 916]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-05-19 (Tue) | 10 | 1,323 | 338.4M | $871.24 |
...
| 2026-05-25 (Mon) | 5 | 642 | 434.6M | $915.92 |
| **Total** | | | **2148.7M** | **$4631.45** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 2,327 | 1016.7M | $2082.92 |
| -Users-manibari-code | 1,620 | 785.9M | $1544.87 |
| -Users-manibari-code-rivendell | 941 | 217.3M | $651.05 |
| rivendell | 97 | 47.1M | $96.69 |
| ChimesFlow | 96 | 42.6M | $70.47 |
| -Users-manibari-code-resume-pool | 89 | 10.8M | $65.05 |
| -Users-manibari-code-news-stock | 82 | 9.2M | $47.54 |
| -Users-manibari-Documents-Peter-Work | 94 | 13.5M | $45.79 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-sales-assistant | 106 | 5.7M | $27.07 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-25 — 94 skills, 20 issue(s)*
