...
**backend/**
- firebase-backend — 3 次修訂, 12天前
- sqlite-to-postgres — 2 次修訂, 12天前

**docs/**
- doc-coauthoring — 2 次修訂, 12天前
- excalidraw-diagram — 2 次修訂, 4天前
- gdoc-report-builder — 2 次修訂, 12天前
- internal-comms — 2 次修訂, 12天前
- iot-factory-report — 2 次修訂, 12天前
- metadata-workshop — 2 次修訂, 12天前
- pitch-deck — 3 次修訂, 12天前
- slide-office-hours — 2 次修訂, 12天前
- slide-template-extractor — 2 次修訂, 12天前
- slide-workflow — 4 次修訂, 12天前
- sow-writer — 2 次修訂, 12天前

**git/**
- auto-stage — 3 次修訂, 12天前

**meta/**
- self-improving-agent — 3 次修訂, 4天前
- session-harvest — 3 次修訂, 12天前
- workflow-retro — 2 次修訂, 12天前

**quality/**
- protect-secrets — 3 次修訂, 12天前

**workflow/**
- autoresearch — 2 次修訂, 12天前
- customer-intel — 5 次修訂, 12天前
- investment-research — 4 次修訂, 12天前
- launchd-agent — 6 次修訂, 12天前
- user-flow — 2 次修訂, 5天前

<details><summary>✅ 穩定 (71)</summary>

**backend/**
- audio-transcription-flow — 1 次, 43天前
- db-migration — 1 次, 69天前
- doc-to-structured-data — 1 次, 55天前
- docker-compose-setup — 2 次, 33天前
- imap-smtp-integration — 1 次, 57天前
- markdown-file-ssot — 1 次, 57天前
- oauth-token-vault — 1 次, 57天前
- rbac-permissions — 1 次, 43天前
- tunnel-proxy-deploy — 1 次, 66天前
- tw-company-lookup — 2 次, 65天前
- vector-search-setup — 1 次, 51天前

**docs/**
- chart-design — 1 次, 2天前
- discovery-interview — 1 次, 43天前
- mcp-builder — 3 次, 71天前
- mermaid-diagram — 1 次, 5天前
- office-docx — 4 次, 42天前
- office-pdf — 3 次, 71天前
- office-pptx — 3 次, 71天前
- office-xlsx — 3 次, 71天前
- rfq-writer — 1 次, 42天前
- telegram-bot — 1 次, 66天前

**frontend/**
- frontend-design — 2 次, 72天前
- ios-integration — 1 次, 73天前
- swiftui-patterns — 1 次, 73天前
- ui-ux-pro-max — 3 次, 71天前

**git/**
- repo-rename — 1 次, 55天前

**meta/**
- agent-persona — 1 次, 37天前
- audit-fix — 1 次, 69天前
- ci-pipeline — 1 次, 69天前
- deploy — 1 次, 69天前
- dev-process-gate — 4 次, 43天前
- init-project — 2 次, 72天前
- knowledge-graph — 1 次, 66天前
- learnings-promotion-sprint — 1 次, 5天前
- plan-check-style — 3 次, 69天前
- session-wrap — 1 次, 36天前
- setup-permissions — 3 次, 69天前
- skill-creator — 4 次, 33天前
- skill-scout — 2 次, 21天前
- sync-readme — 1 次, 50天前

**quality/**
- de-slopify — 2 次, 33天前
- github-repo-audit — 1 次, 37天前
- large-file-refactor — 1 次, 51天前
- qa-auto — 1 次, 66天前
- qa-planner — 1 次, 66天前
- qa-testing — 1 次, 71天前

**workflow/**
- agent-observability — 2 次, 43天前
- candidate-analysis — 1 次, 55天前
- claude-to-telegram — 1 次, 66天前
- client-kickoff-docs — 1 次, 28天前
- context-recovery — 1 次, 66天前
- crm-projection — 1 次, 65天前
- dispatching-parallel-agents — 4 次, 33天前
- env-doctor — 1 次, 28天前
- executing-plans — 3 次, 71天前
- gdrive-to-skills — 2 次, 72天前
- headless-agent — 6 次, 57天前
- jd-writer — 1 次, 37天前
- keyword-discovery — 1 次, 57天前
- material-health — 1 次, 65天前
- mockup — 1 次, 73天前
- mops-financial-scraper — 1 次, 28天前
- planning-with-files — 5 次, 43天前
- presales-pipeline — 1 次, 28天前
- repro-exam — 1 次, 28天前
- requirement — 2 次, 43天前
- sales-material — 3 次, 29天前
- settings-audit — 1 次, 56天前
- subsidy-scraper — 1 次, 65天前
- tender-scraper — 3 次, 57天前
- writing-plans — 3 次, 71天前
...
```
23d7292 feat: opportunity contact multi-role (KDM/KI/KU as array)
b6d2417 feat(frontend): channel_partner is now a Select from /api/partners
2a38173 feat(frontend): group 4 admin tools under collapsible 管理 sidebar item
c0a51fe fix(frontend): bake BACKEND_INTERNAL_URL at build time
8692663 fix(frontend): re-enable output: 'standalone' for Docker build
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-14", "05-15", "05-16", "05-17", "05-18", "05-19", "05-20"]
    y-axis "USD" 0 --> 950
    bar [743, 761, 3, 56, 549, 871, 119]
~~~
...
| 2026-05-20 (Wed) | 1 | 98 | 57.4M | $119.21 |
| **Total** | | | **1272.7M** | **$3102.80** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| ChimesFlow | 1,495 | 511.7M | $1142.00 |
| rivendell | 1,297 | 379.8M | $865.05 |
| -Users-manibari-Documents-Peter-Work | 1,358 | 287.2M | $748.21 |
| news-stock | 323 | 31.7M | $137.68 |
| -Users-manibari-Documents-Projects | 81 | 26.7M | $91.19 |
| -Users-manibari-Documents-Peter | 90 | 19.9M | $66.26 |
| sales-assistant | 240 | 15.7M | $52.40 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-20 — 94 skills, 20 issue(s)*
