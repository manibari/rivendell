...
**backend/**
- firebase-backend — 3 次修訂, 10天前
- sqlite-to-postgres — 2 次修訂, 10天前

**docs/**
- doc-coauthoring — 2 次修訂, 10天前
- excalidraw-diagram — 2 次修訂, 2天前
- gdoc-report-builder — 2 次修訂, 10天前
- internal-comms — 2 次修訂, 10天前
- iot-factory-report — 2 次修訂, 10天前
- metadata-workshop — 2 次修訂, 10天前
- pitch-deck — 3 次修訂, 10天前
- slide-office-hours — 2 次修訂, 10天前
- slide-template-extractor — 2 次修訂, 10天前
- slide-workflow — 4 次修訂, 10天前
- sow-writer — 2 次修訂, 10天前

**git/**
- auto-stage — 3 次修訂, 10天前

**meta/**
- self-improving-agent — 3 次修訂, 2天前
- session-harvest — 3 次修訂, 10天前
- workflow-retro — 2 次修訂, 10天前

**quality/**
- protect-secrets — 3 次修訂, 10天前

**workflow/**
- autoresearch — 2 次修訂, 10天前
- customer-intel — 5 次修訂, 10天前
- investment-research — 4 次修訂, 10天前
- launchd-agent — 6 次修訂, 10天前
- user-flow — 2 次修訂, 3天前

<details><summary>✅ 穩定 (71)</summary>

**backend/**
- audio-transcription-flow — 1 次, 41天前
- db-migration — 1 次, 67天前
- doc-to-structured-data — 1 次, 53天前
- docker-compose-setup — 2 次, 31天前
- imap-smtp-integration — 1 次, 55天前
- markdown-file-ssot — 1 次, 55天前
- oauth-token-vault — 1 次, 55天前
- rbac-permissions — 1 次, 41天前
- tunnel-proxy-deploy — 1 次, 64天前
- tw-company-lookup — 2 次, 63天前
- vector-search-setup — 1 次, 49天前

**docs/**
- chart-design — 1 次, 0天前
- discovery-interview — 1 次, 41天前
- mcp-builder — 3 次, 69天前
- mermaid-diagram — 1 次, 3天前
- office-docx — 4 次, 40天前
- office-pdf — 3 次, 69天前
- office-pptx — 3 次, 69天前
- office-xlsx — 3 次, 69天前
- rfq-writer — 1 次, 40天前
- telegram-bot — 1 次, 64天前

**frontend/**
- frontend-design — 2 次, 70天前
- ios-integration — 1 次, 71天前
- swiftui-patterns — 1 次, 71天前
- ui-ux-pro-max — 3 次, 69天前

**git/**
- repo-rename — 1 次, 53天前

**meta/**
- agent-persona — 1 次, 35天前
- audit-fix — 1 次, 67天前
- ci-pipeline — 1 次, 67天前
- deploy — 1 次, 67天前
- dev-process-gate — 4 次, 41天前
- init-project — 2 次, 70天前
- knowledge-graph — 1 次, 64天前
- learnings-promotion-sprint — 1 次, 3天前
- plan-check-style — 3 次, 67天前
- session-wrap — 1 次, 34天前
- setup-permissions — 3 次, 67天前
- skill-creator — 4 次, 31天前
- skill-scout — 2 次, 19天前
- sync-readme — 1 次, 48天前

**quality/**
- de-slopify — 2 次, 31天前
- github-repo-audit — 1 次, 35天前
- large-file-refactor — 1 次, 49天前
- qa-auto — 1 次, 64天前
- qa-planner — 1 次, 64天前
- qa-testing — 1 次, 69天前
...
- candidate-analysis — 1 次, 53天前
- claude-to-telegram — 1 次, 64天前
- client-kickoff-docs — 1 次, 26天前
- context-recovery — 1 次, 64天前
- crm-projection — 1 次, 63天前
- dispatching-parallel-agents — 4 次, 31天前
- env-doctor — 1 次, 26天前
- executing-plans — 3 次, 69天前
- gdrive-to-skills — 2 次, 70天前
- headless-agent — 6 次, 55天前
- jd-writer — 1 次, 35天前
- keyword-discovery — 1 次, 55天前
- material-health — 1 次, 63天前
- mockup — 1 次, 71天前
- mops-financial-scraper — 1 次, 26天前
- planning-with-files — 5 次, 41天前
- presales-pipeline — 1 次, 26天前
- repro-exam — 1 次, 26天前
- requirement — 2 次, 41天前
- sales-material — 3 次, 27天前
- settings-audit — 1 次, 54天前
- subsidy-scraper — 1 次, 63天前
- tender-scraper — 3 次, 55天前
- writing-plans — 3 次, 69天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-12", "05-13", "05-14", "05-15", "05-16", "05-17", "05-18"]
    y-axis "USD" 0 --> 850
    bar [471, 522, 743, 761, 3, 56, 503]
~~~
...
| 2026-05-17 (Sun) | 6 | 69 | 13.0M | $55.80 |
| 2026-05-18 (Mon) | 10 | 1,096 | 181.9M | $502.94 |
| **Total** | | | **1190.3M** | **$3059.73** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 2,040 | 445.9M | $1258.16 |
| rivendell | 1,312 | 345.1M | $766.45 |
| ChimesFlow | 673 | 272.3M | $607.87 |
| -Users-manibari-Documents-Projects | 333 | 66.9M | $189.07 |
| news-stock | 282 | 23.8M | $116.27 |
| -Users-manibari-Documents-Peter | 117 | 21.5M | $72.51 |
| sales-assistant | 227 | 14.8M | $49.40 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-18 — 94 skills, 19 issue(s)*
