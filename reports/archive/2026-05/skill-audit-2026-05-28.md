...
**docs/**
- excalidraw-diagram — 2 次修訂, 12天前

**meta/**
- self-improving-agent — 3 次修訂, 12天前

**workflow/**
- user-flow — 2 次修訂, 13天前

<details><summary>✅ 穩定 (91)</summary>

**backend/**
- audio-transcription-flow — 1 次, 51天前
- db-migration — 1 次, 77天前
- doc-to-structured-data — 1 次, 63天前
- docker-compose-setup — 2 次, 41天前
- firebase-backend — 3 次, 20天前
- imap-smtp-integration — 1 次, 65天前
- markdown-file-ssot — 1 次, 65天前
- oauth-token-vault — 1 次, 65天前
- rbac-permissions — 1 次, 51天前
- sqlite-to-postgres — 2 次, 20天前
- tunnel-proxy-deploy — 1 次, 74天前
- tw-company-lookup — 2 次, 73天前
- vector-search-setup — 1 次, 59天前

**docs/**
- chart-design — 1 次, 10天前
- discovery-interview — 1 次, 51天前
- doc-coauthoring — 2 次, 20天前
- gdoc-report-builder — 2 次, 20天前
- internal-comms — 2 次, 20天前
- iot-factory-report — 2 次, 20天前
- mcp-builder — 3 次, 79天前
- mermaid-diagram — 1 次, 13天前
- metadata-workshop — 2 次, 20天前
- office-docx — 4 次, 50天前
- office-pdf — 3 次, 79天前
- office-pptx — 3 次, 79天前
- office-xlsx — 3 次, 79天前
- pitch-deck — 3 次, 20天前
- rfq-writer — 1 次, 50天前
- slide-office-hours — 2 次, 20天前
- slide-template-extractor — 2 次, 20天前
- slide-workflow — 4 次, 20天前
- sow-writer — 2 次, 20天前
- telegram-bot — 1 次, 74天前

**frontend/**
- frontend-design — 2 次, 80天前
- ios-integration — 1 次, 81天前
- swiftui-patterns — 1 次, 81天前
- ui-ux-pro-max — 3 次, 79天前

**git/**
- auto-stage — 3 次, 20天前
- repo-rename — 1 次, 63天前

**meta/**
- agent-persona — 1 次, 45天前
- audit-fix — 1 次, 77天前
- ci-pipeline — 1 次, 77天前
- deploy — 1 次, 77天前
- dev-process-gate — 4 次, 51天前
- init-project — 2 次, 80天前
- knowledge-graph — 1 次, 74天前
- learnings-promotion-sprint — 1 次, 13天前
- plan-check-style — 3 次, 77天前
- session-harvest — 3 次, 20天前
- session-wrap — 1 次, 44天前
- setup-permissions — 3 次, 77天前
- skill-creator — 4 次, 41天前
- skill-scout — 2 次, 29天前
- sync-readme — 1 次, 58天前
- workflow-retro — 2 次, 20天前

**quality/**
- de-slopify — 2 次, 41天前
- github-repo-audit — 1 次, 45天前
- large-file-refactor — 1 次, 59天前
- protect-secrets — 3 次, 20天前
- qa-auto — 1 次, 74天前
- qa-planner — 1 次, 74天前
- qa-testing — 1 次, 79天前

**workflow/**
- agent-observability — 2 次, 51天前
- autoresearch — 2 次, 20天前
- candidate-analysis — 1 次, 63天前
- claude-to-telegram — 1 次, 74天前
- client-kickoff-docs — 1 次, 36天前
- context-recovery — 1 次, 74天前
- crm-projection — 1 次, 73天前
- customer-intel — 5 次, 20天前
- dispatching-parallel-agents — 4 次, 41天前
- env-doctor — 1 次, 36天前
- executing-plans — 3 次, 79天前
- gdrive-to-skills — 2 次, 80天前
- headless-agent — 6 次, 65天前
- investment-research — 4 次, 20天前
- jd-writer — 1 次, 45天前
- keyword-discovery — 1 次, 65天前
- launchd-agent — 6 次, 20天前
- material-health — 1 次, 73天前
- mockup — 1 次, 81天前
- mops-financial-scraper — 1 次, 36天前
- planning-with-files — 5 次, 51天前
- presales-pipeline — 1 次, 36天前
- repro-exam — 1 次, 36天前
- requirement — 2 次, 51天前
- sales-material — 3 次, 37天前
- settings-audit — 1 次, 64天前
- subsidy-scraper — 1 次, 73天前
- tender-scraper — 3 次, 65天前
- writing-plans — 3 次, 79天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 97 個 commit（本週）, 148 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 2 dirty, 7 unpushed |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
e885abe feat(api-explorer): admin impersonation via ?as_user_id= on GET requests
3fed492 fix(activities): 500 on weekly query — pass date objs not isoformat strings
4eddb9f feat(api-explorer): role-aware presets, open to all roles
572eb84 feat(admin): 系統 API 偵錯頁 — preset 查詢 + 自訂 GET/POST/...
15125f6 fix(admin): org chart now follows dept tree, not reports_to_user_id
```
</details>
...
xychart-beta
    ...
    y-axis "USD" 0 --> 2050
    bar [1127, 867, 547, 1144, 1964, 1718, 759]
~~~
...
| 2026-05-28 (Thu) | 12 | 1,208 | 320.7M | $758.70 |
| **Total** | | | **4038.1M** | **$8126.14** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-odb-dfm | 3,239 | 1494.8M | $3003.21 |
| -Users-manibari-code | 3,011 | 1431.0M | $2667.30 |
| -Users-manibari-code-ChimesFlow | 1,595 | 732.7M | $1340.59 |
| -Users-manibari-code-rivendell | 927 | 223.7M | $688.63 |
| rivendell | 97 | 47.1M | $96.69 |
| ChimesFlow | 96 | 42.6M | $70.47 |
| -Users-manibari-code-sales-assistant | 242 | 15.5M | $68.08 |
| -Users-manibari-code-resume-pool | 89 | 10.8M | $65.05 |
| -Users-manibari-Vault-Peter | 132 | 18.0M | $53.61 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter | 165 | 15.5M | $39.69 |
| -Users-manibari-code-news-stock | 64 | 5.6M | $27.45 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-28 — 94 skills, 20 issue(s)*
