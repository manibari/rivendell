...
**git/**
- auto-stage — 2 次修訂, 4天前

**meta/**
- skill-scout — 2 次修訂, 3天前

**quality/**
- protect-secrets — 2 次修訂, 4天前

**workflow/**
- launchd-agent — 5 次修訂, 3天前
- sales-material — 3 次修訂, 11天前

<details><summary>✅ 穩定 (84)</summary>

**backend/**
- audio-transcription-flow — 1 次, 25天前
- db-migration — 1 次, 51天前
- doc-to-structured-data — 1 次, 37天前
- docker-compose-setup — 2 次, 15天前
- firebase-backend — 2 次, 15天前
- imap-smtp-integration — 1 次, 39天前
- markdown-file-ssot — 1 次, 39天前
- oauth-token-vault — 1 次, 39天前
- rbac-permissions — 1 次, 25天前
- sqlite-to-postgres — 1 次, 48天前
- tunnel-proxy-deploy — 1 次, 48天前
- tw-company-lookup — 2 次, 47天前
- vector-search-setup — 1 次, 33天前

**docs/**
- discovery-interview — 1 次, 25天前
- doc-coauthoring — 1 次, 4天前
- gdoc-report-builder — 1 次, 19天前
- internal-comms — 1 次, 4天前
- iot-factory-report — 1 次, 19天前
- mcp-builder — 3 次, 53天前
- metadata-workshop — 1 次, 24天前
- office-docx — 4 次, 24天前
- office-pdf — 3 次, 53天前
- office-pptx — 3 次, 53天前
- office-xlsx — 3 次, 53天前
- pitch-deck — 2 次, 22天前
- rfq-writer — 1 次, 24天前
- slide-template-extractor — 1 次, 22天前
- slide-workflow — 1 次, 18天前
- sow-writer — 1 次, 25天前
- telegram-bot — 1 次, 48天前

**frontend/**
- frontend-design — 2 次, 54天前
- ios-integration — 1 次, 55天前
- swiftui-patterns — 1 次, 55天前
- ui-ux-pro-max — 3 次, 53天前

**git/**
- repo-rename — 1 次, 37天前

**meta/**
- agent-persona — 1 次, 19天前
- audit-fix — 1 次, 51天前
- ci-pipeline — 1 次, 51天前
- deploy — 1 次, 51天前
- dev-process-gate — 4 次, 25天前
- init-project — 2 次, 54天前
- knowledge-graph — 1 次, 48天前
- plan-check-style — 3 次, 51天前
- self-improving-agent — 2 次, 33天前
- session-harvest — 2 次, 22天前
- session-wrap — 1 次, 18天前
- setup-permissions — 3 次, 51天前
- skill-creator — 4 次, 15天前
- sync-readme — 1 次, 32天前
- workflow-retro — 1 次, 5天前

**quality/**
- de-slopify — 2 次, 15天前
- github-repo-audit — 1 次, 19天前
- large-file-refactor — 1 次, 33天前
- qa-auto — 1 次, 48天前
- qa-planner — 1 次, 48天前
- qa-testing — 1 次, 53天前
...
- autoresearch — 1 次, 39天前
- candidate-analysis — 1 次, 37天前
- claude-to-telegram — 1 次, 48天前
- client-kickoff-docs — 1 次, 10天前
- context-recovery — 1 次, 48天前
- crm-projection — 1 次, 47天前
- customer-intel — 4 次, 47天前
- dispatching-parallel-agents — 4 次, 15天前
- env-doctor — 1 次, 10天前
- executing-plans — 3 次, 53天前
- gdrive-to-skills — 2 次, 54天前
- headless-agent — 6 次, 39天前
- investment-research — 3 次, 48天前
- jd-writer — 1 次, 19天前
- keyword-discovery — 1 次, 39天前
- material-health — 1 次, 47天前
- mockup — 1 次, 55天前
- mops-financial-scraper — 1 次, 10天前
- planning-with-files — 5 次, 25天前
- presales-pipeline — 1 次, 10天前
- repro-exam — 1 次, 10天前
- requirement — 2 次, 25天前
- settings-audit — 1 次, 38天前
- subsidy-scraper — 1 次, 47天前
- tender-scraper — 3 次, 39天前
- user-flow — 1 次, 55天前
- writing-plans — 3 次, 53天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-26", "04-27", "04-28", "04-29", "04-30", "05-01", "05-02"]
    y-axis "USD" 0 --> 1850
    bar [71, 1755, 929, 731, 660, 4, 0]
~~~
...
*由以下工具產生 `./bin/sk audit` — 2026-05-02 — 89 skills, 19 issue(s)*
