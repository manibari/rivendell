...
**docs/**
- slide-office-hours — 尚未 commit

### 🔧 開發中

**git/**
- auto-stage — 2 次修訂, 6天前

**meta/**
- skill-scout — 2 次修訂, 5天前

**quality/**
- protect-secrets — 2 次修訂, 6天前

**workflow/**
- launchd-agent — 5 次修訂, 5天前
- sales-material — 3 次修訂, 13天前

<details><summary>✅ 穩定 (84)</summary>

**backend/**
- audio-transcription-flow — 1 次, 27天前
- db-migration — 1 次, 53天前
- doc-to-structured-data — 1 次, 39天前
- docker-compose-setup — 2 次, 17天前
- firebase-backend — 2 次, 17天前
- imap-smtp-integration — 1 次, 41天前
- markdown-file-ssot — 1 次, 41天前
- oauth-token-vault — 1 次, 41天前
- rbac-permissions — 1 次, 27天前
- sqlite-to-postgres — 1 次, 50天前
- tunnel-proxy-deploy — 1 次, 50天前
- tw-company-lookup — 2 次, 49天前
- vector-search-setup — 1 次, 35天前

**docs/**
- discovery-interview — 1 次, 27天前
- doc-coauthoring — 1 次, 6天前
- gdoc-report-builder — 1 次, 21天前
- internal-comms — 1 次, 6天前
- iot-factory-report — 1 次, 21天前
- mcp-builder — 3 次, 55天前
- metadata-workshop — 1 次, 26天前
- office-docx — 4 次, 26天前
- office-pdf — 3 次, 55天前
- office-pptx — 3 次, 55天前
- office-xlsx — 3 次, 55天前
- pitch-deck — 2 次, 24天前
- rfq-writer — 1 次, 26天前
- slide-template-extractor — 1 次, 24天前
- slide-workflow — 1 次, 20天前
- sow-writer — 1 次, 27天前
- telegram-bot — 1 次, 50天前

**frontend/**
- frontend-design — 2 次, 56天前
- ios-integration — 1 次, 57天前
- swiftui-patterns — 1 次, 57天前
- ui-ux-pro-max — 3 次, 55天前

**git/**
- repo-rename — 1 次, 39天前

**meta/**
- agent-persona — 1 次, 21天前
- audit-fix — 1 次, 53天前
- ci-pipeline — 1 次, 53天前
- deploy — 1 次, 53天前
- dev-process-gate — 4 次, 27天前
- init-project — 2 次, 56天前
- knowledge-graph — 1 次, 50天前
- plan-check-style — 3 次, 53天前
- self-improving-agent — 2 次, 35天前
- session-harvest — 2 次, 24天前
- session-wrap — 1 次, 20天前
- setup-permissions — 3 次, 53天前
- skill-creator — 4 次, 17天前
- sync-readme — 1 次, 34天前
- workflow-retro — 1 次, 7天前

**quality/**
- de-slopify — 2 次, 17天前
- github-repo-audit — 1 次, 21天前
- large-file-refactor — 1 次, 35天前
- qa-auto — 1 次, 50天前
- qa-planner — 1 次, 50天前
- qa-testing — 1 次, 55天前
...
- autoresearch — 1 次, 41天前
- candidate-analysis — 1 次, 39天前
- claude-to-telegram — 1 次, 50天前
- client-kickoff-docs — 1 次, 12天前
- context-recovery — 1 次, 50天前
- crm-projection — 1 次, 49天前
- customer-intel — 4 次, 49天前
- dispatching-parallel-agents — 4 次, 17天前
- env-doctor — 1 次, 12天前
- executing-plans — 3 次, 55天前
- gdrive-to-skills — 2 次, 56天前
- headless-agent — 6 次, 41天前
- investment-research — 3 次, 50天前
- jd-writer — 1 次, 21天前
- keyword-discovery — 1 次, 41天前
- material-health — 1 次, 49天前
- mockup — 1 次, 57天前
- mops-financial-scraper — 1 次, 12天前
- planning-with-files — 5 次, 27天前
- presales-pipeline — 1 次, 12天前
- repro-exam — 1 次, 12天前
- requirement — 2 次, 27天前
- settings-audit — 1 次, 40天前
- subsidy-scraper — 1 次, 49天前
- tender-scraper — 3 次, 41天前
- user-flow — 1 次, 57天前
- writing-plans — 3 次, 55天前
...
1e810a3 feat(pool): pin stocks to My Picks pool from individual stock pages
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-28", "04-29", "04-30", "05-01", "05-02", "05-03", "05-04"]
    y-axis "USD" 0 --> 1000
    bar [929, 731, 660, 4, 0, 407, 747]
~~~
...
| 2026-05-04 (Mon) | 8 | 1,046 | 289.9M | $746.64 |
| **Total** | | | **1418.5M** | **$3477.07** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 1,661 | 545.2M | $1385.92 |
| news-stock | 1,518 | 356.4M | $775.71 |
| -Users-manibari-Documents-Peter | 356 | 181.2M | $376.74 |
| rivendell | 513 | 108.7M | $356.10 |
|  | 734 | 126.4M | $319.17 |
| sales-johnson | 358 | 39.8M | $110.89 |
| ChimesFlow | 288 | 42.9M | $92.37 |
| sales-assistant | 234 | 17.8M | $60.18 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-04 — 90 skills, 18 issue(s)*
