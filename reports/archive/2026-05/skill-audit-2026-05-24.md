...
**docs/**
- excalidraw-diagram — 2 次修訂, 8天前

**meta/**
- self-improving-agent — 3 次修訂, 8天前
...
**backend/**
- audio-transcription-flow — 1 次, 47天前
- db-migration — 1 次, 73天前
- doc-to-structured-data — 1 次, 59天前
- docker-compose-setup — 2 次, 37天前
- firebase-backend — 3 次, 16天前
- imap-smtp-integration — 1 次, 61天前
- markdown-file-ssot — 1 次, 61天前
- oauth-token-vault — 1 次, 61天前
- rbac-permissions — 1 次, 47天前
- sqlite-to-postgres — 2 次, 16天前
- tunnel-proxy-deploy — 1 次, 70天前
- tw-company-lookup — 2 次, 69天前
- vector-search-setup — 1 次, 55天前

**docs/**
- chart-design — 1 次, 6天前
- discovery-interview — 1 次, 47天前
- doc-coauthoring — 2 次, 16天前
- gdoc-report-builder — 2 次, 16天前
- internal-comms — 2 次, 16天前
- iot-factory-report — 2 次, 16天前
- mcp-builder — 3 次, 75天前
- mermaid-diagram — 1 次, 9天前
- metadata-workshop — 2 次, 16天前
- office-docx — 4 次, 46天前
- office-pdf — 3 次, 75天前
- office-pptx — 3 次, 75天前
- office-xlsx — 3 次, 75天前
- pitch-deck — 3 次, 16天前
- rfq-writer — 1 次, 46天前
- slide-office-hours — 2 次, 16天前
- slide-template-extractor — 2 次, 16天前
- slide-workflow — 4 次, 16天前
- sow-writer — 2 次, 16天前
- telegram-bot — 1 次, 70天前

**frontend/**
- frontend-design — 2 次, 76天前
- ios-integration — 1 次, 77天前
- swiftui-patterns — 1 次, 77天前
- ui-ux-pro-max — 3 次, 75天前

**git/**
- auto-stage — 3 次, 16天前
- repo-rename — 1 次, 59天前

**meta/**
- agent-persona — 1 次, 41天前
- audit-fix — 1 次, 73天前
- ci-pipeline — 1 次, 73天前
- deploy — 1 次, 73天前
- dev-process-gate — 4 次, 47天前
- init-project — 2 次, 76天前
- knowledge-graph — 1 次, 70天前
- learnings-promotion-sprint — 1 次, 9天前
- plan-check-style — 3 次, 73天前
- session-harvest — 3 次, 16天前
- session-wrap — 1 次, 40天前
- setup-permissions — 3 次, 73天前
- skill-creator — 4 次, 37天前
- skill-scout — 2 次, 25天前
- sync-readme — 1 次, 54天前
- workflow-retro — 2 次, 16天前

**quality/**
- de-slopify — 2 次, 37天前
- github-repo-audit — 1 次, 41天前
- large-file-refactor — 1 次, 55天前
- protect-secrets — 3 次, 16天前
- qa-auto — 1 次, 70天前
- qa-planner — 1 次, 70天前
- qa-testing — 1 次, 75天前

**workflow/**
- agent-observability — 2 次, 47天前
- autoresearch — 2 次, 16天前
- candidate-analysis — 1 次, 59天前
- claude-to-telegram — 1 次, 70天前
- client-kickoff-docs — 1 次, 32天前
- context-recovery — 1 次, 70天前
- crm-projection — 1 次, 69天前
- customer-intel — 5 次, 16天前
- dispatching-parallel-agents — 4 次, 37天前
- env-doctor — 1 次, 32天前
- executing-plans — 3 次, 75天前
- gdrive-to-skills — 2 次, 76天前
- headless-agent — 6 次, 61天前
- investment-research — 4 次, 16天前
- jd-writer — 1 次, 41天前
- keyword-discovery — 1 次, 61天前
- launchd-agent — 6 次, 16天前
- material-health — 1 次, 69天前
- mockup — 1 次, 77天前
- mops-financial-scraper — 1 次, 32天前
- planning-with-files — 5 次, 47天前
- presales-pipeline — 1 次, 32天前
- repro-exam — 1 次, 32天前
- requirement — 2 次, 47天前
- sales-material — 3 次, 33天前
- settings-audit — 1 次, 60天前
- subsidy-scraper — 1 次, 69天前
- tender-scraper — 3 次, 61天前
- writing-plans — 3 次, 75天前
...
```
aed38bd fix(admin): org chart — proper tree connectors (T-junction lines)
129d7c5 feat(admin): users.team + sub-team grouping inside dept columns
37aa57d refactor(admin): org chart — drop 丞相 wording, supervisor cluster
d60c35a feat(admin): dept head designation + 5-level org chart
246333e feat(admin): org chart view for /admin/departments
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-18", "05-19", "05-20", "05-21", "05-22", "05-23", "05-24"]
    y-axis "USD" 0 --> 1200
    bar [549, 871, 245, 58, 1127, 867, 274]
~~~
...
| 2026-05-24 (Sun) | 3 | 325 | 136.5M | $274.21 |
| **Total** | | | **1787.7M** | **$3991.64** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 2,405 | 1021.8M | $2100.58 |
| -Users-manibari-code-rivendell | 1,012 | 216.6M | $679.17 |
| -Users-manibari-code | 922 | 272.7M | $519.11 |
| -Users-manibari-Documents-Peter-Work | 740 | 147.1M | $363.04 |
| -Users-manibari-code-news-stock | 235 | 26.5M | $108.57 |
| rivendell | 97 | 47.1M | $96.69 |
| ChimesFlow | 96 | 42.6M | $70.47 |
| -Users-manibari-code-sales-assistant | 217 | 13.3M | $54.02 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-24 — 94 skills, 20 issue(s)*
