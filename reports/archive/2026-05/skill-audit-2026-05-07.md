...
**docs/**
- slide-workflow — 3 次修訂, 0天前

**git/**
- auto-stage — 2 次修訂, 9天前

**meta/**
- skill-scout — 2 次修訂, 8天前

**quality/**
- protect-secrets — 2 次修訂, 9天前

**workflow/**
- launchd-agent — 5 次修訂, 8天前

<details><summary>✅ 穩定 (85)</summary>

**backend/**
- audio-transcription-flow — 1 次, 30天前
- db-migration — 1 次, 56天前
- doc-to-structured-data — 1 次, 42天前
- docker-compose-setup — 2 次, 20天前
- firebase-backend — 2 次, 20天前
- imap-smtp-integration — 1 次, 44天前
- markdown-file-ssot — 1 次, 44天前
- oauth-token-vault — 1 次, 44天前
- rbac-permissions — 1 次, 30天前
- sqlite-to-postgres — 1 次, 53天前
- tunnel-proxy-deploy — 1 次, 53天前
- tw-company-lookup — 2 次, 52天前
- vector-search-setup — 1 次, 38天前

**docs/**
- discovery-interview — 1 次, 30天前
- doc-coauthoring — 1 次, 9天前
- gdoc-report-builder — 1 次, 24天前
- internal-comms — 1 次, 9天前
- iot-factory-report — 1 次, 24天前
- mcp-builder — 3 次, 58天前
- metadata-workshop — 1 次, 29天前
- office-docx — 4 次, 29天前
- office-pdf — 3 次, 58天前
- office-pptx — 3 次, 58天前
- office-xlsx — 3 次, 58天前
- pitch-deck — 2 次, 27天前
- rfq-writer — 1 次, 29天前
- slide-office-hours — 1 次, 2天前
- slide-template-extractor — 1 次, 27天前
- sow-writer — 1 次, 30天前
- telegram-bot — 1 次, 53天前

**frontend/**
- frontend-design — 2 次, 59天前
- ios-integration — 1 次, 60天前
- swiftui-patterns — 1 次, 60天前
- ui-ux-pro-max — 3 次, 58天前

**git/**
- repo-rename — 1 次, 42天前

**meta/**
- agent-persona — 1 次, 24天前
- audit-fix — 1 次, 56天前
- ci-pipeline — 1 次, 56天前
- deploy — 1 次, 56天前
- dev-process-gate — 4 次, 30天前
- init-project — 2 次, 59天前
- knowledge-graph — 1 次, 53天前
- plan-check-style — 3 次, 56天前
- self-improving-agent — 2 次, 38天前
- session-harvest — 2 次, 27天前
- session-wrap — 1 次, 23天前
- setup-permissions — 3 次, 56天前
- skill-creator — 4 次, 20天前
- sync-readme — 1 次, 37天前
- workflow-retro — 1 次, 10天前

**quality/**
- de-slopify — 2 次, 20天前
- github-repo-audit — 1 次, 24天前
- large-file-refactor — 1 次, 38天前
- qa-auto — 1 次, 53天前
- qa-planner — 1 次, 53天前
- qa-testing — 1 次, 58天前
...
- autoresearch — 1 次, 44天前
- candidate-analysis — 1 次, 42天前
- claude-to-telegram — 1 次, 53天前
- client-kickoff-docs — 1 次, 15天前
- context-recovery — 1 次, 53天前
- crm-projection — 1 次, 52天前
- customer-intel — 4 次, 52天前
- dispatching-parallel-agents — 4 次, 20天前
- env-doctor — 1 次, 15天前
- executing-plans — 3 次, 58天前
- gdrive-to-skills — 2 次, 59天前
- headless-agent — 6 次, 44天前
- investment-research — 3 次, 53天前
- jd-writer — 1 次, 24天前
- keyword-discovery — 1 次, 44天前
- material-health — 1 次, 52天前
- mockup — 1 次, 60天前
- mops-financial-scraper — 1 次, 15天前
- planning-with-files — 5 次, 30天前
- presales-pipeline — 1 次, 15天前
- repro-exam — 1 次, 15天前
- requirement — 2 次, 30天前
- sales-material — 3 次, 16天前
- settings-audit — 1 次, 43天前
- subsidy-scraper — 1 次, 52天前
- tender-scraper — 3 次, 44天前
- user-flow — 1 次, 60天前
- writing-plans — 3 次, 58天前
...
b28dab6 fix(opportunities): order pipeline summary by stage ascending
d82b9ee refactor(frontend): migrate antd v6 deprecated props
7ee3cea fix(frontend): allow Cloudflare Tunnel host for Next.js 16 dev HMR
4f36e30 fix(access_log): swallow DetachedInstanceError when reading request.state.user
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-01", "05-02", "05-03", "05-04", "05-05", "05-06", "05-07"]
    y-axis "USD" 0 --> 1150
    bar [4, 0, 407, 763, 1060, 793, 461]
~~~
...
| 2026-05-07 (Thu) | 8 | 1,153 | 195.5M | $460.58 |
| **Total** | | | **1464.2M** | **$3488.02** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents-Peter-Work | 1,461 | 421.9M | $1164.89 |
| ChimesFlow | 1,789 | 452.0M | $877.53 |
| news-stock | 1,339 | 257.7M | $625.43 |
| rivendell | 770 | 167.3M | $435.44 |
|  | 635 | 154.4M | $345.03 |
| news_stock | 28 | 603K | $40.77 |
| sales-assistant | 188 | 10.5M | $36.11 |
| -----backend | 8 | 335K | $3.59 |
...
*由以下工具產生 `./bin/sk audit` — 2026-05-07 — 90 skills, 18 issue(s)*
