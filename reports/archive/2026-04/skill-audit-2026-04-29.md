...
**backend/**
- docker-compose-setup — 2 次修訂, 12天前
- firebase-backend — 2 次修訂, 12天前

**git/**
- auto-stage — 2 次修訂, 1天前

**meta/**
- skill-creator — 4 次修訂, 12天前

**quality/**
- de-slopify — 2 次修訂, 12天前
- protect-secrets — 2 次修訂, 1天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 12天前
- sales-material — 3 次修訂, 8天前

<details><summary>✅ 穩定 (81)</summary>

**backend/**
- audio-transcription-flow — 1 次, 22天前
- db-migration — 1 次, 48天前
- doc-to-structured-data — 1 次, 34天前
- imap-smtp-integration — 1 次, 36天前
- markdown-file-ssot — 1 次, 36天前
- oauth-token-vault — 1 次, 36天前
- rbac-permissions — 1 次, 22天前
- sqlite-to-postgres — 1 次, 45天前
- tunnel-proxy-deploy — 1 次, 45天前
- tw-company-lookup — 2 次, 44天前
- vector-search-setup — 1 次, 30天前

**docs/**
- discovery-interview — 1 次, 22天前
- doc-coauthoring — 1 次, 1天前
- gdoc-report-builder — 1 次, 16天前
- internal-comms — 1 次, 1天前
- iot-factory-report — 1 次, 16天前
- mcp-builder — 3 次, 50天前
- metadata-workshop — 1 次, 21天前
- office-docx — 4 次, 21天前
- office-pdf — 3 次, 50天前
- office-pptx — 3 次, 50天前
- office-xlsx — 3 次, 50天前
- pitch-deck — 2 次, 19天前
- rfq-writer — 1 次, 21天前
- slide-template-extractor — 1 次, 19天前
- slide-workflow — 1 次, 15天前
- sow-writer — 1 次, 22天前
- telegram-bot — 1 次, 45天前

**frontend/**
- frontend-design — 2 次, 51天前
- ios-integration — 1 次, 52天前
- swiftui-patterns — 1 次, 52天前
- ui-ux-pro-max — 3 次, 50天前

**git/**
- repo-rename — 1 次, 34天前

**meta/**
- agent-persona — 1 次, 16天前
- audit-fix — 1 次, 48天前
- ci-pipeline — 1 次, 48天前
- deploy — 1 次, 48天前
- dev-process-gate — 4 次, 22天前
- init-project — 2 次, 51天前
- knowledge-graph — 1 次, 45天前
- plan-check-style — 3 次, 48天前
- self-improving-agent — 2 次, 30天前
- session-harvest — 2 次, 19天前
- session-wrap — 1 次, 15天前
- setup-permissions — 3 次, 48天前
- skill-scout — 1 次, 45天前
- sync-readme — 1 次, 29天前
- workflow-retro — 1 次, 2天前

**quality/**
- github-repo-audit — 1 次, 16天前
- large-file-refactor — 1 次, 30天前
- qa-auto — 1 次, 45天前
- qa-planner — 1 次, 45天前
- qa-testing — 1 次, 50天前
...
- autoresearch — 1 次, 36天前
- candidate-analysis — 1 次, 34天前
- claude-to-telegram — 1 次, 45天前
- client-kickoff-docs — 1 次, 7天前
- context-recovery — 1 次, 45天前
- crm-projection — 1 次, 44天前
- customer-intel — 4 次, 44天前
- env-doctor — 1 次, 7天前
- executing-plans — 3 次, 50天前
- gdrive-to-skills — 2 次, 51天前
- headless-agent — 6 次, 36天前
- investment-research — 3 次, 45天前
- jd-writer — 1 次, 16天前
- keyword-discovery — 1 次, 36天前
- launchd-agent — 4 次, 22天前
- material-health — 1 次, 44天前
- mockup — 1 次, 52天前
- mops-financial-scraper — 1 次, 7天前
- planning-with-files — 5 次, 22天前
- presales-pipeline — 1 次, 7天前
- repro-exam — 1 次, 7天前
- requirement — 2 次, 22天前
- settings-audit — 1 次, 35天前
- subsidy-scraper — 1 次, 44天前
- tender-scraper — 3 次, 36天前
- user-flow — 1 次, 52天前
- writing-plans — 3 次, 50天前
...
| | |
|---|---|
| **狀態** | 💤 沉寂 — 0 個 commit（本週）, 32 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 942 dirty, 2 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-23", "04-24", "04-25", "04-26", "04-27", "04-28", "04-29"]
    y-axis "USD" 0 --> 1850
    bar [1185, 22, 385, 71, 1755, 928, 53]
~~~
...
| 2026-04-28 (Tue) | 11 | 1,455 | 411.6M | $927.82 |
| 2026-04-29 (Wed) | 3 | 88 | 18.1M | $53.16 |
| **Total** | | | **1867.7M** | **$4398.94** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| news-stock | 2,009 | 679.5M | $1467.75 |
| -Users-manibari-Documents-Peter | 1,191 | 323.3M | $754.96 |
| -Users-manibari-Documents | 558 | 321.7M | $715.00 |
| company-proflie | 358 | 184.6M | $397.48 |
| -Users-manibari-Documents-Peter-Work | 549 | 118.8M | $377.05 |
| -Users-manibari-Documents-Peter-ChimesAI | 341 | 85.6M | $205.00 |
| rivendell | 354 | 57.1M | $182.58 |
|  | 347 | 62.2M | $155.55 |
| sales-assistant | 298 | 18.7M | $65.73 |
| news_stock | 28 | 603K | $40.77 |
| sales-johnson | 144 | 9.7M | $33.21 |
| -Users-manibari-Documents-Peter-ChimesAI-01-Presales | 5 | 1.6M | $18.66 |
| resume-pool | 8 | 2.2M | $17.48 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-29 — 89 skills, 19 issue(s)*
