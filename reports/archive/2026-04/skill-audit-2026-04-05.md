...
**meta/**
- self-improving-agent — 2 次修訂, 6天前

**workflow/**
- headless-agent — 6 次修訂, 12天前
- launchd-agent — 3 次修訂, 12天前
- tender-scraper — 3 次修訂, 12天前

<details><summary>✅ 穩定 (61)</summary>

**backend/**
- db-migration — 1 次, 24天前
- doc-to-structured-data — 1 次, 10天前
- firebase-backend — 1 次, 28天前
- imap-smtp-integration — 1 次, 12天前
- markdown-file-ssot — 1 次, 12天前
- oauth-token-vault — 1 次, 12天前
- sqlite-to-postgres — 1 次, 21天前
- tunnel-proxy-deploy — 1 次, 21天前
- tw-company-lookup — 2 次, 20天前
- vector-search-setup — 1 次, 6天前

**docs/**
- mcp-builder — 3 次, 26天前
- office-docx — 3 次, 26天前
- office-pdf — 3 次, 26天前
- office-pptx — 3 次, 26天前
- office-xlsx — 3 次, 26天前
- telegram-bot — 1 次, 21天前

**frontend/**
- frontend-design — 2 次, 27天前
- ios-integration — 1 次, 28天前
- swiftui-patterns — 1 次, 28天前
- ui-ux-pro-max — 3 次, 26天前

**git/**
- auto-stage — 1 次, 10天前
- repo-rename — 1 次, 10天前

**meta/**
- audit-fix — 1 次, 24天前
- ci-pipeline — 1 次, 24天前
- deploy — 1 次, 24天前
- dev-process-gate — 3 次, 24天前
- init-project — 2 次, 27天前
- knowledge-graph — 1 次, 21天前
- plan-check-style — 3 次, 24天前
- session-harvest — 1 次, 21天前
- setup-permissions — 3 次, 24天前
- skill-creator — 2 次, 27天前
- skill-scout — 1 次, 21天前
- sync-readme — 1 次, 5天前

**quality/**
- de-slopify — 1 次, 21天前
- large-file-refactor — 1 次, 6天前
- protect-secrets — 1 次, 10天前
- qa-auto — 1 次, 21天前
- qa-planner — 1 次, 21天前
- qa-testing — 1 次, 26天前

**workflow/**
- agent-observability — 1 次, 11天前
- autoresearch — 1 次, 12天前
- candidate-analysis — 1 次, 10天前
- claude-to-telegram — 1 次, 21天前
- context-recovery — 1 次, 21天前
- crm-projection — 1 次, 20天前
- customer-intel — 4 次, 20天前
- dispatching-parallel-agents — 3 次, 26天前
- executing-plans — 3 次, 26天前
- gdrive-to-skills — 2 次, 27天前
- investment-research — 3 次, 21天前
- keyword-discovery — 1 次, 12天前
- material-health — 1 次, 20天前
- mockup — 1 次, 28天前
- planning-with-files — 4 次, 22天前
- requirement — 1 次, 28天前
- sales-material — 1 次, 20天前
- settings-audit — 1 次, 11天前
- subsidy-scraper — 1 次, 20天前
- user-flow — 1 次, 28天前
- writing-plans — 3 次, 26天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-30", "03-31", "04-01", "04-02", "04-03", "04-04", "04-05"]
    y-axis "USD" 0 --> 650
    bar [567, 326, 116, 151, 0, 0, 0]
~~~
...
| 2026-04-05 (Sun) | 5 | 5 | 0 | $0.00 |
| **Total** | | | **471.9M** | **$1158.43** |
...
| sales-assistant | 463 | 34.0M | $95.31 |
| news-stock | 216 | 20.2M | $64.25 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-05 — 65 skills, 20 issue(s)*
