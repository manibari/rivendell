...
**docs/**
- office-docx — 4 次修訂, 3天前
- pitch-deck — 2 次修訂, 1天前

**meta/**
- dev-process-gate — 4 次修訂, 4天前
- self-improving-agent — 2 次修訂, 12天前
- session-harvest — 2 次修訂, 1天前
- skill-creator — 3 次修訂, 4天前

**workflow/**
- agent-observability — 2 次修訂, 4天前
- launchd-agent — 4 次修訂, 4天前
- planning-with-files — 5 次修訂, 4天前
...
**backend/**
- audio-transcription-flow — 1 次, 4天前
- db-migration — 1 次, 30天前
- doc-to-structured-data — 1 次, 16天前
- docker-compose-setup — 1 次, 4天前
- firebase-backend — 1 次, 34天前
- imap-smtp-integration — 1 次, 18天前
- markdown-file-ssot — 1 次, 18天前
- oauth-token-vault — 1 次, 18天前
- rbac-permissions — 1 次, 4天前
- sqlite-to-postgres — 1 次, 27天前
- tunnel-proxy-deploy — 1 次, 27天前
- tw-company-lookup — 2 次, 26天前
- vector-search-setup — 1 次, 12天前

**docs/**
- discovery-interview — 1 次, 4天前
- mcp-builder — 3 次, 32天前
- metadata-workshop — 1 次, 3天前
- office-pdf — 3 次, 32天前
- office-pptx — 3 次, 32天前
- office-xlsx — 3 次, 32天前
- rfq-writer — 1 次, 3天前
- slide-template-extractor — 1 次, 1天前
- sow-writer — 1 次, 4天前
- telegram-bot — 1 次, 27天前

**frontend/**
- frontend-design — 2 次, 33天前
- ios-integration — 1 次, 34天前
- swiftui-patterns — 1 次, 34天前
- ui-ux-pro-max — 3 次, 32天前

**git/**
- auto-stage — 1 次, 16天前
- repo-rename — 1 次, 16天前

**meta/**
- audit-fix — 1 次, 30天前
- ci-pipeline — 1 次, 30天前
- deploy — 1 次, 30天前
- init-project — 2 次, 33天前
- knowledge-graph — 1 次, 27天前
- plan-check-style — 3 次, 30天前
- setup-permissions — 3 次, 30天前
- skill-scout — 1 次, 27天前
- sync-readme — 1 次, 11天前

**quality/**
- de-slopify — 1 次, 27天前
- large-file-refactor — 1 次, 12天前
- protect-secrets — 1 次, 16天前
- qa-auto — 1 次, 27天前
- qa-planner — 1 次, 27天前
- qa-testing — 1 次, 32天前

**workflow/**
- autoresearch — 1 次, 18天前
- candidate-analysis — 1 次, 16天前
- claude-to-telegram — 1 次, 27天前
- context-recovery — 1 次, 27天前
- crm-projection — 1 次, 26天前
- customer-intel — 4 次, 26天前
- dispatching-parallel-agents — 3 次, 32天前
- executing-plans — 3 次, 32天前
- gdrive-to-skills — 2 次, 33天前
- headless-agent — 6 次, 18天前
- investment-research — 3 次, 27天前
- keyword-discovery — 1 次, 18天前
- material-health — 1 次, 26天前
- mockup — 1 次, 34天前
- settings-audit — 1 次, 17天前
- subsidy-scraper — 1 次, 26天前
- tender-scraper — 3 次, 18天前
- user-flow — 1 次, 34天前
- writing-plans — 3 次, 32天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-05", "04-06", "04-07", "04-08", "04-09", "04-10", "04-11"]
    y-axis "USD" 0 --> 950
    bar [5, 878, 775, 372, 750, 198, 59]
~~~
...
| 2026-04-11 (Sat) | 7 | 56 | 14.7M | $58.70 |
| **Total** | | | **1251.4M** | **$3035.70** |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-11 — 74 skills, 27 issue(s)*
