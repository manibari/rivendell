...
**docs/**
- office-docx — 4 次修訂, 6天前
- pitch-deck — 2 次修訂, 4天前

**meta/**
- dev-process-gate — 4 次修訂, 7天前
- session-harvest — 2 次修訂, 4天前
- skill-creator — 3 次修訂, 7天前

**workflow/**
- agent-observability — 2 次修訂, 7天前
- launchd-agent — 4 次修訂, 7天前
- planning-with-files — 5 次修訂, 7天前
...
**backend/**
- audio-transcription-flow — 1 次, 7天前
- db-migration — 1 次, 33天前
- doc-to-structured-data — 1 次, 19天前
- docker-compose-setup — 1 次, 7天前
- firebase-backend — 1 次, 37天前
- imap-smtp-integration — 1 次, 21天前
- markdown-file-ssot — 1 次, 21天前
- oauth-token-vault — 1 次, 21天前
- rbac-permissions — 1 次, 7天前
- sqlite-to-postgres — 1 次, 30天前
- tunnel-proxy-deploy — 1 次, 30天前
- tw-company-lookup — 2 次, 29天前
- vector-search-setup — 1 次, 15天前

**docs/**
- discovery-interview — 1 次, 7天前
- gdoc-report-builder — 1 次, 1天前
- iot-factory-report — 1 次, 1天前
- mcp-builder — 3 次, 35天前
- metadata-workshop — 1 次, 6天前
- office-pdf — 3 次, 35天前
- office-pptx — 3 次, 35天前
- office-xlsx — 3 次, 35天前
- rfq-writer — 1 次, 6天前
- slide-template-extractor — 1 次, 4天前
- slide-workflow — 1 次, 0天前
- sow-writer — 1 次, 7天前
- telegram-bot — 1 次, 30天前

**frontend/**
- frontend-design — 2 次, 36天前
- ios-integration — 1 次, 37天前
- swiftui-patterns — 1 次, 37天前
- ui-ux-pro-max — 3 次, 35天前

**git/**
- auto-stage — 1 次, 19天前
- repo-rename — 1 次, 19天前

**meta/**
- agent-persona — 1 次, 1天前
- audit-fix — 1 次, 33天前
- ci-pipeline — 1 次, 33天前
- deploy — 1 次, 33天前
- init-project — 2 次, 36天前
- knowledge-graph — 1 次, 30天前
- plan-check-style — 3 次, 33天前
- self-improving-agent — 2 次, 15天前
- session-wrap — 1 次, 0天前
- setup-permissions — 3 次, 33天前
- skill-scout — 1 次, 30天前
- sync-readme — 1 次, 14天前

**quality/**
- de-slopify — 1 次, 30天前
- github-repo-audit — 1 次, 1天前
- large-file-refactor — 1 次, 15天前
- protect-secrets — 1 次, 19天前
- qa-auto — 1 次, 30天前
- qa-planner — 1 次, 30天前
- qa-testing — 1 次, 35天前

**workflow/**
- autoresearch — 1 次, 21天前
- candidate-analysis — 1 次, 19天前
- claude-to-telegram — 1 次, 30天前
- context-recovery — 1 次, 30天前
- crm-projection — 1 次, 29天前
- customer-intel — 4 次, 29天前
- dispatching-parallel-agents — 3 次, 35天前
- executing-plans — 3 次, 35天前
- gdrive-to-skills — 2 次, 36天前
- headless-agent — 6 次, 21天前
- investment-research — 3 次, 30天前
- jd-writer — 1 次, 1天前
- keyword-discovery — 1 次, 21天前
- material-health — 1 次, 29天前
- mockup — 1 次, 37天前
- settings-audit — 1 次, 20天前
- subsidy-scraper — 1 次, 29天前
- tender-scraper — 3 次, 21天前
- user-flow — 1 次, 37天前
- writing-plans — 3 次, 35天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 5 個 commit（本週）, 164 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 36 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
