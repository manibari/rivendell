...
**meta/**
- self-improving-agent — 2 次修訂, 8天前

**workflow/**
- headless-agent — 6 次修訂, 14天前
- launchd-agent — 3 次修訂, 14天前
- tender-scraper — 3 次修訂, 14天前

<details><summary>✅ 穩定 (61)</summary>

**backend/**
- db-migration — 1 次, 26天前
- doc-to-structured-data — 1 次, 12天前
- firebase-backend — 1 次, 30天前
- imap-smtp-integration — 1 次, 14天前
- markdown-file-ssot — 1 次, 14天前
- oauth-token-vault — 1 次, 14天前
- sqlite-to-postgres — 1 次, 23天前
- tunnel-proxy-deploy — 1 次, 23天前
- tw-company-lookup — 2 次, 22天前
- vector-search-setup — 1 次, 8天前

**docs/**
- mcp-builder — 3 次, 28天前
- office-docx — 3 次, 28天前
- office-pdf — 3 次, 28天前
- office-pptx — 3 次, 28天前
- office-xlsx — 3 次, 28天前
- telegram-bot — 1 次, 23天前

**frontend/**
- frontend-design — 2 次, 29天前
- ios-integration — 1 次, 30天前
- swiftui-patterns — 1 次, 30天前
- ui-ux-pro-max — 3 次, 28天前

**git/**
- auto-stage — 1 次, 12天前
- repo-rename — 1 次, 12天前

**meta/**
- audit-fix — 1 次, 26天前
- ci-pipeline — 1 次, 26天前
- deploy — 1 次, 26天前
- dev-process-gate — 3 次, 26天前
- init-project — 2 次, 29天前
- knowledge-graph — 1 次, 23天前
- plan-check-style — 3 次, 26天前
- session-harvest — 1 次, 23天前
- setup-permissions — 3 次, 26天前
- skill-creator — 2 次, 29天前
- skill-scout — 1 次, 23天前
- sync-readme — 1 次, 7天前

**quality/**
- de-slopify — 1 次, 23天前
- large-file-refactor — 1 次, 8天前
- protect-secrets — 1 次, 12天前
- qa-auto — 1 次, 23天前
- qa-planner — 1 次, 23天前
- qa-testing — 1 次, 28天前

**workflow/**
- agent-observability — 1 次, 13天前
- autoresearch — 1 次, 14天前
- candidate-analysis — 1 次, 12天前
- claude-to-telegram — 1 次, 23天前
- context-recovery — 1 次, 23天前
- crm-projection — 1 次, 22天前
- customer-intel — 4 次, 22天前
- dispatching-parallel-agents — 3 次, 28天前
- executing-plans — 3 次, 28天前
- gdrive-to-skills — 2 次, 29天前
- investment-research — 3 次, 23天前
- keyword-discovery — 1 次, 14天前
- material-health — 1 次, 22天前
- mockup — 1 次, 30天前
- planning-with-files — 4 次, 24天前
- requirement — 1 次, 30天前
- sales-material — 1 次, 22天前
- settings-audit — 1 次, 13天前
- subsidy-scraper — 1 次, 22天前
- user-flow — 1 次, 30天前
- writing-plans — 3 次, 28天前
...
```
798721d feat(infra): migrate SQLite→Postgres, add Docker and CI/CD pipeline
...
```
ad13050 chore: add QA session learnings (browse cookie pattern, Next.js layout gotcha)
deb8580 fix(qa): ISSUE-003/004 — Chinese login error + logout redirect
a7f8a15 fix(qa): ISSUE-002 — only add trailing slash on GET requests in proxy
b4d316a fix(qa): ISSUE-001 — hide sidebar/nav on /login page
28792e5 fix(qa): ISSUE-002 — buffer request body in proxy to fix POST redirect hang
```
</details>
...
| news_stock | maintainer | daily 4:00 | ● loaded | 0 |
| news_stock | tester | daily 5:00 | ● loaded | 0 |
| news_stock | developer | weekly 3:00 | ● loaded | 0 |
| rivendell | maintain | daily 22:00 | ● loaded | 0 |
| rivendell | harvest | interval :00 | ● loaded | 0 |
| rivendell | tester | daily 6:00 | ● loaded | 0 |
| sales-assistant | crm-projection | daily 7:00 | ● loaded | 0 |
| sales-assistant | subsidy-scraper | calendar 8:00 | ● loaded | 0 |
| sales-assistant | material-health | weekly 9:00 | ● loaded | 0 |
| sales-assistant | tender-scraper | daily 8:30 | ● loaded | 0 |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-01", "04-02", "04-03", "04-04", "04-05", "04-06", "04-07"]
    y-axis "USD" 0 --> 400
    bar [116, 151, 0, 0, 5, 318, 0]
~~~
...
| 2026-04-06 (Mon) | 11 | 1,628 | 146.3M | $317.87 |
| 2026-04-07 (Tue) | 0 | 0 | 0 | $0.00 |
| **Total** | | | **260.1M** | **$588.77** |
...
|---------|-----------|--------|-----------|
| sales-assistant | 976 | 94.4M | $202.14 |
| rivendell | 720 | 58.8M | $129.86 |
| -Users-manibari-Documents-Projects | 542 | 49.9M | $109.98 |
| Family-Fiscal | 463 | 41.7M | $93.60 |
| news_stock | 20 | 483K | $32.55 |
| news-stock | 66 | 4.2M | $15.09 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-07 — 65 skills, 10 issue(s)*
