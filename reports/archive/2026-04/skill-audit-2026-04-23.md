...
**backend/**
- docker-compose-setup — 2 次修訂, 6天前
- firebase-backend — 2 次修訂, 6天前

**docs/**
- pitch-deck — 2 次修訂, 13天前

**meta/**
- session-harvest — 2 次修訂, 13天前
- skill-creator — 4 次修訂, 6天前

**quality/**
- de-slopify — 2 次修訂, 6天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 6天前
- sales-material — 3 次修訂, 2天前

<details><summary>✅ 穩定 (78)</summary>

**backend/**
- audio-transcription-flow — 1 次, 16天前
- db-migration — 1 次, 42天前
- doc-to-structured-data — 1 次, 28天前
- imap-smtp-integration — 1 次, 30天前
- markdown-file-ssot — 1 次, 30天前
- oauth-token-vault — 1 次, 30天前
- rbac-permissions — 1 次, 16天前
- sqlite-to-postgres — 1 次, 39天前
- tunnel-proxy-deploy — 1 次, 39天前
- tw-company-lookup — 2 次, 38天前
- vector-search-setup — 1 次, 24天前

**docs/**
- discovery-interview — 1 次, 16天前
- gdoc-report-builder — 1 次, 10天前
- iot-factory-report — 1 次, 10天前
- mcp-builder — 3 次, 44天前
- metadata-workshop — 1 次, 15天前
- office-docx — 4 次, 15天前
- office-pdf — 3 次, 44天前
- office-pptx — 3 次, 44天前
- office-xlsx — 3 次, 44天前
- rfq-writer — 1 次, 15天前
- slide-template-extractor — 1 次, 13天前
- slide-workflow — 1 次, 9天前
- sow-writer — 1 次, 16天前
- telegram-bot — 1 次, 39天前

**frontend/**
- frontend-design — 2 次, 45天前
- ios-integration — 1 次, 46天前
- swiftui-patterns — 1 次, 46天前
- ui-ux-pro-max — 3 次, 44天前

**git/**
- auto-stage — 1 次, 28天前
- repo-rename — 1 次, 28天前

**meta/**
- agent-persona — 1 次, 10天前
- audit-fix — 1 次, 42天前
- ci-pipeline — 1 次, 42天前
- deploy — 1 次, 42天前
- dev-process-gate — 4 次, 16天前
- init-project — 2 次, 45天前
- knowledge-graph — 1 次, 39天前
- plan-check-style — 3 次, 42天前
- self-improving-agent — 2 次, 24天前
- session-wrap — 1 次, 9天前
- setup-permissions — 3 次, 42天前
- skill-scout — 1 次, 39天前
- sync-readme — 1 次, 23天前

**quality/**
- github-repo-audit — 1 次, 10天前
- large-file-refactor — 1 次, 24天前
- protect-secrets — 1 次, 28天前
- qa-auto — 1 次, 39天前
- qa-planner — 1 次, 39天前
- qa-testing — 1 次, 44天前
...
- autoresearch — 1 次, 30天前
- candidate-analysis — 1 次, 28天前
- claude-to-telegram — 1 次, 39天前
- client-kickoff-docs — 1 次, 1天前
- context-recovery — 1 次, 39天前
- crm-projection — 1 次, 38天前
- customer-intel — 4 次, 38天前
- env-doctor — 1 次, 1天前
- executing-plans — 3 次, 44天前
- gdrive-to-skills — 2 次, 45天前
- headless-agent — 6 次, 30天前
- investment-research — 3 次, 39天前
- jd-writer — 1 次, 10天前
- keyword-discovery — 1 次, 30天前
- launchd-agent — 4 次, 16天前
- material-health — 1 次, 38天前
- mockup — 1 次, 46天前
- mops-financial-scraper — 1 次, 1天前
- planning-with-files — 5 次, 16天前
- presales-pipeline — 1 次, 1天前
- repro-exam — 1 次, 1天前
- requirement — 2 次, 16天前
- settings-audit — 1 次, 29天前
- subsidy-scraper — 1 次, 38天前
- tender-scraper — 3 次, 30天前
- user-flow — 1 次, 46天前
- writing-plans — 3 次, 44天前
...
```
aeb8e81 feat(mops): HTML scraper for 公開資訊觀測站 balance sheet (t164sb03)
02e25ab docs: correct dev ports to 3001 / 8001
32f63ff feat(mops): fundamentals UI panel on trading page
553b32c chore(agent): research-agent-daily run 2026-04-23
e904e1e chore: add src/services/__init__.py
```
</details>
...
```
be0d60b IR schema upgrade: pcb-enriched.json → full ODB++ reader
fd72c23 Dashboard: PCB layer toggles (silk / top / bot / mask)
1ce38c0 Dashboard canvas pan/zoom: wheel, drag, keyboard, HUD
97c7886 R2.1: fix silk width + arc distance, add geometric CSP classifier
c2e4cf4 R2: add SilkScreen0110-SS (Silk→Pad ≥ 0.15 mm)
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-17", "04-18", "04-19", "04-20", "04-21", "04-22", "04-23"]
    y-axis "USD" 0 --> 800
    bar [190, 26, 90, 710, 550, 358, 399]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-04-17 (Fri) | 10 | 435 | 56.5M | $190.45 |
| 2026-04-18 (Sat) | 8 | 81 | 5.4M | $26.12 |
| 2026-04-19 (Sun) | 5 | 304 | 27.2M | $90.31 |
| 2026-04-20 (Mon) | 13 | 1,462 | 251.3M | $709.99 |
| 2026-04-21 (Tue) | 8 | 1,029 | 203.2M | $550.09 |
| 2026-04-22 (Wed) | 10 | 465 | 121.4M | $358.16 |
| 2026-04-23 (Thu) | 8 | 508 | 192.9M | $398.76 |
| **Total** | | | **857.8M** | **$2323.89** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents | 1,740 | 475.1M | $1138.16 |
| company-proflie | 468 | 143.3M | $328.94 |
| news-stock | 716 | 81.3M | $279.24 |
| -Users-manibari-Documents-Peter-ChimesAI-01-Presales | 212 | 37.9M | $122.97 |
| resume-pool | 131 | 21.7M | $102.35 |
| rivendell | 114 | 24.1M | $93.98 |
| -Users-manibari-Documents-Peter | 268 | 24.4M | $84.95 |
| -Users-manibari-Documents-Peter-ChimesAI-01-Presales-202604 | 203 | 21.1M | $59.03 |
| sales-assistant | 207 | 12.1M | $48.06 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Peter-ChimesAI | 115 | 8.0M | $32.02 |
| -Users-manibari-Documents-Projects | 90 | 5.1M | $20.30 |
| -Users-manibari-Documents-Peter-ChimesAI-02-Deliveries | 16 | 2.9M | $7.48 |
| rakucamp | 4 | 876K | $6.41 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-23 — 86 skills, 30 issue(s)*
