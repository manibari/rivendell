...
**backend/**
- docker-compose-setup — 2 次修訂, 10天前
- firebase-backend — 2 次修訂, 10天前

**meta/**
- skill-creator — 4 次修訂, 10天前

**quality/**
- de-slopify — 2 次修訂, 10天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 10天前
- sales-material — 3 次修訂, 6天前

<details><summary>✅ 穩定 (81)</summary>

**backend/**
- audio-transcription-flow — 1 次, 20天前
- db-migration — 1 次, 46天前
- doc-to-structured-data — 1 次, 32天前
- imap-smtp-integration — 1 次, 34天前
- markdown-file-ssot — 1 次, 34天前
- oauth-token-vault — 1 次, 34天前
- rbac-permissions — 1 次, 20天前
- sqlite-to-postgres — 1 次, 43天前
- tunnel-proxy-deploy — 1 次, 43天前
- tw-company-lookup — 2 次, 42天前
- vector-search-setup — 1 次, 28天前

**docs/**
- discovery-interview — 1 次, 20天前
- gdoc-report-builder — 1 次, 14天前
- iot-factory-report — 1 次, 14天前
- mcp-builder — 3 次, 48天前
- metadata-workshop — 1 次, 19天前
- office-docx — 4 次, 19天前
- office-pdf — 3 次, 48天前
- office-pptx — 3 次, 48天前
- office-xlsx — 3 次, 48天前
- pitch-deck — 2 次, 17天前
- rfq-writer — 1 次, 19天前
- slide-template-extractor — 1 次, 17天前
- slide-workflow — 1 次, 13天前
- sow-writer — 1 次, 20天前
- telegram-bot — 1 次, 43天前

**frontend/**
- frontend-design — 2 次, 49天前
- ios-integration — 1 次, 50天前
- swiftui-patterns — 1 次, 50天前
- ui-ux-pro-max — 3 次, 48天前

**git/**
- auto-stage — 1 次, 32天前
- repo-rename — 1 次, 32天前

**meta/**
- agent-persona — 1 次, 14天前
- audit-fix — 1 次, 46天前
- ci-pipeline — 1 次, 46天前
- deploy — 1 次, 46天前
- dev-process-gate — 4 次, 20天前
- init-project — 2 次, 49天前
- knowledge-graph — 1 次, 43天前
- plan-check-style — 3 次, 46天前
- self-improving-agent — 2 次, 28天前
- session-harvest — 2 次, 17天前
- session-wrap — 1 次, 13天前
- setup-permissions — 3 次, 46天前
- skill-scout — 1 次, 43天前
- sync-readme — 1 次, 27天前
- workflow-retro — 1 次, 0天前

**quality/**
- github-repo-audit — 1 次, 14天前
- large-file-refactor — 1 次, 28天前
- protect-secrets — 1 次, 32天前
- qa-auto — 1 次, 43天前
- qa-planner — 1 次, 43天前
- qa-testing — 1 次, 48天前
...
- autoresearch — 1 次, 34天前
- candidate-analysis — 1 次, 32天前
- claude-to-telegram — 1 次, 43天前
- client-kickoff-docs — 1 次, 5天前
- context-recovery — 1 次, 43天前
- crm-projection — 1 次, 42天前
- customer-intel — 4 次, 42天前
- env-doctor — 1 次, 5天前
- executing-plans — 3 次, 48天前
- gdrive-to-skills — 2 次, 49天前
- headless-agent — 6 次, 34天前
- investment-research — 3 次, 43天前
- jd-writer — 1 次, 14天前
- keyword-discovery — 1 次, 34天前
- launchd-agent — 4 次, 20天前
- material-health — 1 次, 42天前
- mockup — 1 次, 50天前
- mops-financial-scraper — 1 次, 5天前
- planning-with-files — 5 次, 20天前
- presales-pipeline — 1 次, 5天前
- repro-exam — 1 次, 5天前
- requirement — 2 次, 20天前
- settings-audit — 1 次, 33天前
- subsidy-scraper — 1 次, 42天前
- tender-scraper — 3 次, 34天前
- user-flow — 1 次, 50天前
- writing-plans — 3 次, 48天前
...
a51c3e2 feat(mops/ui): six indicators tab in fundamentals panel
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-21", "04-22", "04-23", "04-24", "04-25", "04-26", "04-27"]
    y-axis "USD" 0 --> 1250
    bar [550, 358, 1185, 22, 385, 71, 1068]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-04-21 (Tue) | 8 | 1,029 | 203.2M | $550.09 |
...
| 2026-04-27 (Mon) | 9 | 1,779 | 426.3M | $1067.84 |
| **Total** | | | **1441.9M** | **$3638.90** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents | 1,396 | 529.7M | $1223.46 |
| news-stock | 996 | 269.1M | $696.58 |
| company-proflie | 680 | 261.4M | $595.78 |
| -Users-manibari-Documents-Peter-Work | 520 | 106.9M | $342.93 |
| -Users-manibari-Documents-Peter | 801 | 128.8M | $321.78 |
| -Users-manibari-Documents-Peter-ChimesAI | 341 | 85.6M | $205.00 |
| resume-pool | 139 | 24.0M | $119.83 |
| rivendell | 198 | 19.4M | $62.89 |
| news_stock | 28 | 603K | $40.77 |
| sales-assistant | 187 | 10.0M | $35.93 |
| -Users-manibari-Documents-Peter-ChimesAI-01-Presales | 5 | 1.6M | $18.66 |
| -Users-manibari-Documents-Projects | 79 | 5.6M | $16.05 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-27 — 87 skills, 29 issue(s)*
