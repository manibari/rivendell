...
**backend/**
- docker-compose-setup — 2 次修訂, 11天前
- firebase-backend — 2 次修訂, 11天前

**git/**
- auto-stage — 2 次修訂, 0天前

**meta/**
- skill-creator — 4 次修訂, 11天前

**quality/**
- de-slopify — 2 次修訂, 11天前
- protect-secrets — 2 次修訂, 0天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 11天前
- sales-material — 3 次修訂, 7天前

<details><summary>✅ 穩定 (81)</summary>

**backend/**
- audio-transcription-flow — 1 次, 21天前
- db-migration — 1 次, 47天前
- doc-to-structured-data — 1 次, 33天前
- imap-smtp-integration — 1 次, 35天前
- markdown-file-ssot — 1 次, 35天前
- oauth-token-vault — 1 次, 35天前
- rbac-permissions — 1 次, 21天前
- sqlite-to-postgres — 1 次, 44天前
- tunnel-proxy-deploy — 1 次, 44天前
- tw-company-lookup — 2 次, 43天前
- vector-search-setup — 1 次, 29天前

**docs/**
- discovery-interview — 1 次, 21天前
- doc-coauthoring — 1 次, 0天前
- gdoc-report-builder — 1 次, 15天前
- internal-comms — 1 次, 0天前
- iot-factory-report — 1 次, 15天前
- mcp-builder — 3 次, 49天前
- metadata-workshop — 1 次, 20天前
- office-docx — 4 次, 20天前
- office-pdf — 3 次, 49天前
- office-pptx — 3 次, 49天前
- office-xlsx — 3 次, 49天前
- pitch-deck — 2 次, 18天前
- rfq-writer — 1 次, 20天前
- slide-template-extractor — 1 次, 18天前
- slide-workflow — 1 次, 14天前
- sow-writer — 1 次, 21天前
- telegram-bot — 1 次, 44天前

**frontend/**
- frontend-design — 2 次, 50天前
- ios-integration — 1 次, 51天前
- swiftui-patterns — 1 次, 51天前
- ui-ux-pro-max — 3 次, 49天前

**git/**
- repo-rename — 1 次, 33天前

**meta/**
- agent-persona — 1 次, 15天前
- audit-fix — 1 次, 47天前
- ci-pipeline — 1 次, 47天前
- deploy — 1 次, 47天前
- dev-process-gate — 4 次, 21天前
- init-project — 2 次, 50天前
- knowledge-graph — 1 次, 44天前
- plan-check-style — 3 次, 47天前
- self-improving-agent — 2 次, 29天前
- session-harvest — 2 次, 18天前
- session-wrap — 1 次, 14天前
- setup-permissions — 3 次, 47天前
- skill-scout — 1 次, 44天前
- sync-readme — 1 次, 28天前
- workflow-retro — 1 次, 1天前

**quality/**
- github-repo-audit — 1 次, 15天前
- large-file-refactor — 1 次, 29天前
- qa-auto — 1 次, 44天前
- qa-planner — 1 次, 44天前
- qa-testing — 1 次, 49天前
...
- autoresearch — 1 次, 35天前
- candidate-analysis — 1 次, 33天前
- claude-to-telegram — 1 次, 44天前
- client-kickoff-docs — 1 次, 6天前
- context-recovery — 1 次, 44天前
- crm-projection — 1 次, 43天前
- customer-intel — 4 次, 43天前
- env-doctor — 1 次, 6天前
- executing-plans — 3 次, 49天前
- gdrive-to-skills — 2 次, 50天前
- headless-agent — 6 次, 35天前
- investment-research — 3 次, 44天前
- jd-writer — 1 次, 15天前
- keyword-discovery — 1 次, 35天前
- launchd-agent — 4 次, 21天前
- material-health — 1 次, 43天前
- mockup — 1 次, 51天前
- mops-financial-scraper — 1 次, 6天前
- planning-with-files — 5 次, 21天前
- presales-pipeline — 1 次, 6天前
- repro-exam — 1 次, 6天前
- requirement — 2 次, 21天前
- settings-audit — 1 次, 34天前
- subsidy-scraper — 1 次, 43天前
- tender-scraper — 3 次, 35天前
- user-flow — 1 次, 51天前
- writing-plans — 3 次, 49天前
...
```
f0e878d chore: exclude .claude/ from version control
0572594 chore: remove db WAL files and stray package.json from tracking
c5c4e32 feat: initial ChimesFlow CRM — full-stack B2B sales pipeline
```
</details>
...
```
e0643b4 chore(agent): research-agent-daily run 2026-04-28
e052c18 feat(mops): grading CLI emits CSV + XLSX, regenerate 2026-04 outputs
c51952c fix(mops): YoY uses abs(prior) + FCF cashflow timing override → 97.6% Excel match
0af937a chore(mops): bloomberg-style deck (PPTX) for six indicators
8c5eff5 feat(mops): rules-based letter grading engine matching Excel spec
```
</details>
...
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 941 dirty, 2 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
| **Config** | OK | **權限** | OK (34 rules) |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-22", "04-23", "04-24", "04-25", "04-26", "04-27", "04-28"]
    y-axis "USD" 0 --> 1850
    bar [358, 1185, 22, 385, 71, 1755, 750]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-04-22 (Wed) | 10 | 465 | 121.4M | $358.16 |
| 2026-04-23 (Thu) | 16 | 1,490 | 511.5M | $1184.93 |
| 2026-04-24 (Fri) | 3 | 23 | 2.0M | $22.18 |
| 2026-04-25 (Sat) | 9 | 436 | 159.5M | $384.92 |
| 2026-04-26 (Sun) | 6 | 120 | 17.9M | $70.76 |
| 2026-04-27 (Mon) | 14 | 2,574 | 747.0M | $1755.17 |
| 2026-04-28 (Tue) | 9 | 1,283 | 324.6M | $750.39 |
| **Total** | | | **1884.0M** | **$4526.52** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| news-stock | 2,046 | 682.4M | $1491.69 |
| -Users-manibari-Documents | 791 | 410.8M | $919.73 |
| -Users-manibari-Documents-Peter | 1,051 | 238.1M | $587.93 |
| company-proflie | 370 | 189.5M | $412.42 |
| -Users-manibari-Documents-Peter-Work | 549 | 118.8M | $377.05 |
| -Users-manibari-Documents-Peter-ChimesAI | 341 | 85.6M | $205.00 |
| rivendell | 366 | 57.6M | $184.65 |
| resume-pool | 139 | 24.0M | $119.83 |
|  | 284 | 46.2M | $115.04 |
| sales-assistant | 295 | 18.6M | $63.90 |
| news_stock | 28 | 603K | $40.77 |
| sales-johnson | 130 | 8.4M | $22.14 |
| -Users-manibari-Documents-Peter-ChimesAI-01-Presales | 5 | 1.6M | $18.66 |
| -Users-manibari-Documents-Projects | 24 | 2.5M | $8.48 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-28 — 89 skills, 18 issue(s)*
