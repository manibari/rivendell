...
**backend/**
- docker-compose-setup — 2 次修訂, 0天前
- firebase-backend — 2 次修訂, 0天前

**docs/**
- office-docx — 4 次修訂, 9天前
- pitch-deck — 2 次修訂, 7天前

**meta/**
- dev-process-gate — 4 次修訂, 10天前
- session-harvest — 2 次修訂, 7天前
- skill-creator — 4 次修訂, 0天前

**quality/**
- de-slopify — 2 次修訂, 0天前

**workflow/**
- agent-observability — 2 次修訂, 10天前
- dispatching-parallel-agents — 4 次修訂, 0天前
- launchd-agent — 4 次修訂, 10天前
- planning-with-files — 5 次修訂, 10天前
- requirement — 2 次修訂, 10天前
- sales-material — 2 次修訂, 7天前

<details><summary>✅ 穩定 (67)</summary>

**backend/**
- audio-transcription-flow — 1 次, 10天前
- db-migration — 1 次, 36天前
- doc-to-structured-data — 1 次, 22天前
- imap-smtp-integration — 1 次, 24天前
- markdown-file-ssot — 1 次, 24天前
- oauth-token-vault — 1 次, 24天前
- rbac-permissions — 1 次, 10天前
- sqlite-to-postgres — 1 次, 33天前
- tunnel-proxy-deploy — 1 次, 33天前
- tw-company-lookup — 2 次, 32天前
- vector-search-setup — 1 次, 18天前

**docs/**
- discovery-interview — 1 次, 10天前
- gdoc-report-builder — 1 次, 4天前
- iot-factory-report — 1 次, 4天前
- mcp-builder — 3 次, 38天前
- metadata-workshop — 1 次, 9天前
- office-pdf — 3 次, 38天前
- office-pptx — 3 次, 38天前
- office-xlsx — 3 次, 38天前
- rfq-writer — 1 次, 9天前
- slide-template-extractor — 1 次, 7天前
- slide-workflow — 1 次, 3天前
- sow-writer — 1 次, 10天前
- telegram-bot — 1 次, 33天前

**frontend/**
- frontend-design — 2 次, 39天前
- ios-integration — 1 次, 40天前
- swiftui-patterns — 1 次, 40天前
- ui-ux-pro-max — 3 次, 38天前

**git/**
- auto-stage — 1 次, 22天前
- repo-rename — 1 次, 22天前

**meta/**
- agent-persona — 1 次, 4天前
- audit-fix — 1 次, 36天前
- ci-pipeline — 1 次, 36天前
- deploy — 1 次, 36天前
- init-project — 2 次, 39天前
- knowledge-graph — 1 次, 33天前
- plan-check-style — 3 次, 36天前
- self-improving-agent — 2 次, 18天前
- session-wrap — 1 次, 3天前
- setup-permissions — 3 次, 36天前
- skill-scout — 1 次, 33天前
- sync-readme — 1 次, 17天前

**quality/**
- github-repo-audit — 1 次, 4天前
- large-file-refactor — 1 次, 18天前
- protect-secrets — 1 次, 22天前
- qa-auto — 1 次, 33天前
- qa-planner — 1 次, 33天前
- qa-testing — 1 次, 38天前

**workflow/**
- autoresearch — 1 次, 24天前
- candidate-analysis — 1 次, 22天前
- claude-to-telegram — 1 次, 33天前
- context-recovery — 1 次, 33天前
- crm-projection — 1 次, 32天前
- customer-intel — 4 次, 32天前
- executing-plans — 3 次, 38天前
- gdrive-to-skills — 2 次, 39天前
- headless-agent — 6 次, 24天前
- investment-research — 3 次, 33天前
- jd-writer — 1 次, 4天前
- keyword-discovery — 1 次, 24天前
- material-health — 1 次, 32天前
- mockup — 1 次, 40天前
- settings-audit — 1 次, 23天前
- subsidy-scraper — 1 次, 32天前
- tender-scraper — 3 次, 24天前
- user-flow — 1 次, 40天前
- writing-plans — 3 次, 38天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 1 個 commit（本週）, 135 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 36 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
