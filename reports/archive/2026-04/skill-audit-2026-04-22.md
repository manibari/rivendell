...
**backend/**
- docker-compose-setup — 2 次修訂, 5天前
- firebase-backend — 2 次修訂, 5天前

**docs/**
- office-docx — 4 次修訂, 14天前
- pitch-deck — 2 次修訂, 12天前

**meta/**
- session-harvest — 2 次修訂, 12天前
- skill-creator — 4 次修訂, 5天前

**quality/**
- de-slopify — 2 次修訂, 5天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 5天前
- sales-material — 3 次修訂, 1天前

<details><summary>✅ 穩定 (77)</summary>

**backend/**
- audio-transcription-flow — 1 次, 15天前
- db-migration — 1 次, 41天前
- doc-to-structured-data — 1 次, 27天前
- imap-smtp-integration — 1 次, 29天前
- markdown-file-ssot — 1 次, 29天前
- oauth-token-vault — 1 次, 29天前
- rbac-permissions — 1 次, 15天前
- sqlite-to-postgres — 1 次, 38天前
- tunnel-proxy-deploy — 1 次, 38天前
- tw-company-lookup — 2 次, 37天前
- vector-search-setup — 1 次, 23天前

**docs/**
- discovery-interview — 1 次, 15天前
- gdoc-report-builder — 1 次, 9天前
- iot-factory-report — 1 次, 9天前
- mcp-builder — 3 次, 43天前
- metadata-workshop — 1 次, 14天前
- office-pdf — 3 次, 43天前
- office-pptx — 3 次, 43天前
- office-xlsx — 3 次, 43天前
- rfq-writer — 1 次, 14天前
- slide-template-extractor — 1 次, 12天前
- slide-workflow — 1 次, 8天前
- sow-writer — 1 次, 15天前
- telegram-bot — 1 次, 38天前

**frontend/**
- frontend-design — 2 次, 44天前
- ios-integration — 1 次, 45天前
- swiftui-patterns — 1 次, 45天前
- ui-ux-pro-max — 3 次, 43天前

**git/**
- auto-stage — 1 次, 27天前
- repo-rename — 1 次, 27天前

**meta/**
- agent-persona — 1 次, 9天前
- audit-fix — 1 次, 41天前
- ci-pipeline — 1 次, 41天前
- deploy — 1 次, 41天前
- dev-process-gate — 4 次, 15天前
- init-project — 2 次, 44天前
- knowledge-graph — 1 次, 38天前
- plan-check-style — 3 次, 41天前
- self-improving-agent — 2 次, 23天前
- session-wrap — 1 次, 8天前
- setup-permissions — 3 次, 41天前
- skill-scout — 1 次, 38天前
- sync-readme — 1 次, 22天前

**quality/**
- github-repo-audit — 1 次, 9天前
- large-file-refactor — 1 次, 23天前
- protect-secrets — 1 次, 27天前
- qa-auto — 1 次, 38天前
- qa-planner — 1 次, 38天前
- qa-testing — 1 次, 43天前

**workflow/**
- agent-observability — 2 次, 15天前
- autoresearch — 1 次, 29天前
- candidate-analysis — 1 次, 27天前
- claude-to-telegram — 1 次, 38天前
- client-kickoff-docs — 1 次, 0天前
- context-recovery — 1 次, 38天前
- crm-projection — 1 次, 37天前
- customer-intel — 4 次, 37天前
- env-doctor — 1 次, 0天前
- executing-plans — 3 次, 43天前
- gdrive-to-skills — 2 次, 44天前
- headless-agent — 6 次, 29天前
- investment-research — 3 次, 38天前
- jd-writer — 1 次, 9天前
- keyword-discovery — 1 次, 29天前
- launchd-agent — 4 次, 15天前
- material-health — 1 次, 37天前
- mockup — 1 次, 45天前
- mops-financial-scraper — 1 次, 0天前
- planning-with-files — 5 次, 15天前
- presales-pipeline — 1 次, 0天前
- repro-exam — 1 次, 0天前
- requirement — 2 次, 15天前
- settings-audit — 1 次, 28天前
- subsidy-scraper — 1 次, 37天前
- tender-scraper — 3 次, 29天前
- user-flow — 1 次, 45天前
- writing-plans — 3 次, 43天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 10 個 commit（本週）, 26 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `feat/mops-fundamentals-ui` (3 total) |
| **Git** | 2 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
6a71d87 chore(agent): research-agent-daily run 2026-04-22
ae2687a feat: MOPS historical financials collector (FinMind-based)
50fc28d chore(agent): research-agent-daily run 2026-04-21
cbb143e chore(tests): add pytest suite scaffolding
```
</details>
...
13fbc2b R1: add CP0111 + General0021 (Valor coverage 3 → 5 rules)
1fa77fe Initial commit: odb-dfm v0.1.0 — library + CLI extracted from sandbox
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-16", "04-17", "04-18", "04-19", "04-20", "04-21", "04-22"]
    y-axis "USD" 0 --> 800
    bar [107, 190, 26, 90, 710, 550, 346]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-04-16 (Thu) | 6 | 345 | 33.8M | $107.25 |
...
| 2026-04-22 (Wed) | 7 | 422 | 119.1M | $346.47 |
| **Total** | | | **696.5M** | **$2020.69** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents | 1,520 | 360.8M | $913.35 |
| news-stock | 772 | 85.5M | $295.62 |
| company-proflie | 322 | 76.8M | $198.30 |
| -Users-manibari-Documents-Peter-ChimesAI-01-Presales | 212 | 37.9M | $122.97 |
| resume-pool | 131 | 21.7M | $102.35 |
| rivendell | 122 | 24.4M | $95.51 |
| -Users-manibari-Documents-Peter-ChimesAI-02-Deliveries | 213 | 28.0M | $75.41 |
| -Users-manibari-Documents-Peter-ChimesAI-01-Presales-202604 | 203 | 21.1M | $59.03 |
| -Users-manibari-Documents-Peter | 162 | 14.7M | $51.30 |
| sales-assistant | 212 | 11.8M | $48.13 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-22 — 86 skills, 29 issue(s)*
