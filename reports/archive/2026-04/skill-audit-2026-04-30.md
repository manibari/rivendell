...
**backend/**
- docker-compose-setup — 2 次修訂, 13天前
- firebase-backend — 2 次修訂, 13天前

**git/**
- auto-stage — 2 次修訂, 2天前

**meta/**
- skill-creator — 4 次修訂, 13天前
- skill-scout — 2 次修訂, 1天前

**quality/**
- de-slopify — 2 次修訂, 13天前
- protect-secrets — 2 次修訂, 2天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 13天前
- launchd-agent — 5 次修訂, 1天前
- sales-material — 3 次修訂, 9天前

<details><summary>✅ 穩定 (79)</summary>

**backend/**
- audio-transcription-flow — 1 次, 23天前
- db-migration — 1 次, 49天前
- doc-to-structured-data — 1 次, 35天前
- imap-smtp-integration — 1 次, 37天前
- markdown-file-ssot — 1 次, 37天前
- oauth-token-vault — 1 次, 37天前
- rbac-permissions — 1 次, 23天前
- sqlite-to-postgres — 1 次, 46天前
- tunnel-proxy-deploy — 1 次, 46天前
- tw-company-lookup — 2 次, 45天前
- vector-search-setup — 1 次, 31天前

**docs/**
- discovery-interview — 1 次, 23天前
- doc-coauthoring — 1 次, 2天前
- gdoc-report-builder — 1 次, 17天前
- internal-comms — 1 次, 2天前
- iot-factory-report — 1 次, 17天前
- mcp-builder — 3 次, 51天前
- metadata-workshop — 1 次, 22天前
- office-docx — 4 次, 22天前
- office-pdf — 3 次, 51天前
- office-pptx — 3 次, 51天前
- office-xlsx — 3 次, 51天前
- pitch-deck — 2 次, 20天前
- rfq-writer — 1 次, 22天前
- slide-template-extractor — 1 次, 20天前
- slide-workflow — 1 次, 16天前
- sow-writer — 1 次, 23天前
- telegram-bot — 1 次, 46天前

**frontend/**
- frontend-design — 2 次, 52天前
- ios-integration — 1 次, 53天前
- swiftui-patterns — 1 次, 53天前
- ui-ux-pro-max — 3 次, 51天前

**git/**
- repo-rename — 1 次, 35天前

**meta/**
- agent-persona — 1 次, 17天前
- audit-fix — 1 次, 49天前
- ci-pipeline — 1 次, 49天前
- deploy — 1 次, 49天前
- dev-process-gate — 4 次, 23天前
- init-project — 2 次, 52天前
- knowledge-graph — 1 次, 46天前
- plan-check-style — 3 次, 49天前
- self-improving-agent — 2 次, 31天前
- session-harvest — 2 次, 20天前
- session-wrap — 1 次, 16天前
- setup-permissions — 3 次, 49天前
- sync-readme — 1 次, 30天前
- workflow-retro — 1 次, 3天前

**quality/**
- github-repo-audit — 1 次, 17天前
- large-file-refactor — 1 次, 31天前
- qa-auto — 1 次, 46天前
- qa-planner — 1 次, 46天前
- qa-testing — 1 次, 51天前
...
- autoresearch — 1 次, 37天前
- candidate-analysis — 1 次, 35天前
- claude-to-telegram — 1 次, 46天前
- client-kickoff-docs — 1 次, 8天前
- context-recovery — 1 次, 46天前
- crm-projection — 1 次, 45天前
- customer-intel — 4 次, 45天前
- env-doctor — 1 次, 8天前
- executing-plans — 3 次, 51天前
- gdrive-to-skills — 2 次, 52天前
- headless-agent — 6 次, 37天前
- investment-research — 3 次, 46天前
- jd-writer — 1 次, 17天前
- keyword-discovery — 1 次, 37天前
- material-health — 1 次, 45天前
- mockup — 1 次, 53天前
- mops-financial-scraper — 1 次, 8天前
- planning-with-files — 5 次, 23天前
- presales-pipeline — 1 次, 8天前
- repro-exam — 1 次, 8天前
- requirement — 2 次, 23天前
- settings-audit — 1 次, 36天前
- subsidy-scraper — 1 次, 45天前
- tender-scraper — 3 次, 37天前
- user-flow — 1 次, 53天前
- writing-plans — 3 次, 51天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-24", "04-25", "04-26", "04-27", "04-28", "04-29", "04-30"]
    y-axis "USD" 0 --> 1850
    bar [22, 385, 71, 1755, 929, 731, 654]
~~~
...
| 2026-04-28 (Tue) | 11 | 1,458 | 412.0M | $928.50 |
| 2026-04-29 (Wed) | 14 | 1,279 | 277.7M | $731.24 |
| 2026-04-30 (Thu) | 7 | 680 | 281.9M | $653.80 |
| **Total** | | | **1898.1M** | **$4546.58** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| news-stock | 1,942 | 672.1M | $1420.25 |
| -Users-manibari-Documents-Peter-Work | 1,631 | 511.8M | $1299.71 |
| -Users-manibari-Documents-Peter | 870 | 284.1M | $646.31 |
| rivendell | 516 | 110.3M | $353.38 |
| company-proflie | 176 | 99.8M | $211.85 |
|  | 402 | 78.2M | $197.97 |
| -Users-manibari-Documents | 72 | 35.3M | $116.80 |
| sales-johnson | 358 | 39.8M | $110.89 |
| ChimesFlow | 267 | 42.0M | $88.55 |
| sales-assistant | 331 | 23.2M | $82.22 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-30 — 89 skills, 19 issue(s)*
