...
**backend/**
- docker-compose-setup — 2 次修訂, 9天前
- firebase-backend — 2 次修訂, 9天前

**meta/**
- skill-creator — 4 次修訂, 9天前

**quality/**
- de-slopify — 2 次修訂, 9天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 9天前
- sales-material — 3 次修訂, 5天前

<details><summary>✅ 穩定 (80)</summary>

**backend/**
- audio-transcription-flow — 1 次, 19天前
- db-migration — 1 次, 45天前
- doc-to-structured-data — 1 次, 31天前
- imap-smtp-integration — 1 次, 33天前
- markdown-file-ssot — 1 次, 33天前
- oauth-token-vault — 1 次, 33天前
- rbac-permissions — 1 次, 19天前
- sqlite-to-postgres — 1 次, 42天前
- tunnel-proxy-deploy — 1 次, 42天前
- tw-company-lookup — 2 次, 41天前
- vector-search-setup — 1 次, 27天前

**docs/**
- discovery-interview — 1 次, 19天前
- gdoc-report-builder — 1 次, 13天前
- iot-factory-report — 1 次, 13天前
- mcp-builder — 3 次, 47天前
- metadata-workshop — 1 次, 18天前
- office-docx — 4 次, 18天前
- office-pdf — 3 次, 47天前
- office-pptx — 3 次, 47天前
- office-xlsx — 3 次, 47天前
- pitch-deck — 2 次, 16天前
- rfq-writer — 1 次, 18天前
- slide-template-extractor — 1 次, 16天前
- slide-workflow — 1 次, 12天前
- sow-writer — 1 次, 19天前
- telegram-bot — 1 次, 42天前

**frontend/**
- frontend-design — 2 次, 48天前
- ios-integration — 1 次, 49天前
- swiftui-patterns — 1 次, 49天前
- ui-ux-pro-max — 3 次, 47天前

**git/**
- auto-stage — 1 次, 31天前
- repo-rename — 1 次, 31天前

**meta/**
- agent-persona — 1 次, 13天前
- audit-fix — 1 次, 45天前
- ci-pipeline — 1 次, 45天前
- deploy — 1 次, 45天前
- dev-process-gate — 4 次, 19天前
- init-project — 2 次, 48天前
- knowledge-graph — 1 次, 42天前
- plan-check-style — 3 次, 45天前
- self-improving-agent — 2 次, 27天前
- session-harvest — 2 次, 16天前
- session-wrap — 1 次, 12天前
- setup-permissions — 3 次, 45天前
- skill-scout — 1 次, 42天前
- sync-readme — 1 次, 26天前

**quality/**
- github-repo-audit — 1 次, 13天前
- large-file-refactor — 1 次, 27天前
- protect-secrets — 1 次, 31天前
- qa-auto — 1 次, 42天前
- qa-planner — 1 次, 42天前
- qa-testing — 1 次, 47天前
...
- autoresearch — 1 次, 33天前
- candidate-analysis — 1 次, 31天前
- claude-to-telegram — 1 次, 42天前
- client-kickoff-docs — 1 次, 4天前
- context-recovery — 1 次, 42天前
- crm-projection — 1 次, 41天前
- customer-intel — 4 次, 41天前
- env-doctor — 1 次, 4天前
- executing-plans — 3 次, 47天前
- gdrive-to-skills — 2 次, 48天前
- headless-agent — 6 次, 33天前
- investment-research — 3 次, 42天前
- jd-writer — 1 次, 13天前
- keyword-discovery — 1 次, 33天前
- launchd-agent — 4 次, 19天前
- material-health — 1 次, 41天前
- mockup — 1 次, 49天前
- mops-financial-scraper — 1 次, 4天前
- planning-with-files — 5 次, 19天前
- presales-pipeline — 1 次, 4天前
- repro-exam — 1 次, 4天前
- requirement — 2 次, 19天前
- settings-audit — 1 次, 32天前
- subsidy-scraper — 1 次, 41天前
- tender-scraper — 3 次, 33天前
- user-flow — 1 次, 49天前
- writing-plans — 3 次, 47天前
...
```
db004ea docs(planning): session-wrap update for fundamentals-ui
9d26a4e chore(agent): research-agent-weekly run 2026-04-26
dfa9f35 chore(agent): research-agent-daily run 2026-04-26
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-20", "04-21", "04-22", "04-23", "04-24", "04-25", "04-26"]
    y-axis "USD" 0 --> 1250
    bar [710, 550, 358, 1185, 22, 385, 67]
~~~
...
| 2026-04-26 (Sun) | 4 | 103 | 17.1M | $66.95 |
| **Total** | | | **1266.0M** | **$3277.23** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents | 2,078 | 682.5M | $1628.35 |
| company-proflie | 680 | 261.4M | $595.78 |
| news-stock | 653 | 76.6M | $300.32 |
...
| sales-assistant | 175 | 9.9M | $34.47 |
| -Users-manibari-Documents-Projects | 114 | 7.6M | $28.78 |
| rivendell | 71 | 3.3M | $18.75 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-26 — 86 skills, 29 issue(s)*
