...
**docs/**
- office-docx — 4 次修訂, 4天前
- pitch-deck — 2 次修訂, 2天前

**meta/**
- dev-process-gate — 4 次修訂, 5天前
- self-improving-agent — 2 次修訂, 13天前
- session-harvest — 2 次修訂, 2天前
- skill-creator — 3 次修訂, 5天前

**workflow/**
- agent-observability — 2 次修訂, 5天前
- launchd-agent — 4 次修訂, 5天前
- planning-with-files — 5 次修訂, 5天前
...
**backend/**
- audio-transcription-flow — 1 次, 5天前
- db-migration — 1 次, 31天前
- doc-to-structured-data — 1 次, 17天前
- docker-compose-setup — 1 次, 5天前
- firebase-backend — 1 次, 35天前
- imap-smtp-integration — 1 次, 19天前
- markdown-file-ssot — 1 次, 19天前
- oauth-token-vault — 1 次, 19天前
- rbac-permissions — 1 次, 5天前
- sqlite-to-postgres — 1 次, 28天前
- tunnel-proxy-deploy — 1 次, 28天前
- tw-company-lookup — 2 次, 27天前
- vector-search-setup — 1 次, 13天前

**docs/**
- discovery-interview — 1 次, 5天前
- mcp-builder — 3 次, 33天前
- metadata-workshop — 1 次, 4天前
- office-pdf — 3 次, 33天前
- office-pptx — 3 次, 33天前
- office-xlsx — 3 次, 33天前
- rfq-writer — 1 次, 4天前
- slide-template-extractor — 1 次, 2天前
- sow-writer — 1 次, 5天前
- telegram-bot — 1 次, 28天前

**frontend/**
- frontend-design — 2 次, 34天前
- ios-integration — 1 次, 35天前
- swiftui-patterns — 1 次, 35天前
- ui-ux-pro-max — 3 次, 33天前

**git/**
- auto-stage — 1 次, 17天前
- repo-rename — 1 次, 17天前

**meta/**
- audit-fix — 1 次, 31天前
- ci-pipeline — 1 次, 31天前
- deploy — 1 次, 31天前
- init-project — 2 次, 34天前
- knowledge-graph — 1 次, 28天前
- plan-check-style — 3 次, 31天前
- setup-permissions — 3 次, 31天前
- skill-scout — 1 次, 28天前
- sync-readme — 1 次, 12天前

**quality/**
- de-slopify — 1 次, 28天前
- large-file-refactor — 1 次, 13天前
- protect-secrets — 1 次, 17天前
- qa-auto — 1 次, 28天前
- qa-planner — 1 次, 28天前
- qa-testing — 1 次, 33天前

**workflow/**
- autoresearch — 1 次, 19天前
- candidate-analysis — 1 次, 17天前
- claude-to-telegram — 1 次, 28天前
- context-recovery — 1 次, 28天前
- crm-projection — 1 次, 27天前
- customer-intel — 4 次, 27天前
- dispatching-parallel-agents — 3 次, 33天前
- executing-plans — 3 次, 33天前
- gdrive-to-skills — 2 次, 34天前
- headless-agent — 6 次, 19天前
- investment-research — 3 次, 28天前
- keyword-discovery — 1 次, 19天前
- material-health — 1 次, 27天前
- mockup — 1 次, 35天前
- settings-audit — 1 次, 18天前
- subsidy-scraper — 1 次, 27天前
- tender-scraper — 3 次, 19天前
- user-flow — 1 次, 35天前
- writing-plans — 3 次, 33天前
...
- **[docs,workflow]**: pitch-deck slide-template-extractor — 建議檢查邊界是否清楚
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 25 個 commit（本週）, 114 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 327 dirty, 2 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-06", "04-07", "04-08", "04-09", "04-10", "04-11", "04-12"]
    y-axis "USD" 0 --> 950
    bar [878, 775, 372, 750, 198, 68, 21]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-04-06 (Mon) | 18 | 4,335 | 416.1M | $878.35 |
...
| 2026-04-12 (Sun) | 4 | 90 | 4.4M | $21.46 |
| **Total** | | | **1255.9M** | **$3061.69** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| lorien | 1,487 | 299.6M | $756.77 |
| sales-assistant | 2,608 | 316.5M | $721.26 |
| rivendell | 1,515 | 181.1M | $445.59 |
| -Users-manibari-Documents-Peter | 727 | 164.0M | $354.49 |
| -Users-manibari-Documents-ChimesAI-richwave | 504 | 120.5M | $252.55 |
| Family-Fiscal | 854 | 86.0M | $190.72 |
| rakucamp | 178 | 20.7M | $113.27 |
| news-stock | 519 | 30.3M | $113.00 |
| news_stock | 28 | 603K | $40.77 |
| resume-pool | 141 | 12.7M | $36.76 |
| MingOS | 144 | 10.7M | $28.29 |
| -Users-manibari-Documents-Peter-ChimesAI | 106 | 7.8M | $25.87 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-12 — 74 skills, 28 issue(s)*
