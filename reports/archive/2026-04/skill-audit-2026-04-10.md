...
**docs/**
- office-docx — 4 次修訂, 2天前
- pitch-deck — 2 次修訂, 0天前

**meta/**
- dev-process-gate — 4 次修訂, 3天前
- self-improving-agent — 2 次修訂, 11天前
- session-harvest — 2 次修訂, 0天前
- skill-creator — 3 次修訂, 3天前

**workflow/**
- agent-observability — 2 次修訂, 3天前
- launchd-agent — 4 次修訂, 3天前
- planning-with-files — 5 次修訂, 3天前
- requirement — 2 次修訂, 3天前
- sales-material — 2 次修訂, 0天前

<details><summary>✅ 穩定 (63)</summary>

**backend/**
- audio-transcription-flow — 1 次, 3天前
- db-migration — 1 次, 29天前
- doc-to-structured-data — 1 次, 15天前
- docker-compose-setup — 1 次, 3天前
- firebase-backend — 1 次, 33天前
- imap-smtp-integration — 1 次, 17天前
- markdown-file-ssot — 1 次, 17天前
- oauth-token-vault — 1 次, 17天前
- rbac-permissions — 1 次, 3天前
- sqlite-to-postgres — 1 次, 26天前
- tunnel-proxy-deploy — 1 次, 26天前
- tw-company-lookup — 2 次, 25天前
- vector-search-setup — 1 次, 11天前

**docs/**
- discovery-interview — 1 次, 3天前
- mcp-builder — 3 次, 31天前
- metadata-workshop — 1 次, 2天前
- office-pdf — 3 次, 31天前
- office-pptx — 3 次, 31天前
- office-xlsx — 3 次, 31天前
- rfq-writer — 1 次, 2天前
- slide-template-extractor — 1 次, 0天前
- sow-writer — 1 次, 3天前
- telegram-bot — 1 次, 26天前

**frontend/**
- frontend-design — 2 次, 32天前
- ios-integration — 1 次, 33天前
- swiftui-patterns — 1 次, 33天前
- ui-ux-pro-max — 3 次, 31天前

**git/**
- auto-stage — 1 次, 15天前
- repo-rename — 1 次, 15天前

**meta/**
- audit-fix — 1 次, 29天前
- ci-pipeline — 1 次, 29天前
- deploy — 1 次, 29天前
- init-project — 2 次, 32天前
- knowledge-graph — 1 次, 26天前
- plan-check-style — 3 次, 29天前
- setup-permissions — 3 次, 29天前
- skill-scout — 1 次, 26天前
- sync-readme — 1 次, 10天前

**quality/**
- de-slopify — 1 次, 26天前
- large-file-refactor — 1 次, 11天前
- protect-secrets — 1 次, 15天前
- qa-auto — 1 次, 26天前
- qa-planner — 1 次, 26天前
- qa-testing — 1 次, 31天前

**workflow/**
- autoresearch — 1 次, 17天前
- candidate-analysis — 1 次, 15天前
- claude-to-telegram — 1 次, 26天前
- context-recovery — 1 次, 26天前
- crm-projection — 1 次, 25天前
- customer-intel — 4 次, 25天前
- dispatching-parallel-agents — 3 次, 31天前
- executing-plans — 3 次, 31天前
- gdrive-to-skills — 2 次, 32天前
- headless-agent — 6 次, 17天前
- investment-research — 3 次, 26天前
- keyword-discovery — 1 次, 17天前
- material-health — 1 次, 25天前
- mockup — 1 次, 33天前
- settings-audit — 1 次, 16天前
- subsidy-scraper — 1 次, 25天前
- tender-scraper — 3 次, 17天前
- user-flow — 1 次, 33天前
- writing-plans — 3 次, 31天前
...
a4689fc feat: agent layer — runtime, tools, public API, operator UI
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 25 個 commit（本週）, 125 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 297 dirty, 2 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-04", "04-05", "04-06", "04-07", "04-08", "04-09", "04-10"]
    y-axis "USD" 0 --> 950
    bar [0, 5, 878, 775, 372, 750, 198]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-04-04 (Sat) | 4 | 2 | 0 | $0.00 |
| 2026-04-05 (Sun) | 7 | 43 | 1.3M | $4.82 |
...
| 2026-04-10 (Fri) | 12 | 651 | 79.8M | $197.66 |
| **Total** | | | **1236.7M** | **$2977.00** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| sales-assistant | 2,583 | 315.4M | $712.20 |
| lorien | 1,445 | 285.8M | $707.60 |
| rivendell | 1,516 | 181.1M | $445.59 |
| -Users-manibari-Documents-Peter | 719 | 163.7M | $351.09 |
| -Users-manibari-Documents-ChimesAI-richwave | 504 | 120.5M | $252.55 |
| Family-Fiscal | 854 | 86.0M | $190.72 |
| rakucamp | 177 | 20.7M | $113.27 |
| news-stock | 463 | 26.9M | $96.07 |
| news_stock | 28 | 603K | $40.77 |
| resume-pool | 141 | 12.7M | $36.76 |
| MingOS | 144 | 10.7M | $28.29 |
| -Users-manibari-Documents-Peter-ChimesAI | 102 | 7.2M | $19.74 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-10 — 74 skills, 26 issue(s)*
