...
**backend/**
- docker-compose-setup — 2 次修訂, 4天前
- firebase-backend — 2 次修訂, 4天前

**docs/**
- office-docx — 4 次修訂, 13天前
- pitch-deck — 2 次修訂, 11天前

**meta/**
- dev-process-gate — 4 次修訂, 14天前
- session-harvest — 2 次修訂, 11天前
- skill-creator — 4 次修訂, 4天前

**quality/**
- de-slopify — 2 次修訂, 4天前

**workflow/**
- agent-observability — 2 次修訂, 14天前
- dispatching-parallel-agents — 4 次修訂, 4天前
- launchd-agent — 4 次修訂, 14天前
- planning-with-files — 5 次修訂, 14天前
- requirement — 2 次修訂, 14天前
- sales-material — 3 次修訂, 0天前

<details><summary>✅ 穩定 (67)</summary>

**backend/**
- audio-transcription-flow — 1 次, 14天前
- db-migration — 1 次, 40天前
- doc-to-structured-data — 1 次, 26天前
- imap-smtp-integration — 1 次, 28天前
- markdown-file-ssot — 1 次, 28天前
- oauth-token-vault — 1 次, 28天前
- rbac-permissions — 1 次, 14天前
- sqlite-to-postgres — 1 次, 37天前
- tunnel-proxy-deploy — 1 次, 37天前
- tw-company-lookup — 2 次, 36天前
- vector-search-setup — 1 次, 22天前

**docs/**
- discovery-interview — 1 次, 14天前
- gdoc-report-builder — 1 次, 8天前
- iot-factory-report — 1 次, 8天前
- mcp-builder — 3 次, 42天前
- metadata-workshop — 1 次, 13天前
- office-pdf — 3 次, 42天前
- office-pptx — 3 次, 42天前
- office-xlsx — 3 次, 42天前
- rfq-writer — 1 次, 13天前
- slide-template-extractor — 1 次, 11天前
- slide-workflow — 1 次, 7天前
- sow-writer — 1 次, 14天前
- telegram-bot — 1 次, 37天前

**frontend/**
- frontend-design — 2 次, 43天前
- ios-integration — 1 次, 44天前
- swiftui-patterns — 1 次, 44天前
- ui-ux-pro-max — 3 次, 42天前

**git/**
- auto-stage — 1 次, 26天前
- repo-rename — 1 次, 26天前

**meta/**
- agent-persona — 1 次, 8天前
- audit-fix — 1 次, 40天前
- ci-pipeline — 1 次, 40天前
- deploy — 1 次, 40天前
- init-project — 2 次, 43天前
- knowledge-graph — 1 次, 37天前
- plan-check-style — 3 次, 40天前
- self-improving-agent — 2 次, 22天前
- session-wrap — 1 次, 7天前
- setup-permissions — 3 次, 40天前
- skill-scout — 1 次, 37天前
- sync-readme — 1 次, 21天前

**quality/**
- github-repo-audit — 1 次, 8天前
- large-file-refactor — 1 次, 22天前
- protect-secrets — 1 次, 26天前
- qa-auto — 1 次, 37天前
- qa-planner — 1 次, 37天前
- qa-testing — 1 次, 42天前

**workflow/**
- autoresearch — 1 次, 28天前
- candidate-analysis — 1 次, 26天前
- claude-to-telegram — 1 次, 37天前
- context-recovery — 1 次, 37天前
- crm-projection — 1 次, 36天前
- customer-intel — 4 次, 36天前
- executing-plans — 3 次, 42天前
- gdrive-to-skills — 2 次, 43天前
- headless-agent — 6 次, 28天前
- investment-research — 3 次, 37天前
- jd-writer — 1 次, 8天前
- keyword-discovery — 1 次, 28天前
- material-health — 1 次, 36天前
- mockup — 1 次, 44天前
- settings-audit — 1 次, 27天前
- subsidy-scraper — 1 次, 36天前
- tender-scraper — 3 次, 28天前
- user-flow — 1 次, 44天前
- writing-plans — 3 次, 42天前
...
| **分支** | `feat/mops-historical-financials` (2 total) |
| **Git** | 12 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
972612a chore(reports): add research-agent daily/qa/maintainer runs + docs
dbd533d chore: accumulated DB, collector, and AI pool tweaks
108ad13 docs: add cross-machine doctor script and troubleshooting section
```
</details>
