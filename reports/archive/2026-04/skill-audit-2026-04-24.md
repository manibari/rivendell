...
**backend/**
- docker-compose-setup — 2 次修訂, 7天前
- firebase-backend — 2 次修訂, 7天前

**docs/**
- pitch-deck — 2 次修訂, 14天前

**meta/**
- session-harvest — 2 次修訂, 14天前
- skill-creator — 4 次修訂, 7天前

**quality/**
- de-slopify — 2 次修訂, 7天前

**workflow/**
- dispatching-parallel-agents — 4 次修訂, 7天前
- sales-material — 3 次修訂, 3天前

<details><summary>✅ 穩定 (78)</summary>

**backend/**
- audio-transcription-flow — 1 次, 17天前
- db-migration — 1 次, 43天前
- doc-to-structured-data — 1 次, 29天前
- imap-smtp-integration — 1 次, 31天前
- markdown-file-ssot — 1 次, 31天前
- oauth-token-vault — 1 次, 31天前
- rbac-permissions — 1 次, 17天前
- sqlite-to-postgres — 1 次, 40天前
- tunnel-proxy-deploy — 1 次, 40天前
- tw-company-lookup — 2 次, 39天前
- vector-search-setup — 1 次, 25天前

**docs/**
- discovery-interview — 1 次, 17天前
- gdoc-report-builder — 1 次, 11天前
- iot-factory-report — 1 次, 11天前
- mcp-builder — 3 次, 45天前
- metadata-workshop — 1 次, 16天前
- office-docx — 4 次, 16天前
- office-pdf — 3 次, 45天前
- office-pptx — 3 次, 45天前
- office-xlsx — 3 次, 45天前
- rfq-writer — 1 次, 16天前
- slide-template-extractor — 1 次, 14天前
- slide-workflow — 1 次, 10天前
- sow-writer — 1 次, 17天前
- telegram-bot — 1 次, 40天前

**frontend/**
- frontend-design — 2 次, 46天前
- ios-integration — 1 次, 47天前
- swiftui-patterns — 1 次, 47天前
- ui-ux-pro-max — 3 次, 45天前

**git/**
- auto-stage — 1 次, 29天前
- repo-rename — 1 次, 29天前

**meta/**
- agent-persona — 1 次, 11天前
- audit-fix — 1 次, 43天前
- ci-pipeline — 1 次, 43天前
- deploy — 1 次, 43天前
- dev-process-gate — 4 次, 17天前
- init-project — 2 次, 46天前
- knowledge-graph — 1 次, 40天前
- plan-check-style — 3 次, 43天前
- self-improving-agent — 2 次, 25天前
- session-wrap — 1 次, 10天前
- setup-permissions — 3 次, 43天前
- skill-scout — 1 次, 40天前
- sync-readme — 1 次, 24天前

**quality/**
- github-repo-audit — 1 次, 11天前
- large-file-refactor — 1 次, 25天前
- protect-secrets — 1 次, 29天前
- qa-auto — 1 次, 40天前
- qa-planner — 1 次, 40天前
- qa-testing — 1 次, 45天前
...
- autoresearch — 1 次, 31天前
- candidate-analysis — 1 次, 29天前
- claude-to-telegram — 1 次, 40天前
- client-kickoff-docs — 1 次, 2天前
- context-recovery — 1 次, 40天前
- crm-projection — 1 次, 39天前
- customer-intel — 4 次, 39天前
- env-doctor — 1 次, 2天前
- executing-plans — 3 次, 45天前
- gdrive-to-skills — 2 次, 46天前
- headless-agent — 6 次, 31天前
- investment-research — 3 次, 40天前
- jd-writer — 1 次, 11天前
- keyword-discovery — 1 次, 31天前
- launchd-agent — 4 次, 17天前
- material-health — 1 次, 39天前
- mockup — 1 次, 47天前
- mops-financial-scraper — 1 次, 2天前
- planning-with-files — 5 次, 17天前
- presales-pipeline — 1 次, 2天前
- repro-exam — 1 次, 2天前
- requirement — 2 次, 17天前
- settings-audit — 1 次, 30天前
- subsidy-scraper — 1 次, 39天前
- tender-scraper — 3 次, 31天前
- user-flow — 1 次, 47天前
- writing-plans — 3 次, 45天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-18", "04-19", "04-20", "04-21", "04-22", "04-23", "04-24"]
    y-axis "USD" 0 --> 1250
    bar [26, 90, 710, 550, 358, 1185, 17]
~~~
...
| 2026-04-24 (Fri) | 1 | 2 | 910K | $16.71 |
| **Total** | | | **1121.0M** | **$2936.32** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Documents | 2,008 | 648.2M | $1528.26 |
| company-proflie | 504 | 161.6M | $383.94 |
| news-stock | 760 | 87.1M | $317.41 |
| -Users-manibari-Documents-Peter-ChimesAI | 357 | 86.8M | $212.65 |
| -Users-manibari-Documents-Peter | 450 | 51.2M | $151.56 |
| -Users-manibari-Documents-Peter-ChimesAI-01-Presales | 212 | 37.9M | $122.97 |
| resume-pool | 139 | 24.0M | $119.83 |
| sales-assistant | 211 | 12.3M | $43.58 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Documents-Projects | 114 | 7.6M | $28.78 |
| rivendell | 74 | 3.5M | $20.93 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-24 — 86 skills, 29 issue(s)*
