...
**docs/**
- gdoc-report-builder — 尚未 commit
- iot-factory-report — 尚未 commit

**meta/**
- agent-persona — 尚未 commit

**quality/**
- github-repo-audit — 尚未 commit
...
**docs/**
- office-docx — 4 次修訂, 5天前
- pitch-deck — 2 次修訂, 3天前

**meta/**
- dev-process-gate — 4 次修訂, 6天前
- self-improving-agent — 2 次修訂, 14天前
- session-harvest — 2 次修訂, 3天前
- skill-creator — 3 次修訂, 6天前

**workflow/**
- agent-observability — 2 次修訂, 6天前
- launchd-agent — 4 次修訂, 6天前
- planning-with-files — 5 次修訂, 6天前
...
**backend/**
- audio-transcription-flow — 1 次, 6天前
- db-migration — 1 次, 32天前
- doc-to-structured-data — 1 次, 18天前
- docker-compose-setup — 1 次, 6天前
- firebase-backend — 1 次, 36天前
- imap-smtp-integration — 1 次, 20天前
- markdown-file-ssot — 1 次, 20天前
- oauth-token-vault — 1 次, 20天前
- rbac-permissions — 1 次, 6天前
- sqlite-to-postgres — 1 次, 29天前
- tunnel-proxy-deploy — 1 次, 29天前
- tw-company-lookup — 2 次, 28天前
- vector-search-setup — 1 次, 14天前

**docs/**
- discovery-interview — 1 次, 6天前
- mcp-builder — 3 次, 34天前
- metadata-workshop — 1 次, 5天前
- office-pdf — 3 次, 34天前
- office-pptx — 3 次, 34天前
- office-xlsx — 3 次, 34天前
- rfq-writer — 1 次, 5天前
- slide-template-extractor — 1 次, 3天前
- sow-writer — 1 次, 6天前
- telegram-bot — 1 次, 29天前

**frontend/**
- frontend-design — 2 次, 35天前
- ios-integration — 1 次, 36天前
- swiftui-patterns — 1 次, 36天前
- ui-ux-pro-max — 3 次, 34天前

**git/**
- auto-stage — 1 次, 18天前
- repo-rename — 1 次, 18天前

**meta/**
- audit-fix — 1 次, 32天前
- ci-pipeline — 1 次, 32天前
- deploy — 1 次, 32天前
- init-project — 2 次, 35天前
- knowledge-graph — 1 次, 29天前
- plan-check-style — 3 次, 32天前
- setup-permissions — 3 次, 32天前
- skill-scout — 1 次, 29天前
- sync-readme — 1 次, 13天前

**quality/**
- de-slopify — 1 次, 29天前
- large-file-refactor — 1 次, 14天前
- protect-secrets — 1 次, 18天前
- qa-auto — 1 次, 29天前
- qa-planner — 1 次, 29天前
- qa-testing — 1 次, 34天前

**workflow/**
- autoresearch — 1 次, 20天前
- candidate-analysis — 1 次, 18天前
- claude-to-telegram — 1 次, 29天前
- context-recovery — 1 次, 29天前
- crm-projection — 1 次, 28天前
- customer-intel — 4 次, 28天前
- dispatching-parallel-agents — 3 次, 34天前
- executing-plans — 3 次, 34天前
- gdrive-to-skills — 2 次, 35天前
- headless-agent — 6 次, 20天前
- investment-research — 3 次, 29天前
- keyword-discovery — 1 次, 20天前
- material-health — 1 次, 28天前
- mockup — 1 次, 36天前
- settings-audit — 1 次, 19天前
- subsidy-scraper — 1 次, 28天前
- tender-scraper — 3 次, 20天前
- user-flow — 1 次, 36天前
- writing-plans — 3 次, 34天前
...
- **[docs,workflow]**: iot-factory-report pitch-deck slide-template-extractor — 建議檢查邊界是否清楚
...
```
03973c2f fix: community security wave — 8 PRs, 4 contributors (v0.15.13.0) (#847)
b3d064aa fix: gstack-team-init detects and removes vendored copies (#848)
dae251e0 feat: team-friendly gstack install mode (v0.15.7.0) (#809)
a94a64f8 fix: snapshot -i auto-detects dropdown/popover interactive elements (#845)
237ae2ab Revert "fix: snapshot -i auto-detects dropdown/popover interactive elements (#844)"
```
</details>
...
5efe8b4 feat: migrate agent definitions to .md source of truth (stage 1)
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 21 個 commit（本週）, 113 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 329 dirty, 2 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["04-07", "04-08", "04-09", "04-10", "04-11", "04-12", "04-13"]
    y-axis "USD" 0 --> 850
    bar [775, 372, 750, 198, 68, 21, 145]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-04-07 (Tue) | 11 | 1,627 | 292.6M | $774.50 |
| 2026-04-08 (Wed) | 13 | 573 | 119.3M | $371.78 |
| 2026-04-09 (Thu) | 15 | 1,502 | 327.6M | $749.89 |
| 2026-04-10 (Fri) | 14 | 652 | 79.8M | $197.66 |
| 2026-04-11 (Sat) | 9 | 89 | 16.1M | $68.04 |
| 2026-04-12 (Sun) | 6 | 90 | 4.4M | $21.46 |
| 2026-04-13 (Mon) | 10 | 338 | 55.8M | $145.06 |
| **Total** | | | **895.7M** | **$2328.41** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| lorien | 1,339 | 288.3M | $734.07 |
| -Users-manibari-Documents-Peter | 737 | 164.4M | $356.46 |
| sales-assistant | 693 | 120.9M | $322.09 |
| rivendell | 616 | 99.9M | $289.92 |
| -Users-manibari-Documents-ChimesAI-richwave | 504 | 120.5M | $252.55 |
| -Users-manibari-Documents-Peter-ChimesAI | 388 | 58.3M | $138.38 |
| rakucamp | 39 | 8.8M | $91.14 |
| news-stock | 356 | 20.4M | $83.20 |
| news_stock | 28 | 603K | $40.77 |
| Family-Fiscal | 69 | 5.3M | $19.30 |
| -Users-manibari-Documents-Projects | 72 | 5.5M | $18.81 |
| resume-pool | 36 | 1.9M | $11.51 |
| MingOS | 9 | 900K | $6.66 |
| -Users-manibari-Documents-ChimesAI | 13 | 581K | $4.31 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-13 — 79 skills, 28 issue(s)*
