...
**agents/**
- agent-observability — 2 次修訂, 2天前
- agent-persona — 2 次修訂, 2天前

**backend/**
- imap-smtp-integration — 2 次修訂, 2天前
- markdown-file-ssot — 2 次修訂, 2天前
- oauth-token-vault — 2 次修訂, 2天前
- spine-auth — 2 次修訂, 8天前

**business/**
- customer-intel — 2 次修訂, 2天前
- investment-research — 2 次修訂, 2天前

**docs/**
- office-pptx — 4 次修訂, 1天前
- pitch-deck — 4 次修訂, 1天前
- slide-workflow — 5 次修訂, 1天前
- subsidy-writer — 3 次修訂, 0天前

**git/**
- concurrent-session-git — 2 次修訂, 2天前

**media/**
- video-transcript — 5 次修訂, 5天前

**quality/**
- de-slopify — 4 次修訂, 2天前
- say-it-plain — 2 次修訂, 8天前

**workflow/**
- autoresearch — 3 次修訂, 2天前
- gdrive-to-skills — 3 次修訂, 2天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 112天前 (2026-04-07)
- db-migration — 1 次, 138天前 (2026-03-12)
- doc-to-structured-data — 1 次, 124天前 (2026-03-26)
- docker-compose-setup — 2 次, 102天前 (2026-04-17)
- rbac-permissions — 1 次, 112天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 135天前 (2026-03-15)
- vector-search-setup — 1 次, 120天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 112天前 (2026-04-07)
- office-docx — 4 次, 111天前 (2026-04-08)
- office-pdf — 3 次, 140天前 (2026-03-10)
- office-xlsx — 3 次, 140天前 (2026-03-10)
- rfq-writer — 1 次, 111天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 141天前 (2026-03-09)
- ios-integration — 1 次, 142天前 (2026-03-08)
- swiftui-patterns — 1 次, 142天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 140天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 124天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 138天前 (2026-03-12)
- ci-pipeline — 1 次, 138天前 (2026-03-12)
- deploy — 1 次, 138天前 (2026-03-12)
- dev-process-gate — 4 次, 112天前 (2026-04-07)
- init-project — 2 次, 141天前 (2026-03-09)
- knowledge-graph — 1 次, 135天前 (2026-03-15)
- plan-check-style — 3 次, 138天前 (2026-03-12)
- session-wrap — 1 次, 105天前 (2026-04-14)
- setup-permissions — 3 次, 138天前 (2026-03-12)
- skill-creator — 4 次, 102天前 (2026-04-17)
- sync-readme — 1 次, 119天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 106天前 (2026-04-13)
- large-file-refactor — 1 次, 120天前 (2026-03-30)
- qa-auto — 1 次, 135天前 (2026-03-15)
- qa-planner — 1 次, 135天前 (2026-03-15)
- qa-testing — 1 次, 140天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 135天前 (2026-03-15)
- context-recovery — 1 次, 135天前 (2026-03-15)
- settings-audit — 1 次, 125天前 (2026-03-25)

<details><summary>✅ 穩定 (62)</summary>

**agents/**
- agent-dispatch — 1 次, 5天前
- agent-headless — 1 次, 5天前
- agent-launchd — 1 次, 5天前

**backend/**
- ai-vision-extract — 1 次, 29天前
- backend-async-jobs — 3 次, 15天前
- firebase-backend — 3 次, 81天前
- ic-lot-normalization — 1 次, 34天前
- mcp-builder — 1 次, 5天前
- ml-eval-quality — 2 次, 15天前
- ml-model-registry — 2 次, 15天前
- odb-dfm-reference — 1 次, 34天前
- spine-rbac — 1 次, 30天前
- spine-schema-sync — 1 次, 30天前
- spine-versioning — 1 次, 29天前
- sqlite-to-postgres — 2 次, 81天前
- telegram-bot — 1 次, 5天前

**business/**
- candidate-analysis — 1 次, 5天前
- client-kickoff-docs — 1 次, 5天前
...
- tender-scraper — 1 次, 5天前
- tw-company-lookup — 1 次, 5天前

**docs/**
- chart-design — 1 次, 71天前
- doc-coauthoring — 2 次, 81天前
- excalidraw-diagram — 2 次, 73天前
- gdoc-report-builder — 2 次, 81天前
- internal-comms — 2 次, 81天前
- iot-factory-report — 2 次, 81天前
- mermaid-diagram — 1 次, 74天前
- metadata-workshop — 2 次, 81天前
- slide-office-hours — 2 次, 81天前
- slide-template-extractor — 2 次, 81天前
- sow-writer — 2 次, 81天前

**frontend/**
- chimesflow-design — 1 次, 47天前

**git/**
- auto-stage — 3 次, 81天前

**media/**
- local-media-transcribe — 1 次, 0天前
- subtitle-file — 1 次, 5天前
- video-clip-extract — 1 次, 5天前

**meta/**
- learnings-promotion-sprint — 1 次, 74天前
- self-improving-agent — 3 次, 73天前
- session-harvest — 3 次, 81天前
- skill-scout — 2 次, 90天前
- task-brief — 1 次, 42天前
- workflow-retro — 2 次, 81天前

**planning/**
- app-ops-baseline — 1 次, 5天前
- executing-plans — 1 次, 5天前
- mockup — 1 次, 5天前
- planning-with-files — 1 次, 5天前
- requirement — 1 次, 5天前
- user-flow — 1 次, 5天前
- writing-plans — 1 次, 5天前

**quality/**
- protect-secrets — 3 次, 81天前
- qa-journey — 1 次, 2天前

**workflow/**
- context-journal — 1 次, 8天前
- env-doctor — 3 次, 42天前
- repro-exam — 3 次, 42天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 17 個 commit（本週）, 78 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `master` (1 total) |
| **Git** | 7 dirty, 17 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
| **Config** | **missing** | **權限** | OK (0 rules) |
...
c66b366 feat(groups): product-group management page — SBL phase-1 step 4 (complete)
d58446e feat(groups): SBL product-group API + RBAC + US-6 display — steps 3 & 5
8bcc7de feat(rules): SBL/SYL engine + resolver — step 1-2 (equivalence-gated)
```
</details>
...
```
e68dcbf Merge engine/sim: 玩家戰爭/外交 command(宣戰/徵兵/出擊)+ _resolve_attack factor
eb8161c feat(game): 玩家可觸發的確定性戰爭/外交 command(宣戰/徵兵/出擊)
455f8c9 Merge branch 'main' into client/ui
078c505 feat(ui): /campaign board from watch+advance to operable (收口 step 1)
65b2580 Merge engine/sim: TD-1 引擎純度 — 君主名號池 → data/houses.yaml(69→55)
```
</details>
...
```
29066a6 merge: origin/main (ops serve.sh) — content no-op, history reconciliation only
cac73c6 fix(engine): a hole rim is not a board edge — CP0011 10→2, PCBGeneral0041 58→46 (customer raised 7/15, unfixed 7/27)
63938fd data(lib): component library → customer 20260728 revision (NO_BODY+3 is a milled hole, not a fiducial)
5152349 release: cut 0.37.17 — DWG upload recognition merged (C1) + three review fixes
f27a829 chore(build): rebuild standalone viewer bundle after the geometry-pack.ts change
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-22", "07-23", "07-24", "07-25", "07-26", "07-27", "07-28"]
    y-axis "USD" 0 --> 1500
    bar [1026, 1443, 1068, 405, 1135, 457, 1381]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-07-22 (Wed) | 16 | 1,520 | 330.4M | $1025.88 |
...
| 2026-07-28 (Tue) | 19 | 2,011 | 573.2M | $1380.96 |
| **Total** | | | **2601.5M** | **$6914.78** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Vault-Peter-Work | 2,212 | 558.8M | $1367.49 |
| -Users-manibari-code-mops-dbs | 818 | 383.8M | $1184.40 |
| -Users-manibari-code-IC-YMS | 1,158 | 424.0M | $940.05 |
| -Users-manibari-code-rivendell | 1,412 | 256.2M | $832.69 |
| -Users-manibari-code-PTI-ARES | 1,207 | 286.8M | $672.44 |
| -Users-manibari-code-MingOS | 715 | 164.0M | $472.71 |
| -Users-manibari-code-MingOS-engine | 534 | 154.7M | $444.78 |
| -Users-manibari-code-Verdandi-AutoML | 459 | 145.5M | $355.22 |
| -Users-manibari-code-Family-Fiscal | 544 | 130.4M | $267.48 |
| -Users-manibari-code-ChimesFlow | 183 | 47.4M | $195.87 |
| -Users-manibari-code-sales-assistant | 322 | 21.3M | $68.41 |
| -Users-manibari-code | 174 | 14.5M | $65.24 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-28 — 116 skills, 61 issue(s)*
