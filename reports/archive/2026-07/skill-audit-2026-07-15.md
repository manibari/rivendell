...
**backend/**
- backend-async-jobs — 3 次修訂, 2天前
- ml-eval-quality — 2 次修訂, 2天前
- ml-model-registry — 2 次修訂, 2天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 99天前 (2026-04-07)
- db-migration — 1 次, 125天前 (2026-03-12)
- doc-to-structured-data — 1 次, 111天前 (2026-03-26)
- imap-smtp-integration — 1 次, 113天前 (2026-03-24)
- markdown-file-ssot — 1 次, 113天前 (2026-03-24)
- oauth-token-vault — 1 次, 113天前 (2026-03-24)
- rbac-permissions — 1 次, 99天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 122天前 (2026-03-15)
- tw-company-lookup — 2 次, 121天前 (2026-03-16)
- vector-search-setup — 1 次, 107天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 99天前 (2026-04-07)
- mcp-builder — 3 次, 127天前 (2026-03-10)
- office-docx — 4 次, 98天前 (2026-04-08)
- office-pdf — 3 次, 127天前 (2026-03-10)
- office-pptx — 3 次, 127天前 (2026-03-10)
- office-xlsx — 3 次, 127天前 (2026-03-10)
- rfq-writer — 1 次, 98天前 (2026-04-08)
- telegram-bot — 1 次, 122天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 128天前 (2026-03-09)
- ios-integration — 1 次, 129天前 (2026-03-08)
- swiftui-patterns — 1 次, 129天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 127天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 111天前 (2026-03-26)

**meta/**
- agent-persona — 1 次, 93天前 (2026-04-13)
- audit-fix — 1 次, 125天前 (2026-03-12)
- ci-pipeline — 1 次, 125天前 (2026-03-12)
- deploy — 1 次, 125天前 (2026-03-12)
- dev-process-gate — 4 次, 99天前 (2026-04-07)
- init-project — 2 次, 128天前 (2026-03-09)
- knowledge-graph — 1 次, 122天前 (2026-03-15)
- plan-check-style — 3 次, 125天前 (2026-03-12)
- session-wrap — 1 次, 92天前 (2026-04-14)
- setup-permissions — 3 次, 125天前 (2026-03-12)
- sync-readme — 1 次, 106天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 93天前 (2026-04-13)
- large-file-refactor — 1 次, 107天前 (2026-03-30)
- qa-auto — 1 次, 122天前 (2026-03-15)
- qa-planner — 1 次, 122天前 (2026-03-15)
- qa-testing — 1 次, 127天前 (2026-03-10)

**workflow/**
- agent-observability — 2 次, 99天前 (2026-04-07)
- candidate-analysis — 1 次, 111天前 (2026-03-26)
- claude-to-telegram — 1 次, 122天前 (2026-03-15)
- context-recovery — 1 次, 122天前 (2026-03-15)
- crm-projection — 1 次, 121天前 (2026-03-16)
- executing-plans — 3 次, 127天前 (2026-03-10)
- gdrive-to-skills — 2 次, 128天前 (2026-03-09)
- headless-agent — 6 次, 113天前 (2026-03-24)
- jd-writer — 1 次, 93天前 (2026-04-13)
- keyword-discovery — 1 次, 113天前 (2026-03-24)
- material-health — 1 次, 121天前 (2026-03-16)
- mockup — 1 次, 129天前 (2026-03-08)
- planning-with-files — 5 次, 99天前 (2026-04-07)
- requirement — 2 次, 99天前 (2026-04-07)
- settings-audit — 1 次, 112天前 (2026-03-25)
- subsidy-scraper — 1 次, 121天前 (2026-03-16)
- tender-scraper — 3 次, 113天前 (2026-03-24)
- writing-plans — 3 次, 127天前 (2026-03-10)

<details><summary>✅ 穩定 (48)</summary>

**backend/**
- ai-vision-extract — 1 次, 16天前
- docker-compose-setup — 2 次, 89天前
- firebase-backend — 3 次, 68天前
- ic-lot-normalization — 1 次, 21天前
- odb-dfm-reference — 1 次, 21天前
- spine-auth — 1 次, 17天前
- spine-rbac — 1 次, 17天前
- spine-schema-sync — 1 次, 17天前
- spine-versioning — 1 次, 16天前
- sqlite-to-postgres — 2 次, 68天前

**docs/**
- chart-design — 1 次, 58天前
- doc-coauthoring — 2 次, 68天前
- excalidraw-diagram — 2 次, 60天前
- gdoc-report-builder — 2 次, 68天前
- internal-comms — 2 次, 68天前
- iot-factory-report — 2 次, 68天前
- mermaid-diagram — 1 次, 61天前
- metadata-workshop — 2 次, 68天前
- pitch-deck — 3 次, 68天前
- slide-office-hours — 2 次, 68天前
- slide-template-extractor — 2 次, 68天前
- slide-workflow — 4 次, 68天前
- sow-writer — 2 次, 68天前

**frontend/**
- chimesflow-design — 1 次, 34天前

**git/**
- auto-stage — 3 次, 68天前
- concurrent-session-git — 1 次, 28天前

**meta/**
- learnings-promotion-sprint — 1 次, 61天前
- self-improving-agent — 3 次, 60天前
- session-harvest — 3 次, 68天前
- skill-creator — 4 次, 89天前
- skill-scout — 2 次, 77天前
- task-brief — 1 次, 29天前
- workflow-retro — 2 次, 68天前

**quality/**
- de-slopify — 2 次, 89天前
- protect-secrets — 3 次, 68天前

**workflow/**
- app-ops-baseline — 1 次, 34天前
- autoresearch — 2 次, 68天前
- client-kickoff-docs — 2 次, 29天前
- customer-intel — 5 次, 68天前
- dispatching-parallel-agents — 4 次, 89天前
- env-doctor — 3 次, 29天前
- investment-research — 4 次, 68天前
- launchd-agent — 6 次, 68天前
- mops-financial-scraper — 3 次, 29天前
- presales-pipeline — 3 次, 29天前
- repro-exam — 3 次, 29天前
- sales-material — 3 次, 85天前
- user-flow — 2 次, 61天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 12 個 commit（本週）, 12 個（本月） |
| **技術棧** |  Python |
| **分支** | `main` (1 total) |
| **Git** | 1 dirty, 12 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
1cea311 docs: institution unlock model — schools of thought + state prerequisites
```
</details>
...
```
9587346 feat(audit): render audit — per-board display health check wired into ingest
cb712ee feat(canvas): Valor-parity status bar — Highlighted: 1; layer,#id,Kind(...),X/Y,r,POS,Net,COMP,PIN
04f9720 feat(canvas): via pads split into top-via/bottom-via pseudo-layers (Valor convention)
14be20f fix(canvas): draw order surfaces→pads→lines — pads no longer buried under the pour
8e3c81b fix(console): guard every list/shape fetch against 401 detail bodies
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-09", "07-10", "07-11", "07-12", "07-13", "07-14", "07-15"]
    y-axis "USD" 0 --> 1300
    bar [1143, 176, 142, 24, 1174, 927, 1227]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-07-09 (Thu) | 13 | 1,022 | 462.8M | $1143.36 |
...
| 2026-07-15 (Wed) | 7 | 869 | 586.5M | $1226.95 |
| **Total** | | | **1863.7M** | **$4812.77** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-PTI-ARES | 1,802 | 973.3M | $2174.82 |
| -Users-manibari-code-IC-YMS | 357 | 294.9M | $884.18 |
| -Users-manibari-code-MingOS | 313 | 87.9M | $326.60 |
| -Users-manibari-code-rivendell | 285 | 97.5M | $324.98 |
| -Users-manibari-code-mops-dbs | 262 | 108.5M | $311.50 |
| -Users-manibari-code-Verdandi-AutoML | 316 | 144.7M | $297.15 |
| -Users-manibari-Vault-Peter-Work | 280 | 43.1M | $131.01 |
| -Users-manibari-code-verdandi-or | 178 | 41.5M | $108.93 |
| -Users-manibari-code-sales-assistant | 330 | 21.6M | $78.19 |
...
| -Users-manibari-code-ChimesFlow | 46 | 3.4M | $14.05 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-15 — 108 skills, 78 issue(s)*
