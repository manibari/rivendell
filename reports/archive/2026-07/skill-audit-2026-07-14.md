...
**backend/**
- backend-async-jobs — 3 次修訂, 1天前
- ml-eval-quality — 2 次修訂, 1天前
- ml-model-registry — 2 次修訂, 1天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 98天前 (2026-04-07)
- db-migration — 1 次, 124天前 (2026-03-12)
- doc-to-structured-data — 1 次, 110天前 (2026-03-26)
- imap-smtp-integration — 1 次, 112天前 (2026-03-24)
- markdown-file-ssot — 1 次, 112天前 (2026-03-24)
- oauth-token-vault — 1 次, 112天前 (2026-03-24)
- rbac-permissions — 1 次, 98天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 121天前 (2026-03-15)
- tw-company-lookup — 2 次, 120天前 (2026-03-16)
- vector-search-setup — 1 次, 106天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 98天前 (2026-04-07)
- mcp-builder — 3 次, 126天前 (2026-03-10)
- office-docx — 4 次, 97天前 (2026-04-08)
- office-pdf — 3 次, 126天前 (2026-03-10)
- office-pptx — 3 次, 126天前 (2026-03-10)
- office-xlsx — 3 次, 126天前 (2026-03-10)
- rfq-writer — 1 次, 97天前 (2026-04-08)
- telegram-bot — 1 次, 121天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 127天前 (2026-03-09)
- ios-integration — 1 次, 128天前 (2026-03-08)
- swiftui-patterns — 1 次, 128天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 126天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 110天前 (2026-03-26)

**meta/**
- agent-persona — 1 次, 92天前 (2026-04-13)
- audit-fix — 1 次, 124天前 (2026-03-12)
- ci-pipeline — 1 次, 124天前 (2026-03-12)
- deploy — 1 次, 124天前 (2026-03-12)
- dev-process-gate — 4 次, 98天前 (2026-04-07)
- init-project — 2 次, 127天前 (2026-03-09)
- knowledge-graph — 1 次, 121天前 (2026-03-15)
- plan-check-style — 3 次, 124天前 (2026-03-12)
- session-wrap — 1 次, 91天前 (2026-04-14)
- setup-permissions — 3 次, 124天前 (2026-03-12)
- sync-readme — 1 次, 105天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 92天前 (2026-04-13)
- large-file-refactor — 1 次, 106天前 (2026-03-30)
- qa-auto — 1 次, 121天前 (2026-03-15)
- qa-planner — 1 次, 121天前 (2026-03-15)
- qa-testing — 1 次, 126天前 (2026-03-10)

**workflow/**
- agent-observability — 2 次, 98天前 (2026-04-07)
- candidate-analysis — 1 次, 110天前 (2026-03-26)
- claude-to-telegram — 1 次, 121天前 (2026-03-15)
- context-recovery — 1 次, 121天前 (2026-03-15)
- crm-projection — 1 次, 120天前 (2026-03-16)
- executing-plans — 3 次, 126天前 (2026-03-10)
- gdrive-to-skills — 2 次, 127天前 (2026-03-09)
- headless-agent — 6 次, 112天前 (2026-03-24)
- jd-writer — 1 次, 92天前 (2026-04-13)
- keyword-discovery — 1 次, 112天前 (2026-03-24)
- material-health — 1 次, 120天前 (2026-03-16)
- mockup — 1 次, 128天前 (2026-03-08)
- planning-with-files — 5 次, 98天前 (2026-04-07)
- requirement — 2 次, 98天前 (2026-04-07)
- settings-audit — 1 次, 111天前 (2026-03-25)
- subsidy-scraper — 1 次, 120天前 (2026-03-16)
- tender-scraper — 3 次, 112天前 (2026-03-24)
- writing-plans — 3 次, 126天前 (2026-03-10)

<details><summary>✅ 穩定 (48)</summary>

**backend/**
- ai-vision-extract — 1 次, 15天前
- docker-compose-setup — 2 次, 88天前
- firebase-backend — 3 次, 67天前
- ic-lot-normalization — 1 次, 20天前
- odb-dfm-reference — 1 次, 20天前
- spine-auth — 1 次, 16天前
- spine-rbac — 1 次, 16天前
- spine-schema-sync — 1 次, 16天前
- spine-versioning — 1 次, 15天前
- sqlite-to-postgres — 2 次, 67天前

**docs/**
- chart-design — 1 次, 57天前
- doc-coauthoring — 2 次, 67天前
- excalidraw-diagram — 2 次, 59天前
- gdoc-report-builder — 2 次, 67天前
- internal-comms — 2 次, 67天前
- iot-factory-report — 2 次, 67天前
- mermaid-diagram — 1 次, 60天前
- metadata-workshop — 2 次, 67天前
- pitch-deck — 3 次, 67天前
- slide-office-hours — 2 次, 67天前
- slide-template-extractor — 2 次, 67天前
- slide-workflow — 4 次, 67天前
- sow-writer — 2 次, 67天前

**frontend/**
- chimesflow-design — 1 次, 33天前

**git/**
- auto-stage — 3 次, 67天前
- concurrent-session-git — 1 次, 27天前

**meta/**
- learnings-promotion-sprint — 1 次, 60天前
- self-improving-agent — 3 次, 59天前
- session-harvest — 3 次, 67天前
- skill-creator — 4 次, 88天前
- skill-scout — 2 次, 76天前
- task-brief — 1 次, 28天前
- workflow-retro — 2 次, 67天前

**quality/**
- de-slopify — 2 次, 88天前
- protect-secrets — 3 次, 67天前

**workflow/**
- app-ops-baseline — 1 次, 33天前
- autoresearch — 2 次, 67天前
- client-kickoff-docs — 2 次, 28天前
- customer-intel — 5 次, 67天前
- dispatching-parallel-agents — 4 次, 88天前
- env-doctor — 3 次, 28天前
- investment-research — 4 次, 67天前
- launchd-agent — 6 次, 67天前
- mops-financial-scraper — 3 次, 28天前
- presales-pipeline — 3 次, 28天前
- repro-exam — 3 次, 28天前
- sales-material — 3 次, 84天前
- user-flow — 2 次, 60天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 2 個 commit（本週）, 189 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
78187d8 mockup: interactive L3 mockup for court-chart and main screen
1f09b6c docs: add power-as-debt and loyalty-visibility design models
17471f5 docs: institution design becomes an org-chart with 10 decision points
7e1aacc design: add DESIGN.md — Warring States era, bamboo-slip UI, five-virtues dynamic accent
bea62e7 docs: add M1 user flow — onboarding, real-time main loop, endgame attribution
```
</details>
...
```
cf344ee feat(auth): account system (admin/manager/user) + API keys + admin-only ops pages — 0.27.0
581f214 chore(learnings): session learnings — Valor 對帳方法論 + 元件定義原則
e1ba0c1 release: cut 0.24.0–0.26.0 — engine parity / rule-library editing / review UX
3f2186a docs(plans): Phase D scorecard + Silkscreen0011 recon notes
45501aa docs(console): full per-button user manual; fix ruleset rule count
```
</details>
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 1 個 commit（本週）, 192 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 5 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-08", "07-09", "07-10", "07-11", "07-12", "07-13", "07-14"]
    y-axis "USD" 0 --> 1850
    bar [1788, 1143, 176, 142, 24, 1174, 608]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-07-08 (Wed) | 19 | 2,384 | 754.1M | $1788.31 |
...
| 2026-07-14 (Tue) | 10 | 635 | 197.7M | $608.34 |
| **Total** | | | **1876.9M** | **$5055.78** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-PTI-ARES | 2,185 | 822.0M | $1968.17 |
| -Users-manibari-code-IC-YMS | 359 | 291.3M | $894.26 |
| -Users-manibari-code-Verdandi-AutoML | 456 | 192.5M | $455.08 |
| -Users-manibari-code-rivendell | 311 | 105.2M | $336.95 |
| -Users-manibari-Vault-Peter-Work | 429 | 103.4M | $320.49 |
| -Users-manibari-code-mops-dbs | 297 | 115.2M | $306.91 |
| -Users-manibari-code-MingOS | 259 | 64.0M | $207.66 |
| -Users-manibari-code | 481 | 47.9M | $139.64 |
| -Users-manibari-code-verdandi-or | 246 | 49.1M | $138.69 |
| -Users-manibari-code-sales-assistant | 332 | 21.7M | $78.87 |
| -Users-manibari-code-ChimesFlow | 60 | 28.2M | $71.72 |
| -Users-manibari-code-tukey-bi | 17 | 14.4M | $67.98 |
| -Users-manibari-code-iihi | 34 | 12.2M | $43.08 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-14 — 108 skills, 78 issue(s)*
