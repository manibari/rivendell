...
**agents/**
- agent-observability — 2 次修訂, 1天前
- agent-persona — 2 次修訂, 1天前

**backend/**
- backend-async-jobs — 3 次修訂, 14天前
- imap-smtp-integration — 2 次修訂, 1天前
- markdown-file-ssot — 2 次修訂, 1天前
- ml-eval-quality — 2 次修訂, 14天前
- ml-model-registry — 2 次修訂, 14天前
- oauth-token-vault — 2 次修訂, 1天前
- spine-auth — 2 次修訂, 7天前

**business/**
- customer-intel — 2 次修訂, 1天前
- investment-research — 2 次修訂, 1天前

**docs/**
- office-pptx — 4 次修訂, 0天前
- pitch-deck — 4 次修訂, 0天前
- slide-workflow — 5 次修訂, 0天前
- subsidy-writer — 2 次修訂, 1天前

**git/**
- concurrent-session-git — 2 次修訂, 1天前

**media/**
- video-transcript — 5 次修訂, 4天前

**quality/**
- de-slopify — 4 次修訂, 1天前
- say-it-plain — 2 次修訂, 7天前

**workflow/**
- autoresearch — 3 次修訂, 1天前
- gdrive-to-skills — 3 次修訂, 1天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 111天前 (2026-04-07)
- db-migration — 1 次, 137天前 (2026-03-12)
- doc-to-structured-data — 1 次, 123天前 (2026-03-26)
- docker-compose-setup — 2 次, 101天前 (2026-04-17)
- rbac-permissions — 1 次, 111天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 134天前 (2026-03-15)
- vector-search-setup — 1 次, 119天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 111天前 (2026-04-07)
- office-docx — 4 次, 110天前 (2026-04-08)
- office-pdf — 3 次, 139天前 (2026-03-10)
- office-xlsx — 3 次, 139天前 (2026-03-10)
- rfq-writer — 1 次, 110天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 140天前 (2026-03-09)
- ios-integration — 1 次, 141天前 (2026-03-08)
- swiftui-patterns — 1 次, 141天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 139天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 123天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 137天前 (2026-03-12)
- ci-pipeline — 1 次, 137天前 (2026-03-12)
- deploy — 1 次, 137天前 (2026-03-12)
- dev-process-gate — 4 次, 111天前 (2026-04-07)
- init-project — 2 次, 140天前 (2026-03-09)
- knowledge-graph — 1 次, 134天前 (2026-03-15)
- plan-check-style — 3 次, 137天前 (2026-03-12)
- session-wrap — 1 次, 104天前 (2026-04-14)
- setup-permissions — 3 次, 137天前 (2026-03-12)
- skill-creator — 4 次, 101天前 (2026-04-17)
- sync-readme — 1 次, 118天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 105天前 (2026-04-13)
- large-file-refactor — 1 次, 119天前 (2026-03-30)
- qa-auto — 1 次, 134天前 (2026-03-15)
- qa-planner — 1 次, 134天前 (2026-03-15)
- qa-testing — 1 次, 139天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 134天前 (2026-03-15)
- context-recovery — 1 次, 134天前 (2026-03-15)
- settings-audit — 1 次, 124天前 (2026-03-25)

<details><summary>✅ 穩定 (58)</summary>

**agents/**
- agent-dispatch — 1 次, 4天前
- agent-headless — 1 次, 4天前
- agent-launchd — 1 次, 4天前

**backend/**
- ai-vision-extract — 1 次, 28天前
- firebase-backend — 3 次, 80天前
- ic-lot-normalization — 1 次, 33天前
- mcp-builder — 1 次, 4天前
- odb-dfm-reference — 1 次, 33天前
- spine-rbac — 1 次, 29天前
- spine-schema-sync — 1 次, 29天前
- spine-versioning — 1 次, 28天前
- sqlite-to-postgres — 2 次, 80天前
- telegram-bot — 1 次, 4天前

**business/**
- candidate-analysis — 1 次, 4天前
- client-kickoff-docs — 1 次, 4天前
...
- tender-scraper — 1 次, 4天前
- tw-company-lookup — 1 次, 4天前

**docs/**
- chart-design — 1 次, 70天前
- doc-coauthoring — 2 次, 80天前
- excalidraw-diagram — 2 次, 72天前
- gdoc-report-builder — 2 次, 80天前
- internal-comms — 2 次, 80天前
- iot-factory-report — 2 次, 80天前
- mermaid-diagram — 1 次, 73天前
- metadata-workshop — 2 次, 80天前
- slide-office-hours — 2 次, 80天前
- slide-template-extractor — 2 次, 80天前
- sow-writer — 2 次, 80天前

**frontend/**
- chimesflow-design — 1 次, 46天前
...
**meta/**
- learnings-promotion-sprint — 1 次, 73天前
- self-improving-agent — 3 次, 72天前
- session-harvest — 3 次, 80天前
- skill-scout — 2 次, 89天前
- task-brief — 1 次, 41天前
- workflow-retro — 2 次, 80天前

**planning/**
- app-ops-baseline — 1 次, 4天前
- executing-plans — 1 次, 4天前
- mockup — 1 次, 4天前
- planning-with-files — 1 次, 4天前
- requirement — 1 次, 4天前
- user-flow — 1 次, 4天前
- writing-plans — 1 次, 4天前

**quality/**
- protect-secrets — 3 次, 80天前
- qa-journey — 1 次, 1天前

**workflow/**
- context-journal — 1 次, 7天前
- env-doctor — 3 次, 41天前
- repro-exam — 3 次, 41天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 10 個 commit（本週）, 76 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `master` (1 total) |
| **Git** | 1 dirty, 10 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
| **Config** | **missing** | **權限** | OK (0 rules) |
...
```
afda7b1 feat(cp): phase-2 batch 4 — CP raw per-die parametrics → cp_param + CP 參數分析
9df7a67 docs: log phase-2 batch-3 completion + data-consolidation learning
2fc5541 feat(die): ingest FT test raw for all products — die_summary 1 → 125 lots
1c68065 feat(wat): over-spec overview lever + terminology batch + data expansion
95719cd feat(frontend): phase 4 — peripheral pages, account admin, legacy retirement
```
</details>
...
```
44c4366 fix(review): class-source label knows the library value (was mislabeled 幾何判定)
c906b4c fix(engine): CP0030 measures body-less components from real pad edges (customer correction)
6be45c9 fix(enricher): official component library outranks the learned SoT (J551 8639conn)
fb46d19 feat(admission): classification-source guard — majority-heuristic boards flag degraded
12a7046 fix(backend): board-settings DB read logs before degrading (same-shape audit of 0.37.11 lesson)
```
</details>
...
```
c556763 feat(analytics): Screener 改顯示六指標等級（收盤+AA~C+綜合分+完整度）v0.18.21
933c5e6 feat(monitor): 資料閱覽新增「六大指標」tab（含 prod fallback）v0.18.20
e109f89 fix(notes): 放寬 ③ tuple glob 至全合併變體 + 止殘餘 churn；加 F17 codex-OCR 管線 + 自動化規劃
182e82c feat(monitor): dev 撈 prod — 大股東本機缺→即時撈 prod dataapi v0.18.19
9d58784 feat(analytics): 六大指標評分說明 + 濾掉「沒滿」的假高分 v0.18.18
```
</details>
...
fa4db5b chore(materials): crm-projection refresh 2026-07-25
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-21", "07-22", "07-23", "07-24", "07-25", "07-26", "07-27"]
    y-axis "USD" 0 --> 1550
    bar [1490, 1026, 1443, 1068, 405, 1135, 401]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-07-21 (Tue) | 30 | 1,604 | 700.8M | $1489.62 |
...
| 2026-07-27 (Mon) | 7 | 571 | 129.7M | $400.72 |
| **Total** | | | **2710.3M** | **$6967.13** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-mops-dbs | 1,504 | 751.5M | $1817.29 |
| -Users-manibari-Vault-Peter-Work | 1,628 | 397.0M | $1045.32 |
| -Users-manibari-code-MingOS | 1,020 | 389.3M | $971.30 |
| -Users-manibari-code-rivendell | 1,327 | 233.3M | $708.70 |
| -Users-manibari-code-IC-YMS | 777 | 282.9M | $590.96 |
| -Users-manibari-code-PTI-ARES | 659 | 184.0M | $455.69 |
| -Users-manibari-code-MingOS-engine | 520 | 140.0M | $398.30 |
| -Users-manibari-code-Verdandi-AutoML | 521 | 99.3M | $288.55 |
| -Users-manibari-code-Family-Fiscal | 544 | 130.4M | $267.48 |
| -Users-manibari-code-ChimesFlow | 200 | 49.9M | $209.13 |
| -Users-manibari-code-sales-assistant | 333 | 21.9M | $70.67 |
| -Users-manibari-code | 174 | 14.5M | $65.24 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-mops-dbs-services-mops-notes | 40 | 2.8M | $38.94 |
| -Users-manibari-code-Urd-BI | 127 | 11.3M | $26.93 |
| -Users-manibari-code-resume-pool | 28 | 2.2M | $12.64 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-27 — 115 skills, 62 issue(s)*
