...
**backend/**
- backend-async-jobs — 2 次修訂, 14天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 111天前 (2026-03-12)
- doc-to-structured-data — 1 次, 97天前 (2026-03-26)
- imap-smtp-integration — 1 次, 99天前 (2026-03-24)
- markdown-file-ssot — 1 次, 99天前 (2026-03-24)
- oauth-token-vault — 1 次, 99天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 108天前 (2026-03-15)
- tw-company-lookup — 2 次, 107天前 (2026-03-16)
- vector-search-setup — 1 次, 93天前 (2026-03-30)

**docs/**
- mcp-builder — 3 次, 113天前 (2026-03-10)
- office-pdf — 3 次, 113天前 (2026-03-10)
- office-pptx — 3 次, 113天前 (2026-03-10)
- office-xlsx — 3 次, 113天前 (2026-03-10)
- telegram-bot — 1 次, 108天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 114天前 (2026-03-09)
- ios-integration — 1 次, 115天前 (2026-03-08)
- swiftui-patterns — 1 次, 115天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 113天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 97天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 111天前 (2026-03-12)
- ci-pipeline — 1 次, 111天前 (2026-03-12)
- deploy — 1 次, 111天前 (2026-03-12)
- init-project — 2 次, 114天前 (2026-03-09)
- knowledge-graph — 1 次, 108天前 (2026-03-15)
- plan-check-style — 3 次, 111天前 (2026-03-12)
- setup-permissions — 3 次, 111天前 (2026-03-12)
- sync-readme — 1 次, 92天前 (2026-03-31)

**quality/**
- large-file-refactor — 1 次, 93天前 (2026-03-30)
- qa-auto — 1 次, 108天前 (2026-03-15)
- qa-planner — 1 次, 108天前 (2026-03-15)
- qa-testing — 1 次, 113天前 (2026-03-10)

**workflow/**
- candidate-analysis — 1 次, 97天前 (2026-03-26)
- claude-to-telegram — 1 次, 108天前 (2026-03-15)
- context-recovery — 1 次, 108天前 (2026-03-15)
- crm-projection — 1 次, 107天前 (2026-03-16)
- executing-plans — 3 次, 113天前 (2026-03-10)
- gdrive-to-skills — 2 次, 114天前 (2026-03-09)
- headless-agent — 6 次, 99天前 (2026-03-24)
- keyword-discovery — 1 次, 99天前 (2026-03-24)
- material-health — 1 次, 107天前 (2026-03-16)
- mockup — 1 次, 115天前 (2026-03-08)
- settings-audit — 1 次, 98天前 (2026-03-25)
- subsidy-scraper — 1 次, 107天前 (2026-03-16)
- tender-scraper — 3 次, 99天前 (2026-03-24)
- writing-plans — 3 次, 113天前 (2026-03-10)

<details><summary>✅ 穩定 (63)</summary>

**backend/**
- ai-vision-extract — 1 次, 2天前
- audio-transcription-flow — 1 次, 85天前
- docker-compose-setup — 2 次, 75天前
- firebase-backend — 3 次, 54天前
- ic-lot-normalization — 1 次, 7天前
- ml-eval-quality — 1 次, 7天前
- ml-model-registry — 1 次, 7天前
- odb-dfm-reference — 1 次, 7天前
- rbac-permissions — 1 次, 85天前
- spine-auth — 1 次, 3天前
- spine-rbac — 1 次, 3天前
- spine-schema-sync — 1 次, 3天前
- spine-versioning — 1 次, 2天前
- sqlite-to-postgres — 2 次, 54天前

**docs/**
- chart-design — 1 次, 44天前
- discovery-interview — 1 次, 85天前
- doc-coauthoring — 2 次, 54天前
- excalidraw-diagram — 2 次, 46天前
- gdoc-report-builder — 2 次, 54天前
- internal-comms — 2 次, 54天前
- iot-factory-report — 2 次, 54天前
- mermaid-diagram — 1 次, 47天前
- metadata-workshop — 2 次, 54天前
- office-docx — 4 次, 84天前
- pitch-deck — 3 次, 54天前
- rfq-writer — 1 次, 84天前
- slide-office-hours — 2 次, 54天前
- slide-template-extractor — 2 次, 54天前
- slide-workflow — 4 次, 54天前
- sow-writer — 2 次, 54天前

**frontend/**
- chimesflow-design — 1 次, 20天前

**git/**
- auto-stage — 3 次, 54天前
- concurrent-session-git — 1 次, 14天前

**meta/**
- agent-persona — 1 次, 79天前
- dev-process-gate — 4 次, 85天前
- learnings-promotion-sprint — 1 次, 47天前
- self-improving-agent — 3 次, 46天前
- session-harvest — 3 次, 54天前
- session-wrap — 1 次, 78天前
- skill-creator — 4 次, 75天前
- skill-scout — 2 次, 63天前
- task-brief — 1 次, 15天前
- workflow-retro — 2 次, 54天前

**quality/**
- de-slopify — 2 次, 75天前
- github-repo-audit — 1 次, 79天前
- protect-secrets — 3 次, 54天前

**workflow/**
- agent-observability — 2 次, 85天前
- app-ops-baseline — 1 次, 20天前
- autoresearch — 2 次, 54天前
- client-kickoff-docs — 2 次, 15天前
- customer-intel — 5 次, 54天前
- dispatching-parallel-agents — 4 次, 75天前
- env-doctor — 3 次, 15天前
- investment-research — 4 次, 54天前
- jd-writer — 1 次, 79天前
- launchd-agent — 6 次, 54天前
- mops-financial-scraper — 3 次, 15天前
- planning-with-files — 5 次, 85天前
- presales-pipeline — 3 次, 15天前
- repro-exam — 3 次, 15天前
- requirement — 2 次, 85天前
- sales-material — 3 次, 71天前
- user-flow — 2 次, 47天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 23 個 commit（本週）, 366 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/presales-todo` (3 total) | 2 個 open PR |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
d76b2a1 feat(presales): stage-templated presales help to-do (sales→presales) — v1.33.37
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 70 個 commit（本週）, 160 個（本月） |
| **技術棧** |  Node.js Python |
| **分支** | `next-wave-2026-05` (5 total) | 1 個 open PR |
| **Git** | 1 dirty, 2 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
61a97bd fix(viewer): Matrix tool first in toolbar; split outline/rout out of the 鑽孔 group
2853c68 feat(viewer): click a component + layer-driven element info; overlay polish
e5e7b63 feat(viewer): parse ODB++ .pad_usage → show feature type (VIA / FIDUCIAL / TOEPRINT)
e2144a8 fix(viewer): status bar wraps (no truncation) + component info on body hover
db5506f docs(report): add print @page for 1600×900 PDF export + version label → v0.23.0
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 162 個 commit（本週）, 187 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
888ecc1 docs: facts_api_kickoff 標記已完成（apps/api 實現，非原提三 port 方案）
e2c2a97 docs: 更新技術/操作文件（apps/api + 4b + 清過時 8082-8084 port）
65ce63d feat(apps/api): 正式化 — pyproject + Dockerfile + compose + 匯總 healthz + CORS
92eba02 feat(apps/api): master + price + facts 三域完成（契約 §3/§4/§5 全四域）
288e049 feat(apps/api): 資料服務層骨架 + rev 域（契約 §0+§1，全市場批次彙總）
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-25", "06-26", "06-27", "06-28", "06-29", "06-30", "07-01"]
    y-axis "USD" 0 --> 3800
    bar [2389, 1973, 3712, 2519, 2908, 2686, 2435]
~~~
...
| 2026-07-01 (Wed) | 13 | 3,006 | 1108.7M | $2435.36 |
| **Total** | | | **8469.5M** | **$18622.84** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Vault-Peter-Family | 4,105 | 2491.2M | $4884.25 |
| -Users-manibari-code-mops-dbs | 2,318 | 1463.4M | $3209.63 |
| -Users-manibari-code-ChimesFlow | 2,158 | 1252.0M | $2774.90 |
| -Users-manibari-code-PTI-ARES | 3,414 | 1340.0M | $2642.20 |
| -Users-manibari-code-IC-YMS | 1,252 | 627.7M | $1572.26 |
| -Users-manibari-code-tukey-automl | 1,293 | 626.6M | $1401.46 |
| -Users-manibari-code-rivendell | 801 | 274.7M | $1004.08 |
| -Users-manibari-code-tukey-bi | 443 | 167.1M | $446.64 |
| -Users-manibari-code-TWstock-invest | 442 | 95.3M | $296.96 |
| -Users-manibari-Vault-Peter-Work | 687 | 102.5M | $272.43 |
| -Users-manibari-code-sales-assistant | 272 | 17.3M | $69.29 |
| -Users-manibari-code | 69 | 10.1M | $43.22 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-01 — 108 skills, 64 issue(s)*
