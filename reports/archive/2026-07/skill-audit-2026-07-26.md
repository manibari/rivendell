...
**agents/**
- agent-observability — 2 次修訂, 0天前
- agent-persona — 2 次修訂, 0天前

**backend/**
- backend-async-jobs — 3 次修訂, 13天前
- imap-smtp-integration — 2 次修訂, 0天前
- markdown-file-ssot — 2 次修訂, 0天前
- ml-eval-quality — 2 次修訂, 13天前
- ml-model-registry — 2 次修訂, 13天前
- oauth-token-vault — 2 次修訂, 0天前
- spine-auth — 2 次修訂, 6天前

**business/**
- customer-intel — 2 次修訂, 0天前
- investment-research — 2 次修訂, 0天前

**docs/**
- subsidy-writer — 2 次修訂, 0天前

**git/**
- concurrent-session-git — 2 次修訂, 0天前

**media/**
- video-transcript — 5 次修訂, 3天前

**quality/**
- de-slopify — 4 次修訂, 0天前
- say-it-plain — 2 次修訂, 6天前

**workflow/**
- autoresearch — 3 次修訂, 0天前
- gdrive-to-skills — 3 次修訂, 0天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 110天前 (2026-04-07)
- db-migration — 1 次, 136天前 (2026-03-12)
- doc-to-structured-data — 1 次, 122天前 (2026-03-26)
- docker-compose-setup — 2 次, 100天前 (2026-04-17)
- rbac-permissions — 1 次, 110天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 133天前 (2026-03-15)
- vector-search-setup — 1 次, 118天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 110天前 (2026-04-07)
- office-docx — 4 次, 109天前 (2026-04-08)
- office-pdf — 3 次, 138天前 (2026-03-10)
- office-pptx — 3 次, 138天前 (2026-03-10)
- office-xlsx — 3 次, 138天前 (2026-03-10)
- rfq-writer — 1 次, 109天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 139天前 (2026-03-09)
- ios-integration — 1 次, 140天前 (2026-03-08)
- swiftui-patterns — 1 次, 140天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 138天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 122天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 136天前 (2026-03-12)
- ci-pipeline — 1 次, 136天前 (2026-03-12)
- deploy — 1 次, 136天前 (2026-03-12)
- dev-process-gate — 4 次, 110天前 (2026-04-07)
- init-project — 2 次, 139天前 (2026-03-09)
- knowledge-graph — 1 次, 133天前 (2026-03-15)
- plan-check-style — 3 次, 136天前 (2026-03-12)
- session-wrap — 1 次, 103天前 (2026-04-14)
- setup-permissions — 3 次, 136天前 (2026-03-12)
- skill-creator — 4 次, 100天前 (2026-04-17)
- sync-readme — 1 次, 117天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 104天前 (2026-04-13)
- large-file-refactor — 1 次, 118天前 (2026-03-30)
- qa-auto — 1 次, 133天前 (2026-03-15)
- qa-planner — 1 次, 133天前 (2026-03-15)
- qa-testing — 1 次, 138天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 133天前 (2026-03-15)
- context-recovery — 1 次, 133天前 (2026-03-15)
- settings-audit — 1 次, 123天前 (2026-03-25)

<details><summary>✅ 穩定 (60)</summary>

**agents/**
- agent-dispatch — 1 次, 3天前
- agent-headless — 1 次, 3天前
- agent-launchd — 1 次, 3天前

**backend/**
- ai-vision-extract — 1 次, 27天前
- firebase-backend — 3 次, 79天前
- ic-lot-normalization — 1 次, 32天前
- mcp-builder — 1 次, 3天前
- odb-dfm-reference — 1 次, 32天前
- spine-rbac — 1 次, 28天前
- spine-schema-sync — 1 次, 28天前
- spine-versioning — 1 次, 27天前
- sqlite-to-postgres — 2 次, 79天前
- telegram-bot — 1 次, 3天前

**business/**
- candidate-analysis — 1 次, 3天前
- client-kickoff-docs — 1 次, 3天前
...
- tender-scraper — 1 次, 3天前
- tw-company-lookup — 1 次, 3天前

**docs/**
- chart-design — 1 次, 69天前
- doc-coauthoring — 2 次, 79天前
- excalidraw-diagram — 2 次, 71天前
- gdoc-report-builder — 2 次, 79天前
- internal-comms — 2 次, 79天前
- iot-factory-report — 2 次, 79天前
- mermaid-diagram — 1 次, 72天前
- metadata-workshop — 2 次, 79天前
- pitch-deck — 3 次, 79天前
- slide-office-hours — 2 次, 79天前
- slide-template-extractor — 2 次, 79天前
- slide-workflow — 4 次, 79天前
- sow-writer — 2 次, 79天前

**frontend/**
- chimesflow-design — 1 次, 45天前
...
**meta/**
- learnings-promotion-sprint — 1 次, 72天前
- self-improving-agent — 3 次, 71天前
- session-harvest — 3 次, 79天前
- skill-scout — 2 次, 88天前
- task-brief — 1 次, 40天前
- workflow-retro — 2 次, 79天前

**planning/**
- app-ops-baseline — 1 次, 3天前
- executing-plans — 1 次, 3天前
- mockup — 1 次, 3天前
- planning-with-files — 1 次, 3天前
- requirement — 1 次, 3天前
- user-flow — 1 次, 3天前
- writing-plans — 1 次, 3天前

**quality/**
- protect-secrets — 3 次, 79天前
- qa-journey — 1 次, 0天前

**workflow/**
- context-journal — 1 次, 6天前
- env-doctor — 3 次, 40天前
- repro-exam — 3 次, 40天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-20", "07-21", "07-22", "07-23", "07-24", "07-25", "07-26"]
    y-axis "USD" 0 --> 2700
    bar [2648, 1490, 1026, 1443, 1068, 405, 531]
~~~
...
| 2026-07-26 (Sun) | 8 | 859 | 241.1M | $530.83 |
| **Total** | | | **3511.8M** | **$8610.34** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-MingOS | 2,325 | 884.0M | $1902.46 |
| -Users-manibari-code-mops-dbs | 1,519 | 763.1M | $1856.47 |
| -Users-manibari-Vault-Peter-Work | 2,121 | 607.3M | $1556.77 |
| -Users-manibari-code-rivendell | 1,436 | 220.7M | $683.42 |
| -Users-manibari-code-PTI-ARES | 1,037 | 246.8M | $627.77 |
| -Users-manibari-code-IC-YMS | 785 | 273.9M | $567.83 |
| -Users-manibari-code-ChimesFlow | 668 | 186.8M | $517.33 |
...
| -Users-manibari-code-sales-assistant | 331 | 21.7M | $70.72 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-26 — 115 skills, 62 issue(s)*
