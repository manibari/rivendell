...
**backend/**
- db-migration — 1 次, 112天前 (2026-03-12)
- doc-to-structured-data — 1 次, 98天前 (2026-03-26)
- imap-smtp-integration — 1 次, 100天前 (2026-03-24)
- markdown-file-ssot — 1 次, 100天前 (2026-03-24)
- oauth-token-vault — 1 次, 100天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 109天前 (2026-03-15)
- tw-company-lookup — 2 次, 108天前 (2026-03-16)
- vector-search-setup — 1 次, 94天前 (2026-03-30)

**docs/**
- mcp-builder — 3 次, 114天前 (2026-03-10)
- office-pdf — 3 次, 114天前 (2026-03-10)
- office-pptx — 3 次, 114天前 (2026-03-10)
- office-xlsx — 3 次, 114天前 (2026-03-10)
- telegram-bot — 1 次, 109天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 115天前 (2026-03-09)
- ios-integration — 1 次, 116天前 (2026-03-08)
- swiftui-patterns — 1 次, 116天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 114天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 98天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 112天前 (2026-03-12)
- ci-pipeline — 1 次, 112天前 (2026-03-12)
- deploy — 1 次, 112天前 (2026-03-12)
- init-project — 2 次, 115天前 (2026-03-09)
- knowledge-graph — 1 次, 109天前 (2026-03-15)
- plan-check-style — 3 次, 112天前 (2026-03-12)
- setup-permissions — 3 次, 112天前 (2026-03-12)
- sync-readme — 1 次, 93天前 (2026-03-31)

**quality/**
- large-file-refactor — 1 次, 94天前 (2026-03-30)
- qa-auto — 1 次, 109天前 (2026-03-15)
- qa-planner — 1 次, 109天前 (2026-03-15)
- qa-testing — 1 次, 114天前 (2026-03-10)

**workflow/**
- candidate-analysis — 1 次, 98天前 (2026-03-26)
- claude-to-telegram — 1 次, 109天前 (2026-03-15)
- context-recovery — 1 次, 109天前 (2026-03-15)
- crm-projection — 1 次, 108天前 (2026-03-16)
- executing-plans — 3 次, 114天前 (2026-03-10)
- gdrive-to-skills — 2 次, 115天前 (2026-03-09)
- headless-agent — 6 次, 100天前 (2026-03-24)
- keyword-discovery — 1 次, 100天前 (2026-03-24)
- material-health — 1 次, 108天前 (2026-03-16)
- mockup — 1 次, 116天前 (2026-03-08)
- settings-audit — 1 次, 99天前 (2026-03-25)
- subsidy-scraper — 1 次, 108天前 (2026-03-16)
- tender-scraper — 3 次, 100天前 (2026-03-24)
- writing-plans — 3 次, 114天前 (2026-03-10)

<details><summary>✅ 穩定 (64)</summary>

**backend/**
- ai-vision-extract — 1 次, 3天前
- audio-transcription-flow — 1 次, 86天前
- backend-async-jobs — 2 次, 15天前
- docker-compose-setup — 2 次, 76天前
- firebase-backend — 3 次, 55天前
- ic-lot-normalization — 1 次, 8天前
- ml-eval-quality — 1 次, 8天前
- ml-model-registry — 1 次, 8天前
- odb-dfm-reference — 1 次, 8天前
- rbac-permissions — 1 次, 86天前
- spine-auth — 1 次, 4天前
- spine-rbac — 1 次, 4天前
- spine-schema-sync — 1 次, 4天前
- spine-versioning — 1 次, 3天前
- sqlite-to-postgres — 2 次, 55天前

**docs/**
- chart-design — 1 次, 45天前
- discovery-interview — 1 次, 86天前
- doc-coauthoring — 2 次, 55天前
- excalidraw-diagram — 2 次, 47天前
- gdoc-report-builder — 2 次, 55天前
- internal-comms — 2 次, 55天前
- iot-factory-report — 2 次, 55天前
- mermaid-diagram — 1 次, 48天前
- metadata-workshop — 2 次, 55天前
- office-docx — 4 次, 85天前
- pitch-deck — 3 次, 55天前
- rfq-writer — 1 次, 85天前
- slide-office-hours — 2 次, 55天前
- slide-template-extractor — 2 次, 55天前
- slide-workflow — 4 次, 55天前
- sow-writer — 2 次, 55天前

**frontend/**
- chimesflow-design — 1 次, 21天前

**git/**
- auto-stage — 3 次, 55天前
- concurrent-session-git — 1 次, 15天前

**meta/**
- agent-persona — 1 次, 80天前
- dev-process-gate — 4 次, 86天前
- learnings-promotion-sprint — 1 次, 48天前
- self-improving-agent — 3 次, 47天前
- session-harvest — 3 次, 55天前
- session-wrap — 1 次, 79天前
- skill-creator — 4 次, 76天前
- skill-scout — 2 次, 64天前
- task-brief — 1 次, 16天前
- workflow-retro — 2 次, 55天前

**quality/**
- de-slopify — 2 次, 76天前
- github-repo-audit — 1 次, 80天前
- protect-secrets — 3 次, 55天前

**workflow/**
- agent-observability — 2 次, 86天前
- app-ops-baseline — 1 次, 21天前
- autoresearch — 2 次, 55天前
- client-kickoff-docs — 2 次, 16天前
- customer-intel — 5 次, 55天前
- dispatching-parallel-agents — 4 次, 76天前
- env-doctor — 3 次, 16天前
- investment-research — 4 次, 55天前
- jd-writer — 1 次, 80天前
- launchd-agent — 6 次, 55天前
- mops-financial-scraper — 3 次, 16天前
- planning-with-files — 5 次, 86天前
- presales-pipeline — 3 次, 16天前
- repro-exam — 3 次, 16天前
- requirement — 2 次, 86天前
- sales-material — 3 次, 72天前
- user-flow — 2 次, 48天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 17 個 commit（本週）, 346 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/product-taxonomy` (5 total) | 3 個 open PR |
| **Git** | 9 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
1065204 feat(ocr): codex_http provider — host codex bridge over a port (container ↔ host) — v1.33.35 (#114)
b4b45e1 feat(ocr): 名片辨識預設用 codex CLI（ChatGPT 登入、免 API key）— v1.33.34 (#113)
ecbdf83 feat(accounts): 掃名片建客戶 as standalone 客戶 nav entry + mobile camera (v1.33.33) (#112)
5206284 fix(enrichment): pick representative industry, skip boilerplate 營業項目 (v1.33.32) (#108)
268dea1 feat(accounts): business-card OCR — scan card → prefill account+contact (v1.33.31, test feature) (#106)
```
</details>
...
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
| **Config** | no AGENTS.md | **權限** | OK (7 rules) |

<details><summary>近期 commits</summary>

```
5cabe2d feat(materials): 材質模型 schema (選 b — 完整設計)
9b0bd84 feat(viz3d): headless 3D 預覽 PNG renderer (matplotlib Agg)
c65c1a8 docs: session 交接筆記 — L1 端到端驗證通過 (真板 PB0009)
fbd179a docs: 物理模型資料實查落地（3 板 ODB++）
fc5422d docs: Norns NPI 願景釘樁 — 雲端 ODB++ DFM + 材質標記物理 3D 模型
```
</details>
...
9cc9112 docs(baselines): Valor DFM ground-truth extractor + per-rule reconciliation
4c828f8 feat(review): CP0030 component-spacing threshold matrix heatmap + class-pair highlight
f011a66 feat(viewer): show component Z height (H) in the element info
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 152 個 commit（本週）, 187 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 83 個 commit（本週）, 121 個（本月） |
| **技術棧** |  Make |
| **分支** | `feat/monorepo` (2 total) | 1 個 open PR |
| **Git** | 4 dirty, 2 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
94a1a7e feat(monitor): 限流趨勢分外部來源（v0.8.6）
3996f0d feat(ui): 使用手冊改 step-by-step + 箭頭截圖（v0.8.5）
efdf213 fix(monitor): changelog latest_version 同日多版本排序錯（QA 揪出）
9b923ee feat(dev): spine-versioning gate — 改 app code 沒 bump 版本就擋 + 補齊 SEED
59296e2 feat(ui): 右上使用者選單（ChimesFlow 風格）+ 補版本紀錄（spine-versioning）
```
</details>
...
1a5b1a4 fix(stock-picking): frame entry allocation as today's plan with stale-price note
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-26", "06-27", "06-28", "06-29", "06-30", "07-01", "07-02"]
    y-axis "USD" 0 --> 3800
    bar [1973, 3712, 2519, 2908, 2686, 2656, 2660]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-26 (Fri) | 12 | 2,463 | 873.4M | $1972.68 |
| 2026-06-27 (Sat) | 9 | 2,943 | 1707.9M | $3711.74 |
...
| 2026-07-02 (Thu) | 17 | 2,701 | 1179.4M | $2659.96 |
| **Total** | | | **8542.4M** | **$19114.44** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Vault-Peter-Family | 3,520 | 2064.4M | $4068.76 |
| -Users-manibari-code-mops-dbs | 2,562 | 1688.2M | $3646.03 |
| -Users-manibari-code-PTI-ARES | 3,843 | 1546.2M | $3079.53 |
| -Users-manibari-code-ChimesFlow | 1,760 | 854.7M | $2093.13 |
| -Users-manibari-code-IC-YMS | 1,648 | 736.1M | $1856.92 |
| -Users-manibari-code-tukey-automl | 1,236 | 569.9M | $1298.08 |
| -Users-manibari-code-tukey-bi | 1,145 | 524.8M | $1169.47 |
| -Users-manibari-code-rivendell | 709 | 248.2M | $912.87 |
| -Users-manibari-code-TWstock-invest | 525 | 129.0M | $409.70 |
| -Users-manibari-Vault-Peter-Work | 861 | 132.3M | $379.40 |
| -Users-manibari-code | 180 | 26.3M | $107.68 |
| -Users-manibari-code-sales-assistant | 276 | 18.0M | $73.04 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-Norns-ERP | 40 | 2.5M | $14.30 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-02 — 108 skills, 65 issue(s)*
