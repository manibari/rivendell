...
**backend/**
- db-migration — 1 次, 115天前 (2026-03-12)
- doc-to-structured-data — 1 次, 101天前 (2026-03-26)
- imap-smtp-integration — 1 次, 103天前 (2026-03-24)
- markdown-file-ssot — 1 次, 103天前 (2026-03-24)
- oauth-token-vault — 1 次, 103天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 112天前 (2026-03-15)
- tw-company-lookup — 2 次, 111天前 (2026-03-16)
- vector-search-setup — 1 次, 97天前 (2026-03-30)

**docs/**
- mcp-builder — 3 次, 117天前 (2026-03-10)
- office-pdf — 3 次, 117天前 (2026-03-10)
- office-pptx — 3 次, 117天前 (2026-03-10)
- office-xlsx — 3 次, 117天前 (2026-03-10)
- telegram-bot — 1 次, 112天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 118天前 (2026-03-09)
- ios-integration — 1 次, 119天前 (2026-03-08)
- swiftui-patterns — 1 次, 119天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 117天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 101天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 115天前 (2026-03-12)
- ci-pipeline — 1 次, 115天前 (2026-03-12)
- deploy — 1 次, 115天前 (2026-03-12)
- init-project — 2 次, 118天前 (2026-03-09)
- knowledge-graph — 1 次, 112天前 (2026-03-15)
- plan-check-style — 3 次, 115天前 (2026-03-12)
- setup-permissions — 3 次, 115天前 (2026-03-12)
- sync-readme — 1 次, 96天前 (2026-03-31)

**quality/**
- large-file-refactor — 1 次, 97天前 (2026-03-30)
- qa-auto — 1 次, 112天前 (2026-03-15)
- qa-planner — 1 次, 112天前 (2026-03-15)
- qa-testing — 1 次, 117天前 (2026-03-10)

**workflow/**
- candidate-analysis — 1 次, 101天前 (2026-03-26)
- claude-to-telegram — 1 次, 112天前 (2026-03-15)
- context-recovery — 1 次, 112天前 (2026-03-15)
- crm-projection — 1 次, 111天前 (2026-03-16)
- executing-plans — 3 次, 117天前 (2026-03-10)
- gdrive-to-skills — 2 次, 118天前 (2026-03-09)
- headless-agent — 6 次, 103天前 (2026-03-24)
- keyword-discovery — 1 次, 103天前 (2026-03-24)
- material-health — 1 次, 111天前 (2026-03-16)
- mockup — 1 次, 119天前 (2026-03-08)
- settings-audit — 1 次, 102天前 (2026-03-25)
- subsidy-scraper — 1 次, 111天前 (2026-03-16)
- tender-scraper — 3 次, 103天前 (2026-03-24)
- writing-plans — 3 次, 117天前 (2026-03-10)

<details><summary>✅ 穩定 (64)</summary>

**backend/**
- ai-vision-extract — 1 次, 6天前
- audio-transcription-flow — 1 次, 89天前
- backend-async-jobs — 2 次, 18天前
- docker-compose-setup — 2 次, 79天前
- firebase-backend — 3 次, 58天前
- ic-lot-normalization — 1 次, 11天前
- ml-eval-quality — 1 次, 11天前
- ml-model-registry — 1 次, 11天前
- odb-dfm-reference — 1 次, 11天前
- rbac-permissions — 1 次, 89天前
- spine-auth — 1 次, 7天前
- spine-rbac — 1 次, 7天前
- spine-schema-sync — 1 次, 7天前
- spine-versioning — 1 次, 6天前
- sqlite-to-postgres — 2 次, 58天前

**docs/**
- chart-design — 1 次, 48天前
- discovery-interview — 1 次, 89天前
- doc-coauthoring — 2 次, 58天前
- excalidraw-diagram — 2 次, 50天前
- gdoc-report-builder — 2 次, 58天前
- internal-comms — 2 次, 58天前
- iot-factory-report — 2 次, 58天前
- mermaid-diagram — 1 次, 51天前
- metadata-workshop — 2 次, 58天前
- office-docx — 4 次, 88天前
- pitch-deck — 3 次, 58天前
- rfq-writer — 1 次, 88天前
- slide-office-hours — 2 次, 58天前
- slide-template-extractor — 2 次, 58天前
- slide-workflow — 4 次, 58天前
- sow-writer — 2 次, 58天前

**frontend/**
- chimesflow-design — 1 次, 24天前

**git/**
- auto-stage — 3 次, 58天前
- concurrent-session-git — 1 次, 18天前

**meta/**
- agent-persona — 1 次, 83天前
- dev-process-gate — 4 次, 89天前
- learnings-promotion-sprint — 1 次, 51天前
- self-improving-agent — 3 次, 50天前
- session-harvest — 3 次, 58天前
- session-wrap — 1 次, 82天前
- skill-creator — 4 次, 79天前
- skill-scout — 2 次, 67天前
- task-brief — 1 次, 19天前
- workflow-retro — 2 次, 58天前

**quality/**
- de-slopify — 2 次, 79天前
- github-repo-audit — 1 次, 83天前
- protect-secrets — 3 次, 58天前

**workflow/**
- agent-observability — 2 次, 89天前
- app-ops-baseline — 1 次, 24天前
- autoresearch — 2 次, 58天前
- client-kickoff-docs — 2 次, 19天前
- customer-intel — 5 次, 58天前
- dispatching-parallel-agents — 4 次, 79天前
- env-doctor — 3 次, 19天前
- investment-research — 4 次, 58天前
- jd-writer — 1 次, 83天前
- launchd-agent — 6 次, 58天前
- mops-financial-scraper — 3 次, 19天前
- planning-with-files — 5 次, 89天前
- presales-pipeline — 3 次, 19天前
- repro-exam — 3 次, 19天前
- requirement — 2 次, 89天前
- sales-material — 3 次, 75天前
- user-flow — 2 次, 51天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 11 個 commit（本週）, 314 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `fix/ci-green` (2 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
7e73479 fix(ci): scope vitest to src/ (skip Playwright e2e) + align stale feedback test
aa02c2d feat(opps): persist list filters/sort across reloads (per user) — v1.33.36 (#115)
ed5ab88 feat(products): product-line architecture diagram (3 platforms × 3 foundations) — v1.33.38 (#117)
93ad4be feat(products): product-line taxonomy foundation — platform + domain tags — v1.33.39 (#118)
64a19da feat(presales): stage-templated presales help to-do (sales→presales) — v1.33.37 (#116)
```
</details>
...
```
600b85e feat(ingest): IPC-2581 rev B reader → 統一 Board · v0.3.0
241f7f1 docs: 資料流加 IPC-2581 輸入(開放富格式) · v0.2.2
df8d323 docs: 資料流圖(A共用庫/B隨案/ODB++ vs Gerber) 嵌入 journey · v0.2.1
cb3abd5 feat(viz3d): via/drill 納入 3D · v0.2.0
d46609a docs: 客戶旅程 SoT — 主要買家=力成，潛在=仁寶/立積/增你強 · v0.1.2
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 78 個 commit（本週）, 144 個（本月） |
| **技術棧** |  Node.js Python |
| **分支** | `next-wave-2026-05` (5 total) |
| **Git** | 1 dirty, 3 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
8142e81 fix(frontend): rulecheck 版本卡片版面溢出 — 響應式 Col + badge 換行
8a9b2a0 docs(plans): rules are subject-anchored — the real engine model (from Valor check names)
b2816b8 docs(plans): phased CP0030 + rule-coverage reconciliation plan
456adf7 feat(console): account menu (個人資料/意見回饋/使用手冊/登出) + record this session's shipped items
b17e810 docs(baselines): reconcile oracle — per-rule precision/recall vs Valor + FP characterization
```
</details>
...
437f7f1 docs: README 加版本 gate 安裝說明
52250c0 chore: 裝版本 bump gate(pre-push hook)— 動 code 沒 bump changelog 就擋
3d6df87 refactor(web): 首頁精簡 — 移除 hero 贅述句 + 收緊咖啡因說明(留資訊少字)
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 100 個 commit（本週）, 173 個（本月） |
| **技術棧** |  Make |
| **分支** | `main` (2 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
8ad6268 feat(monitor): per-source throttle timelines + bulk-job badge v0.14.1
f976227 docs(runbook): prod deploy guide for the 2026-07 platform state
de1790a feat(monitor): 分析平台 management page v0.14.0
45a0845 refactor(monitor): second cut — crawl domain extracted to crawl.py v0.13.3
7784477 refactor(monitor): crawl-env single truth + viewer feature module v0.13.2
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-29", "06-30", "07-01", "07-02", "07-03", "07-04", "07-05"]
    y-axis "USD" 0 --> 3000
    bar [2908, 2686, 2656, 2854, 1398, 495, 2124]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-29 (Mon) | 17 | 2,485 | 1213.1M | $2907.97 |
| 2026-06-30 (Tue) | 14 | 2,187 | 1228.2M | $2686.36 |
| 2026-07-01 (Wed) | 14 | 3,171 | 1168.3M | $2656.32 |
| 2026-07-02 (Thu) | 19 | 2,985 | 1234.2M | $2854.11 |
| 2026-07-03 (Fri) | 13 | 1,208 | 564.8M | $1397.89 |
| 2026-07-04 (Sat) | 7 | 702 | 244.7M | $495.01 |
| 2026-07-05 (Sun) | 16 | 2,029 | 853.6M | $2124.49 |
| **Total** | | | **6506.8M** | **$15122.15** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-mops-dbs | 3,141 | 1687.3M | $3441.33 |
| -Users-manibari-code-PTI-ARES | 4,149 | 1655.7M | $3402.91 |
| -Users-manibari-code-IC-YMS | 1,292 | 681.6M | $1695.11 |
| -Users-manibari-code-tukey-automl | 1,264 | 631.4M | $1439.46 |
| -Users-manibari-code-tukey-bi | 1,017 | 538.1M | $1263.50 |
| -Users-manibari-code-ChimesFlow | 898 | 521.2M | $1259.91 |
| -Users-manibari-Vault-Peter-Work | 910 | 180.6M | $767.24 |
| -Users-manibari-code-rivendell | 402 | 171.5M | $571.16 |
| -Users-manibari-Vault-Peter-Family | 269 | 198.3M | $487.64 |
| -Users-manibari-code-TWstock-invest | 427 | 120.4M | $381.05 |
| -Users-manibari-code | 189 | 30.8M | $141.36 |
| -Users-manibari-code-iihi | 245 | 43.9M | $105.71 |
| -Users-manibari-code-sales-assistant | 275 | 18.0M | $74.26 |
| -Users-manibari-code-news-stock | 196 | 22.0M | $58.22 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-Norns-ERP | 56 | 4.0M | $24.34 |
| -Users-manibari-code-vantage-3dgs | 31 | 1.7M | $5.53 |
| -Users-manibari-code-mops-dbs-apps-analytics | 6 | 260K | $3.42 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-05 — 108 skills, 63 issue(s)*
