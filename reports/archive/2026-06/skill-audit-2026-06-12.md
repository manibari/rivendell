...
**backend/**
- db-migration — 1 次, 92天前 (2026-03-12)

**docs/**
- mcp-builder — 3 次, 94天前 (2026-03-10)
- office-pdf — 3 次, 94天前 (2026-03-10)
- office-pptx — 3 次, 94天前 (2026-03-10)
- office-xlsx — 3 次, 94天前 (2026-03-10)

**frontend/**
- frontend-design — 2 次, 95天前 (2026-03-09)
- ios-integration — 1 次, 96天前 (2026-03-08)
- swiftui-patterns — 1 次, 96天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 94天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 92天前 (2026-03-12)
- ci-pipeline — 1 次, 92天前 (2026-03-12)
- deploy — 1 次, 92天前 (2026-03-12)
- init-project — 2 次, 95天前 (2026-03-09)
- plan-check-style — 3 次, 92天前 (2026-03-12)
- setup-permissions — 3 次, 92天前 (2026-03-12)

**quality/**
- qa-testing — 1 次, 94天前 (2026-03-10)

**workflow/**
- executing-plans — 3 次, 94天前 (2026-03-10)
- gdrive-to-skills — 2 次, 95天前 (2026-03-09)
- mockup — 1 次, 96天前 (2026-03-08)
- writing-plans — 3 次, 94天前 (2026-03-10)

<details><summary>✅ 穩定 (76)</summary>

**backend/**
- audio-transcription-flow — 1 次, 66天前
- doc-to-structured-data — 1 次, 78天前
- docker-compose-setup — 2 次, 56天前
- firebase-backend — 3 次, 35天前
- imap-smtp-integration — 1 次, 80天前
- markdown-file-ssot — 1 次, 80天前
- oauth-token-vault — 1 次, 80天前
- rbac-permissions — 1 次, 66天前
- sqlite-to-postgres — 2 次, 35天前
- tunnel-proxy-deploy — 1 次, 89天前
- tw-company-lookup — 2 次, 88天前
- vector-search-setup — 1 次, 74天前

**docs/**
- chart-design — 1 次, 25天前
- discovery-interview — 1 次, 66天前
- doc-coauthoring — 2 次, 35天前
- excalidraw-diagram — 2 次, 27天前
- gdoc-report-builder — 2 次, 35天前
- internal-comms — 2 次, 35天前
- iot-factory-report — 2 次, 35天前
- mermaid-diagram — 1 次, 28天前
- metadata-workshop — 2 次, 35天前
- office-docx — 4 次, 65天前
- pitch-deck — 3 次, 35天前
- rfq-writer — 1 次, 65天前
- slide-office-hours — 2 次, 35天前
- slide-template-extractor — 2 次, 35天前
- slide-workflow — 4 次, 35天前
- sow-writer — 2 次, 35天前
- telegram-bot — 1 次, 89天前

**frontend/**
- chimesflow-design — 1 次, 1天前

**git/**
- auto-stage — 3 次, 35天前
- repo-rename — 1 次, 78天前

**meta/**
- agent-persona — 1 次, 60天前
- dev-process-gate — 4 次, 66天前
- knowledge-graph — 1 次, 89天前
- learnings-promotion-sprint — 1 次, 28天前
- self-improving-agent — 3 次, 27天前
- session-harvest — 3 次, 35天前
- session-wrap — 1 次, 59天前
- skill-creator — 4 次, 56天前
- skill-scout — 2 次, 44天前
- sync-readme — 1 次, 73天前
- workflow-retro — 2 次, 35天前

**quality/**
- de-slopify — 2 次, 56天前
- github-repo-audit — 1 次, 60天前
- large-file-refactor — 1 次, 74天前
- protect-secrets — 3 次, 35天前
- qa-auto — 1 次, 89天前
- qa-planner — 1 次, 89天前

**workflow/**
- agent-observability — 2 次, 66天前
- app-ops-baseline — 1 次, 1天前
- autoresearch — 2 次, 35天前
- candidate-analysis — 1 次, 78天前
- claude-to-telegram — 1 次, 89天前
- client-kickoff-docs — 1 次, 51天前
- context-recovery — 1 次, 89天前
- crm-projection — 1 次, 88天前
- customer-intel — 5 次, 35天前
- dispatching-parallel-agents — 4 次, 56天前
- env-doctor — 1 次, 51天前
- headless-agent — 6 次, 80天前
- investment-research — 4 次, 35天前
- jd-writer — 1 次, 60天前
- keyword-discovery — 1 次, 80天前
- launchd-agent — 6 次, 35天前
- material-health — 1 次, 88天前
- mops-financial-scraper — 1 次, 51天前
- planning-with-files — 5 次, 66天前
- presales-pipeline — 1 次, 51天前
- repro-exam — 1 次, 51天前
- requirement — 2 次, 66天前
- sales-material — 3 次, 52天前
- settings-audit — 1 次, 79天前
- subsidy-scraper — 1 次, 88天前
- tender-scraper — 3 次, 80天前
- user-flow — 2 次, 28天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 114 個 commit（本週）, 351 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (4 total) |
| **Git** | 6 unpushed |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
a9ca545 feat(accounts): detail-page cross-visibility gating (FE)
805d88d feat(accounts): create-form global dedup banner + transfer request (FE)
2686cf5 feat(accounts): request-transfer endpoint (v1 notify-only)
1a8d6c3 feat(accounts): global dedup-check endpoint (existence + owner only)
6285881 feat(accounts): gate 窗口 write paths by account ownership
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 6 個 commit（本週）, 75 個（本月） |
| **技術棧** |  Python |
| **分支** | `next-wave-2026-05` (5 total) |
| **Git** | 2 dirty, 30 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
670c5c2 fix(viewers): draw raw toggled layers on top + stronger surface fill
5339eb8 feat(viewers): data-driven raw-layer coverage — expose every ODB++ layer's surfaces+lines
2969593 feat(rules): close V3 checklist blocker — route V3 → engine-shaped rules.json
d48b664 docs: self-serve upload requirement, roadmap, user-flow + SBOM
b5e243f feat(serve): per-project data inventory + upload slots
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-06", "06-07", "06-08", "06-09", "06-10", "06-11", "06-12"]
    y-axis "USD" 0 --> 2600
    bar [7, 448, 1213, 2528, 1774, 1301, 1203]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-06 (Sat) | 1 | 35 | 2.0M | $6.62 |
...
| 2026-06-12 (Fri) | 13 | 1,662 | 516.1M | $1203.27 |
| **Total** | | | **4007.0M** | **$8473.37** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 5,204 | 2862.8M | $5367.26 |
| -Users-manibari-code | 1,253 | 296.9M | $913.18 |
| -Users-manibari-code-tukey-automl | 918 | 326.6M | $723.47 |
| -Users-manibari-code-vantage-3dgs | 672 | 228.1M | $616.04 |
| -Users-manibari-Vault-Peter-Work | 1,276 | 208.1M | $548.11 |
| -Users-manibari-code-tukey-bi | 349 | 46.9M | $134.09 |
| -Users-manibari-code-sales-assistant | 237 | 13.5M | $57.86 |
| -Users-manibari-Vault-Peter | 116 | 8.0M | $41.26 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-rivendell | 124 | 6.1M | $36.95 |
| -Users-manibari-code-automl-platform | 110 | 8.8M | $27.97 |
| -Users-manibari-code-PTI-ARES | 31 | 1.4M | $7.18 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-12 — 96 skills, 43 issue(s)*
