...
**frontend/**
- ios-integration — 1 次, 91天前 (2026-03-08)
- swiftui-patterns — 1 次, 91天前 (2026-03-08)

**workflow/**
- mockup — 1 次, 91天前 (2026-03-08)

<details><summary>✅ 穩定 (91)</summary>

**backend/**
- audio-transcription-flow — 1 次, 61天前
- db-migration — 1 次, 87天前
- doc-to-structured-data — 1 次, 73天前
- docker-compose-setup — 2 次, 51天前
- firebase-backend — 3 次, 30天前
- imap-smtp-integration — 1 次, 75天前
- markdown-file-ssot — 1 次, 75天前
- oauth-token-vault — 1 次, 75天前
- rbac-permissions — 1 次, 61天前
- sqlite-to-postgres — 2 次, 30天前
- tunnel-proxy-deploy — 1 次, 84天前
- tw-company-lookup — 2 次, 83天前
- vector-search-setup — 1 次, 69天前

**docs/**
- chart-design — 1 次, 20天前
- discovery-interview — 1 次, 61天前
- doc-coauthoring — 2 次, 30天前
- excalidraw-diagram — 2 次, 22天前
- gdoc-report-builder — 2 次, 30天前
- internal-comms — 2 次, 30天前
- iot-factory-report — 2 次, 30天前
- mcp-builder — 3 次, 89天前
- mermaid-diagram — 1 次, 23天前
- metadata-workshop — 2 次, 30天前
- office-docx — 4 次, 60天前
- office-pdf — 3 次, 89天前
- office-pptx — 3 次, 89天前
- office-xlsx — 3 次, 89天前
- pitch-deck — 3 次, 30天前
- rfq-writer — 1 次, 60天前
- slide-office-hours — 2 次, 30天前
- slide-template-extractor — 2 次, 30天前
- slide-workflow — 4 次, 30天前
- sow-writer — 2 次, 30天前
- telegram-bot — 1 次, 84天前

**frontend/**
- frontend-design — 2 次, 90天前
- ui-ux-pro-max — 3 次, 89天前

**git/**
- auto-stage — 3 次, 30天前
- repo-rename — 1 次, 73天前

**meta/**
- agent-persona — 1 次, 55天前
- audit-fix — 1 次, 87天前
- ci-pipeline — 1 次, 87天前
- deploy — 1 次, 87天前
- dev-process-gate — 4 次, 61天前
- init-project — 2 次, 90天前
- knowledge-graph — 1 次, 84天前
- learnings-promotion-sprint — 1 次, 23天前
- plan-check-style — 3 次, 87天前
- self-improving-agent — 3 次, 22天前
- session-harvest — 3 次, 30天前
- session-wrap — 1 次, 54天前
- setup-permissions — 3 次, 87天前
- skill-creator — 4 次, 51天前
- skill-scout — 2 次, 39天前
- sync-readme — 1 次, 68天前
- workflow-retro — 2 次, 30天前

**quality/**
- de-slopify — 2 次, 51天前
- github-repo-audit — 1 次, 55天前
- large-file-refactor — 1 次, 69天前
- protect-secrets — 3 次, 30天前
- qa-auto — 1 次, 84天前
- qa-planner — 1 次, 84天前
- qa-testing — 1 次, 89天前

**workflow/**
- agent-observability — 2 次, 61天前
- autoresearch — 2 次, 30天前
- candidate-analysis — 1 次, 73天前
- claude-to-telegram — 1 次, 84天前
- client-kickoff-docs — 1 次, 46天前
- context-recovery — 1 次, 84天前
- crm-projection — 1 次, 83天前
- customer-intel — 5 次, 30天前
- dispatching-parallel-agents — 4 次, 51天前
- env-doctor — 1 次, 46天前
- executing-plans — 3 次, 89天前
- gdrive-to-skills — 2 次, 90天前
- headless-agent — 6 次, 75天前
- investment-research — 4 次, 30天前
- jd-writer — 1 次, 55天前
- keyword-discovery — 1 次, 75天前
- launchd-agent — 6 次, 30天前
- material-health — 1 次, 83天前
- mops-financial-scraper — 1 次, 46天前
- planning-with-files — 5 次, 61天前
- presales-pipeline — 1 次, 46天前
- repro-exam — 1 次, 46天前
- requirement — 2 次, 61天前
- sales-material — 3 次, 47天前
- settings-audit — 1 次, 74天前
- subsidy-scraper — 1 次, 83天前
- tender-scraper — 3 次, 75天前
- user-flow — 2 次, 23天前
- writing-plans — 3 次, 89天前
...
```
dcb9e36 fix(quotes): editable display name per line — keep catalog link, unlink via ×
9a22b24 fix(partners): list deals linked via channel_partner_id too (incl. won)
ce3ff93 fix(opps): surface activity attachments in the 附件與文件 section
7f4aa27 refactor(opps): 主辦/補助機關 = a sales channel, not a separate entity
23c069f feat(activities): attendees on the create form (客戶 + 內部同仁)
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-01", "06-02", "06-03", "06-04", "06-05", "06-06", "06-07"]
    y-axis "USD" 0 --> 2750
    bar [1549, 2049, 2693, 2297, 376, 7, 59]
~~~
...
| 2026-06-07 (Sun) | 4 | 247 | 17.5M | $58.51 |
| **Total** | | | **4145.3M** | **$9028.73** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 3,682 | 1993.0M | $3963.99 |
| -Users-manibari-code | 3,148 | 1383.4M | $2905.96 |
| -Users-manibari-Vault-Peter | 1,677 | 468.6M | $1099.96 |
| -Users-manibari-code-news-stock | 415 | 99.4M | $350.55 |
| -Users-manibari-code-rivendell | 154 | 56.2M | $289.53 |
| -Users-manibari-code-PTI-ARES | 379 | 72.2M | $180.68 |
| -Users-manibari-Vault-Peter-Work | 306 | 45.0M | $128.11 |
| -Users-manibari-code-sales-assistant | 339 | 21.3M | $84.95 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-3DGS | 72 | 5.1M | $20.80 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-07 — 94 skills, 24 issue(s)*
