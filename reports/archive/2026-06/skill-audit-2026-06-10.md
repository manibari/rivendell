...
**docs/**
- mcp-builder — 3 次, 92天前 (2026-03-10)
- office-pdf — 3 次, 92天前 (2026-03-10)
- office-pptx — 3 次, 92天前 (2026-03-10)
- office-xlsx — 3 次, 92天前 (2026-03-10)

**frontend/**
- frontend-design — 2 次, 93天前 (2026-03-09)
- ios-integration — 1 次, 94天前 (2026-03-08)
- swiftui-patterns — 1 次, 94天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 92天前 (2026-03-10)

**meta/**
- init-project — 2 次, 93天前 (2026-03-09)

**quality/**
- qa-testing — 1 次, 92天前 (2026-03-10)

**workflow/**
- executing-plans — 3 次, 92天前 (2026-03-10)
- gdrive-to-skills — 2 次, 93天前 (2026-03-09)
- mockup — 1 次, 94天前 (2026-03-08)
- writing-plans — 3 次, 92天前 (2026-03-10)

<details><summary>✅ 穩定 (80)</summary>

**backend/**
- audio-transcription-flow — 1 次, 64天前
- db-migration — 1 次, 90天前
- doc-to-structured-data — 1 次, 76天前
- docker-compose-setup — 2 次, 54天前
- firebase-backend — 3 次, 33天前
- imap-smtp-integration — 1 次, 78天前
- markdown-file-ssot — 1 次, 78天前
- oauth-token-vault — 1 次, 78天前
- rbac-permissions — 1 次, 64天前
- sqlite-to-postgres — 2 次, 33天前
- tunnel-proxy-deploy — 1 次, 87天前
- tw-company-lookup — 2 次, 86天前
- vector-search-setup — 1 次, 72天前

**docs/**
- chart-design — 1 次, 23天前
- discovery-interview — 1 次, 64天前
- doc-coauthoring — 2 次, 33天前
- excalidraw-diagram — 2 次, 25天前
- gdoc-report-builder — 2 次, 33天前
- internal-comms — 2 次, 33天前
- iot-factory-report — 2 次, 33天前
- mermaid-diagram — 1 次, 26天前
- metadata-workshop — 2 次, 33天前
- office-docx — 4 次, 63天前
- pitch-deck — 3 次, 33天前
- rfq-writer — 1 次, 63天前
- slide-office-hours — 2 次, 33天前
- slide-template-extractor — 2 次, 33天前
- slide-workflow — 4 次, 33天前
- sow-writer — 2 次, 33天前
- telegram-bot — 1 次, 87天前

**git/**
- auto-stage — 3 次, 33天前
- repo-rename — 1 次, 76天前

**meta/**
- agent-persona — 1 次, 58天前
- audit-fix — 1 次, 90天前
- ci-pipeline — 1 次, 90天前
- deploy — 1 次, 90天前
- dev-process-gate — 4 次, 64天前
- knowledge-graph — 1 次, 87天前
- learnings-promotion-sprint — 1 次, 26天前
- plan-check-style — 3 次, 90天前
- self-improving-agent — 3 次, 25天前
- session-harvest — 3 次, 33天前
- session-wrap — 1 次, 57天前
- setup-permissions — 3 次, 90天前
- skill-creator — 4 次, 54天前
- skill-scout — 2 次, 42天前
- sync-readme — 1 次, 71天前
- workflow-retro — 2 次, 33天前

**quality/**
- de-slopify — 2 次, 54天前
- github-repo-audit — 1 次, 58天前
- large-file-refactor — 1 次, 72天前
- protect-secrets — 3 次, 33天前
- qa-auto — 1 次, 87天前
- qa-planner — 1 次, 87天前

**workflow/**
- agent-observability — 2 次, 64天前
- autoresearch — 2 次, 33天前
- candidate-analysis — 1 次, 76天前
- claude-to-telegram — 1 次, 87天前
- client-kickoff-docs — 1 次, 49天前
- context-recovery — 1 次, 87天前
- crm-projection — 1 次, 86天前
- customer-intel — 5 次, 33天前
- dispatching-parallel-agents — 4 次, 54天前
- env-doctor — 1 次, 49天前
- headless-agent — 6 次, 78天前
- investment-research — 4 次, 33天前
- jd-writer — 1 次, 58天前
- keyword-discovery — 1 次, 78天前
- launchd-agent — 6 次, 33天前
- material-health — 1 次, 86天前
- mops-financial-scraper — 1 次, 49天前
- planning-with-files — 5 次, 64天前
- presales-pipeline — 1 次, 49天前
- repro-exam — 1 次, 49天前
- requirement — 2 次, 64天前
- sales-material — 3 次, 50天前
- settings-audit — 1 次, 77天前
- subsidy-scraper — 1 次, 86天前
- tender-scraper — 3 次, 78天前
- user-flow — 2 次, 26天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 100 個 commit（本週）, 326 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
e3e76c1 feat(quotes): payment_terms is an AutoComplete (presets + custom)
8863a14 feat(targets): coverage KPI — named accounts + industry counts (P2+ = met)
8706686 feat(accounts): staleness column to front, broader signal, >90d return-to-pool
e5f3621 feat(documents): scope as numbered list; (sales contract 詠鋐→乙方 on prod)
c147f27 feat(documents): download filename = 日期_專案名稱_合約名稱
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-04", "06-05", "06-06", "06-07", "06-08", "06-09", "06-10"]
    y-axis "USD" 0 --> 2600
    bar [2297, 376, 7, 448, 1213, 2528, 467]
~~~
...
| 2026-06-10 (Wed) | 8 | 921 | 178.8M | $467.00 |
| **Total** | | | **3554.7M** | **$7335.31** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 4,133 | 2361.7M | $4442.59 |
| -Users-manibari-code | 1,603 | 622.8M | $1380.37 |
| -Users-manibari-code-3DGS | 641 | 209.4M | $525.84 |
| -Users-manibari-Vault-Peter-Work | 954 | 106.0M | $276.17 |
| -Users-manibari-Vault-Peter | 482 | 114.4M | $269.43 |
| -Users-manibari-code-PTI-ARES | 379 | 72.2M | $180.68 |
| -Users-manibari-code-news-stock | 87 | 34.2M | $119.44 |
| -Users-manibari-code-sales-assistant | 258 | 15.4M | $64.01 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-rivendell | 116 | 5.7M | $33.81 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-10 — 94 skills, 35 issue(s)*
