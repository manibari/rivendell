...
**backend/**
- audio-transcription-flow — 1 次, 59天前
- db-migration — 1 次, 85天前
- doc-to-structured-data — 1 次, 71天前
- docker-compose-setup — 2 次, 49天前
- firebase-backend — 3 次, 28天前
- imap-smtp-integration — 1 次, 73天前
- markdown-file-ssot — 1 次, 73天前
- oauth-token-vault — 1 次, 73天前
- rbac-permissions — 1 次, 59天前
- sqlite-to-postgres — 2 次, 28天前
- tunnel-proxy-deploy — 1 次, 82天前
- tw-company-lookup — 2 次, 81天前
- vector-search-setup — 1 次, 67天前

**docs/**
- chart-design — 1 次, 18天前
- discovery-interview — 1 次, 59天前
- doc-coauthoring — 2 次, 28天前
- excalidraw-diagram — 2 次, 20天前
- gdoc-report-builder — 2 次, 28天前
- internal-comms — 2 次, 28天前
- iot-factory-report — 2 次, 28天前
- mcp-builder — 3 次, 87天前
- mermaid-diagram — 1 次, 21天前
- metadata-workshop — 2 次, 28天前
- office-docx — 4 次, 58天前
- office-pdf — 3 次, 87天前
- office-pptx — 3 次, 87天前
- office-xlsx — 3 次, 87天前
- pitch-deck — 3 次, 28天前
- rfq-writer — 1 次, 58天前
- slide-office-hours — 2 次, 28天前
- slide-template-extractor — 2 次, 28天前
- slide-workflow — 4 次, 28天前
- sow-writer — 2 次, 28天前
- telegram-bot — 1 次, 82天前

**frontend/**
- frontend-design — 2 次, 88天前
- ios-integration — 1 次, 89天前
- swiftui-patterns — 1 次, 89天前
- ui-ux-pro-max — 3 次, 87天前

**git/**
- auto-stage — 3 次, 28天前
- repo-rename — 1 次, 71天前

**meta/**
- agent-persona — 1 次, 53天前
- audit-fix — 1 次, 85天前
- ci-pipeline — 1 次, 85天前
- deploy — 1 次, 85天前
- dev-process-gate — 4 次, 59天前
- init-project — 2 次, 88天前
- knowledge-graph — 1 次, 82天前
- learnings-promotion-sprint — 1 次, 21天前
- plan-check-style — 3 次, 85天前
- self-improving-agent — 3 次, 20天前
- session-harvest — 3 次, 28天前
- session-wrap — 1 次, 52天前
- setup-permissions — 3 次, 85天前
- skill-creator — 4 次, 49天前
- skill-scout — 2 次, 37天前
- sync-readme — 1 次, 66天前
- workflow-retro — 2 次, 28天前

**quality/**
- de-slopify — 2 次, 49天前
- github-repo-audit — 1 次, 53天前
- large-file-refactor — 1 次, 67天前
- protect-secrets — 3 次, 28天前
- qa-auto — 1 次, 82天前
- qa-planner — 1 次, 82天前
- qa-testing — 1 次, 87天前

**workflow/**
- agent-observability — 2 次, 59天前
- autoresearch — 2 次, 28天前
- candidate-analysis — 1 次, 71天前
- claude-to-telegram — 1 次, 82天前
- client-kickoff-docs — 1 次, 44天前
- context-recovery — 1 次, 82天前
- crm-projection — 1 次, 81天前
- customer-intel — 5 次, 28天前
- dispatching-parallel-agents — 4 次, 49天前
- env-doctor — 1 次, 44天前
- executing-plans — 3 次, 87天前
- gdrive-to-skills — 2 次, 88天前
- headless-agent — 6 次, 73天前
- investment-research — 4 次, 28天前
- jd-writer — 1 次, 53天前
- keyword-discovery — 1 次, 73天前
- launchd-agent — 6 次, 28天前
- material-health — 1 次, 81天前
- mockup — 1 次, 89天前
- mops-financial-scraper — 1 次, 44天前
- planning-with-files — 5 次, 59天前
- presales-pipeline — 1 次, 44天前
- repro-exam — 1 次, 44天前
- requirement — 2 次, 59天前
- sales-material — 3 次, 45天前
- settings-audit — 1 次, 72天前
- subsidy-scraper — 1 次, 81天前
- tender-scraper — 3 次, 73天前
- user-flow — 2 次, 21天前
- writing-plans — 3 次, 87天前
...
xychart-beta
    ...
    y-axis "USD" 0 --> 2750
    bar [1693, 50, 1549, 2049, 2693, 2297, 365]
~~~
...
| 2026-06-05 (Fri) | 4 | 569 | 179.9M | $365.12 |
| **Total** | | | **4535.1M** | **$10696.10** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 3,991 | 2197.1M | $4503.07 |
| -Users-manibari-code | 3,355 | 1423.7M | $3573.17 |
| -Users-manibari-Vault-Peter | 1,677 | 468.6M | $1099.96 |
| -Users-manibari-code-rivendell | 297 | 118.1M | $546.65 |
| -Users-manibari-code-news-stock | 468 | 102.4M | $365.11 |
| -Users-manibari-Vault-Peter-Work | 481 | 129.6M | $329.62 |
| -Users-manibari-code-PTI-ARES | 379 | 72.2M | $180.68 |
| -Users-manibari-code-sales-assistant | 314 | 19.9M | $78.96 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-odb-dfm | 12 | 2.4M | $14.66 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-05 — 94 skills, 22 issue(s)*
