...
**backend/**
- db-migration — 1 次, 93天前 (2026-03-12)

**docs/**
- mcp-builder — 3 次, 95天前 (2026-03-10)
- office-pdf — 3 次, 95天前 (2026-03-10)
- office-pptx — 3 次, 95天前 (2026-03-10)
- office-xlsx — 3 次, 95天前 (2026-03-10)

**frontend/**
- frontend-design — 2 次, 96天前 (2026-03-09)
- ios-integration — 1 次, 97天前 (2026-03-08)
- swiftui-patterns — 1 次, 97天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 95天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 93天前 (2026-03-12)
- ci-pipeline — 1 次, 93天前 (2026-03-12)
- deploy — 1 次, 93天前 (2026-03-12)
- init-project — 2 次, 96天前 (2026-03-09)
- plan-check-style — 3 次, 93天前 (2026-03-12)
- setup-permissions — 3 次, 93天前 (2026-03-12)

**quality/**
- qa-testing — 1 次, 95天前 (2026-03-10)

**workflow/**
- executing-plans — 3 次, 95天前 (2026-03-10)
- gdrive-to-skills — 2 次, 96天前 (2026-03-09)
- mockup — 1 次, 97天前 (2026-03-08)
- writing-plans — 3 次, 95天前 (2026-03-10)

<details><summary>✅ 穩定 (76)</summary>

**backend/**
- audio-transcription-flow — 1 次, 67天前
- doc-to-structured-data — 1 次, 79天前
- docker-compose-setup — 2 次, 57天前
- firebase-backend — 3 次, 36天前
- imap-smtp-integration — 1 次, 81天前
- markdown-file-ssot — 1 次, 81天前
- oauth-token-vault — 1 次, 81天前
- rbac-permissions — 1 次, 67天前
- sqlite-to-postgres — 2 次, 36天前
- tunnel-proxy-deploy — 1 次, 90天前
- tw-company-lookup — 2 次, 89天前
- vector-search-setup — 1 次, 75天前

**docs/**
- chart-design — 1 次, 26天前
- discovery-interview — 1 次, 67天前
- doc-coauthoring — 2 次, 36天前
- excalidraw-diagram — 2 次, 28天前
- gdoc-report-builder — 2 次, 36天前
- internal-comms — 2 次, 36天前
- iot-factory-report — 2 次, 36天前
- mermaid-diagram — 1 次, 29天前
- metadata-workshop — 2 次, 36天前
- office-docx — 4 次, 66天前
- pitch-deck — 3 次, 36天前
- rfq-writer — 1 次, 66天前
- slide-office-hours — 2 次, 36天前
- slide-template-extractor — 2 次, 36天前
- slide-workflow — 4 次, 36天前
- sow-writer — 2 次, 36天前
- telegram-bot — 1 次, 90天前

**frontend/**
- chimesflow-design — 1 次, 2天前

**git/**
- auto-stage — 3 次, 36天前
- repo-rename — 1 次, 79天前

**meta/**
- agent-persona — 1 次, 61天前
- dev-process-gate — 4 次, 67天前
- knowledge-graph — 1 次, 90天前
- learnings-promotion-sprint — 1 次, 29天前
- self-improving-agent — 3 次, 28天前
- session-harvest — 3 次, 36天前
- session-wrap — 1 次, 60天前
- skill-creator — 4 次, 57天前
- skill-scout — 2 次, 45天前
- sync-readme — 1 次, 74天前
- workflow-retro — 2 次, 36天前

**quality/**
- de-slopify — 2 次, 57天前
- github-repo-audit — 1 次, 61天前
- large-file-refactor — 1 次, 75天前
- protect-secrets — 3 次, 36天前
- qa-auto — 1 次, 90天前
- qa-planner — 1 次, 90天前

**workflow/**
- agent-observability — 2 次, 67天前
- app-ops-baseline — 1 次, 2天前
- autoresearch — 2 次, 36天前
- candidate-analysis — 1 次, 79天前
- claude-to-telegram — 1 次, 90天前
- client-kickoff-docs — 1 次, 52天前
- context-recovery — 1 次, 90天前
- crm-projection — 1 次, 89天前
- customer-intel — 5 次, 36天前
- dispatching-parallel-agents — 4 次, 57天前
- env-doctor — 1 次, 52天前
- headless-agent — 6 次, 81天前
- investment-research — 4 次, 36天前
- jd-writer — 1 次, 61天前
- keyword-discovery — 1 次, 81天前
- launchd-agent — 6 次, 36天前
- material-health — 1 次, 89天前
- mops-financial-scraper — 1 次, 52天前
- planning-with-files — 5 次, 67天前
- presales-pipeline — 1 次, 52天前
- repro-exam — 1 次, 52天前
- requirement — 2 次, 67天前
- sales-material — 3 次, 53天前
- settings-audit — 1 次, 80天前
- subsidy-scraper — 1 次, 89天前
- tender-scraper — 3 次, 81天前
- user-flow — 2 次, 29天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 128 個 commit（本週）, 355 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `fix/poc-skip-steps` (3 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
cbfcacb fix(opps): gate alert reflects P4-skip (show P5 gate, not P4)
c7af24d fix(opps): wrap detail-header actions so title doesn't collapse vertical
6c5afbf chore(release): ship v1.22.2 — 今日計畫互動優化
dbda3b5 refactor(nav): move 週工作日誌 out of 交付 to top-level (personal log)
0983430 feat(today): plan-type toggle, auto-link opportunity, no weekend reminder
```
</details>
...
```
a004382 feat: refine PL contract ledger workflow
6618794 feat: add PL contract ledger rollup
f7e0b93 chore: migrate dev ports to 8020/3020 and fix launchd auto-start
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-07", "06-08", "06-09", "06-10", "06-11", "06-12", "06-13"]
    y-axis "USD" 0 --> 3000
    bar [448, 1213, 2528, 1774, 1301, 2932, 1899]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-07 (Sun) | 6 | 1,042 | 198.0M | $448.46 |
| 2026-06-08 (Mon) | 9 | 1,340 | 590.1M | $1212.84 |
...
| 2026-06-13 (Sat) | 8 | 2,475 | 975.6M | $1898.78 |
| **Total** | | | **5841.2M** | **$12094.18** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 5,705 | 3188.5M | $5981.77 |
| -Users-manibari-code | 2,435 | 980.9M | $2281.44 |
| -Users-manibari-code-tukey-automl | 2,421 | 1052.3M | $2055.48 |
| -Users-manibari-code-vantage-3dgs | 699 | 229.4M | $620.55 |
| -Users-manibari-Vault-Peter-Work | 1,281 | 210.1M | $572.48 |
| -Users-manibari-code-rivendell | 510 | 81.4M | $249.90 |
| -Users-manibari-code-tukey-bi | 366 | 51.0M | $154.58 |
| -Users-manibari-code-sales-assistant | 231 | 13.0M | $56.52 |
| -Users-manibari-Vault-Peter | 116 | 8.0M | $41.26 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-automl-platform | 110 | 8.8M | $27.97 |
| -Users-manibari-code-resume-pool | 145 | 8.1M | $24.08 |
| -Users-manibari-code-Family-Fiscal | 121 | 7.5M | $17.94 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-13 — 96 skills, 34 issue(s)*
