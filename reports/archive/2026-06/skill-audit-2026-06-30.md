...
**backend/**
- backend-async-jobs — 2 次修訂, 13天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 14天前
- env-doctor — 3 次修訂, 14天前
- mops-financial-scraper — 3 次修訂, 14天前
- presales-pipeline — 3 次修訂, 14天前
- repro-exam — 3 次修訂, 14天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 110天前 (2026-03-12)
- doc-to-structured-data — 1 次, 96天前 (2026-03-26)
- imap-smtp-integration — 1 次, 98天前 (2026-03-24)
- markdown-file-ssot — 1 次, 98天前 (2026-03-24)
- oauth-token-vault — 1 次, 98天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 107天前 (2026-03-15)
- tw-company-lookup — 2 次, 106天前 (2026-03-16)
- vector-search-setup — 1 次, 92天前 (2026-03-30)

**docs/**
- mcp-builder — 3 次, 112天前 (2026-03-10)
- office-pdf — 3 次, 112天前 (2026-03-10)
- office-pptx — 3 次, 112天前 (2026-03-10)
- office-xlsx — 3 次, 112天前 (2026-03-10)
- telegram-bot — 1 次, 107天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 113天前 (2026-03-09)
- ios-integration — 1 次, 114天前 (2026-03-08)
- swiftui-patterns — 1 次, 114天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 112天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 96天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 110天前 (2026-03-12)
- ci-pipeline — 1 次, 110天前 (2026-03-12)
- deploy — 1 次, 110天前 (2026-03-12)
- init-project — 2 次, 113天前 (2026-03-09)
- knowledge-graph — 1 次, 107天前 (2026-03-15)
- plan-check-style — 3 次, 110天前 (2026-03-12)
- setup-permissions — 3 次, 110天前 (2026-03-12)
- sync-readme — 1 次, 91天前 (2026-03-31)

**quality/**
- large-file-refactor — 1 次, 92天前 (2026-03-30)
- qa-auto — 1 次, 107天前 (2026-03-15)
- qa-planner — 1 次, 107天前 (2026-03-15)
- qa-testing — 1 次, 112天前 (2026-03-10)

**workflow/**
- candidate-analysis — 1 次, 96天前 (2026-03-26)
- claude-to-telegram — 1 次, 107天前 (2026-03-15)
- context-recovery — 1 次, 107天前 (2026-03-15)
- crm-projection — 1 次, 106天前 (2026-03-16)
- executing-plans — 3 次, 112天前 (2026-03-10)
- gdrive-to-skills — 2 次, 113天前 (2026-03-09)
- headless-agent — 6 次, 98天前 (2026-03-24)
- keyword-discovery — 1 次, 98天前 (2026-03-24)
- material-health — 1 次, 106天前 (2026-03-16)
- mockup — 1 次, 114天前 (2026-03-08)
- settings-audit — 1 次, 97天前 (2026-03-25)
- subsidy-scraper — 1 次, 106天前 (2026-03-16)
- tender-scraper — 3 次, 98天前 (2026-03-24)
- writing-plans — 3 次, 112天前 (2026-03-10)

<details><summary>✅ 穩定 (58)</summary>

**backend/**
- ai-vision-extract — 1 次, 1天前
- audio-transcription-flow — 1 次, 84天前
- docker-compose-setup — 2 次, 74天前
- firebase-backend — 3 次, 53天前
- ic-lot-normalization — 1 次, 6天前
- ml-eval-quality — 1 次, 6天前
- ml-model-registry — 1 次, 6天前
- odb-dfm-reference — 1 次, 6天前
- rbac-permissions — 1 次, 84天前
- spine-auth — 1 次, 2天前
- spine-rbac — 1 次, 2天前
- spine-schema-sync — 1 次, 2天前
- spine-versioning — 1 次, 1天前
- sqlite-to-postgres — 2 次, 53天前

**docs/**
- chart-design — 1 次, 43天前
- discovery-interview — 1 次, 84天前
- doc-coauthoring — 2 次, 53天前
- excalidraw-diagram — 2 次, 45天前
- gdoc-report-builder — 2 次, 53天前
- internal-comms — 2 次, 53天前
- iot-factory-report — 2 次, 53天前
- mermaid-diagram — 1 次, 46天前
- metadata-workshop — 2 次, 53天前
- office-docx — 4 次, 83天前
- pitch-deck — 3 次, 53天前
- rfq-writer — 1 次, 83天前
- slide-office-hours — 2 次, 53天前
- slide-template-extractor — 2 次, 53天前
- slide-workflow — 4 次, 53天前
- sow-writer — 2 次, 53天前

**frontend/**
- chimesflow-design — 1 次, 19天前

**git/**
- auto-stage — 3 次, 53天前
- concurrent-session-git — 1 次, 13天前

**meta/**
- agent-persona — 1 次, 78天前
- dev-process-gate — 4 次, 84天前
- learnings-promotion-sprint — 1 次, 46天前
- self-improving-agent — 3 次, 45天前
- session-harvest — 3 次, 53天前
- session-wrap — 1 次, 77天前
- skill-creator — 4 次, 74天前
- skill-scout — 2 次, 62天前
- task-brief — 1 次, 14天前
- workflow-retro — 2 次, 53天前

**quality/**
- de-slopify — 2 次, 74天前
- github-repo-audit — 1 次, 78天前
- protect-secrets — 3 次, 53天前

**workflow/**
- agent-observability — 2 次, 84天前
- app-ops-baseline — 1 次, 19天前
- autoresearch — 2 次, 53天前
- customer-intel — 5 次, 53天前
- dispatching-parallel-agents — 4 次, 74天前
- investment-research — 4 次, 53天前
- jd-writer — 1 次, 78天前
- launchd-agent — 6 次, 53天前
- planning-with-files — 5 次, 84天前
- requirement — 2 次, 84天前
- sales-material — 3 次, 70天前
- user-flow — 2 次, 46天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 2 個 commit（本週）, 92 個（本月） |
| **技術棧** |  Node.js Python |
| **分支** | `next-wave-2026-05` (5 total) | 1 個 open PR |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
| **Config** | **missing** | **權限** | OK (10 rules) |

<details><summary>近期 commits</summary>

```
27562af docs(plan): data-architecture convergence plan (Postgres-centered IR + Arrow geometry pack)
9a73a91 fix(console): reactive ?status= tab switching on projects page
fd7a481 docs(progress): session 2026-06-17→21 — console build, engine correctness, report
d9e3e75 style(report)+test: enlarge/center PPTX text; seed count 90→89
552562e style(report): larger centered slide text (字太小+致中)
```
</details>
...
502b3b7 chore: 移除 host-specific 硬編碼路徑，支援跨機器執行
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 187 個 commit（本週）, 187 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 84 個 commit（本週）, 103 個（本月） |
| **技術棧** |  Make |
| **分支** | `feat/monorepo` (2 total) | 1 個 open PR |
| **Git** | 2 dirty, 56 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
3fc2e4b feat(api): /api/meta 自描述 metadata（下游能吃的資料字典）
d9b32fd feat(4b): mops_bs/cf cutover 採用 packages/facts（三表全完成，demo 零漂移）
78d452c feat(4b): mops_pl cutover 採用 packages/facts + 修 framework 類名 bug
fe43ead test(4b): 等價演練 — framework fact_to_rows == 手寫 writer（demo 證 cutover 安全）
cf9968a chore(infra): 底層重構安全網 — make test 修復 + 孤兒 framework 標注 + 依賴規矩
```
</details>
...
xychart-beta
    ...
    y-axis "USD" 0 --> 3800
    bar [3089, 2389, 1973, 3712, 2519, 2908, 1044]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-24 (Wed) | 12 | 3,037 | 1398.1M | $3088.75 |
| 2026-06-25 (Thu) | 11 | 1,815 | 1166.1M | $2389.32 |
| 2026-06-26 (Fri) | 12 | 2,463 | 873.4M | $1972.68 |
| 2026-06-27 (Sat) | 9 | 2,943 | 1707.9M | $3711.74 |
| 2026-06-28 (Sun) | 11 | 2,386 | 1172.1M | $2519.41 |
| 2026-06-29 (Mon) | 17 | 2,484 | 1213.0M | $2907.79 |
| 2026-06-30 (Tue) | 10 | 788 | 371.3M | $1043.80 |
| **Total** | | | **7901.8M** | **$17633.49** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Vault-Peter-Family | 4,968 | 3004.5M | $5912.70 |
| -Users-manibari-code-ChimesFlow | 2,836 | 1559.1M | $3296.69 |
| -Users-manibari-code-mops-dbs | 2,385 | 1390.5M | $3105.04 |
| -Users-manibari-code-tukey-automl | 1,486 | 764.5M | $1713.26 |
| -Users-manibari-code-rivendell | 924 | 408.4M | $1417.13 |
| -Users-manibari-code-IC-YMS | 882 | 339.6M | $930.61 |
| -Users-manibari-code-tukey-bi | 516 | 172.7M | $460.50 |
| -Users-manibari-Vault-Peter-Work | 864 | 118.7M | $315.83 |
| -Users-manibari-code-TWstock-invest | 398 | 78.8M | $228.45 |
| -Users-manibari-code-PTI-ARES | 233 | 31.5M | $112.56 |
| -Users-manibari-code-sales-assistant | 258 | 16.2M | $65.88 |
| -Users-manibari-code | 73 | 10.6M | $48.88 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-tukey-or | 62 | 5.2M | $20.45 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-30 — 108 skills, 65 issue(s)*
