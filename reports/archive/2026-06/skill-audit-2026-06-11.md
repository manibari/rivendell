...
**backend/**
- db-migration — 1 次, 91天前 (2026-03-12)

**docs/**
- mcp-builder — 3 次, 93天前 (2026-03-10)
- office-pdf — 3 次, 93天前 (2026-03-10)
- office-pptx — 3 次, 93天前 (2026-03-10)
- office-xlsx — 3 次, 93天前 (2026-03-10)

**frontend/**
- frontend-design — 2 次, 94天前 (2026-03-09)
- ios-integration — 1 次, 95天前 (2026-03-08)
- swiftui-patterns — 1 次, 95天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 93天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 91天前 (2026-03-12)
- ci-pipeline — 1 次, 91天前 (2026-03-12)
- deploy — 1 次, 91天前 (2026-03-12)
- init-project — 2 次, 94天前 (2026-03-09)
- plan-check-style — 3 次, 91天前 (2026-03-12)
- setup-permissions — 3 次, 91天前 (2026-03-12)

**quality/**
- qa-testing — 1 次, 93天前 (2026-03-10)

**workflow/**
- executing-plans — 3 次, 93天前 (2026-03-10)
- gdrive-to-skills — 2 次, 94天前 (2026-03-09)
- mockup — 1 次, 95天前 (2026-03-08)
- writing-plans — 3 次, 93天前 (2026-03-10)

<details><summary>✅ 穩定 (76)</summary>

**backend/**
- audio-transcription-flow — 1 次, 65天前
- doc-to-structured-data — 1 次, 77天前
- docker-compose-setup — 2 次, 55天前
- firebase-backend — 3 次, 34天前
- imap-smtp-integration — 1 次, 79天前
- markdown-file-ssot — 1 次, 79天前
- oauth-token-vault — 1 次, 79天前
- rbac-permissions — 1 次, 65天前
- sqlite-to-postgres — 2 次, 34天前
- tunnel-proxy-deploy — 1 次, 88天前
- tw-company-lookup — 2 次, 87天前
- vector-search-setup — 1 次, 73天前

**docs/**
- chart-design — 1 次, 24天前
- discovery-interview — 1 次, 65天前
- doc-coauthoring — 2 次, 34天前
- excalidraw-diagram — 2 次, 26天前
- gdoc-report-builder — 2 次, 34天前
- internal-comms — 2 次, 34天前
- iot-factory-report — 2 次, 34天前
- mermaid-diagram — 1 次, 27天前
- metadata-workshop — 2 次, 34天前
- office-docx — 4 次, 64天前
- pitch-deck — 3 次, 34天前
- rfq-writer — 1 次, 64天前
- slide-office-hours — 2 次, 34天前
- slide-template-extractor — 2 次, 34天前
- slide-workflow — 4 次, 34天前
- sow-writer — 2 次, 34天前
- telegram-bot — 1 次, 88天前

**frontend/**
- chimesflow-design — 1 次, 0天前

**git/**
- auto-stage — 3 次, 34天前
- repo-rename — 1 次, 77天前

**meta/**
- agent-persona — 1 次, 59天前
- dev-process-gate — 4 次, 65天前
- knowledge-graph — 1 次, 88天前
- learnings-promotion-sprint — 1 次, 27天前
- self-improving-agent — 3 次, 26天前
- session-harvest — 3 次, 34天前
- session-wrap — 1 次, 58天前
- skill-creator — 4 次, 55天前
- skill-scout — 2 次, 43天前
- sync-readme — 1 次, 72天前
- workflow-retro — 2 次, 34天前

**quality/**
- de-slopify — 2 次, 55天前
- github-repo-audit — 1 次, 59天前
- large-file-refactor — 1 次, 73天前
- protect-secrets — 3 次, 34天前
- qa-auto — 1 次, 88天前
- qa-planner — 1 次, 88天前

**workflow/**
- agent-observability — 2 次, 65天前
- app-ops-baseline — 1 次, 0天前
- autoresearch — 2 次, 34天前
- candidate-analysis — 1 次, 77天前
- claude-to-telegram — 1 次, 88天前
- client-kickoff-docs — 1 次, 50天前
- context-recovery — 1 次, 88天前
- crm-projection — 1 次, 87天前
- customer-intel — 5 次, 34天前
- dispatching-parallel-agents — 4 次, 55天前
- env-doctor — 1 次, 50天前
- headless-agent — 6 次, 79天前
- investment-research — 4 次, 34天前
- jd-writer — 1 次, 59天前
- keyword-discovery — 1 次, 79天前
- launchd-agent — 6 次, 34天前
- material-health — 1 次, 87天前
- mops-financial-scraper — 1 次, 50天前
- planning-with-files — 5 次, 65天前
- presales-pipeline — 1 次, 50天前
- repro-exam — 1 次, 50天前
- requirement — 2 次, 65天前
- sales-material — 3 次, 51天前
- settings-audit — 1 次, 78天前
- subsidy-scraper — 1 次, 87天前
- tender-scraper — 3 次, 79天前
- user-flow — 2 次, 27天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 108 個 commit（本週）, 345 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (3 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
e082919 feat(today): role-based daily plan module (sales touchpoints / RD work-log)
b1ff714 fix(targets): assign-target 年度 saves period_type=annual (was 'yearly')
b4d81fd feat(targets): person picker on 個人目標 tab so managers can view anyone
3b6b27b docs(learnings): reinforce alembic revision-id ≤32 chars rule
c74db17 fix(migrations): shorten v1.19.4 revision id (>32 chars)
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 6 個 commit（本週）, 73 個（本月） |
| **技術棧** |  Python |
| **分支** | `next-wave-2026-05` (5 total) | 1 個 open PR |
| **Git** | 2 dirty, 28 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
f0299b1 fix(viewers): layer viewer degrades gracefully on missing layer / unregistered DWG
c696a2e docs(security): v0.5.1 scan refresh + multi-scanner; pin pillow>=12.2.0; IT report PDF
```
</details>
...
xychart-beta
    ...
    y-axis "USD" 0 --> 2600
    bar [376, 7, 448, 1213, 2528, 1774, 879]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-05 (Fri) | 6 | 612 | 182.1M | $375.60 |
...
| 2026-06-11 (Thu) | 11 | 846 | 292.9M | $879.15 |
| **Total** | | | **3524.7M** | **$7224.18** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 4,816 | 2706.4M | $4997.92 |
| -Users-manibari-code | 1,045 | 295.0M | $763.03 |
| -Users-manibari-code-3DGS | 672 | 228.1M | $616.04 |
| -Users-manibari-Vault-Peter-Work | 1,123 | 134.3M | $375.69 |
| -Users-manibari-code-tukey-automl | 529 | 124.3M | $313.39 |
| -Users-manibari-code-sales-assistant | 250 | 14.2M | $59.34 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-rivendell | 124 | 6.1M | $37.96 |
| -Users-manibari-code-automl-platform | 110 | 8.8M | $27.97 |
| -Users-manibari-Vault-Peter | 48 | 3.4M | $17.84 |
| -Users-manibari-code-tukey-bi | 76 | 4.2M | $15.00 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-11 — 96 skills, 45 issue(s)*
