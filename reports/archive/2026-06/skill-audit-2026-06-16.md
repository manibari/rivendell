...
**workflow/**
- client-kickoff-docs — 2 次修訂, 0天前
- env-doctor — 3 次修訂, 0天前
- mops-financial-scraper — 3 次修訂, 0天前
- presales-pipeline — 3 次修訂, 0天前
- repro-exam — 3 次修訂, 0天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 96天前 (2026-03-12)
- tunnel-proxy-deploy — 1 次, 93天前 (2026-03-15)
- tw-company-lookup — 2 次, 92天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 98天前 (2026-03-10)
- office-pdf — 3 次, 98天前 (2026-03-10)
- office-pptx — 3 次, 98天前 (2026-03-10)
- office-xlsx — 3 次, 98天前 (2026-03-10)
- telegram-bot — 1 次, 93天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 99天前 (2026-03-09)
- ios-integration — 1 次, 100天前 (2026-03-08)
- swiftui-patterns — 1 次, 100天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 98天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 96天前 (2026-03-12)
- ci-pipeline — 1 次, 96天前 (2026-03-12)
- deploy — 1 次, 96天前 (2026-03-12)
- init-project — 2 次, 99天前 (2026-03-09)
- knowledge-graph — 1 次, 93天前 (2026-03-15)
- plan-check-style — 3 次, 96天前 (2026-03-12)
- setup-permissions — 3 次, 96天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 93天前 (2026-03-15)
- qa-planner — 1 次, 93天前 (2026-03-15)
- qa-testing — 1 次, 98天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 93天前 (2026-03-15)
- context-recovery — 1 次, 93天前 (2026-03-15)
- crm-projection — 1 次, 92天前 (2026-03-16)
- executing-plans — 3 次, 98天前 (2026-03-10)
- gdrive-to-skills — 2 次, 99天前 (2026-03-09)
- material-health — 1 次, 92天前 (2026-03-16)
- mockup — 1 次, 100天前 (2026-03-08)
- subsidy-scraper — 1 次, 92天前 (2026-03-16)
- writing-plans — 3 次, 98天前 (2026-03-10)

<details><summary>✅ 穩定 (61)</summary>

**backend/**
- audio-transcription-flow — 1 次, 70天前
- doc-to-structured-data — 1 次, 82天前
- docker-compose-setup — 2 次, 60天前
- firebase-backend — 3 次, 39天前
- imap-smtp-integration — 1 次, 84天前
- markdown-file-ssot — 1 次, 84天前
- oauth-token-vault — 1 次, 84天前
- rbac-permissions — 1 次, 70天前
- sqlite-to-postgres — 2 次, 39天前
- vector-search-setup — 1 次, 78天前

**docs/**
- chart-design — 1 次, 29天前
- discovery-interview — 1 次, 70天前
- doc-coauthoring — 2 次, 39天前
- excalidraw-diagram — 2 次, 31天前
- gdoc-report-builder — 2 次, 39天前
- internal-comms — 2 次, 39天前
- iot-factory-report — 2 次, 39天前
- mermaid-diagram — 1 次, 32天前
- metadata-workshop — 2 次, 39天前
- office-docx — 4 次, 69天前
- pitch-deck — 3 次, 39天前
- rfq-writer — 1 次, 69天前
- slide-office-hours — 2 次, 39天前
- slide-template-extractor — 2 次, 39天前
- slide-workflow — 4 次, 39天前
- sow-writer — 2 次, 39天前

**frontend/**
- chimesflow-design — 1 次, 5天前

**git/**
- auto-stage — 3 次, 39天前
- repo-rename — 1 次, 82天前

**meta/**
- agent-persona — 1 次, 64天前
- dev-process-gate — 4 次, 70天前
- learnings-promotion-sprint — 1 次, 32天前
- self-improving-agent — 3 次, 31天前
- session-harvest — 3 次, 39天前
- session-wrap — 1 次, 63天前
- skill-creator — 4 次, 60天前
- skill-scout — 2 次, 48天前
- sync-readme — 1 次, 77天前
- task-brief — 1 次, 0天前
- workflow-retro — 2 次, 39天前

**quality/**
- de-slopify — 2 次, 60天前
- github-repo-audit — 1 次, 64天前
- large-file-refactor — 1 次, 78天前
- protect-secrets — 3 次, 39天前

**workflow/**
- agent-observability — 2 次, 70天前
- app-ops-baseline — 1 次, 5天前
- autoresearch — 2 次, 39天前
- candidate-analysis — 1 次, 82天前
- customer-intel — 5 次, 39天前
- dispatching-parallel-agents — 4 次, 60天前
- headless-agent — 6 次, 84天前
- investment-research — 4 次, 39天前
- jd-writer — 1 次, 64天前
- keyword-discovery — 1 次, 84天前
- launchd-agent — 6 次, 39天前
- planning-with-files — 5 次, 70天前
- requirement — 2 次, 70天前
- sales-material — 3 次, 56天前
- settings-audit — 1 次, 83天前
- tender-scraper — 3 次, 84天前
- user-flow — 2 次, 32天前
...
```
b66dcac Merge pull request #29 from Chimes-AI-Projects/feat/poc-apply-from-opp
3d91006 feat(poc): 申請 POC shortcut from an opportunity at P4
56f6d7b Merge pull request #28 from Chimes-AI-Projects/fix/poc-reject-rollback-multi
60b86cb fix(poc): only roll the deal back on reject when no other POC is alive
5303c0f Merge pull request #27 from Chimes-AI-Projects/fix/contract-license-period-default
```
</details>
...
```
1733b8c feat(console): scaffold FastAPI backend + Next.js frontend (shell + ops baseline)
20a9b50 mockup: restyle to ChimesFlow palette/font (drop dark override)
65c2fea docs(progress): 2026-06-09→13 session — multi-board validation + engine hardening + console pivot
3e4d9bf mockup: sidebar groups → collapsible toggles (antd Menu SubMenu / ChimesFlow)
52094b5 mockup: regroup sidebar (作業 / 資料管理) + project step-by-step rail
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-10", "06-11", "06-12", "06-13", "06-14", "06-15", "06-16"]
    y-axis "USD" 0 --> 3000
    bar [1774, 1301, 2932, 2283, 959, 2230, 2598]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-10 (Wed) | 15 | 2,559 | 842.5M | $1773.56 |
...
| 2026-06-16 (Tue) | 7 | 2,028 | 1185.8M | $2597.74 |
| **Total** | | | **6552.3M** | **$14076.04** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-tukey-automl | 4,616 | 2363.0M | $4617.56 |
| -Users-manibari-code | 3,896 | 1793.9M | $4042.63 |
| -Users-manibari-code-ChimesFlow | 3,248 | 1715.7M | $3386.70 |
| -Users-manibari-code-rivendell | 725 | 220.2M | $720.28 |
| -Users-manibari-Vault-Peter-Work | 1,182 | 202.7M | $552.18 |
| -Users-manibari-code-Family-Fiscal | 666 | 148.9M | $350.38 |
| -Users-manibari-code-tukey-bi | 294 | 47.8M | $149.55 |
| -Users-manibari-code-vantage-3dgs | 58 | 20.0M | $94.71 |
| -Users-manibari-code-sales-assistant | 339 | 22.0M | $86.50 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-16 — 97 skills, 48 issue(s)*
