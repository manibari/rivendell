...
**docs/**
- mcp-builder — 3 次, 91天前 (2026-03-10)
- office-pdf — 3 次, 91天前 (2026-03-10)
- office-pptx — 3 次, 91天前 (2026-03-10)
- office-xlsx — 3 次, 91天前 (2026-03-10)

**frontend/**
- frontend-design — 2 次, 92天前 (2026-03-09)
- ios-integration — 1 次, 93天前 (2026-03-08)
- swiftui-patterns — 1 次, 93天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 91天前 (2026-03-10)

**meta/**
- init-project — 2 次, 92天前 (2026-03-09)

**quality/**
- qa-testing — 1 次, 91天前 (2026-03-10)

**workflow/**
- executing-plans — 3 次, 91天前 (2026-03-10)
- gdrive-to-skills — 2 次, 92天前 (2026-03-09)
- mockup — 1 次, 93天前 (2026-03-08)
- writing-plans — 3 次, 91天前 (2026-03-10)

<details><summary>✅ 穩定 (80)</summary>

**backend/**
- audio-transcription-flow — 1 次, 63天前
- db-migration — 1 次, 89天前
- doc-to-structured-data — 1 次, 75天前
- docker-compose-setup — 2 次, 53天前
- firebase-backend — 3 次, 32天前
- imap-smtp-integration — 1 次, 77天前
- markdown-file-ssot — 1 次, 77天前
- oauth-token-vault — 1 次, 77天前
- rbac-permissions — 1 次, 63天前
- sqlite-to-postgres — 2 次, 32天前
- tunnel-proxy-deploy — 1 次, 86天前
- tw-company-lookup — 2 次, 85天前
- vector-search-setup — 1 次, 71天前

**docs/**
- chart-design — 1 次, 22天前
- discovery-interview — 1 次, 63天前
- doc-coauthoring — 2 次, 32天前
- excalidraw-diagram — 2 次, 24天前
- gdoc-report-builder — 2 次, 32天前
- internal-comms — 2 次, 32天前
- iot-factory-report — 2 次, 32天前
- mermaid-diagram — 1 次, 25天前
- metadata-workshop — 2 次, 32天前
- office-docx — 4 次, 62天前
- pitch-deck — 3 次, 32天前
- rfq-writer — 1 次, 62天前
- slide-office-hours — 2 次, 32天前
- slide-template-extractor — 2 次, 32天前
- slide-workflow — 4 次, 32天前
- sow-writer — 2 次, 32天前
- telegram-bot — 1 次, 86天前

**git/**
- auto-stage — 3 次, 32天前
- repo-rename — 1 次, 75天前

**meta/**
- agent-persona — 1 次, 57天前
- audit-fix — 1 次, 89天前
- ci-pipeline — 1 次, 89天前
- deploy — 1 次, 89天前
- dev-process-gate — 4 次, 63天前
- knowledge-graph — 1 次, 86天前
- learnings-promotion-sprint — 1 次, 25天前
- plan-check-style — 3 次, 89天前
- self-improving-agent — 3 次, 24天前
- session-harvest — 3 次, 32天前
- session-wrap — 1 次, 56天前
- setup-permissions — 3 次, 89天前
- skill-creator — 4 次, 53天前
- skill-scout — 2 次, 41天前
- sync-readme — 1 次, 70天前
- workflow-retro — 2 次, 32天前

**quality/**
- de-slopify — 2 次, 53天前
- github-repo-audit — 1 次, 57天前
- large-file-refactor — 1 次, 71天前
- protect-secrets — 3 次, 32天前
- qa-auto — 1 次, 86天前
- qa-planner — 1 次, 86天前

**workflow/**
- agent-observability — 2 次, 63天前
- autoresearch — 2 次, 32天前
- candidate-analysis — 1 次, 75天前
- claude-to-telegram — 1 次, 86天前
- client-kickoff-docs — 1 次, 48天前
- context-recovery — 1 次, 86天前
- crm-projection — 1 次, 85天前
- customer-intel — 5 次, 32天前
- dispatching-parallel-agents — 4 次, 53天前
- env-doctor — 1 次, 48天前
- headless-agent — 6 次, 77天前
- investment-research — 4 次, 32天前
- jd-writer — 1 次, 57天前
- keyword-discovery — 1 次, 77天前
- launchd-agent — 6 次, 32天前
- material-health — 1 次, 85天前
- mops-financial-scraper — 1 次, 48天前
- planning-with-files — 5 次, 63天前
- presales-pipeline — 1 次, 48天前
- repro-exam — 1 次, 48天前
- requirement — 2 次, 63天前
- sales-material — 3 次, 49天前
- settings-audit — 1 次, 76天前
- subsidy-scraper — 1 次, 85天前
- tender-scraper — 3 次, 77天前
- user-flow — 2 次, 25天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 110 個 commit（本週）, 311 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
9f002fc feat(accounts): store 代表人; MOPS enrich now saves it; doc party_b_rep autofill
317c457 feat(documents): auto-fill scope/amount/payment/warranty from the quote
b0b3a06 feat(notifications): in-app notification bell + event wiring
483e1c2 feat(poc): POC workflow UI — submit / review-assign / RD workload
ba72576 feat(poc): POC request workflow backend (bind opp → review/assign → workload)
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 24 個 commit（本週）, 69 個（本月） |
| **技術棧** |  Python |
| **分支** | `next-wave-2026-05` (5 total) |
| **Git** | 2 dirty, 24 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
4ef70fd fix(viewers): board name in layer/dwg title was hardcoded "PB0009" (US-1 leftover)
7e28cbe docs: reserve rule tier (D-A9/D-17) + multi-party RBAC vision (D-16)
1f65ed8 docs(rules): ground Normal/Advanced tier in real V3 spacing-table data
deb0df4 docs: sync STATUS/progress/README to v0.5.1 + reserve normal/advanced rule tier
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-03", "06-04", "06-05", "06-06", "06-07", "06-08", "06-09"]
    y-axis "USD" 0 --> 2750
    bar [2693, 2297, 376, 7, 448, 1213, 2073]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-03 (Wed) | 13 | 2,927 | 1236.3M | $2693.45 |
| 2026-06-04 (Thu) | 13 | 2,530 | 986.5M | $2296.83 |
...
| 2026-06-09 (Tue) | 5 | 1,944 | 1187.9M | $2072.83 |
| **Total** | | | **4382.8M** | **$9106.63** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 4,003 | 2201.0M | $4137.75 |
| -Users-manibari-code | 3,005 | 1344.0M | $2781.95 |
| -Users-manibari-Vault-Peter | 1,254 | 412.0M | $936.20 |
| -Users-manibari-code-3DGS | 641 | 209.4M | $525.84 |
| -Users-manibari-code-news-stock | 156 | 57.0M | $209.30 |
| -Users-manibari-code-PTI-ARES | 379 | 72.2M | $180.68 |
| -Users-manibari-code-rivendell | 137 | 20.5M | $128.37 |
| -Users-manibari-Vault-Peter-Work | 377 | 36.8M | $94.67 |
| -Users-manibari-code-sales-assistant | 267 | 15.8M | $64.68 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-automl-platform | 110 | 8.8M | $27.97 |
| -Users-manibari-code-tukey-bi | 76 | 4.2M | $15.00 |
| -Users-manibari-Downloads | 25 | 1.1M | $4.22 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-09 — 94 skills, 35 issue(s)*
