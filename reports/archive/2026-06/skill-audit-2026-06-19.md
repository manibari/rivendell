...
**backend/**
- backend-async-jobs — 2 次修訂, 2天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 3天前
- env-doctor — 3 次修訂, 3天前
- mops-financial-scraper — 3 次修訂, 3天前
- presales-pipeline — 3 次修訂, 3天前
- repro-exam — 3 次修訂, 3天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 99天前 (2026-03-12)
- tunnel-proxy-deploy — 1 次, 96天前 (2026-03-15)
- tw-company-lookup — 2 次, 95天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 101天前 (2026-03-10)
- office-pdf — 3 次, 101天前 (2026-03-10)
- office-pptx — 3 次, 101天前 (2026-03-10)
- office-xlsx — 3 次, 101天前 (2026-03-10)
- telegram-bot — 1 次, 96天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 102天前 (2026-03-09)
- ios-integration — 1 次, 103天前 (2026-03-08)
- swiftui-patterns — 1 次, 103天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 101天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 99天前 (2026-03-12)
- ci-pipeline — 1 次, 99天前 (2026-03-12)
- deploy — 1 次, 99天前 (2026-03-12)
- init-project — 2 次, 102天前 (2026-03-09)
- knowledge-graph — 1 次, 96天前 (2026-03-15)
- plan-check-style — 3 次, 99天前 (2026-03-12)
- setup-permissions — 3 次, 99天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 96天前 (2026-03-15)
- qa-planner — 1 次, 96天前 (2026-03-15)
- qa-testing — 1 次, 101天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 96天前 (2026-03-15)
- context-recovery — 1 次, 96天前 (2026-03-15)
- crm-projection — 1 次, 95天前 (2026-03-16)
- executing-plans — 3 次, 101天前 (2026-03-10)
- gdrive-to-skills — 2 次, 102天前 (2026-03-09)
- material-health — 1 次, 95天前 (2026-03-16)
- mockup — 1 次, 103天前 (2026-03-08)
- subsidy-scraper — 1 次, 95天前 (2026-03-16)
- writing-plans — 3 次, 101天前 (2026-03-10)

<details><summary>✅ 穩定 (62)</summary>

**backend/**
- audio-transcription-flow — 1 次, 73天前
- doc-to-structured-data — 1 次, 85天前
- docker-compose-setup — 2 次, 63天前
- firebase-backend — 3 次, 42天前
- imap-smtp-integration — 1 次, 87天前
- markdown-file-ssot — 1 次, 87天前
- oauth-token-vault — 1 次, 87天前
- rbac-permissions — 1 次, 73天前
- sqlite-to-postgres — 2 次, 42天前
- vector-search-setup — 1 次, 81天前

**docs/**
- chart-design — 1 次, 32天前
- discovery-interview — 1 次, 73天前
- doc-coauthoring — 2 次, 42天前
- excalidraw-diagram — 2 次, 34天前
- gdoc-report-builder — 2 次, 42天前
- internal-comms — 2 次, 42天前
- iot-factory-report — 2 次, 42天前
- mermaid-diagram — 1 次, 35天前
- metadata-workshop — 2 次, 42天前
- office-docx — 4 次, 72天前
- pitch-deck — 3 次, 42天前
- rfq-writer — 1 次, 72天前
- slide-office-hours — 2 次, 42天前
- slide-template-extractor — 2 次, 42天前
- slide-workflow — 4 次, 42天前
- sow-writer — 2 次, 42天前

**frontend/**
- chimesflow-design — 1 次, 8天前

**git/**
- auto-stage — 3 次, 42天前
- concurrent-session-git — 1 次, 2天前
- repo-rename — 1 次, 85天前

**meta/**
- agent-persona — 1 次, 67天前
- dev-process-gate — 4 次, 73天前
- learnings-promotion-sprint — 1 次, 35天前
- self-improving-agent — 3 次, 34天前
- session-harvest — 3 次, 42天前
- session-wrap — 1 次, 66天前
- skill-creator — 4 次, 63天前
- skill-scout — 2 次, 51天前
- sync-readme — 1 次, 80天前
- task-brief — 1 次, 3天前
- workflow-retro — 2 次, 42天前

**quality/**
- de-slopify — 2 次, 63天前
- github-repo-audit — 1 次, 67天前
- large-file-refactor — 1 次, 81天前
- protect-secrets — 3 次, 42天前

**workflow/**
- agent-observability — 2 次, 73天前
- app-ops-baseline — 1 次, 8天前
- autoresearch — 2 次, 42天前
- candidate-analysis — 1 次, 85天前
- customer-intel — 5 次, 42天前
- dispatching-parallel-agents — 4 次, 63天前
- headless-agent — 6 次, 87天前
- investment-research — 4 次, 42天前
- jd-writer — 1 次, 67天前
- keyword-discovery — 1 次, 87天前
- launchd-agent — 6 次, 42天前
- planning-with-files — 5 次, 73天前
- requirement — 2 次, 73天前
- sales-material — 3 次, 59天前
- settings-audit — 1 次, 86天前
- tender-scraper — 3 次, 87天前
- user-flow — 2 次, 35天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 128 個 commit（本週）, 450 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/contract-document-management` (6 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
67d1741 docs(requirement): 合約文件管理（備存+通知+三方可見+補件上傳）
36c2ad3 Merge pull request #64 from Chimes-AI-Projects/feat/login-logo-and-closeout-time
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-13", "06-14", "06-15", "06-16", "06-17", "06-18", "06-19"]
    y-axis "USD" 0 --> 4400
    bar [2283, 959, 2230, 4301, 2972, 1974, 32]
~~~
...
| 2026-06-18 (Thu) | 8 | 1,964 | 1028.4M | $1973.83 |
| 2026-06-19 (Fri) | 2 | 25 | 6.0M | $31.95 |
| **Total** | | | **7253.3M** | **$14750.66** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-tukey-automl | 5,337 | 2606.1M | $4954.58 |
| -Users-manibari-code | 4,320 | 2326.1M | $4764.10 |
| -Users-manibari-code-ChimesFlow | 3,530 | 1879.5M | $3622.20 |
| -Users-manibari-code-rivendell | 754 | 264.9M | $944.00 |
| -Users-manibari-code-Family-Fiscal | 666 | 148.9M | $350.38 |
| -Users-manibari-code-sales-assistant | 334 | 22.6M | $89.25 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-tukey-bi | 4 | 1.0M | $9.97 |
| -Users-manibari-Vault-Peter-Work | 40 | 2.7M | $9.48 |
| -Users-manibari-code-vantage-3dgs | 27 | 1.3M | $4.51 |
| -Users-manibari-Vault-Peter | 4 | 211K | $2.19 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-19 — 99 skills, 48 issue(s)*
