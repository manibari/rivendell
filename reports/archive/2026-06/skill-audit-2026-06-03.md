...
**backend/**
- audio-transcription-flow — 1 次, 57天前
- db-migration — 1 次, 83天前
- doc-to-structured-data — 1 次, 69天前
- docker-compose-setup — 2 次, 47天前
- firebase-backend — 3 次, 26天前
- imap-smtp-integration — 1 次, 71天前
- markdown-file-ssot — 1 次, 71天前
- oauth-token-vault — 1 次, 71天前
- rbac-permissions — 1 次, 57天前
- sqlite-to-postgres — 2 次, 26天前
- tunnel-proxy-deploy — 1 次, 80天前
- tw-company-lookup — 2 次, 79天前
- vector-search-setup — 1 次, 65天前

**docs/**
- chart-design — 1 次, 16天前
- discovery-interview — 1 次, 57天前
- doc-coauthoring — 2 次, 26天前
- excalidraw-diagram — 2 次, 18天前
- gdoc-report-builder — 2 次, 26天前
- internal-comms — 2 次, 26天前
- iot-factory-report — 2 次, 26天前
- mcp-builder — 3 次, 85天前
- mermaid-diagram — 1 次, 19天前
- metadata-workshop — 2 次, 26天前
- office-docx — 4 次, 56天前
- office-pdf — 3 次, 85天前
- office-pptx — 3 次, 85天前
- office-xlsx — 3 次, 85天前
- pitch-deck — 3 次, 26天前
- rfq-writer — 1 次, 56天前
- slide-office-hours — 2 次, 26天前
- slide-template-extractor — 2 次, 26天前
- slide-workflow — 4 次, 26天前
- sow-writer — 2 次, 26天前
- telegram-bot — 1 次, 80天前

**frontend/**
- frontend-design — 2 次, 86天前
- ios-integration — 1 次, 87天前
- swiftui-patterns — 1 次, 87天前
- ui-ux-pro-max — 3 次, 85天前

**git/**
- auto-stage — 3 次, 26天前
- repo-rename — 1 次, 69天前

**meta/**
- agent-persona — 1 次, 51天前
- audit-fix — 1 次, 83天前
- ci-pipeline — 1 次, 83天前
- deploy — 1 次, 83天前
- dev-process-gate — 4 次, 57天前
- init-project — 2 次, 86天前
- knowledge-graph — 1 次, 80天前
- learnings-promotion-sprint — 1 次, 19天前
- plan-check-style — 3 次, 83天前
- self-improving-agent — 3 次, 18天前
- session-harvest — 3 次, 26天前
- session-wrap — 1 次, 50天前
- setup-permissions — 3 次, 83天前
- skill-creator — 4 次, 47天前
- skill-scout — 2 次, 35天前
- sync-readme — 1 次, 64天前
- workflow-retro — 2 次, 26天前

**quality/**
- de-slopify — 2 次, 47天前
- github-repo-audit — 1 次, 51天前
- large-file-refactor — 1 次, 65天前
- protect-secrets — 3 次, 26天前
- qa-auto — 1 次, 80天前
- qa-planner — 1 次, 80天前
- qa-testing — 1 次, 85天前

**workflow/**
- agent-observability — 2 次, 57天前
- autoresearch — 2 次, 26天前
- candidate-analysis — 1 次, 69天前
- claude-to-telegram — 1 次, 80天前
- client-kickoff-docs — 1 次, 42天前
- context-recovery — 1 次, 80天前
- crm-projection — 1 次, 79天前
- customer-intel — 5 次, 26天前
- dispatching-parallel-agents — 4 次, 47天前
- env-doctor — 1 次, 42天前
- executing-plans — 3 次, 85天前
- gdrive-to-skills — 2 次, 86天前
- headless-agent — 6 次, 71天前
- investment-research — 4 次, 26天前
- jd-writer — 1 次, 51天前
- keyword-discovery — 1 次, 71天前
- launchd-agent — 6 次, 26天前
- material-health — 1 次, 79天前
- mockup — 1 次, 87天前
- mops-financial-scraper — 1 次, 42天前
- planning-with-files — 5 次, 57天前
- presales-pipeline — 1 次, 42天前
- repro-exam — 1 次, 42天前
- requirement — 2 次, 57天前
- sales-material — 3 次, 43天前
- settings-audit — 1 次, 70天前
- subsidy-scraper — 1 次, 79天前
- tender-scraper — 3 次, 71天前
- user-flow — 2 次, 19天前
- writing-plans — 3 次, 85天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 106 個 commit（本週）, 247 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
a8fa941 feat(targets): 業績目標 P1 backend — 三層 scope + 年/季/月 強制對齊
ff1b2bb docs: flag SQLite self-host compose/guide as NOT current prod (Postgres)
f430b46 fix(roadmap): seed release_items so prod's empty /admin/roadmap populates
79465f1 docs(flows): sales-target-planning user flow (P1 數字層)
23de34d feat(opps): 主辦機關 on the detail-page edit form + sales-target-planning req
```
</details>
...
```
75d3112 v0.3.1: show version on the frontend (viewer badge + launcher footer)
36f25ad v0.3.0 (US-9b): fold viewers into package; measure to real outline not hull
b703460 docs(learnings): canvas perf (Path2D/setTransform), Tab terminology, shared assets, view argv bug
1740052 v0.2.3: optional --dwg, shared component lib/checklist, Tab measurable
d21da81 v0.2.2: proper copper-plane perf fix (Path2D + setTransform)
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-28", "05-29", "05-30", "05-31", "06-01", "06-02", "06-03"]
    y-axis "USD" 0 --> 2150
    bar [1095, 2080, 1693, 50, 1549, 2049, 1755]
~~~
...
| 2026-06-03 (Wed) | 10 | 2,081 | 775.8M | $1755.12 |
| **Total** | | | **4338.8M** | **$10271.21** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 5,104 | 2664.5M | $5387.93 |
| -Users-manibari-code | 1,502 | 475.0M | $1625.08 |
| -Users-manibari-Vault-Peter | 2,075 | 558.7M | $1224.86 |
| -Users-manibari-code-rivendell | 362 | 139.1M | $682.74 |
| -Users-manibari-code-odb-dfm | 396 | 202.0M | $494.80 |
| -Users-manibari-Vault-Peter-Work | 556 | 187.1M | $456.26 |
| -Users-manibari-code-news-stock | 450 | 73.4M | $266.59 |
| -Users-manibari-code-sales-assistant | 337 | 22.4M | $89.03 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-03 — 94 skills, 22 issue(s)*
