...
**backend/**
- backend-async-jobs — 2 次修訂, 11天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 12天前
- env-doctor — 3 次修訂, 12天前
- mops-financial-scraper — 3 次修訂, 12天前
- presales-pipeline — 3 次修訂, 12天前
- repro-exam — 3 次修訂, 12天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 108天前 (2026-03-12)
- doc-to-structured-data — 1 次, 94天前 (2026-03-26)
- imap-smtp-integration — 1 次, 96天前 (2026-03-24)
- markdown-file-ssot — 1 次, 96天前 (2026-03-24)
- oauth-token-vault — 1 次, 96天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 105天前 (2026-03-15)
- tw-company-lookup — 2 次, 104天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 110天前 (2026-03-10)
- office-pdf — 3 次, 110天前 (2026-03-10)
- office-pptx — 3 次, 110天前 (2026-03-10)
- office-xlsx — 3 次, 110天前 (2026-03-10)
- telegram-bot — 1 次, 105天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 111天前 (2026-03-09)
- ios-integration — 1 次, 112天前 (2026-03-08)
- swiftui-patterns — 1 次, 112天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 110天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 94天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 108天前 (2026-03-12)
- ci-pipeline — 1 次, 108天前 (2026-03-12)
- deploy — 1 次, 108天前 (2026-03-12)
- init-project — 2 次, 111天前 (2026-03-09)
- knowledge-graph — 1 次, 105天前 (2026-03-15)
- plan-check-style — 3 次, 108天前 (2026-03-12)
- setup-permissions — 3 次, 108天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 105天前 (2026-03-15)
- qa-planner — 1 次, 105天前 (2026-03-15)
- qa-testing — 1 次, 110天前 (2026-03-10)

**workflow/**
- candidate-analysis — 1 次, 94天前 (2026-03-26)
- claude-to-telegram — 1 次, 105天前 (2026-03-15)
- context-recovery — 1 次, 105天前 (2026-03-15)
- crm-projection — 1 次, 104天前 (2026-03-16)
- executing-plans — 3 次, 110天前 (2026-03-10)
- gdrive-to-skills — 2 次, 111天前 (2026-03-09)
- headless-agent — 6 次, 96天前 (2026-03-24)
- keyword-discovery — 1 次, 96天前 (2026-03-24)
- material-health — 1 次, 104天前 (2026-03-16)
- mockup — 1 次, 112天前 (2026-03-08)
- settings-audit — 1 次, 95天前 (2026-03-25)
- subsidy-scraper — 1 次, 104天前 (2026-03-16)
- tender-scraper — 3 次, 96天前 (2026-03-24)
- writing-plans — 3 次, 110天前 (2026-03-10)

<details><summary>✅ 穩定 (59)</summary>

**backend/**
- audio-transcription-flow — 1 次, 82天前
- docker-compose-setup — 2 次, 72天前
- firebase-backend — 3 次, 51天前
- ic-lot-normalization — 1 次, 4天前
- ml-eval-quality — 1 次, 4天前
- ml-model-registry — 1 次, 4天前
- odb-dfm-reference — 1 次, 4天前
- rbac-permissions — 1 次, 82天前
- spine-auth — 1 次, 0天前
- spine-rbac — 1 次, 0天前
- spine-schema-sync — 1 次, 0天前
- sqlite-to-postgres — 2 次, 51天前
- vector-search-setup — 1 次, 90天前

**docs/**
- chart-design — 1 次, 41天前
- discovery-interview — 1 次, 82天前
- doc-coauthoring — 2 次, 51天前
- excalidraw-diagram — 2 次, 43天前
- gdoc-report-builder — 2 次, 51天前
- internal-comms — 2 次, 51天前
- iot-factory-report — 2 次, 51天前
- mermaid-diagram — 1 次, 44天前
- metadata-workshop — 2 次, 51天前
- office-docx — 4 次, 81天前
- pitch-deck — 3 次, 51天前
- rfq-writer — 1 次, 81天前
- slide-office-hours — 2 次, 51天前
- slide-template-extractor — 2 次, 51天前
- slide-workflow — 4 次, 51天前
- sow-writer — 2 次, 51天前

**frontend/**
- chimesflow-design — 1 次, 17天前

**git/**
- auto-stage — 3 次, 51天前
- concurrent-session-git — 1 次, 11天前

**meta/**
- agent-persona — 1 次, 76天前
- dev-process-gate — 4 次, 82天前
- learnings-promotion-sprint — 1 次, 44天前
- self-improving-agent — 3 次, 43天前
- session-harvest — 3 次, 51天前
- session-wrap — 1 次, 75天前
- skill-creator — 4 次, 72天前
- skill-scout — 2 次, 60天前
- sync-readme — 1 次, 89天前
- task-brief — 1 次, 12天前
- workflow-retro — 2 次, 51天前

**quality/**
- de-slopify — 2 次, 72天前
- github-repo-audit — 1 次, 76天前
- large-file-refactor — 1 次, 90天前
- protect-secrets — 3 次, 51天前

**workflow/**
- agent-observability — 2 次, 82天前
- app-ops-baseline — 1 次, 17天前
- autoresearch — 2 次, 51天前
- customer-intel — 5 次, 51天前
- dispatching-parallel-agents — 4 次, 72天前
- investment-research — 4 次, 51天前
- jd-writer — 1 次, 76天前
- launchd-agent — 6 次, 51天前
- planning-with-files — 5 次, 82天前
- requirement — 2 次, 82天前
- sales-material — 3 次, 68天前
- user-flow — 2 次, 44天前
...
```
111a5f0 chore(frontend): clear antd v6 deprecation warnings — Alert message→title, InputNumber addon→prefix/suffix (v1.33.29) (#104)
468fe22 feat(contracts): multi-file support — 主約/附約/附件/修約/補充協議 (v1.33.28) (#103)
3b22b05 feat(opps): MEDDIC ↔ 商機聯絡人 3K 雙向加法同步 — v1.33.27 (#102)
22d23d8 fix(contracts): show original uploaded file name instead of UUID — v1.33.26 (#100)
4533fb0 fix(contracts): file upload auth-refresh (#96) + billing-plan ratio derivation (#97) — v1.33.25 (#99)
```
</details>
...
970bfca fix: 修復模組化拆分後的多個前端問題並統一 market 代碼
162189f chore: 新增 frontend/pnpm-lock.yaml（新目錄 pnpm install 產生）
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 145 個 commit（本週）, 145 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
ed7f3d6 perf(web): 圖片大幅壓縮(孕肚 1MB→360KB, help 3.6M→664K)修網路卡 + 日誌記裝置(手機/平板/電腦)
3607b68 docs: 設計決策(App=280days 插圖/icon; 報告=StressWatch)+ 孕期報告 mockup
66252dd docs: 整條 flow + Home(寶寶為主) mockup(對齊 280days, 待 Peter 確認)
16268ac feat(web): onboarding 加角色(媽媽/爸爸/家人)→ 同步資料 步驟(依 design system IA)
32ddd2a docs: iihi 設計系統 + IA SoT(對齊 280days; 角色→同步→寶寶主畫面→add-ons)
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 58 個 commit（本週）, 73 個（本月） |
| **技術棧** |  Make |
| **分支** | `feat/monorepo` (2 total) | 1 個 open PR |
| **Git** | 1 dirty, 26 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
e6cca51 feat(monitor): 版本紀錄改產品級 release-notes（timeline + 類型色標）
64d4976 docs(monitor): 開發藍圖標記 auth/deploy 完成
03377b7 feat(monitor): 帳號權限（auth + RBAC）+ 部署狀態頁 + price 全市場回補
e7fa87a feat(monitor): 通知鈴鐺 + header bar + 開發藍圖更新
283f08f feat(crawl): 爬蟲功能補完 — notes 順序 + master 同步按鈕 + 部分失敗警告
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-22", "06-23", "06-24", "06-25", "06-26", "06-27", "06-28"]
    y-axis "USD" 0 --> 3800
    bar [1166, 2436, 3089, 2389, 1973, 3710, 1540]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-22 (Mon) | 8 | 1,238 | 516.9M | $1166.02 |
...
| 2026-06-27 (Sat) | 9 | 2,937 | 1707.3M | $3709.99 |
| 2026-06-28 (Sun) | 8 | 1,276 | 706.6M | $1539.94 |
| **Total** | | | **7600.4M** | **$16302.90** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Vault-Peter-Family | 4,891 | 2926.1M | $5714.48 |
| -Users-manibari-code-ChimesFlow | 2,945 | 1511.7M | $3113.89 |
| -Users-manibari-code-tukey-automl | 1,867 | 1099.7M | $2323.46 |
| -Users-manibari-code-mops-dbs | 1,701 | 863.4M | $1921.13 |
| -Users-manibari-code-rivendell | 842 | 388.9M | $1246.37 |
| -Users-manibari-code | 768 | 399.4M | $850.47 |
| -Users-manibari-code-IC-YMS | 613 | 188.5M | $479.30 |
| -Users-manibari-code-tukey-bi | 457 | 135.9M | $367.94 |
| -Users-manibari-Vault-Peter-Work | 509 | 51.5M | $151.16 |
| -Users-manibari-code-sales-assistant | 313 | 19.9M | $81.59 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-PTI-ARES | 146 | 10.2M | $32.67 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-28 — 106 skills, 62 issue(s)*
