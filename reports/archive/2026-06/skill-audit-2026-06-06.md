...
**backend/**
- audio-transcription-flow — 1 次, 60天前
- db-migration — 1 次, 86天前
- doc-to-structured-data — 1 次, 72天前
- docker-compose-setup — 2 次, 50天前
- firebase-backend — 3 次, 29天前
- imap-smtp-integration — 1 次, 74天前
- markdown-file-ssot — 1 次, 74天前
- oauth-token-vault — 1 次, 74天前
- rbac-permissions — 1 次, 60天前
- sqlite-to-postgres — 2 次, 29天前
- tunnel-proxy-deploy — 1 次, 83天前
- tw-company-lookup — 2 次, 82天前
- vector-search-setup — 1 次, 68天前

**docs/**
- chart-design — 1 次, 19天前
- discovery-interview — 1 次, 60天前
- doc-coauthoring — 2 次, 29天前
- excalidraw-diagram — 2 次, 21天前
- gdoc-report-builder — 2 次, 29天前
- internal-comms — 2 次, 29天前
- iot-factory-report — 2 次, 29天前
- mcp-builder — 3 次, 88天前
- mermaid-diagram — 1 次, 22天前
- metadata-workshop — 2 次, 29天前
- office-docx — 4 次, 59天前
- office-pdf — 3 次, 88天前
- office-pptx — 3 次, 88天前
- office-xlsx — 3 次, 88天前
- pitch-deck — 3 次, 29天前
- rfq-writer — 1 次, 59天前
- slide-office-hours — 2 次, 29天前
- slide-template-extractor — 2 次, 29天前
- slide-workflow — 4 次, 29天前
- sow-writer — 2 次, 29天前
- telegram-bot — 1 次, 83天前

**frontend/**
- frontend-design — 2 次, 89天前
- ios-integration — 1 次, 90天前
- swiftui-patterns — 1 次, 90天前
- ui-ux-pro-max — 3 次, 88天前

**git/**
- auto-stage — 3 次, 29天前
- repo-rename — 1 次, 72天前

**meta/**
- agent-persona — 1 次, 54天前
- audit-fix — 1 次, 86天前
- ci-pipeline — 1 次, 86天前
- deploy — 1 次, 86天前
- dev-process-gate — 4 次, 60天前
- init-project — 2 次, 89天前
- knowledge-graph — 1 次, 83天前
- learnings-promotion-sprint — 1 次, 22天前
- plan-check-style — 3 次, 86天前
- self-improving-agent — 3 次, 21天前
- session-harvest — 3 次, 29天前
- session-wrap — 1 次, 53天前
- setup-permissions — 3 次, 86天前
- skill-creator — 4 次, 50天前
- skill-scout — 2 次, 38天前
- sync-readme — 1 次, 67天前
- workflow-retro — 2 次, 29天前

**quality/**
- de-slopify — 2 次, 50天前
- github-repo-audit — 1 次, 54天前
- large-file-refactor — 1 次, 68天前
- protect-secrets — 3 次, 29天前
- qa-auto — 1 次, 83天前
- qa-planner — 1 次, 83天前
- qa-testing — 1 次, 88天前

**workflow/**
- agent-observability — 2 次, 60天前
- autoresearch — 2 次, 29天前
- candidate-analysis — 1 次, 72天前
- claude-to-telegram — 1 次, 83天前
- client-kickoff-docs — 1 次, 45天前
- context-recovery — 1 次, 83天前
- crm-projection — 1 次, 82天前
- customer-intel — 5 次, 29天前
- dispatching-parallel-agents — 4 次, 50天前
- env-doctor — 1 次, 45天前
- executing-plans — 3 次, 88天前
- gdrive-to-skills — 2 次, 89天前
- headless-agent — 6 次, 74天前
- investment-research — 4 次, 29天前
- jd-writer — 1 次, 54天前
- keyword-discovery — 1 次, 74天前
- launchd-agent — 6 次, 29天前
- material-health — 1 次, 82天前
- mockup — 1 次, 90天前
- mops-financial-scraper — 1 次, 45天前
- planning-with-files — 5 次, 60天前
- presales-pipeline — 1 次, 45天前
- repro-exam — 1 次, 45天前
- requirement — 2 次, 60天前
- sales-material — 3 次, 46天前
- settings-audit — 1 次, 73天前
- subsidy-scraper — 1 次, 82天前
- tender-scraper — 3 次, 74天前
- user-flow — 2 次, 22天前
- writing-plans — 3 次, 88天前
...
4c83321 feat(targets): P1 achievement — won-deal progress next to 年/季 targets
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-31", "06-01", "06-02", "06-03", "06-04", "06-05", "06-06"]
    y-axis "USD" 0 --> 2750
    bar [50, 1549, 2049, 2693, 2297, 376, 0]
~~~
...
| 2026-06-06 (Sat) | 0 | 0 | 0 | $0.00 |
| **Total** | | | **4134.3M** | **$9013.77** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 3,547 | 1985.1M | $3956.11 |
...
| -Users-manibari-code-rivendell | 198 | 59.1M | $308.18 |
| -Users-manibari-code-PTI-ARES | 379 | 72.2M | $180.68 |
| -Users-manibari-Vault-Peter-Work | 306 | 45.0M | $128.11 |
| -Users-manibari-code-sales-assistant | 322 | 20.4M | $80.01 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-06 — 94 skills, 19 issue(s)*
