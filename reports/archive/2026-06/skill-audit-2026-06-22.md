...
**backend/**
- backend-async-jobs — 2 次修訂, 5天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 6天前
- env-doctor — 3 次修訂, 6天前
- mops-financial-scraper — 3 次修訂, 6天前
- presales-pipeline — 3 次修訂, 6天前
- repro-exam — 3 次修訂, 6天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 102天前 (2026-03-12)
- tunnel-proxy-deploy — 1 次, 99天前 (2026-03-15)
- tw-company-lookup — 2 次, 98天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 104天前 (2026-03-10)
- office-pdf — 3 次, 104天前 (2026-03-10)
- office-pptx — 3 次, 104天前 (2026-03-10)
- office-xlsx — 3 次, 104天前 (2026-03-10)
- telegram-bot — 1 次, 99天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 105天前 (2026-03-09)
- ios-integration — 1 次, 106天前 (2026-03-08)
- swiftui-patterns — 1 次, 106天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 104天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 102天前 (2026-03-12)
- ci-pipeline — 1 次, 102天前 (2026-03-12)
- deploy — 1 次, 102天前 (2026-03-12)
- init-project — 2 次, 105天前 (2026-03-09)
- knowledge-graph — 1 次, 99天前 (2026-03-15)
- plan-check-style — 3 次, 102天前 (2026-03-12)
- setup-permissions — 3 次, 102天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 99天前 (2026-03-15)
- qa-planner — 1 次, 99天前 (2026-03-15)
- qa-testing — 1 次, 104天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 99天前 (2026-03-15)
- context-recovery — 1 次, 99天前 (2026-03-15)
- crm-projection — 1 次, 98天前 (2026-03-16)
- executing-plans — 3 次, 104天前 (2026-03-10)
- gdrive-to-skills — 2 次, 105天前 (2026-03-09)
- material-health — 1 次, 98天前 (2026-03-16)
- mockup — 1 次, 106天前 (2026-03-08)
- subsidy-scraper — 1 次, 98天前 (2026-03-16)
- writing-plans — 3 次, 104天前 (2026-03-10)

<details><summary>✅ 穩定 (62)</summary>

**backend/**
- audio-transcription-flow — 1 次, 76天前
- doc-to-structured-data — 1 次, 88天前
- docker-compose-setup — 2 次, 66天前
- firebase-backend — 3 次, 45天前
- imap-smtp-integration — 1 次, 90天前
- markdown-file-ssot — 1 次, 90天前
- oauth-token-vault — 1 次, 90天前
- rbac-permissions — 1 次, 76天前
- sqlite-to-postgres — 2 次, 45天前
- vector-search-setup — 1 次, 84天前

**docs/**
- chart-design — 1 次, 35天前
- discovery-interview — 1 次, 76天前
- doc-coauthoring — 2 次, 45天前
- excalidraw-diagram — 2 次, 37天前
- gdoc-report-builder — 2 次, 45天前
- internal-comms — 2 次, 45天前
- iot-factory-report — 2 次, 45天前
- mermaid-diagram — 1 次, 38天前
- metadata-workshop — 2 次, 45天前
- office-docx — 4 次, 75天前
- pitch-deck — 3 次, 45天前
- rfq-writer — 1 次, 75天前
- slide-office-hours — 2 次, 45天前
- slide-template-extractor — 2 次, 45天前
- slide-workflow — 4 次, 45天前
- sow-writer — 2 次, 45天前

**frontend/**
- chimesflow-design — 1 次, 11天前

**git/**
- auto-stage — 3 次, 45天前
- concurrent-session-git — 1 次, 5天前
- repo-rename — 1 次, 88天前

**meta/**
- agent-persona — 1 次, 70天前
- dev-process-gate — 4 次, 76天前
- learnings-promotion-sprint — 1 次, 38天前
- self-improving-agent — 3 次, 37天前
- session-harvest — 3 次, 45天前
- session-wrap — 1 次, 69天前
- skill-creator — 4 次, 66天前
- skill-scout — 2 次, 54天前
- sync-readme — 1 次, 83天前
- task-brief — 1 次, 6天前
- workflow-retro — 2 次, 45天前

**quality/**
- de-slopify — 2 次, 66天前
- github-repo-audit — 1 次, 70天前
- large-file-refactor — 1 次, 84天前
- protect-secrets — 3 次, 45天前

**workflow/**
- agent-observability — 2 次, 76天前
- app-ops-baseline — 1 次, 11天前
- autoresearch — 2 次, 45天前
- candidate-analysis — 1 次, 88天前
- customer-intel — 5 次, 45天前
- dispatching-parallel-agents — 4 次, 66天前
- headless-agent — 6 次, 90天前
- investment-research — 4 次, 45天前
- jd-writer — 1 次, 70天前
- keyword-discovery — 1 次, 90天前
- launchd-agent — 6 次, 45天前
- planning-with-files — 5 次, 76天前
- requirement — 2 次, 76天前
- sales-material — 3 次, 62天前
- settings-audit — 1 次, 89天前
- tender-scraper — 3 次, 90天前
- user-flow — 2 次, 38天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 137 個 commit（本週）, 477 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/worklog-participants` (6 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
9a9d154 feat(worklog): add participants to internal work plans (v1.33.8)
3faba16 Merge pull request #78 from Chimes-AI-Projects/fix/roadmap-future-timestamps
4e318a2 fix(roadmap): 版本變更頁時間不再標成未來 v1.33.7
c91d61d Merge pull request #77 from Chimes-AI-Projects/feat/calendar-drag-reschedule
e19afcc fix(version): APP_VERSION 補正到 1.33.6（先前 sed bump 連續 silent no-op 卡在 1.33.3）
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-16", "06-17", "06-18", "06-19", "06-20", "06-21", "06-22"]
    y-axis "USD" 0 --> 4400
    bar [4301, 2972, 1976, 34, 125, 1728, 1159]
~~~
...
| 2026-06-22 (Mon) | 7 | 1,214 | 514.9M | $1159.06 |
| **Total** | | | **5984.0M** | **$12296.01** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 4,082 | 2344.7M | $4475.76 |
| -Users-manibari-code-tukey-automl | 3,587 | 1908.6M | $3678.03 |
| -Users-manibari-code | 3,078 | 1550.6M | $3356.30 |
| -Users-manibari-code-rivendell | 227 | 98.7M | $499.61 |
| -Users-manibari-Vault-Peter-Family | 267 | 49.5M | $144.39 |
| -Users-manibari-code-sales-assistant | 270 | 18.2M | $76.92 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-Family-Fiscal | 5 | 2.3M | $27.55 |
| -Users-manibari-code-PTI-ARES | 100 | 6.8M | $18.15 |
| -Users-manibari-Vault-Peter | 26 | 1.7M | $9.83 |
| -Users-manibari-Vault-Peter-Work | 40 | 2.7M | $9.48 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-22 — 99 skills, 49 issue(s)*
