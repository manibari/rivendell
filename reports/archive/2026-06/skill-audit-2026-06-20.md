...
**backend/**
- backend-async-jobs — 2 次修訂, 3天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 4天前
- env-doctor — 3 次修訂, 4天前
- mops-financial-scraper — 3 次修訂, 4天前
- presales-pipeline — 3 次修訂, 4天前
- repro-exam — 3 次修訂, 4天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 100天前 (2026-03-12)
- tunnel-proxy-deploy — 1 次, 97天前 (2026-03-15)
- tw-company-lookup — 2 次, 96天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 102天前 (2026-03-10)
- office-pdf — 3 次, 102天前 (2026-03-10)
- office-pptx — 3 次, 102天前 (2026-03-10)
- office-xlsx — 3 次, 102天前 (2026-03-10)
- telegram-bot — 1 次, 97天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 103天前 (2026-03-09)
- ios-integration — 1 次, 104天前 (2026-03-08)
- swiftui-patterns — 1 次, 104天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 102天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 100天前 (2026-03-12)
- ci-pipeline — 1 次, 100天前 (2026-03-12)
- deploy — 1 次, 100天前 (2026-03-12)
- init-project — 2 次, 103天前 (2026-03-09)
- knowledge-graph — 1 次, 97天前 (2026-03-15)
- plan-check-style — 3 次, 100天前 (2026-03-12)
- setup-permissions — 3 次, 100天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 97天前 (2026-03-15)
- qa-planner — 1 次, 97天前 (2026-03-15)
- qa-testing — 1 次, 102天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 97天前 (2026-03-15)
- context-recovery — 1 次, 97天前 (2026-03-15)
- crm-projection — 1 次, 96天前 (2026-03-16)
- executing-plans — 3 次, 102天前 (2026-03-10)
- gdrive-to-skills — 2 次, 103天前 (2026-03-09)
- material-health — 1 次, 96天前 (2026-03-16)
- mockup — 1 次, 104天前 (2026-03-08)
- subsidy-scraper — 1 次, 96天前 (2026-03-16)
- writing-plans — 3 次, 102天前 (2026-03-10)

<details><summary>✅ 穩定 (62)</summary>

**backend/**
- audio-transcription-flow — 1 次, 74天前
- doc-to-structured-data — 1 次, 86天前
- docker-compose-setup — 2 次, 64天前
- firebase-backend — 3 次, 43天前
- imap-smtp-integration — 1 次, 88天前
- markdown-file-ssot — 1 次, 88天前
- oauth-token-vault — 1 次, 88天前
- rbac-permissions — 1 次, 74天前
- sqlite-to-postgres — 2 次, 43天前
- vector-search-setup — 1 次, 82天前

**docs/**
- chart-design — 1 次, 33天前
- discovery-interview — 1 次, 74天前
- doc-coauthoring — 2 次, 43天前
- excalidraw-diagram — 2 次, 35天前
- gdoc-report-builder — 2 次, 43天前
- internal-comms — 2 次, 43天前
- iot-factory-report — 2 次, 43天前
- mermaid-diagram — 1 次, 36天前
- metadata-workshop — 2 次, 43天前
- office-docx — 4 次, 73天前
- pitch-deck — 3 次, 43天前
- rfq-writer — 1 次, 73天前
- slide-office-hours — 2 次, 43天前
- slide-template-extractor — 2 次, 43天前
- slide-workflow — 4 次, 43天前
- sow-writer — 2 次, 43天前

**frontend/**
- chimesflow-design — 1 次, 9天前

**git/**
- auto-stage — 3 次, 43天前
- concurrent-session-git — 1 次, 3天前
- repo-rename — 1 次, 86天前

**meta/**
- agent-persona — 1 次, 68天前
- dev-process-gate — 4 次, 74天前
- learnings-promotion-sprint — 1 次, 36天前
- self-improving-agent — 3 次, 35天前
- session-harvest — 3 次, 43天前
- session-wrap — 1 次, 67天前
- skill-creator — 4 次, 64天前
- skill-scout — 2 次, 52天前
- sync-readme — 1 次, 81天前
- task-brief — 1 次, 4天前
- workflow-retro — 2 次, 43天前

**quality/**
- de-slopify — 2 次, 64天前
- github-repo-audit — 1 次, 68天前
- large-file-refactor — 1 次, 82天前
- protect-secrets — 3 次, 43天前

**workflow/**
- agent-observability — 2 次, 74天前
- app-ops-baseline — 1 次, 9天前
- autoresearch — 2 次, 43天前
- candidate-analysis — 1 次, 86天前
- customer-intel — 5 次, 43天前
- dispatching-parallel-agents — 4 次, 64天前
- headless-agent — 6 次, 88天前
- investment-research — 4 次, 43天前
- jd-writer — 1 次, 68天前
- keyword-discovery — 1 次, 88天前
- launchd-agent — 6 次, 43天前
- planning-with-files — 5 次, 74天前
- requirement — 2 次, 74天前
- sales-material — 3 次, 60天前
- settings-audit — 1 次, 87天前
- tender-scraper — 3 次, 88天前
- user-flow — 2 次, 36天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 114 個 commit（本週）, 449 個（本月） |
| **技術棧** |  Node.js |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-14", "06-15", "06-16", "06-17", "06-18", "06-19", "06-20"]
    y-axis "USD" 0 --> 4400
    bar [959, 2230, 4301, 2972, 1976, 34, 113]
~~~
...
| 2026-06-18 (Thu) | 8 | 1,967 | 1029.3M | $1975.54 |
| 2026-06-19 (Fri) | 3 | 29 | 7.1M | $34.49 |
| 2026-06-20 (Sat) | 2 | 117 | 44.8M | $113.41 |
| **Total** | | | **6136.9M** | **$12584.98** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-tukey-automl | 4,277 | 2224.6M | $4261.20 |
| -Users-manibari-code | 3,493 | 1886.3M | $3908.22 |
| -Users-manibari-code-ChimesFlow | 3,203 | 1671.4M | $3259.28 |
| -Users-manibari-code-rivendell | 363 | 189.2M | $729.41 |
| -Users-manibari-code-Family-Fiscal | 545 | 141.4M | $332.43 |
| -Users-manibari-code-sales-assistant | 308 | 21.0M | $82.77 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-20 — 99 skills, 48 issue(s)*
