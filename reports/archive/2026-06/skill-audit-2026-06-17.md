...
**backend/**
- backend-async-jobs — 2 次修訂, 0天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 1天前
- env-doctor — 3 次修訂, 1天前
- mops-financial-scraper — 3 次修訂, 1天前
- presales-pipeline — 3 次修訂, 1天前
- repro-exam — 3 次修訂, 1天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 97天前 (2026-03-12)
- tunnel-proxy-deploy — 1 次, 94天前 (2026-03-15)
- tw-company-lookup — 2 次, 93天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 99天前 (2026-03-10)
- office-pdf — 3 次, 99天前 (2026-03-10)
- office-pptx — 3 次, 99天前 (2026-03-10)
- office-xlsx — 3 次, 99天前 (2026-03-10)
- telegram-bot — 1 次, 94天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 100天前 (2026-03-09)
- ios-integration — 1 次, 101天前 (2026-03-08)
- swiftui-patterns — 1 次, 101天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 99天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 97天前 (2026-03-12)
- ci-pipeline — 1 次, 97天前 (2026-03-12)
- deploy — 1 次, 97天前 (2026-03-12)
- init-project — 2 次, 100天前 (2026-03-09)
- knowledge-graph — 1 次, 94天前 (2026-03-15)
- plan-check-style — 3 次, 97天前 (2026-03-12)
- setup-permissions — 3 次, 97天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 94天前 (2026-03-15)
- qa-planner — 1 次, 94天前 (2026-03-15)
- qa-testing — 1 次, 99天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 94天前 (2026-03-15)
- context-recovery — 1 次, 94天前 (2026-03-15)
- crm-projection — 1 次, 93天前 (2026-03-16)
- executing-plans — 3 次, 99天前 (2026-03-10)
- gdrive-to-skills — 2 次, 100天前 (2026-03-09)
- material-health — 1 次, 93天前 (2026-03-16)
- mockup — 1 次, 101天前 (2026-03-08)
- subsidy-scraper — 1 次, 93天前 (2026-03-16)
- writing-plans — 3 次, 99天前 (2026-03-10)

<details><summary>✅ 穩定 (62)</summary>

**backend/**
- audio-transcription-flow — 1 次, 71天前
- doc-to-structured-data — 1 次, 83天前
- docker-compose-setup — 2 次, 61天前
- firebase-backend — 3 次, 40天前
- imap-smtp-integration — 1 次, 85天前
- markdown-file-ssot — 1 次, 85天前
- oauth-token-vault — 1 次, 85天前
- rbac-permissions — 1 次, 71天前
- sqlite-to-postgres — 2 次, 40天前
- vector-search-setup — 1 次, 79天前

**docs/**
- chart-design — 1 次, 30天前
- discovery-interview — 1 次, 71天前
- doc-coauthoring — 2 次, 40天前
- excalidraw-diagram — 2 次, 32天前
- gdoc-report-builder — 2 次, 40天前
- internal-comms — 2 次, 40天前
- iot-factory-report — 2 次, 40天前
- mermaid-diagram — 1 次, 33天前
- metadata-workshop — 2 次, 40天前
- office-docx — 4 次, 70天前
- pitch-deck — 3 次, 40天前
- rfq-writer — 1 次, 70天前
- slide-office-hours — 2 次, 40天前
- slide-template-extractor — 2 次, 40天前
- slide-workflow — 4 次, 40天前
- sow-writer — 2 次, 40天前

**frontend/**
- chimesflow-design — 1 次, 6天前

**git/**
- auto-stage — 3 次, 40天前
- concurrent-session-git — 1 次, 0天前
- repo-rename — 1 次, 83天前

**meta/**
- agent-persona — 1 次, 65天前
- dev-process-gate — 4 次, 71天前
- learnings-promotion-sprint — 1 次, 33天前
- self-improving-agent — 3 次, 32天前
- session-harvest — 3 次, 40天前
- session-wrap — 1 次, 64天前
- skill-creator — 4 次, 61天前
- skill-scout — 2 次, 49天前
- sync-readme — 1 次, 78天前
- task-brief — 1 次, 1天前
- workflow-retro — 2 次, 40天前

**quality/**
- de-slopify — 2 次, 61天前
- github-repo-audit — 1 次, 65天前
- large-file-refactor — 1 次, 79天前
- protect-secrets — 3 次, 40天前

**workflow/**
- agent-observability — 2 次, 71天前
- app-ops-baseline — 1 次, 6天前
- autoresearch — 2 次, 40天前
- candidate-analysis — 1 次, 83天前
- customer-intel — 5 次, 40天前
- dispatching-parallel-agents — 4 次, 61天前
- headless-agent — 6 次, 85天前
- investment-research — 4 次, 40天前
- jd-writer — 1 次, 65天前
- keyword-discovery — 1 次, 85天前
- launchd-agent — 6 次, 40天前
- planning-with-files — 5 次, 71天前
- requirement — 2 次, 71天前
- sales-material — 3 次, 57天前
- settings-audit — 1 次, 84天前
- tender-scraper — 3 次, 85天前
- user-flow — 2 次, 33天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 124 個 commit（本週）, 438 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (5 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
b2147c4 Merge pull request #50 from Chimes-AI-Projects/feat/activity-5w-fields
a23b9bc feat(today): 業務活動補齊人事時地物 — 與會人/地點/起訖時間 v1.27.0
e462412 Merge pull request #49 from Chimes-AI-Projects/feat/knowledge-unfiled-uploads
dd344aa feat(knowledge): 「未整理上傳」聚合收件匣 v1.26.5
46bcb1f Merge pull request #48 from Chimes-AI-Projects/feat/account-staleness-reminder
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-11", "06-12", "06-13", "06-14", "06-15", "06-16", "06-17"]
    y-axis "USD" 0 --> 4400
    bar [1301, 2932, 2283, 959, 2230, 4301, 2437]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-11 (Thu) | 14 | 1,293 | 441.2M | $1300.66 |
...
| 2026-06-17 (Wed) | 8 | 2,469 | 1140.6M | $2436.76 |
| **Total** | | | **7772.8M** | **$16442.49** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code | 5,442 | 2775.1M | $5872.00 |
| -Users-manibari-code-tukey-automl | 5,372 | 2713.2M | $5212.01 |
| -Users-manibari-code-ChimesFlow | 3,323 | 1655.9M | $3399.57 |
| -Users-manibari-code-rivendell | 767 | 265.5M | $946.85 |
| -Users-manibari-code-Family-Fiscal | 666 | 148.9M | $350.38 |
| -Users-manibari-Vault-Peter-Work | 495 | 112.0M | $295.30 |
| -Users-manibari-code-tukey-bi | 294 | 47.8M | $149.55 |
| -Users-manibari-code-sales-assistant | 331 | 21.5M | $84.68 |
| -Users-manibari-code-vantage-3dgs | 49 | 14.7M | $56.60 |
| -Users-manibari-Vault-Peter | 116 | 8.0M | $41.26 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-resume-pool | 145 | 8.1M | $24.08 |
| -Users-manibari-code-PTI-ARES | 43 | 2.1M | $10.21 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-17 — 99 skills, 48 issue(s)*
