...
**backend/**
- backend-async-jobs — 2 次修訂, 12天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 13天前
- env-doctor — 3 次修訂, 13天前
- mops-financial-scraper — 3 次修訂, 13天前
- presales-pipeline — 3 次修訂, 13天前
- repro-exam — 3 次修訂, 13天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 109天前 (2026-03-12)
- doc-to-structured-data — 1 次, 95天前 (2026-03-26)
- imap-smtp-integration — 1 次, 97天前 (2026-03-24)
- markdown-file-ssot — 1 次, 97天前 (2026-03-24)
- oauth-token-vault — 1 次, 97天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 106天前 (2026-03-15)
- tw-company-lookup — 2 次, 105天前 (2026-03-16)
- vector-search-setup — 1 次, 91天前 (2026-03-30)

**docs/**
- mcp-builder — 3 次, 111天前 (2026-03-10)
- office-pdf — 3 次, 111天前 (2026-03-10)
- office-pptx — 3 次, 111天前 (2026-03-10)
- office-xlsx — 3 次, 111天前 (2026-03-10)
- telegram-bot — 1 次, 106天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 112天前 (2026-03-09)
- ios-integration — 1 次, 113天前 (2026-03-08)
- swiftui-patterns — 1 次, 113天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 111天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 95天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 109天前 (2026-03-12)
- ci-pipeline — 1 次, 109天前 (2026-03-12)
- deploy — 1 次, 109天前 (2026-03-12)
- init-project — 2 次, 112天前 (2026-03-09)
- knowledge-graph — 1 次, 106天前 (2026-03-15)
- plan-check-style — 3 次, 109天前 (2026-03-12)
- setup-permissions — 3 次, 109天前 (2026-03-12)

**quality/**
- large-file-refactor — 1 次, 91天前 (2026-03-30)
- qa-auto — 1 次, 106天前 (2026-03-15)
- qa-planner — 1 次, 106天前 (2026-03-15)
- qa-testing — 1 次, 111天前 (2026-03-10)

**workflow/**
- candidate-analysis — 1 次, 95天前 (2026-03-26)
- claude-to-telegram — 1 次, 106天前 (2026-03-15)
- context-recovery — 1 次, 106天前 (2026-03-15)
- crm-projection — 1 次, 105天前 (2026-03-16)
- executing-plans — 3 次, 111天前 (2026-03-10)
- gdrive-to-skills — 2 次, 112天前 (2026-03-09)
- headless-agent — 6 次, 97天前 (2026-03-24)
- keyword-discovery — 1 次, 97天前 (2026-03-24)
- material-health — 1 次, 105天前 (2026-03-16)
- mockup — 1 次, 113天前 (2026-03-08)
- settings-audit — 1 次, 96天前 (2026-03-25)
- subsidy-scraper — 1 次, 105天前 (2026-03-16)
- tender-scraper — 3 次, 97天前 (2026-03-24)
- writing-plans — 3 次, 111天前 (2026-03-10)

<details><summary>✅ 穩定 (59)</summary>

**backend/**
- ai-vision-extract — 1 次, 0天前
- audio-transcription-flow — 1 次, 83天前
- docker-compose-setup — 2 次, 73天前
- firebase-backend — 3 次, 52天前
- ic-lot-normalization — 1 次, 5天前
- ml-eval-quality — 1 次, 5天前
- ml-model-registry — 1 次, 5天前
- odb-dfm-reference — 1 次, 5天前
- rbac-permissions — 1 次, 83天前
- spine-auth — 1 次, 1天前
- spine-rbac — 1 次, 1天前
- spine-schema-sync — 1 次, 1天前
- spine-versioning — 1 次, 0天前
- sqlite-to-postgres — 2 次, 52天前

**docs/**
- chart-design — 1 次, 42天前
- discovery-interview — 1 次, 83天前
- doc-coauthoring — 2 次, 52天前
- excalidraw-diagram — 2 次, 44天前
- gdoc-report-builder — 2 次, 52天前
- internal-comms — 2 次, 52天前
- iot-factory-report — 2 次, 52天前
- mermaid-diagram — 1 次, 45天前
- metadata-workshop — 2 次, 52天前
- office-docx — 4 次, 82天前
- pitch-deck — 3 次, 52天前
- rfq-writer — 1 次, 82天前
- slide-office-hours — 2 次, 52天前
- slide-template-extractor — 2 次, 52天前
- slide-workflow — 4 次, 52天前
- sow-writer — 2 次, 52天前

**frontend/**
- chimesflow-design — 1 次, 18天前

**git/**
- auto-stage — 3 次, 52天前
- concurrent-session-git — 1 次, 12天前

**meta/**
- agent-persona — 1 次, 77天前
- dev-process-gate — 4 次, 83天前
- learnings-promotion-sprint — 1 次, 45天前
- self-improving-agent — 3 次, 44天前
- session-harvest — 3 次, 52天前
- session-wrap — 1 次, 76天前
- skill-creator — 4 次, 73天前
- skill-scout — 2 次, 61天前
- sync-readme — 1 次, 90天前
- task-brief — 1 次, 13天前
- workflow-retro — 2 次, 52天前

**quality/**
- de-slopify — 2 次, 73天前
- github-repo-audit — 1 次, 77天前
- protect-secrets — 3 次, 52天前

**workflow/**
- agent-observability — 2 次, 83天前
- app-ops-baseline — 1 次, 18天前
- autoresearch — 2 次, 52天前
- customer-intel — 5 次, 52天前
- dispatching-parallel-agents — 4 次, 73天前
- investment-research — 4 次, 52天前
- jd-writer — 1 次, 77天前
- launchd-agent — 6 次, 52天前
- planning-with-files — 5 次, 83天前
- requirement — 2 次, 83天前
- sales-material — 3 次, 69天前
- user-flow — 2 次, 45天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 25 個 commit（本週）, 394 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/ocr-codex-provider` (2 total) | 1 個 open PR |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
5632c13 feat(ocr): default to codex CLI provider (ChatGPT OAuth, no API key) — v1.33.34
...
c972f9b feat(opps): list name click → opportunity detail (not inline rename) — v1.33.30 (#105)
```
</details>
...
66b264c feat(engine): Phase 2 — CP0011 uses the tolerant per-pin pad matcher
```
</details>
...
1539cf5 docs: 移除專案 CLAUDE.md 重複的 code-review 規則
f2524f8 feat: 退場候選頁支援一鍵複製刪除命令
a4c9c37 fix: 業務說明變更 dismiss 改走 mops_master API（移除直連 PG）
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 184 個 commit（本週）, 184 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
be3e714 fix(web): 給醫師看每區改獨立卡片(方塊)+ 字級放大到 15.5px, 版面更明確
ae963e7 fix(web): 給醫師看 — 內容字級放大(13→15px)+ 建議想問醫師移到最下面
8ed3e08 feat(web): 營養量表過量改用安全上限(UL)判定, 非 1.5x建議量
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 70 個 commit（本週）, 85 個（本月） |
| **技術棧** |  Make |
| **分支** | `feat/monorepo` (2 total) | 1 個 open PR |
| **Git** | 1 dirty, 38 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
2f40605 feat(monitor): MLOps 風格 Worker 時間軸（swimlane Gantt）+ 失敗重跑
df8eb82 refactor(ui): 爬蟲監控 UX 重整 + 資料狀態移到資料閱覽（功能切分乾淨）
54456ad feat(master): 補 alembic migration（spine-schema-sync，per-service 慣例）
156017c refactor(ui): 一般設定 → 資料來源頁（API 三分類的第 1 種）
11c9eeb feat(monitor): 開發藍圖/版本紀錄改 ChimesFlow（單一資料源 release_items）
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-23", "06-24", "06-25", "06-26", "06-27", "06-28", "06-29"]
    y-axis "USD" 0 --> 3800
    bar [2436, 3089, 2389, 1973, 3712, 2519, 2049]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-23 (Tue) | 10 | 2,348 | 1231.9M | $2436.20 |
...
| 2026-06-29 (Mon) | 13 | 1,616 | 834.5M | $2048.96 |
| **Total** | | | **8384.0M** | **$18167.08** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Vault-Peter-Family | 5,638 | 3404.4M | $6647.11 |
| -Users-manibari-code-ChimesFlow | 2,799 | 1471.6M | $3068.06 |
| -Users-manibari-code-mops-dbs | 2,111 | 1142.4M | $2614.82 |
| -Users-manibari-code-tukey-automl | 1,888 | 1031.7M | $2149.72 |
| -Users-manibari-code-rivendell | 936 | 417.6M | $1400.57 |
| -Users-manibari-code | 627 | 358.8M | $724.30 |
| -Users-manibari-code-IC-YMS | 755 | 259.4M | $709.39 |
| -Users-manibari-code-tukey-bi | 457 | 135.9M | $367.94 |
| -Users-manibari-Vault-Peter-Work | 860 | 118.3M | $310.21 |
| -Users-manibari-code-TWstock-invest | 169 | 19.5M | $75.92 |
| -Users-manibari-code-sales-assistant | 260 | 16.0M | $64.06 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-tukey-or | 62 | 5.2M | $20.45 |
| -Users-manibari-code-PTI-ARES | 46 | 3.4M | $14.52 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-29 — 108 skills, 64 issue(s)*
