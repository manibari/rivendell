...
**backend/**
- audio-transcription-flow — 1 次, 58天前
- db-migration — 1 次, 84天前
- doc-to-structured-data — 1 次, 70天前
- docker-compose-setup — 2 次, 48天前
- firebase-backend — 3 次, 27天前
- imap-smtp-integration — 1 次, 72天前
- markdown-file-ssot — 1 次, 72天前
- oauth-token-vault — 1 次, 72天前
- rbac-permissions — 1 次, 58天前
- sqlite-to-postgres — 2 次, 27天前
- tunnel-proxy-deploy — 1 次, 81天前
- tw-company-lookup — 2 次, 80天前
- vector-search-setup — 1 次, 66天前

**docs/**
- chart-design — 1 次, 17天前
- discovery-interview — 1 次, 58天前
- doc-coauthoring — 2 次, 27天前
- excalidraw-diagram — 2 次, 19天前
- gdoc-report-builder — 2 次, 27天前
- internal-comms — 2 次, 27天前
- iot-factory-report — 2 次, 27天前
- mcp-builder — 3 次, 86天前
- mermaid-diagram — 1 次, 20天前
- metadata-workshop — 2 次, 27天前
- office-docx — 4 次, 57天前
- office-pdf — 3 次, 86天前
- office-pptx — 3 次, 86天前
- office-xlsx — 3 次, 86天前
- pitch-deck — 3 次, 27天前
- rfq-writer — 1 次, 57天前
- slide-office-hours — 2 次, 27天前
- slide-template-extractor — 2 次, 27天前
- slide-workflow — 4 次, 27天前
- sow-writer — 2 次, 27天前
- telegram-bot — 1 次, 81天前

**frontend/**
- frontend-design — 2 次, 87天前
- ios-integration — 1 次, 88天前
- swiftui-patterns — 1 次, 88天前
- ui-ux-pro-max — 3 次, 86天前

**git/**
- auto-stage — 3 次, 27天前
- repo-rename — 1 次, 70天前

**meta/**
- agent-persona — 1 次, 52天前
- audit-fix — 1 次, 84天前
- ci-pipeline — 1 次, 84天前
- deploy — 1 次, 84天前
- dev-process-gate — 4 次, 58天前
- init-project — 2 次, 87天前
- knowledge-graph — 1 次, 81天前
- learnings-promotion-sprint — 1 次, 20天前
- plan-check-style — 3 次, 84天前
- self-improving-agent — 3 次, 19天前
- session-harvest — 3 次, 27天前
- session-wrap — 1 次, 51天前
- setup-permissions — 3 次, 84天前
- skill-creator — 4 次, 48天前
- skill-scout — 2 次, 36天前
- sync-readme — 1 次, 65天前
- workflow-retro — 2 次, 27天前

**quality/**
- de-slopify — 2 次, 48天前
- github-repo-audit — 1 次, 52天前
- large-file-refactor — 1 次, 66天前
- protect-secrets — 3 次, 27天前
- qa-auto — 1 次, 81天前
- qa-planner — 1 次, 81天前
- qa-testing — 1 次, 86天前

**workflow/**
- agent-observability — 2 次, 58天前
- autoresearch — 2 次, 27天前
- candidate-analysis — 1 次, 70天前
- claude-to-telegram — 1 次, 81天前
- client-kickoff-docs — 1 次, 43天前
- context-recovery — 1 次, 81天前
- crm-projection — 1 次, 80天前
- customer-intel — 5 次, 27天前
- dispatching-parallel-agents — 4 次, 48天前
- env-doctor — 1 次, 43天前
- executing-plans — 3 次, 86天前
- gdrive-to-skills — 2 次, 87天前
- headless-agent — 6 次, 72天前
- investment-research — 4 次, 27天前
- jd-writer — 1 次, 52天前
- keyword-discovery — 1 次, 72天前
- launchd-agent — 6 次, 27天前
- material-health — 1 次, 80天前
- mockup — 1 次, 88天前
- mops-financial-scraper — 1 次, 43天前
- planning-with-files — 5 次, 58天前
- presales-pipeline — 1 次, 43天前
- repro-exam — 1 次, 43天前
- requirement — 2 次, 58天前
- sales-material — 3 次, 44天前
- settings-audit — 1 次, 71天前
- subsidy-scraper — 1 次, 80天前
- tender-scraper — 3 次, 72天前
- user-flow — 2 次, 20天前
- writing-plans — 3 次, 86天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 110 個 commit（本週）, 247 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 26 個 commit（本週）, 67 個（本月） |
| **技術棧** |  Python |
| **分支** | `next-wave-2026-05` (5 total) | 1 個 open PR |
| **Git** | 2 dirty, 22 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
9d1f04b test: seed fixture path 01-Presales → 02-Deliveries (力成 deal won 2026-06-04)
75bb4ed docs(learnings): verify/recall acceptance harnesses + MTG-HOLE false-negative + US-2
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-29", "05-30", "05-31", "06-01", "06-02", "06-03", "06-04"]
    y-axis "USD" 0 --> 2750
    bar [2080, 1693, 50, 1549, 2049, 2693, 2066]
~~~
...
| 2026-06-04 (Thu) | 11 | 2,130 | 904.1M | $2066.19 |
| **Total** | | | **5250.8M** | **$12180.22** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 4,816 | 2781.5M | $5636.30 |
| -Users-manibari-code | 3,130 | 1278.3M | $3306.08 |
| -Users-manibari-Vault-Peter | 2,231 | 697.1M | $1534.52 |
| -Users-manibari-code-rivendell | 319 | 123.0M | $596.45 |
| -Users-manibari-Vault-Peter-Work | 556 | 187.1M | $456.26 |
| -Users-manibari-code-news-stock | 517 | 106.5M | $380.83 |
| -Users-manibari-code-PTI-ARES | 258 | 39.3M | $106.42 |
| -Users-manibari-code-odb-dfm | 121 | 17.7M | $81.35 |
| -Users-manibari-code-sales-assistant | 304 | 19.3M | $77.80 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-04 — 94 skills, 21 issue(s)*
