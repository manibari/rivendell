...
**backend/**
- audio-transcription-flow — 1 次, 55天前
- db-migration — 1 次, 81天前
- doc-to-structured-data — 1 次, 67天前
- docker-compose-setup — 2 次, 45天前
- firebase-backend — 3 次, 24天前
- imap-smtp-integration — 1 次, 69天前
- markdown-file-ssot — 1 次, 69天前
- oauth-token-vault — 1 次, 69天前
- rbac-permissions — 1 次, 55天前
- sqlite-to-postgres — 2 次, 24天前
- tunnel-proxy-deploy — 1 次, 78天前
- tw-company-lookup — 2 次, 77天前
- vector-search-setup — 1 次, 63天前

**docs/**
- chart-design — 1 次, 14天前
- discovery-interview — 1 次, 55天前
- doc-coauthoring — 2 次, 24天前
- excalidraw-diagram — 2 次, 16天前
- gdoc-report-builder — 2 次, 24天前
- internal-comms — 2 次, 24天前
- iot-factory-report — 2 次, 24天前
- mcp-builder — 3 次, 83天前
- mermaid-diagram — 1 次, 17天前
- metadata-workshop — 2 次, 24天前
- office-docx — 4 次, 54天前
- office-pdf — 3 次, 83天前
- office-pptx — 3 次, 83天前
- office-xlsx — 3 次, 83天前
- pitch-deck — 3 次, 24天前
- rfq-writer — 1 次, 54天前
- slide-office-hours — 2 次, 24天前
- slide-template-extractor — 2 次, 24天前
- slide-workflow — 4 次, 24天前
- sow-writer — 2 次, 24天前
- telegram-bot — 1 次, 78天前

**frontend/**
- frontend-design — 2 次, 84天前
- ios-integration — 1 次, 85天前
- swiftui-patterns — 1 次, 85天前
- ui-ux-pro-max — 3 次, 83天前

**git/**
- auto-stage — 3 次, 24天前
- repo-rename — 1 次, 67天前

**meta/**
- agent-persona — 1 次, 49天前
- audit-fix — 1 次, 81天前
- ci-pipeline — 1 次, 81天前
- deploy — 1 次, 81天前
- dev-process-gate — 4 次, 55天前
- init-project — 2 次, 84天前
- knowledge-graph — 1 次, 78天前
- learnings-promotion-sprint — 1 次, 17天前
- plan-check-style — 3 次, 81天前
- self-improving-agent — 3 次, 16天前
- session-harvest — 3 次, 24天前
- session-wrap — 1 次, 48天前
- setup-permissions — 3 次, 81天前
- skill-creator — 4 次, 45天前
- skill-scout — 2 次, 33天前
- sync-readme — 1 次, 62天前
- workflow-retro — 2 次, 24天前

**quality/**
- de-slopify — 2 次, 45天前
- github-repo-audit — 1 次, 49天前
- large-file-refactor — 1 次, 63天前
- protect-secrets — 3 次, 24天前
- qa-auto — 1 次, 78天前
- qa-planner — 1 次, 78天前
- qa-testing — 1 次, 83天前

**workflow/**
- agent-observability — 2 次, 55天前
- autoresearch — 2 次, 24天前
- candidate-analysis — 1 次, 67天前
- claude-to-telegram — 1 次, 78天前
- client-kickoff-docs — 1 次, 40天前
- context-recovery — 1 次, 78天前
- crm-projection — 1 次, 77天前
- customer-intel — 5 次, 24天前
- dispatching-parallel-agents — 4 次, 45天前
- env-doctor — 1 次, 40天前
- executing-plans — 3 次, 83天前
- gdrive-to-skills — 2 次, 84天前
- headless-agent — 6 次, 69天前
- investment-research — 4 次, 24天前
- jd-writer — 1 次, 49天前
- keyword-discovery — 1 次, 69天前
- launchd-agent — 6 次, 24天前
- material-health — 1 次, 77天前
- mockup — 1 次, 85天前
- mops-financial-scraper — 1 次, 40天前
- planning-with-files — 5 次, 55天前
- presales-pipeline — 1 次, 40天前
- repro-exam — 1 次, 40天前
- requirement — 2 次, 55天前
- sales-material — 3 次, 41天前
- settings-audit — 1 次, 68天前
- subsidy-scraper — 1 次, 77天前
- tender-scraper — 3 次, 69天前
- user-flow — 2 次, 17天前
- writing-plans — 3 次, 83天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 102 個 commit（本週）, 202 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (1 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
a35c9a6 test: repair the broken pytest suite (ARRAY-on-SQLite) + refresh stale RBAC
32d01ad fix(enrich): gov agencies / non-companies return None instead of a blank record
c5c3164 docs(roadmap): redesign as workstreams (W1–W6) with dependency chain
f3efe21 docs(accounting): capture financial-engine spec (保固/保修, 人力分類, 工時, work-codes)
820de7f fix(enrich): 分公司 borrows head-office capital + full-list industry match
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["05-26", "05-27", "05-28", "05-29", "05-30", "05-31", "06-01"]
    y-axis "USD" 0 --> 2150
    bar [2047, 1718, 1095, 2080, 1693, 50, 1517]
~~~
...
| 2026-06-01 (Mon) | 9 | 1,793 | 734.2M | $1516.91 |
| **Total** | | | **4503.6M** | **$10200.22** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 2,969 | 1610.4M | $3285.86 |
| -Users-manibari-code-odb-dfm | 3,361 | 1512.7M | $3085.09 |
| -Users-manibari-code | 1,482 | 642.9M | $1752.56 |
| -Users-manibari-Vault-Peter | 1,438 | 343.7M | $749.30 |
| -Users-manibari-code-rivendell | 411 | 142.0M | $651.79 |
| -Users-manibari-Vault-Peter-Work | 556 | 187.1M | $456.26 |
| -Users-manibari-code-news-stock | 276 | 27.7M | $93.29 |
| -Users-manibari-code-sales-assistant | 321 | 21.6M | $86.36 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-01 — 94 skills, 21 issue(s)*
