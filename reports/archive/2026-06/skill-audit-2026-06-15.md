...
**workflow/**
- env-doctor — 2 次修訂, 0天前
- mops-financial-scraper — 2 次修訂, 0天前
- presales-pipeline — 2 次修訂, 0天前
- repro-exam — 2 次修訂, 0天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 95天前 (2026-03-12)
- tunnel-proxy-deploy — 1 次, 92天前 (2026-03-15)
- tw-company-lookup — 2 次, 91天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 97天前 (2026-03-10)
- office-pdf — 3 次, 97天前 (2026-03-10)
- office-pptx — 3 次, 97天前 (2026-03-10)
- office-xlsx — 3 次, 97天前 (2026-03-10)
- telegram-bot — 1 次, 92天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 98天前 (2026-03-09)
- ios-integration — 1 次, 99天前 (2026-03-08)
- swiftui-patterns — 1 次, 99天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 97天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 95天前 (2026-03-12)
- ci-pipeline — 1 次, 95天前 (2026-03-12)
- deploy — 1 次, 95天前 (2026-03-12)
- init-project — 2 次, 98天前 (2026-03-09)
- knowledge-graph — 1 次, 92天前 (2026-03-15)
- plan-check-style — 3 次, 95天前 (2026-03-12)
- setup-permissions — 3 次, 95天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 92天前 (2026-03-15)
- qa-planner — 1 次, 92天前 (2026-03-15)
- qa-testing — 1 次, 97天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 92天前 (2026-03-15)
- context-recovery — 1 次, 92天前 (2026-03-15)
- crm-projection — 1 次, 91天前 (2026-03-16)
- executing-plans — 3 次, 97天前 (2026-03-10)
- gdrive-to-skills — 2 次, 98天前 (2026-03-09)
- material-health — 1 次, 91天前 (2026-03-16)
- mockup — 1 次, 99天前 (2026-03-08)
- subsidy-scraper — 1 次, 91天前 (2026-03-16)
- writing-plans — 3 次, 97天前 (2026-03-10)

<details><summary>✅ 穩定 (61)</summary>

**backend/**
- audio-transcription-flow — 1 次, 69天前
- doc-to-structured-data — 1 次, 81天前
- docker-compose-setup — 2 次, 59天前
- firebase-backend — 3 次, 38天前
- imap-smtp-integration — 1 次, 83天前
- markdown-file-ssot — 1 次, 83天前
- oauth-token-vault — 1 次, 83天前
- rbac-permissions — 1 次, 69天前
- sqlite-to-postgres — 2 次, 38天前
- vector-search-setup — 1 次, 77天前

**docs/**
- chart-design — 1 次, 28天前
- discovery-interview — 1 次, 69天前
- doc-coauthoring — 2 次, 38天前
- excalidraw-diagram — 2 次, 30天前
- gdoc-report-builder — 2 次, 38天前
- internal-comms — 2 次, 38天前
- iot-factory-report — 2 次, 38天前
- mermaid-diagram — 1 次, 31天前
- metadata-workshop — 2 次, 38天前
- office-docx — 4 次, 68天前
- pitch-deck — 3 次, 38天前
- rfq-writer — 1 次, 68天前
- slide-office-hours — 2 次, 38天前
- slide-template-extractor — 2 次, 38天前
- slide-workflow — 4 次, 38天前
- sow-writer — 2 次, 38天前

**frontend/**
- chimesflow-design — 1 次, 4天前

**git/**
- auto-stage — 3 次, 38天前
- repo-rename — 1 次, 81天前

**meta/**
- agent-persona — 1 次, 63天前
- dev-process-gate — 4 次, 69天前
- learnings-promotion-sprint — 1 次, 31天前
- self-improving-agent — 3 次, 30天前
- session-harvest — 3 次, 38天前
- session-wrap — 1 次, 62天前
- skill-creator — 4 次, 59天前
- skill-scout — 2 次, 47天前
- sync-readme — 1 次, 76天前
- workflow-retro — 2 次, 38天前

**quality/**
- de-slopify — 2 次, 59天前
- github-repo-audit — 1 次, 63天前
- large-file-refactor — 1 次, 77天前
- protect-secrets — 3 次, 38天前

**workflow/**
- agent-observability — 2 次, 69天前
- app-ops-baseline — 1 次, 4天前
- autoresearch — 2 次, 38天前
- candidate-analysis — 1 次, 81天前
- client-kickoff-docs — 1 次, 54天前
- customer-intel — 5 次, 38天前
- dispatching-parallel-agents — 4 次, 59天前
- headless-agent — 6 次, 83天前
- investment-research — 4 次, 38天前
- jd-writer — 1 次, 63天前
- keyword-discovery — 1 次, 83天前
- launchd-agent — 6 次, 38天前
- planning-with-files — 5 次, 69天前
- requirement — 2 次, 69天前
- sales-material — 3 次, 55天前
- settings-audit — 1 次, 82天前
- tender-scraper — 3 次, 83天前
- user-flow — 2 次, 31天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 119 個 commit（本週）, 374 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (2 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
0e7eaa1 Merge pull request #17 from Chimes-AI-Projects/feat/channel-partner-presales-tracking
08893a2 chore(release): ship v1.23.0 — work-log Phase A (partner / work_type+opp / first_met)
39e9b33 feat(work-log): Phase A — activities page partner field + account first_met UI
4ca8915 feat(work-log): Phase A — today page B/C/D/G + account-list first_met
eb5ee04 feat(work-log): Phase A backend API — partner_id / opportunity_id+work_type / first_met
```
</details>
...
d94a934 mockup: PTI-ARES console — dark 2K desktop, Violation Review workspace as hero
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-09", "06-10", "06-11", "06-12", "06-13", "06-14", "06-15"]
    y-axis "USD" 0 --> 3000
    bar [2528, 1774, 1301, 2932, 2283, 959, 1953]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-09 (Tue) | 6 | 2,359 | 1417.2M | $2527.95 |
...
| 2026-06-15 (Mon) | 7 | 2,021 | 960.4M | $1953.44 |
| **Total** | | | **6659.7M** | **$13729.92** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 4,869 | 2781.2M | $5243.05 |
| -Users-manibari-code-tukey-automl | 3,783 | 1801.9M | $3486.22 |
| -Users-manibari-code | 3,177 | 1438.7M | $3210.72 |
| -Users-manibari-Vault-Peter-Work | 1,267 | 209.4M | $569.01 |
| -Users-manibari-code-rivendell | 673 | 174.6M | $492.47 |
| -Users-manibari-code-Family-Fiscal | 661 | 146.5M | $322.83 |
| -Users-manibari-code-tukey-bi | 294 | 47.8M | $149.55 |
| -Users-manibari-code-vantage-3dgs | 58 | 20.0M | $94.71 |
| -Users-manibari-code-sales-assistant | 328 | 21.4M | $85.81 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-15 — 96 skills, 46 issue(s)*
