...
**backend/**
- backend-async-jobs — 2 次修訂, 7天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 8天前
- env-doctor — 3 次修訂, 8天前
- mops-financial-scraper — 3 次修訂, 8天前
- presales-pipeline — 3 次修訂, 8天前
- repro-exam — 3 次修訂, 8天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 104天前 (2026-03-12)
- imap-smtp-integration — 1 次, 92天前 (2026-03-24)
- markdown-file-ssot — 1 次, 92天前 (2026-03-24)
- oauth-token-vault — 1 次, 92天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 101天前 (2026-03-15)
- tw-company-lookup — 2 次, 100天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 106天前 (2026-03-10)
- office-pdf — 3 次, 106天前 (2026-03-10)
- office-pptx — 3 次, 106天前 (2026-03-10)
- office-xlsx — 3 次, 106天前 (2026-03-10)
- telegram-bot — 1 次, 101天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 107天前 (2026-03-09)
- ios-integration — 1 次, 108天前 (2026-03-08)
- swiftui-patterns — 1 次, 108天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 106天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 104天前 (2026-03-12)
- ci-pipeline — 1 次, 104天前 (2026-03-12)
- deploy — 1 次, 104天前 (2026-03-12)
- init-project — 2 次, 107天前 (2026-03-09)
- knowledge-graph — 1 次, 101天前 (2026-03-15)
- plan-check-style — 3 次, 104天前 (2026-03-12)
- setup-permissions — 3 次, 104天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 101天前 (2026-03-15)
- qa-planner — 1 次, 101天前 (2026-03-15)
- qa-testing — 1 次, 106天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 101天前 (2026-03-15)
- context-recovery — 1 次, 101天前 (2026-03-15)
- crm-projection — 1 次, 100天前 (2026-03-16)
- executing-plans — 3 次, 106天前 (2026-03-10)
- gdrive-to-skills — 2 次, 107天前 (2026-03-09)
- headless-agent — 6 次, 92天前 (2026-03-24)
- keyword-discovery — 1 次, 92天前 (2026-03-24)
- material-health — 1 次, 100天前 (2026-03-16)
- mockup — 1 次, 108天前 (2026-03-08)
- settings-audit — 1 次, 91天前 (2026-03-25)
- subsidy-scraper — 1 次, 100天前 (2026-03-16)
- tender-scraper — 3 次, 92天前 (2026-03-24)
- writing-plans — 3 次, 106天前 (2026-03-10)

<details><summary>✅ 穩定 (59)</summary>

**backend/**
- audio-transcription-flow — 1 次, 78天前
- doc-to-structured-data — 1 次, 90天前
- docker-compose-setup — 2 次, 68天前
- firebase-backend — 3 次, 47天前
- ic-lot-normalization — 1 次, 0天前
- ml-eval-quality — 1 次, 0天前
- ml-model-registry — 1 次, 0天前
- odb-dfm-reference — 1 次, 0天前
- rbac-permissions — 1 次, 78天前
- sqlite-to-postgres — 2 次, 47天前
- vector-search-setup — 1 次, 86天前

**docs/**
- chart-design — 1 次, 37天前
- discovery-interview — 1 次, 78天前
- doc-coauthoring — 2 次, 47天前
- excalidraw-diagram — 2 次, 39天前
- gdoc-report-builder — 2 次, 47天前
- internal-comms — 2 次, 47天前
- iot-factory-report — 2 次, 47天前
- mermaid-diagram — 1 次, 40天前
- metadata-workshop — 2 次, 47天前
- office-docx — 4 次, 77天前
- pitch-deck — 3 次, 47天前
- rfq-writer — 1 次, 77天前
- slide-office-hours — 2 次, 47天前
- slide-template-extractor — 2 次, 47天前
- slide-workflow — 4 次, 47天前
- sow-writer — 2 次, 47天前

**frontend/**
- chimesflow-design — 1 次, 13天前

**git/**
- auto-stage — 3 次, 47天前
- concurrent-session-git — 1 次, 7天前
- repo-rename — 1 次, 90天前

**meta/**
- agent-persona — 1 次, 72天前
- dev-process-gate — 4 次, 78天前
- learnings-promotion-sprint — 1 次, 40天前
- self-improving-agent — 3 次, 39天前
- session-harvest — 3 次, 47天前
- session-wrap — 1 次, 71天前
- skill-creator — 4 次, 68天前
- skill-scout — 2 次, 56天前
- sync-readme — 1 次, 85天前
- task-brief — 1 次, 8天前
- workflow-retro — 2 次, 47天前

**quality/**
- de-slopify — 2 次, 68天前
- github-repo-audit — 1 次, 72天前
- large-file-refactor — 1 次, 86天前
- protect-secrets — 3 次, 47天前

**workflow/**
- agent-observability — 2 次, 78天前
- app-ops-baseline — 1 次, 13天前
- autoresearch — 2 次, 47天前
- candidate-analysis — 1 次, 90天前
- customer-intel — 5 次, 47天前
- dispatching-parallel-agents — 4 次, 68天前
- investment-research — 4 次, 47天前
- jd-writer — 1 次, 72天前
- launchd-agent — 6 次, 47天前
- planning-with-files — 5 次, 78天前
- requirement — 2 次, 78天前
- sales-material — 3 次, 64天前
- user-flow — 2 次, 40天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 77 個 commit（本週）, 448 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/orgchart-drag-members` (7 total) | 2 個 open PR |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
94fb177 fix(departments): member-transfer modal overflow (tags spilling past list)
1a8f571 feat(org): drag members between departments in the org chart (v1.33.13)
82131a3 fix(products): move 關聯商機/報價 list to bottom of edit drawer (v1.33.12)
5cbb401 feat(products): list linked opportunities/quotes in edit drawer (v1.33.11) (#82)
3759679 fix(products): surface delete in tree view (default), tooltip in table (v1.33.10) (#81)
```
</details>
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 2 個 commit（本週）, 135 個（本月） |
| **技術棧** |  Node.js Python |
...
```
571653f feat(web): 改用 Clerk 取代 Auth.js — 零 Google Console 設定的 Google 登入
288bed6 feat(web): 改 Google OAuth(Auth.js v5)取代極簡密碼 — 修我誤推 OAuth 到階段二
2669e51 feat(web): M4 PWA 離線讀 + iOS meta + 部署(Cloudflare Tunnel)
7d4ba6e feat(web): M3 記錄(photo-first)+ 上傳 Route Handler + history
bfcd781 feat(web): M2b 極簡 Auth — 共享密碼 cookie + middleware 守門
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-18", "06-19", "06-20", "06-21", "06-22", "06-23", "06-24"]
    y-axis "USD" 0 --> 2550
    bar [1976, 34, 125, 1728, 1166, 2436, 2484]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-18 (Thu) | 8 | 1,970 | 1029.4M | $1976.18 |
| 2026-06-19 (Fri) | 3 | 29 | 7.1M | $34.49 |
| 2026-06-20 (Sat) | 3 | 159 | 48.1M | $125.14 |
| 2026-06-21 (Sun) | 10 | 1,616 | 872.0M | $1728.42 |
| 2026-06-22 (Mon) | 8 | 1,238 | 516.9M | $1166.02 |
| 2026-06-23 (Tue) | 10 | 2,348 | 1231.9M | $2436.20 |
| 2026-06-24 (Wed) | 10 | 2,559 | 1177.4M | $2484.30 |
| **Total** | | | **4882.8M** | **$9950.76** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-tukey-automl | 3,151 | 1680.8M | $3230.57 |
| -Users-manibari-code-ChimesFlow | 2,781 | 1461.9M | $2802.38 |
| -Users-manibari-Vault-Peter-Family | 1,756 | 937.6M | $1850.87 |
| -Users-manibari-code | 994 | 538.7M | $1254.21 |
| -Users-manibari-code-rivendell | 302 | 171.8M | $504.38 |
| -Users-manibari-code-mops-dbs | 208 | 32.8M | $101.75 |
| -Users-manibari-Vault-Peter-Work | 245 | 25.8M | $74.24 |
| -Users-manibari-code-sales-assistant | 272 | 17.5M | $73.63 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-PTI-ARES | 122 | 9.1M | $28.45 |
| -Users-manibari-code-tukey-or | 62 | 5.2M | $20.45 |
| -Users-manibari-Vault-Peter | 26 | 1.7M | $9.83 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-24 — 103 skills, 58 issue(s)*
