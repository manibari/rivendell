...
**backend/**
- backend-async-jobs — 2 次修訂, 10天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 11天前
- env-doctor — 3 次修訂, 11天前
- mops-financial-scraper — 3 次修訂, 11天前
- presales-pipeline — 3 次修訂, 11天前
- repro-exam — 3 次修訂, 11天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 107天前 (2026-03-12)
- doc-to-structured-data — 1 次, 93天前 (2026-03-26)
- imap-smtp-integration — 1 次, 95天前 (2026-03-24)
- markdown-file-ssot — 1 次, 95天前 (2026-03-24)
- oauth-token-vault — 1 次, 95天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 104天前 (2026-03-15)
- tw-company-lookup — 2 次, 103天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 109天前 (2026-03-10)
- office-pdf — 3 次, 109天前 (2026-03-10)
- office-pptx — 3 次, 109天前 (2026-03-10)
- office-xlsx — 3 次, 109天前 (2026-03-10)
- telegram-bot — 1 次, 104天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 110天前 (2026-03-09)
- ios-integration — 1 次, 111天前 (2026-03-08)
- swiftui-patterns — 1 次, 111天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 109天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 93天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 107天前 (2026-03-12)
- ci-pipeline — 1 次, 107天前 (2026-03-12)
- deploy — 1 次, 107天前 (2026-03-12)
- init-project — 2 次, 110天前 (2026-03-09)
- knowledge-graph — 1 次, 104天前 (2026-03-15)
- plan-check-style — 3 次, 107天前 (2026-03-12)
- setup-permissions — 3 次, 107天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 104天前 (2026-03-15)
- qa-planner — 1 次, 104天前 (2026-03-15)
- qa-testing — 1 次, 109天前 (2026-03-10)

**workflow/**
- candidate-analysis — 1 次, 93天前 (2026-03-26)
- claude-to-telegram — 1 次, 104天前 (2026-03-15)
- context-recovery — 1 次, 104天前 (2026-03-15)
- crm-projection — 1 次, 103天前 (2026-03-16)
- executing-plans — 3 次, 109天前 (2026-03-10)
- gdrive-to-skills — 2 次, 110天前 (2026-03-09)
- headless-agent — 6 次, 95天前 (2026-03-24)
- keyword-discovery — 1 次, 95天前 (2026-03-24)
- material-health — 1 次, 103天前 (2026-03-16)
- mockup — 1 次, 111天前 (2026-03-08)
- settings-audit — 1 次, 94天前 (2026-03-25)
- subsidy-scraper — 1 次, 103天前 (2026-03-16)
- tender-scraper — 3 次, 95天前 (2026-03-24)
- writing-plans — 3 次, 109天前 (2026-03-10)

<details><summary>✅ 穩定 (56)</summary>

**backend/**
- audio-transcription-flow — 1 次, 81天前
- docker-compose-setup — 2 次, 71天前
- firebase-backend — 3 次, 50天前
- ic-lot-normalization — 1 次, 3天前
- ml-eval-quality — 1 次, 3天前
- ml-model-registry — 1 次, 3天前
- odb-dfm-reference — 1 次, 3天前
- rbac-permissions — 1 次, 81天前
- sqlite-to-postgres — 2 次, 50天前
- vector-search-setup — 1 次, 89天前

**docs/**
- chart-design — 1 次, 40天前
- discovery-interview — 1 次, 81天前
- doc-coauthoring — 2 次, 50天前
- excalidraw-diagram — 2 次, 42天前
- gdoc-report-builder — 2 次, 50天前
- internal-comms — 2 次, 50天前
- iot-factory-report — 2 次, 50天前
- mermaid-diagram — 1 次, 43天前
- metadata-workshop — 2 次, 50天前
- office-docx — 4 次, 80天前
- pitch-deck — 3 次, 50天前
- rfq-writer — 1 次, 80天前
- slide-office-hours — 2 次, 50天前
- slide-template-extractor — 2 次, 50天前
- slide-workflow — 4 次, 50天前
- sow-writer — 2 次, 50天前

**frontend/**
- chimesflow-design — 1 次, 16天前

**git/**
- auto-stage — 3 次, 50天前
- concurrent-session-git — 1 次, 10天前

**meta/**
- agent-persona — 1 次, 75天前
- dev-process-gate — 4 次, 81天前
- learnings-promotion-sprint — 1 次, 43天前
- self-improving-agent — 3 次, 42天前
- session-harvest — 3 次, 50天前
- session-wrap — 1 次, 74天前
- skill-creator — 4 次, 71天前
- skill-scout — 2 次, 59天前
- sync-readme — 1 次, 88天前
- task-brief — 1 次, 11天前
- workflow-retro — 2 次, 50天前

**quality/**
- de-slopify — 2 次, 71天前
- github-repo-audit — 1 次, 75天前
- large-file-refactor — 1 次, 89天前
- protect-secrets — 3 次, 50天前

**workflow/**
- agent-observability — 2 次, 81天前
- app-ops-baseline — 1 次, 16天前
- autoresearch — 2 次, 50天前
- customer-intel — 5 次, 50天前
- dispatching-parallel-agents — 4 次, 71天前
- investment-research — 4 次, 50天前
- jd-writer — 1 次, 75天前
- launchd-agent — 6 次, 50天前
- planning-with-files — 5 次, 81天前
- requirement — 2 次, 81天前
- sales-material — 3 次, 67天前
- user-flow — 2 次, 43天前
...
```
364a922 feat: 後端 Swagger API 文件(/docs)+ admin 系統狀態監控面板
b8a4450 fix(ops): compose 加 restart: unless-stopped(防 process 掛掉→站 500)
f720745 feat(web): 卡通胎兒 — 自繪 SVG 睡寶寶 + 每週大小/水果對比(engagement)
3398709 docs(roadmap): 加入競品借鏡 + 視覺體驗重點軸 + 差異化
9b63332 docs: 更新歷程 v0.5.0(家庭分享/顯示密碼/相簿上傳/版本footer/Docker)
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 39 個 commit（本週）, 53 個（本月） |
| **技術棧** |  Make |
| **分支** | `feat/monorepo` (2 total) | 1 個 open PR |
| **Git** | 2 dirty, 6 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
7e2e6cd test(monitor): 端對端 QA 腳本（爬蟲監控+資料閱覽+下載）
5a46c77 feat(monitor): 資料閱覽改 Excel 風格表（凍結窗格+千元+下載）
46a7444 feat(monitor): 資料閱覽加「已爬取公司」入口（解決進頁空白）
150469a feat(monitor): 爬蟲可選起始年份 + 修「已是最新」誤導訊息
681492e feat(monitor): React SPA 前端（ChimesFlow 淺色）— 爬蟲監控 + 資料閱覽兩頁
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-21", "06-22", "06-23", "06-24", "06-25", "06-26", "06-27"]
    y-axis "USD" 0 --> 3150
    bar [1728, 1166, 2436, 3089, 2389, 1973, 1778]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-21 (Sun) | 10 | 1,616 | 872.0M | $1728.42 |
...
| 2026-06-27 (Sat) | 8 | 1,418 | 797.7M | $1777.90 |
| **Total** | | | **6856.1M** | **$14559.30** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Vault-Peter-Family | 3,302 | 1945.0M | $3880.58 |
| -Users-manibari-code-ChimesFlow | 3,749 | 1956.2M | $3774.15 |
| -Users-manibari-code-tukey-automl | 2,300 | 1352.5M | $2796.23 |
| -Users-manibari-code | 943 | 513.9M | $1170.56 |
| -Users-manibari-code-mops-dbs | 974 | 444.9M | $1061.58 |
| -Users-manibari-code-rivendell | 675 | 279.1M | $906.58 |
| -Users-manibari-code-tukey-bi | 457 | 135.9M | $367.94 |
| -Users-manibari-code-IC-YMS | 504 | 141.9M | $313.45 |
| -Users-manibari-Vault-Peter-Work | 509 | 51.5M | $151.16 |
| -Users-manibari-code-sales-assistant | 295 | 18.5M | $76.97 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-PTI-ARES | 146 | 10.2M | $32.67 |
| -Users-manibari-code-tukey-or | 62 | 5.2M | $20.45 |
| -Users-manibari-Vault-Peter | 19 | 1.3M | $6.99 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-27 — 103 skills, 62 issue(s)*
