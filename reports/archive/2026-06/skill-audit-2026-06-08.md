...
**frontend/**
- frontend-design — 2 次, 91天前 (2026-03-09)
- ios-integration — 1 次, 92天前 (2026-03-08)
- swiftui-patterns — 1 次, 92天前 (2026-03-08)

**meta/**
- init-project — 2 次, 91天前 (2026-03-09)

**workflow/**
- gdrive-to-skills — 2 次, 91天前 (2026-03-09)
- mockup — 1 次, 92天前 (2026-03-08)

<details><summary>✅ 穩定 (88)</summary>

**backend/**
- audio-transcription-flow — 1 次, 62天前
- db-migration — 1 次, 88天前
- doc-to-structured-data — 1 次, 74天前
- docker-compose-setup — 2 次, 52天前
- firebase-backend — 3 次, 31天前
- imap-smtp-integration — 1 次, 76天前
- markdown-file-ssot — 1 次, 76天前
- oauth-token-vault — 1 次, 76天前
- rbac-permissions — 1 次, 62天前
- sqlite-to-postgres — 2 次, 31天前
- tunnel-proxy-deploy — 1 次, 85天前
- tw-company-lookup — 2 次, 84天前
- vector-search-setup — 1 次, 70天前

**docs/**
- chart-design — 1 次, 21天前
- discovery-interview — 1 次, 62天前
- doc-coauthoring — 2 次, 31天前
- excalidraw-diagram — 2 次, 23天前
- gdoc-report-builder — 2 次, 31天前
- internal-comms — 2 次, 31天前
- iot-factory-report — 2 次, 31天前
- mcp-builder — 3 次, 90天前
- mermaid-diagram — 1 次, 24天前
- metadata-workshop — 2 次, 31天前
- office-docx — 4 次, 61天前
- office-pdf — 3 次, 90天前
- office-pptx — 3 次, 90天前
- office-xlsx — 3 次, 90天前
- pitch-deck — 3 次, 31天前
- rfq-writer — 1 次, 61天前
- slide-office-hours — 2 次, 31天前
- slide-template-extractor — 2 次, 31天前
- slide-workflow — 4 次, 31天前
- sow-writer — 2 次, 31天前
- telegram-bot — 1 次, 85天前

**frontend/**
- ui-ux-pro-max — 3 次, 90天前

**git/**
- auto-stage — 3 次, 31天前
- repo-rename — 1 次, 74天前

**meta/**
- agent-persona — 1 次, 56天前
- audit-fix — 1 次, 88天前
- ci-pipeline — 1 次, 88天前
- deploy — 1 次, 88天前
- dev-process-gate — 4 次, 62天前
- knowledge-graph — 1 次, 85天前
- learnings-promotion-sprint — 1 次, 24天前
- plan-check-style — 3 次, 88天前
- self-improving-agent — 3 次, 23天前
- session-harvest — 3 次, 31天前
- session-wrap — 1 次, 55天前
- setup-permissions — 3 次, 88天前
- skill-creator — 4 次, 52天前
- skill-scout — 2 次, 40天前
- sync-readme — 1 次, 69天前
- workflow-retro — 2 次, 31天前

**quality/**
- de-slopify — 2 次, 52天前
- github-repo-audit — 1 次, 56天前
- large-file-refactor — 1 次, 70天前
- protect-secrets — 3 次, 31天前
- qa-auto — 1 次, 85天前
- qa-planner — 1 次, 85天前
- qa-testing — 1 次, 90天前

**workflow/**
- agent-observability — 2 次, 62天前
- autoresearch — 2 次, 31天前
- candidate-analysis — 1 次, 74天前
- claude-to-telegram — 1 次, 85天前
- client-kickoff-docs — 1 次, 47天前
- context-recovery — 1 次, 85天前
- crm-projection — 1 次, 84天前
- customer-intel — 5 次, 31天前
- dispatching-parallel-agents — 4 次, 52天前
- env-doctor — 1 次, 47天前
- executing-plans — 3 次, 90天前
- headless-agent — 6 次, 76天前
- investment-research — 4 次, 31天前
- jd-writer — 1 次, 56天前
- keyword-discovery — 1 次, 76天前
- launchd-agent — 6 次, 31天前
- material-health — 1 次, 84天前
- mops-financial-scraper — 1 次, 47天前
- planning-with-files — 5 次, 62天前
- presales-pipeline — 1 次, 47天前
- repro-exam — 1 次, 47天前
- requirement — 2 次, 62天前
- sales-material — 3 次, 48天前
- settings-audit — 1 次, 75天前
- subsidy-scraper — 1 次, 84天前
- tender-scraper — 3 次, 76天前
- user-flow — 2 次, 24天前
- writing-plans — 3 次, 90天前
...
```
4f00d85 fix(quotes): 備註 supports line breaks
e40a577 fix(targets): 個人 target can target a specific user (managers set for reps)
fb0de89 feat(documents): generic document-template generation engine (Slice 2)
d2839fc feat(ux): proper 返回上一頁 + 週會 P0 filter + P6 links existing quote
a51764e feat(roadmap): 出貨回顧 view — shipped by 30/60/90-day window with dates
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-02", "06-03", "06-04", "06-05", "06-06", "06-07", "06-08"]
    y-axis "USD" 0 --> 2750
    bar [2049, 2693, 2297, 376, 7, 448, 1207]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-02 (Tue) | 7 | 1,964 | 973.8M | $2049.17 |
...
| 2026-06-08 (Mon) | 8 | 1,310 | 588.5M | $1206.51 |
| **Total** | | | **4167.1M** | **$9076.64** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 3,959 | 1929.6M | $3859.66 |
| -Users-manibari-code | 2,989 | 1359.4M | $2838.41 |
| -Users-manibari-Vault-Peter | 1,305 | 422.3M | $975.02 |
| -Users-manibari-code-3DGS | 641 | 209.4M | $525.84 |
| -Users-manibari-code-news-stock | 218 | 71.6M | $273.98 |
| -Users-manibari-code-rivendell | 164 | 42.9M | $234.02 |
| -Users-manibari-code-PTI-ARES | 379 | 72.2M | $180.68 |
| -Users-manibari-Vault-Peter-Work | 292 | 30.2M | $77.84 |
| -Users-manibari-code-sales-assistant | 262 | 15.6M | $64.00 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-08 — 94 skills, 27 issue(s)*
