...
**backend/**
- backend-async-jobs — 2 次修訂, 8天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 9天前
- env-doctor — 3 次修訂, 9天前
- mops-financial-scraper — 3 次修訂, 9天前
- presales-pipeline — 3 次修訂, 9天前
- repro-exam — 3 次修訂, 9天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 105天前 (2026-03-12)
- doc-to-structured-data — 1 次, 91天前 (2026-03-26)
- imap-smtp-integration — 1 次, 93天前 (2026-03-24)
- markdown-file-ssot — 1 次, 93天前 (2026-03-24)
- oauth-token-vault — 1 次, 93天前 (2026-03-24)
- tunnel-proxy-deploy — 1 次, 102天前 (2026-03-15)
- tw-company-lookup — 2 次, 101天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 107天前 (2026-03-10)
- office-pdf — 3 次, 107天前 (2026-03-10)
- office-pptx — 3 次, 107天前 (2026-03-10)
- office-xlsx — 3 次, 107天前 (2026-03-10)
- telegram-bot — 1 次, 102天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 108天前 (2026-03-09)
- ios-integration — 1 次, 109天前 (2026-03-08)
- swiftui-patterns — 1 次, 109天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 107天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 91天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 105天前 (2026-03-12)
- ci-pipeline — 1 次, 105天前 (2026-03-12)
- deploy — 1 次, 105天前 (2026-03-12)
- init-project — 2 次, 108天前 (2026-03-09)
- knowledge-graph — 1 次, 102天前 (2026-03-15)
- plan-check-style — 3 次, 105天前 (2026-03-12)
- setup-permissions — 3 次, 105天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 102天前 (2026-03-15)
- qa-planner — 1 次, 102天前 (2026-03-15)
- qa-testing — 1 次, 107天前 (2026-03-10)

**workflow/**
- candidate-analysis — 1 次, 91天前 (2026-03-26)
- claude-to-telegram — 1 次, 102天前 (2026-03-15)
- context-recovery — 1 次, 102天前 (2026-03-15)
- crm-projection — 1 次, 101天前 (2026-03-16)
- executing-plans — 3 次, 107天前 (2026-03-10)
- gdrive-to-skills — 2 次, 108天前 (2026-03-09)
- headless-agent — 6 次, 93天前 (2026-03-24)
- keyword-discovery — 1 次, 93天前 (2026-03-24)
- material-health — 1 次, 101天前 (2026-03-16)
- mockup — 1 次, 109天前 (2026-03-08)
- settings-audit — 1 次, 92天前 (2026-03-25)
- subsidy-scraper — 1 次, 101天前 (2026-03-16)
- tender-scraper — 3 次, 93天前 (2026-03-24)
- writing-plans — 3 次, 107天前 (2026-03-10)

<details><summary>✅ 穩定 (56)</summary>

**backend/**
- audio-transcription-flow — 1 次, 79天前
- docker-compose-setup — 2 次, 69天前
- firebase-backend — 3 次, 48天前
- ic-lot-normalization — 1 次, 1天前
- ml-eval-quality — 1 次, 1天前
- ml-model-registry — 1 次, 1天前
- odb-dfm-reference — 1 次, 1天前
- rbac-permissions — 1 次, 79天前
- sqlite-to-postgres — 2 次, 48天前
- vector-search-setup — 1 次, 87天前

**docs/**
- chart-design — 1 次, 38天前
- discovery-interview — 1 次, 79天前
- doc-coauthoring — 2 次, 48天前
- excalidraw-diagram — 2 次, 40天前
- gdoc-report-builder — 2 次, 48天前
- internal-comms — 2 次, 48天前
- iot-factory-report — 2 次, 48天前
- mermaid-diagram — 1 次, 41天前
- metadata-workshop — 2 次, 48天前
- office-docx — 4 次, 78天前
- pitch-deck — 3 次, 48天前
- rfq-writer — 1 次, 78天前
- slide-office-hours — 2 次, 48天前
- slide-template-extractor — 2 次, 48天前
- slide-workflow — 4 次, 48天前
- sow-writer — 2 次, 48天前

**frontend/**
- chimesflow-design — 1 次, 14天前

**git/**
- auto-stage — 3 次, 48天前
- concurrent-session-git — 1 次, 8天前

**meta/**
- agent-persona — 1 次, 73天前
- dev-process-gate — 4 次, 79天前
- learnings-promotion-sprint — 1 次, 41天前
- self-improving-agent — 3 次, 40天前
- session-harvest — 3 次, 48天前
- session-wrap — 1 次, 72天前
- skill-creator — 4 次, 69天前
- skill-scout — 2 次, 57天前
- sync-readme — 1 次, 86天前
- task-brief — 1 次, 9天前
- workflow-retro — 2 次, 48天前

**quality/**
- de-slopify — 2 次, 69天前
- github-repo-audit — 1 次, 73天前
- large-file-refactor — 1 次, 87天前
- protect-secrets — 3 次, 48天前

**workflow/**
- agent-observability — 2 次, 79天前
- app-ops-baseline — 1 次, 14天前
- autoresearch — 2 次, 48天前
- customer-intel — 5 次, 48天前
- dispatching-parallel-agents — 4 次, 69天前
- investment-research — 4 次, 48天前
- jd-writer — 1 次, 73天前
- launchd-agent — 6 次, 48天前
- planning-with-files — 5 次, 79天前
- requirement — 2 次, 79天前
- sales-material — 3 次, 65天前
- user-flow — 2 次, 41天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 51 個 commit（本週）, 408 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/feedback-image-and-mine` (8 total) | 1 個 open PR |
| **Git** | 5 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
c09dbaf feat: feedback screenshots + my-feedback view + closeout URL attachments (v1.33.16)
94c399a feat(quotes): 報價可上傳客戶回簽 PDF (v1.33.15) (#87)
cba51f8 test(e2e): add Playwright smoke harness for 破圖 / flow regressions (#85)
ad39205 feat(org): 組織圖拖曳調動成員 + 折入 #83 (v1.33.13) (#84)
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 2 個 commit（本週）, 126 個（本月） |
| **技術棧** |  Node.js Python |
...
```
b36246a feat(web): 日曆可點日期 + 自己新增事件 + 修縣市閃爍
36f4304 feat(web): 醫院 autocomplete(健保醫學中心+區域醫院, 就近建議)
adb0856 feat(web): 預約可填時間/院所/備註 + 每項用途與對象(媽媽/寶寶)+ 醫療資料校正
b5fe64a test(web): QA smoke test(20 項全綠)+ QA checklist
e29b730 feat(web): 設定區(管理員專用)— 帳號管理 + 開發藍圖 + 版本紀錄
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-19", "06-20", "06-21", "06-22", "06-23", "06-24", "06-25"]
    y-axis "USD" 0 --> 3150
    bar [34, 125, 1728, 1166, 2436, 3089, 1145]
~~~
...
| 2026-06-25 (Thu) | 10 | 936 | 512.1M | $1145.03 |
| **Total** | | | **4586.1M** | **$9724.07** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-ChimesFlow | 2,515 | 1358.2M | $2642.10 |
| -Users-manibari-Vault-Peter-Family | 2,094 | 1197.1M | $2380.52 |
| -Users-manibari-code-tukey-automl | 2,090 | 1136.9M | $2309.31 |
| -Users-manibari-code | 935 | 513.0M | $1163.72 |
| -Users-manibari-code-rivendell | 392 | 202.9M | $677.66 |
| -Users-manibari-code-mops-dbs | 410 | 100.4M | $285.93 |
| -Users-manibari-Vault-Peter-Work | 264 | 26.9M | $79.11 |
| -Users-manibari-code-sales-assistant | 285 | 18.4M | $74.63 |
| -Users-manibari-code-tukey-bi | 151 | 15.7M | $50.98 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-25 — 103 skills, 61 issue(s)*
