...
**backend/**
- backend-async-jobs — 2 次修訂, 4天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 5天前
- env-doctor — 3 次修訂, 5天前
- mops-financial-scraper — 3 次修訂, 5天前
- presales-pipeline — 3 次修訂, 5天前
- repro-exam — 3 次修訂, 5天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 101天前 (2026-03-12)
- tunnel-proxy-deploy — 1 次, 98天前 (2026-03-15)
- tw-company-lookup — 2 次, 97天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 103天前 (2026-03-10)
- office-pdf — 3 次, 103天前 (2026-03-10)
- office-pptx — 3 次, 103天前 (2026-03-10)
- office-xlsx — 3 次, 103天前 (2026-03-10)
- telegram-bot — 1 次, 98天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 104天前 (2026-03-09)
- ios-integration — 1 次, 105天前 (2026-03-08)
- swiftui-patterns — 1 次, 105天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 103天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 101天前 (2026-03-12)
- ci-pipeline — 1 次, 101天前 (2026-03-12)
- deploy — 1 次, 101天前 (2026-03-12)
- init-project — 2 次, 104天前 (2026-03-09)
- knowledge-graph — 1 次, 98天前 (2026-03-15)
- plan-check-style — 3 次, 101天前 (2026-03-12)
- setup-permissions — 3 次, 101天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 98天前 (2026-03-15)
- qa-planner — 1 次, 98天前 (2026-03-15)
- qa-testing — 1 次, 103天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 98天前 (2026-03-15)
- context-recovery — 1 次, 98天前 (2026-03-15)
- crm-projection — 1 次, 97天前 (2026-03-16)
- executing-plans — 3 次, 103天前 (2026-03-10)
- gdrive-to-skills — 2 次, 104天前 (2026-03-09)
- material-health — 1 次, 97天前 (2026-03-16)
- mockup — 1 次, 105天前 (2026-03-08)
- subsidy-scraper — 1 次, 97天前 (2026-03-16)
- writing-plans — 3 次, 103天前 (2026-03-10)

<details><summary>✅ 穩定 (62)</summary>

**backend/**
- audio-transcription-flow — 1 次, 75天前
- doc-to-structured-data — 1 次, 87天前
- docker-compose-setup — 2 次, 65天前
- firebase-backend — 3 次, 44天前
- imap-smtp-integration — 1 次, 89天前
- markdown-file-ssot — 1 次, 89天前
- oauth-token-vault — 1 次, 89天前
- rbac-permissions — 1 次, 75天前
- sqlite-to-postgres — 2 次, 44天前
- vector-search-setup — 1 次, 83天前

**docs/**
- chart-design — 1 次, 34天前
- discovery-interview — 1 次, 75天前
- doc-coauthoring — 2 次, 44天前
- excalidraw-diagram — 2 次, 36天前
- gdoc-report-builder — 2 次, 44天前
- internal-comms — 2 次, 44天前
- iot-factory-report — 2 次, 44天前
- mermaid-diagram — 1 次, 37天前
- metadata-workshop — 2 次, 44天前
- office-docx — 4 次, 74天前
- pitch-deck — 3 次, 44天前
- rfq-writer — 1 次, 74天前
- slide-office-hours — 2 次, 44天前
- slide-template-extractor — 2 次, 44天前
- slide-workflow — 4 次, 44天前
- sow-writer — 2 次, 44天前

**frontend/**
- chimesflow-design — 1 次, 10天前

**git/**
- auto-stage — 3 次, 44天前
- concurrent-session-git — 1 次, 4天前
- repo-rename — 1 次, 87天前

**meta/**
- agent-persona — 1 次, 69天前
- dev-process-gate — 4 次, 75天前
- learnings-promotion-sprint — 1 次, 37天前
- self-improving-agent — 3 次, 36天前
- session-harvest — 3 次, 44天前
- session-wrap — 1 次, 68天前
- skill-creator — 4 次, 65天前
- skill-scout — 2 次, 53天前
- sync-readme — 1 次, 82天前
- task-brief — 1 次, 5天前
- workflow-retro — 2 次, 44天前

**quality/**
- de-slopify — 2 次, 65天前
- github-repo-audit — 1 次, 69天前
- large-file-refactor — 1 次, 83天前
- protect-secrets — 3 次, 44天前

**workflow/**
- agent-observability — 2 次, 75天前
- app-ops-baseline — 1 次, 10天前
- autoresearch — 2 次, 44天前
- candidate-analysis — 1 次, 87天前
- customer-intel — 5 次, 44天前
- dispatching-parallel-agents — 4 次, 65天前
- headless-agent — 6 次, 89天前
- investment-research — 4 次, 44天前
- jd-writer — 1 次, 69天前
- keyword-discovery — 1 次, 89天前
- launchd-agent — 6 次, 44天前
- planning-with-files — 5 次, 75天前
- requirement — 2 次, 75天前
- sales-material — 3 次, 61天前
- settings-audit — 1 次, 88天前
- tender-scraper — 3 次, 89天前
- user-flow — 2 次, 37天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 119 個 commit（本週）, 449 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `main` (6 total) |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
db49811 Merge pull request #66 from Chimes-AI-Projects/fix/prefs-col-menu-wrap
af84fca fix(table): 欄位「⋯」選單在窄排序欄不再掉到第二行 v1.32.1
bafd300 Merge pull request #65 from Chimes-AI-Projects/feat/contract-document-management
4d47eb9 feat(documents): 前端 — 列印即備存 hook + 三方合約/備存文件可見 v1.32.0
5211546 feat(documents): 備存後端 — generated_documents model/API + 通知 + 合約 partner 篩
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-15", "06-16", "06-17", "06-18", "06-19", "06-20", "06-21"]
    y-axis "USD" 0 --> 4400
    bar [2230, 4301, 2972, 1976, 34, 125, 719]
~~~
...
| 2026-06-21 (Sun) | 7 | 721 | 344.4M | $719.42 |
| **Total** | | | **6026.0M** | **$12357.72** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-tukey-automl | 4,215 | 2120.7M | $4064.57 |
| -Users-manibari-code | 3,348 | 1866.4M | $3907.20 |
| -Users-manibari-code-ChimesFlow | 3,471 | 1798.6M | $3485.21 |
| -Users-manibari-code-rivendell | 331 | 176.9M | $685.22 |
| -Users-manibari-code-Family-Fiscal | 81 | 36.0M | $106.85 |
| -Users-manibari-code-sales-assistant | 327 | 23.1M | $89.36 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-21 — 99 skills, 50 issue(s)*
