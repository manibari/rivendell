...
**backend/**
- backend-async-jobs — 2 次修訂, 1天前

**workflow/**
- client-kickoff-docs — 2 次修訂, 2天前
- env-doctor — 3 次修訂, 2天前
- mops-financial-scraper — 3 次修訂, 2天前
- presales-pipeline — 3 次修訂, 2天前
- repro-exam — 3 次修訂, 2天前

### ❓ 可能棄用

**backend/**
- db-migration — 1 次, 98天前 (2026-03-12)
- tunnel-proxy-deploy — 1 次, 95天前 (2026-03-15)
- tw-company-lookup — 2 次, 94天前 (2026-03-16)

**docs/**
- mcp-builder — 3 次, 100天前 (2026-03-10)
- office-pdf — 3 次, 100天前 (2026-03-10)
- office-pptx — 3 次, 100天前 (2026-03-10)
- office-xlsx — 3 次, 100天前 (2026-03-10)
- telegram-bot — 1 次, 95天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 101天前 (2026-03-09)
- ios-integration — 1 次, 102天前 (2026-03-08)
- swiftui-patterns — 1 次, 102天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 100天前 (2026-03-10)

**meta/**
- audit-fix — 1 次, 98天前 (2026-03-12)
- ci-pipeline — 1 次, 98天前 (2026-03-12)
- deploy — 1 次, 98天前 (2026-03-12)
- init-project — 2 次, 101天前 (2026-03-09)
- knowledge-graph — 1 次, 95天前 (2026-03-15)
- plan-check-style — 3 次, 98天前 (2026-03-12)
- setup-permissions — 3 次, 98天前 (2026-03-12)

**quality/**
- qa-auto — 1 次, 95天前 (2026-03-15)
- qa-planner — 1 次, 95天前 (2026-03-15)
- qa-testing — 1 次, 100天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 95天前 (2026-03-15)
- context-recovery — 1 次, 95天前 (2026-03-15)
- crm-projection — 1 次, 94天前 (2026-03-16)
- executing-plans — 3 次, 100天前 (2026-03-10)
- gdrive-to-skills — 2 次, 101天前 (2026-03-09)
- material-health — 1 次, 94天前 (2026-03-16)
- mockup — 1 次, 102天前 (2026-03-08)
- subsidy-scraper — 1 次, 94天前 (2026-03-16)
- writing-plans — 3 次, 100天前 (2026-03-10)

<details><summary>✅ 穩定 (62)</summary>

**backend/**
- audio-transcription-flow — 1 次, 72天前
- doc-to-structured-data — 1 次, 84天前
- docker-compose-setup — 2 次, 62天前
- firebase-backend — 3 次, 41天前
- imap-smtp-integration — 1 次, 86天前
- markdown-file-ssot — 1 次, 86天前
- oauth-token-vault — 1 次, 86天前
- rbac-permissions — 1 次, 72天前
- sqlite-to-postgres — 2 次, 41天前
- vector-search-setup — 1 次, 80天前

**docs/**
- chart-design — 1 次, 31天前
- discovery-interview — 1 次, 72天前
- doc-coauthoring — 2 次, 41天前
- excalidraw-diagram — 2 次, 33天前
- gdoc-report-builder — 2 次, 41天前
- internal-comms — 2 次, 41天前
- iot-factory-report — 2 次, 41天前
- mermaid-diagram — 1 次, 34天前
- metadata-workshop — 2 次, 41天前
- office-docx — 4 次, 71天前
- pitch-deck — 3 次, 41天前
- rfq-writer — 1 次, 71天前
- slide-office-hours — 2 次, 41天前
- slide-template-extractor — 2 次, 41天前
- slide-workflow — 4 次, 41天前
- sow-writer — 2 次, 41天前

**frontend/**
- chimesflow-design — 1 次, 7天前

**git/**
- auto-stage — 3 次, 41天前
- concurrent-session-git — 1 次, 1天前
- repo-rename — 1 次, 84天前

**meta/**
- agent-persona — 1 次, 66天前
- dev-process-gate — 4 次, 72天前
- learnings-promotion-sprint — 1 次, 34天前
- self-improving-agent — 3 次, 33天前
- session-harvest — 3 次, 41天前
- session-wrap — 1 次, 65天前
- skill-creator — 4 次, 62天前
- skill-scout — 2 次, 50天前
- sync-readme — 1 次, 79天前
- task-brief — 1 次, 2天前
- workflow-retro — 2 次, 41天前

**quality/**
- de-slopify — 2 次, 62天前
- github-repo-audit — 1 次, 66天前
- large-file-refactor — 1 次, 80天前
- protect-secrets — 3 次, 41天前

**workflow/**
- agent-observability — 2 次, 72天前
- app-ops-baseline — 1 次, 7天前
- autoresearch — 2 次, 41天前
- candidate-analysis — 1 次, 84天前
- customer-intel — 5 次, 41天前
- dispatching-parallel-agents — 4 次, 62天前
- headless-agent — 6 次, 86天前
- investment-research — 4 次, 41天前
- jd-writer — 1 次, 66天前
- keyword-discovery — 1 次, 86天前
- launchd-agent — 6 次, 41天前
- planning-with-files — 5 次, 72天前
- requirement — 2 次, 72天前
- sales-material — 3 次, 58天前
- settings-audit — 1 次, 85天前
- tender-scraper — 3 次, 86天前
- user-flow — 2 次, 34天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 132 個 commit（本週）, 465 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/login-logo-and-closeout-time` (6 total) | 1 個 open PR |
| **Git** | clean |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
a229071 feat(ui): 登入頁改用公司 logo + 收尾「下一步日期」可填時刻 v1.31.1
ae08fc9 Merge pull request #63 from Chimes-AI-Projects/feat/loi-from-opportunity
36a383f feat(opps): 商機 → 一鍵產生合作意願書（LOI）v1.31.0
cf8b402 Merge pull request #62 from Chimes-AI-Projects/feat/partner-attendees-and-fonts
a977f3b feat(today): 通路與會同仁 + 商機綁通路自動帶 + 行事曆字級放大 v1.30.0
```
</details>
...
7c88c77 test(baseline): Phase 2 regression guard + Valor accuracy target
c4d9edb docs(decision-log): D-18 — board IR → Postgres + pin↔pad foreign key
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["06-12", "06-13", "06-14", "06-15", "06-16", "06-17", "06-18"]
    y-axis "USD" 0 --> 4400
    bar [2932, 2283, 959, 2230, 4301, 2972, 1485]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-06-12 (Fri) | 18 | 3,115 | 1376.5M | $2931.92 |
| 2026-06-13 (Sat) | 12 | 2,907 | 1163.2M | $2283.34 |
| 2026-06-14 (Sun) | 7 | 1,160 | 458.7M | $959.06 |
| 2026-06-15 (Mon) | 8 | 2,266 | 1084.5M | $2229.77 |
| 2026-06-16 (Tue) | 8 | 3,833 | 2108.1M | $4300.99 |
| 2026-06-17 (Wed) | 9 | 2,861 | 1404.5M | $2971.73 |
| 2026-06-18 (Thu) | 7 | 1,234 | 785.3M | $1485.20 |
| **Total** | | | **8380.7M** | **$17162.00** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-tukey-automl | 5,579 | 3003.9M | $5642.71 |
| -Users-manibari-code | 5,116 | 2699.5M | $5614.26 |
| -Users-manibari-code-ChimesFlow | 3,866 | 2068.8M | $4030.07 |
| -Users-manibari-code-rivendell | 770 | 265.7M | $948.49 |
| -Users-manibari-code-Family-Fiscal | 666 | 148.9M | $350.38 |
| -Users-manibari-Vault-Peter-Work | 475 | 107.7M | $276.63 |
| -Users-manibari-code-tukey-bi | 294 | 47.8M | $149.55 |
| -Users-manibari-code-sales-assistant | 343 | 23.0M | $89.26 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-Vault-Peter | 72 | 4.9M | $25.61 |
| -Users-manibari-code-resume-pool | 145 | 8.1M | $24.08 |
| -Users-manibari-code-PTI-ARES | 23 | 1.3M | $6.45 |
| -Users-manibari-code-vantage-3dgs | 27 | 1.3M | $4.51 |
...
*由以下工具產生 `./bin/sk audit` — 2026-06-18 — 99 skills, 48 issue(s)*
