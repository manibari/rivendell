...
**agents/**
- agent-observability — 2 次修訂, 8天前
- agent-persona — 2 次修訂, 8天前

**backend/**
- imap-smtp-integration — 2 次修訂, 8天前
- markdown-file-ssot — 2 次修訂, 8天前
- oauth-token-vault — 2 次修訂, 8天前
- spine-auth — 2 次修訂, 14天前

**business/**
- customer-intel — 2 次修訂, 8天前
- investment-research — 2 次修訂, 8天前

**docs/**
- office-pptx — 4 次修訂, 7天前
- pitch-deck — 5 次修訂, 1天前
- slide-workflow — 5 次修訂, 7天前
- subsidy-writer — 3 次修訂, 6天前

**git/**
- concurrent-session-git — 2 次修訂, 8天前

**media/**
- local-media-transcribe — 2 次修訂, 0天前
- video-transcript — 5 次修訂, 11天前

**meta/**
- doc-drift-sync — 2 次修訂, 0天前
- setup-permissions — 4 次修訂, 1天前

**quality/**
- de-slopify — 5 次修訂, 1天前
- say-it-plain — 2 次修訂, 14天前

**workflow/**
- autoresearch — 3 次修訂, 8天前
- gdrive-to-skills — 3 次修訂, 8天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 118天前 (2026-04-07)
- db-migration — 1 次, 144天前 (2026-03-12)
- doc-to-structured-data — 1 次, 130天前 (2026-03-26)
- docker-compose-setup — 2 次, 108天前 (2026-04-17)
- rbac-permissions — 1 次, 118天前 (2026-04-07)
- vector-search-setup — 1 次, 126天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 118天前 (2026-04-07)
- office-docx — 4 次, 117天前 (2026-04-08)
- office-pdf — 3 次, 146天前 (2026-03-10)
- office-xlsx — 3 次, 146天前 (2026-03-10)
- rfq-writer — 1 次, 117天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 147天前 (2026-03-09)
- ios-integration — 1 次, 148天前 (2026-03-08)
- swiftui-patterns — 1 次, 148天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 146天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 130天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 144天前 (2026-03-12)
- ci-pipeline — 1 次, 144天前 (2026-03-12)
- deploy — 1 次, 144天前 (2026-03-12)
- dev-process-gate — 4 次, 118天前 (2026-04-07)
- init-project — 2 次, 147天前 (2026-03-09)
- knowledge-graph — 1 次, 141天前 (2026-03-15)
- plan-check-style — 3 次, 144天前 (2026-03-12)
- session-wrap — 1 次, 111天前 (2026-04-14)
- skill-creator — 4 次, 108天前 (2026-04-17)
- skill-scout — 2 次, 96天前 (2026-04-29)
- sync-readme — 1 次, 125天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 112天前 (2026-04-13)
- large-file-refactor — 1 次, 126天前 (2026-03-30)
- qa-auto — 1 次, 141天前 (2026-03-15)
- qa-planner — 1 次, 141天前 (2026-03-15)
- qa-testing — 1 次, 146天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 141天前 (2026-03-15)
- context-recovery — 1 次, 141天前 (2026-03-15)
- settings-audit — 1 次, 131天前 (2026-03-25)

<details><summary>✅ 穩定 (65)</summary>

**agents/**
- agent-dispatch — 1 次, 11天前
- agent-headless — 1 次, 11天前
- agent-launchd — 1 次, 11天前

**backend/**
- ai-vision-extract — 1 次, 35天前
- backend-async-jobs — 3 次, 21天前
- cloudflare-tunnel-ops — 1 次, 17天前
- cloudflare-tunnel-provision — 1 次, 17天前
- firebase-backend — 3 次, 87天前
- ic-lot-normalization — 1 次, 40天前
- mcp-builder — 1 次, 11天前
- ml-eval-quality — 2 次, 21天前
- ml-model-registry — 2 次, 21天前
- odb-dfm-reference — 1 次, 40天前
- spine-rbac — 1 次, 36天前
- spine-schema-sync — 1 次, 36天前
- spine-versioning — 1 次, 35天前
- sqlite-to-postgres — 2 次, 87天前
- telegram-bot — 1 次, 11天前
- tunnel-proxy-deploy — 2 次, 17天前

**business/**
- candidate-analysis — 1 次, 11天前
- client-kickoff-docs — 1 次, 11天前
- crm-projection — 1 次, 11天前
- jd-writer — 1 次, 11天前
- keyword-discovery — 1 次, 11天前
- material-health — 1 次, 11天前
- mops-financial-scraper — 1 次, 11天前
- presales-pipeline — 1 次, 11天前
- sales-material — 1 次, 11天前
- subsidy-scraper — 1 次, 11天前
- tender-scraper — 1 次, 11天前
- tw-company-lookup — 1 次, 11天前

**docs/**
- chart-design — 1 次, 77天前
- doc-coauthoring — 2 次, 87天前
- excalidraw-diagram — 2 次, 79天前
- gdoc-report-builder — 2 次, 87天前
- internal-comms — 2 次, 87天前
- iot-factory-report — 2 次, 87天前
- mermaid-diagram — 1 次, 80天前
- metadata-workshop — 2 次, 87天前
- slide-office-hours — 2 次, 87天前
- slide-template-extractor — 2 次, 87天前
- sow-writer — 2 次, 87天前

**frontend/**
- chimesflow-design — 1 次, 53天前

**git/**
- auto-stage — 3 次, 87天前
- resolving-merge-conflicts — 1 次, 0天前

**media/**
- subtitle-file — 1 次, 11天前
- video-clip-extract — 1 次, 11天前

**meta/**
- learnings-promotion-sprint — 1 次, 80天前
- self-improving-agent — 3 次, 79天前
- session-harvest — 3 次, 87天前
- task-brief — 1 次, 48天前
- workflow-retro — 2 次, 87天前
- writing-great-skills — 1 次, 0天前

**planning/**
- app-ops-baseline — 1 次, 11天前
- executing-plans — 1 次, 11天前
- mockup — 1 次, 11天前
- planning-with-files — 1 次, 11天前
- requirement — 1 次, 11天前
- user-flow — 1 次, 11天前
- writing-plans — 1 次, 11天前

**quality/**
- protect-secrets — 3 次, 87天前
- qa-journey — 1 次, 8天前

**workflow/**
- context-journal — 1 次, 14天前
- env-doctor — 3 次, 48天前
- repro-exam — 3 次, 48天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 1 個 commit（本週）, 7 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `feat/scan-card-qa-flow` (9 total) | 6 個 open PR |
| **Git** | 2 dirty, 1 unpushed |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
4ba8fe3 feat(products): product-line relational graph (基石←平台←應用→場域) — v1.33.43 (#122)
4553ac6 fix(targets): 目標產業 picker uses full industry taxonomy, not just existing accounts' — v1.33.42 (#121)
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 10 個 commit（本週）, 47 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `master` (1 total) |
| **Git** | 7 dirty, 20 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
| **Config** | **missing** | **權限** | OK (0 rules) |
...
```
56496d3 fix(engine): the tab region was a union bbox spanning the whole board — 0041 recall 1/5 → 4/5 on AA0004450
1d1cadf fix(engine): point-to-arc distance measured against the whole circle — 0.658 mm was reported as 0.2877 mm
ead9261 docs(report): the weekly deck goes back to being a weekly deck — and the gantt now shows the October plan
055f1c1 fix(console): auto-revealed layers now close again — reveal that only opens is worse than none
a33ce53 docs(report): Gate A was never at 94.37% — we measured a path production doesn't use
```
</details>
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 1 個 commit（本週）, 15 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 3913 dirty, 1 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
5e8dd72 chore(materials): crm-projection refresh 2026-07-26
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-28", "07-29", "07-30", "07-31", "08-01", "08-02", "08-03"]
    y-axis "USD" 0 --> 2000
    bar [1879, 1928, 1188, 213, 5, 367, 928]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-07-28 (Tue) | 22 | 2,535 | 792.2M | $1879.02 |
| 2026-07-29 (Wed) | 24 | 2,202 | 732.6M | $1927.53 |
| 2026-07-30 (Thu) | 12 | 1,289 | 524.9M | $1187.66 |
| 2026-07-31 (Fri) | 9 | 482 | 74.6M | $212.61 |
| 2026-08-01 (Sat) | 2 | 26 | 1.4M | $4.90 |
| 2026-08-02 (Sun) | 10 | 804 | 141.1M | $366.89 |
| 2026-08-03 (Mon) | 11 | 1,341 | 442.2M | $928.31 |
| **Total** | | | **2709.1M** | **$6506.92** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| vantage-3dgs | 1,772 | 690.6M | $1509.32 |
| PTI-ARES | 1,440 | 517.4M | $1204.62 |
| Vault-Peter-Work | 1,380 | 305.5M | $759.19 |
| rivendell | 1,074 | 267.3M | $741.18 |
| Verdandi-AutoML | 559 | 260.1M | $615.52 |
| IC-YMS | 582 | 223.3M | $552.76 |
| -Users-manibari-code | 950 | 184.7M | $425.71 |
| mops-dbs | 303 | 137.8M | $347.37 |
| MingOS | 194 | 79.0M | $204.32 |
| sales-assistant | 343 | 23.9M | $73.60 |
| MingOS-engine | 32 | 15.6M | $52.95 |
| news_stock | 28 | 603K | $40.77 |
| ChimesFlow | 42 | 3.0M | $11.96 |
| resume-pool | 8 | 843K | $8.43 |
...
*由以下工具產生 `./bin/sk audit` — 2026-08-03 — 121 skills, 62 issue(s)*
