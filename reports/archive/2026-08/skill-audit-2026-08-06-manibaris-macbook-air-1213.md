...
**agents/**
- agent-observability — 2 次修訂, 11天前
- agent-persona — 2 次修訂, 11天前

**backend/**
- imap-smtp-integration — 2 次修訂, 11天前
- markdown-file-ssot — 2 次修訂, 11天前
- oauth-token-vault — 2 次修訂, 11天前

**business/**
- customer-intel — 2 次修訂, 11天前
- investment-research — 2 次修訂, 11天前

**docs/**
- office-pptx — 4 次修訂, 10天前
- pitch-deck — 5 次修訂, 4天前
- slide-workflow — 5 次修訂, 10天前
- subsidy-writer — 3 次修訂, 9天前

**git/**
- concurrent-session-git — 2 次修訂, 11天前

**media/**
- local-media-transcribe — 2 次修訂, 3天前
- video-transcript — 5 次修訂, 14天前

**meta/**
- doc-drift-sync — 2 次修訂, 3天前
- setup-permissions — 4 次修訂, 4天前

**quality/**
- de-slopify — 5 次修訂, 4天前

**workflow/**
- autoresearch — 3 次修訂, 11天前
- gdrive-to-skills — 3 次修訂, 11天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 121天前 (2026-04-07)
- db-migration — 1 次, 147天前 (2026-03-12)
- doc-to-structured-data — 1 次, 133天前 (2026-03-26)
- docker-compose-setup — 2 次, 111天前 (2026-04-17)
- rbac-permissions — 1 次, 121天前 (2026-04-07)
- vector-search-setup — 1 次, 129天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 121天前 (2026-04-07)
- office-docx — 4 次, 120天前 (2026-04-08)
- office-pdf — 3 次, 149天前 (2026-03-10)
- office-xlsx — 3 次, 149天前 (2026-03-10)
- rfq-writer — 1 次, 120天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 150天前 (2026-03-09)
- ios-integration — 1 次, 151天前 (2026-03-08)
- swiftui-patterns — 1 次, 151天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 149天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 133天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 147天前 (2026-03-12)
- ci-pipeline — 1 次, 147天前 (2026-03-12)
- deploy — 1 次, 147天前 (2026-03-12)
- dev-process-gate — 4 次, 121天前 (2026-04-07)
- init-project — 2 次, 150天前 (2026-03-09)
- knowledge-graph — 1 次, 144天前 (2026-03-15)
- plan-check-style — 3 次, 147天前 (2026-03-12)
- session-wrap — 1 次, 114天前 (2026-04-14)
- skill-creator — 4 次, 111天前 (2026-04-17)
- skill-scout — 2 次, 99天前 (2026-04-29)
- sync-readme — 1 次, 128天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 115天前 (2026-04-13)
- large-file-refactor — 1 次, 129天前 (2026-03-30)
- qa-auto — 1 次, 144天前 (2026-03-15)
- qa-planner — 1 次, 144天前 (2026-03-15)
- qa-testing — 1 次, 149天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 144天前 (2026-03-15)
- context-recovery — 1 次, 144天前 (2026-03-15)
- settings-audit — 1 次, 134天前 (2026-03-25)

<details><summary>✅ 穩定 (67)</summary>

**agents/**
- agent-dispatch — 1 次, 14天前
- agent-headless — 1 次, 14天前
- agent-launchd — 1 次, 14天前

**backend/**
- ai-vision-extract — 1 次, 38天前
- backend-async-jobs — 3 次, 24天前
- cloudflare-tunnel-ops — 1 次, 20天前
- cloudflare-tunnel-provision — 1 次, 20天前
- firebase-backend — 3 次, 90天前
- ic-lot-normalization — 1 次, 43天前
- mcp-builder — 1 次, 14天前
- ml-eval-quality — 2 次, 24天前
- ml-model-registry — 2 次, 24天前
- odb-dfm-reference — 1 次, 43天前
- spine-auth — 2 次, 17天前
- spine-rbac — 1 次, 39天前
- spine-schema-sync — 1 次, 39天前
- spine-versioning — 1 次, 38天前
- sqlite-to-postgres — 2 次, 90天前
- telegram-bot — 1 次, 14天前
- tunnel-proxy-deploy — 2 次, 20天前

**business/**
- candidate-analysis — 1 次, 14天前
- client-kickoff-docs — 1 次, 14天前
- crm-projection — 1 次, 14天前
- jd-writer — 1 次, 14天前
- keyword-discovery — 1 次, 14天前
- material-health — 1 次, 14天前
- mops-financial-scraper — 1 次, 14天前
- presales-pipeline — 1 次, 14天前
- sales-material — 1 次, 14天前
- subsidy-scraper — 1 次, 14天前
- tender-scraper — 1 次, 14天前
- tw-company-lookup — 1 次, 14天前

**docs/**
- chart-design — 1 次, 80天前
- doc-coauthoring — 2 次, 90天前
- excalidraw-diagram — 2 次, 82天前
- gdoc-report-builder — 2 次, 90天前
- internal-comms — 2 次, 90天前
- iot-factory-report — 2 次, 90天前
- mermaid-diagram — 1 次, 83天前
- metadata-workshop — 2 次, 90天前
- slide-office-hours — 2 次, 90天前
- slide-template-extractor — 2 次, 90天前
- sow-writer — 2 次, 90天前

**frontend/**
- chimesflow-design — 1 次, 56天前

**git/**
- auto-stage — 3 次, 90天前
- resolving-merge-conflicts — 1 次, 3天前

**media/**
- subtitle-file — 1 次, 14天前
- video-clip-extract — 1 次, 14天前

**meta/**
- learnings-promotion-sprint — 1 次, 83天前
- self-improving-agent — 3 次, 82天前
- session-harvest — 3 次, 90天前
- task-brief — 1 次, 51天前
- workflow-retro — 2 次, 90天前
- writing-great-skills — 1 次, 3天前

**planning/**
- app-ops-baseline — 1 次, 14天前
- executing-plans — 1 次, 14天前
- mockup — 1 次, 14天前
- planning-with-files — 1 次, 14天前
- requirement — 1 次, 14天前
- user-flow — 1 次, 14天前
- writing-plans — 1 次, 14天前

**quality/**
- protect-secrets — 3 次, 90天前
- qa-journey — 1 次, 11天前
- say-it-plain — 2 次, 17天前

**workflow/**
- context-journal — 1 次, 17天前
- env-doctor — 3 次, 51天前
- repro-exam — 3 次, 51天前
...
2e505f1 refactor(rules): gap_mm() — 六個距離進入點收斂成一個 dispatch
af87e41 docs(plan): 票 09 拆票 — 量出「primitive 庫今天並不存在」
5caa2f6 test(guards): 跨界守衛到位 — 當場抓到兩條真的漂移
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-31", "08-01", "08-02", "08-03", "08-04", "08-05", "08-06"]
    y-axis "USD" 0 --> 2350
    bar [213, 5, 367, 1089, 2281, 1016, 1040]
~~~
...
| 2026-08-06 (Thu) | 16 | 1,966 | 420.8M | $1040.33 |
| **Total** | | | **2705.9M** | **$6011.02** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| PTI-ARES | 3,955 | 1645.6M | $3337.46 |
| vantage-3dgs | 813 | 367.8M | $856.80 |
| rivendell | 873 | 189.3M | $447.34 |
| Vault-Peter-Work | 755 | 138.2M | $400.03 |
| -Users-manibari-code | 552 | 98.8M | $253.88 |
| PTI-ARES-Converter | 387 | 84.8M | $208.97 |
| PTI-ARES-Main | 259 | 47.8M | $103.62 |
| ChimesFlow | 268 | 34.3M | $90.28 |
| IC-YMS | 233 | 23.4M | $85.89 |
| sales-assistant | 367 | 25.4M | $77.39 |
| news-stock | 208 | 27.1M | $69.55 |
| PTI-ARES-Translate | 155 | 20.3M | $61.15 |
...
*由以下工具產生 `./bin/sk audit` — 2026-08-06 — 121 skills, 62 issue(s)*
