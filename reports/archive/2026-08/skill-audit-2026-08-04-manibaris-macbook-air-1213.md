...
- agent-persona — 2 次修訂, 9天前

**backend/**
- imap-smtp-integration — 2 次修訂, 9天前
- markdown-file-ssot — 2 次修訂, 9天前
- oauth-token-vault — 2 次修訂, 9天前

**business/**
- customer-intel — 2 次修訂, 9天前
- investment-research — 2 次修訂, 9天前

**docs/**
- office-pptx — 4 次修訂, 8天前
- pitch-deck — 5 次修訂, 2天前
- slide-workflow — 5 次修訂, 8天前
- subsidy-writer — 3 次修訂, 7天前

**git/**
- concurrent-session-git — 2 次修訂, 9天前

**media/**
- local-media-transcribe — 2 次修訂, 1天前
- video-transcript — 5 次修訂, 12天前

**meta/**
- doc-drift-sync — 2 次修訂, 1天前
- setup-permissions — 4 次修訂, 2天前

**quality/**
- de-slopify — 5 次修訂, 2天前

**workflow/**
- autoresearch — 3 次修訂, 9天前
- gdrive-to-skills — 3 次修訂, 9天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 119天前 (2026-04-07)
- db-migration — 1 次, 145天前 (2026-03-12)
- doc-to-structured-data — 1 次, 131天前 (2026-03-26)
- docker-compose-setup — 2 次, 109天前 (2026-04-17)
- rbac-permissions — 1 次, 119天前 (2026-04-07)
- vector-search-setup — 1 次, 127天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 119天前 (2026-04-07)
- office-docx — 4 次, 118天前 (2026-04-08)
- office-pdf — 3 次, 147天前 (2026-03-10)
- office-xlsx — 3 次, 147天前 (2026-03-10)
- rfq-writer — 1 次, 118天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 148天前 (2026-03-09)
- ios-integration — 1 次, 149天前 (2026-03-08)
- swiftui-patterns — 1 次, 149天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 147天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 131天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 145天前 (2026-03-12)
- ci-pipeline — 1 次, 145天前 (2026-03-12)
- deploy — 1 次, 145天前 (2026-03-12)
- dev-process-gate — 4 次, 119天前 (2026-04-07)
- init-project — 2 次, 148天前 (2026-03-09)
- knowledge-graph — 1 次, 142天前 (2026-03-15)
- plan-check-style — 3 次, 145天前 (2026-03-12)
- session-wrap — 1 次, 112天前 (2026-04-14)
- skill-creator — 4 次, 109天前 (2026-04-17)
- skill-scout — 2 次, 97天前 (2026-04-29)
- sync-readme — 1 次, 126天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 113天前 (2026-04-13)
- large-file-refactor — 1 次, 127天前 (2026-03-30)
- qa-auto — 1 次, 142天前 (2026-03-15)
- qa-planner — 1 次, 142天前 (2026-03-15)
- qa-testing — 1 次, 147天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 142天前 (2026-03-15)
- context-recovery — 1 次, 142天前 (2026-03-15)
- settings-audit — 1 次, 132天前 (2026-03-25)

<details><summary>✅ 穩定 (67)</summary>

**agents/**
- agent-dispatch — 1 次, 12天前
- agent-headless — 1 次, 12天前
- agent-launchd — 1 次, 12天前

**backend/**
- ai-vision-extract — 1 次, 36天前
- backend-async-jobs — 3 次, 22天前
- cloudflare-tunnel-ops — 1 次, 18天前
- cloudflare-tunnel-provision — 1 次, 18天前
- firebase-backend — 3 次, 88天前
- ic-lot-normalization — 1 次, 41天前
- mcp-builder — 1 次, 12天前
- ml-eval-quality — 2 次, 22天前
- ml-model-registry — 2 次, 22天前
- odb-dfm-reference — 1 次, 41天前
- spine-auth — 2 次, 15天前
- spine-rbac — 1 次, 37天前
- spine-schema-sync — 1 次, 37天前
- spine-versioning — 1 次, 36天前
- sqlite-to-postgres — 2 次, 88天前
- telegram-bot — 1 次, 12天前
- tunnel-proxy-deploy — 2 次, 18天前

**business/**
- candidate-analysis — 1 次, 12天前
- client-kickoff-docs — 1 次, 12天前
- crm-projection — 1 次, 12天前
- jd-writer — 1 次, 12天前
- keyword-discovery — 1 次, 12天前
- material-health — 1 次, 12天前
- mops-financial-scraper — 1 次, 12天前
- presales-pipeline — 1 次, 12天前
- sales-material — 1 次, 12天前
- subsidy-scraper — 1 次, 12天前
- tender-scraper — 1 次, 12天前
- tw-company-lookup — 1 次, 12天前

**docs/**
- chart-design — 1 次, 78天前
- doc-coauthoring — 2 次, 88天前
- excalidraw-diagram — 2 次, 80天前
- gdoc-report-builder — 2 次, 88天前
- internal-comms — 2 次, 88天前
- iot-factory-report — 2 次, 88天前
- mermaid-diagram — 1 次, 81天前
- metadata-workshop — 2 次, 88天前
- slide-office-hours — 2 次, 88天前
- slide-template-extractor — 2 次, 88天前
- sow-writer — 2 次, 88天前

**frontend/**
- chimesflow-design — 1 次, 54天前

**git/**
- auto-stage — 3 次, 88天前
- resolving-merge-conflicts — 1 次, 1天前

**media/**
- subtitle-file — 1 次, 12天前
- video-clip-extract — 1 次, 12天前

**meta/**
- learnings-promotion-sprint — 1 次, 81天前
- self-improving-agent — 3 次, 80天前
- session-harvest — 3 次, 88天前
- task-brief — 1 次, 49天前
- workflow-retro — 2 次, 88天前
- writing-great-skills — 1 次, 1天前

**planning/**
- app-ops-baseline — 1 次, 12天前
- executing-plans — 1 次, 12天前
- mockup — 1 次, 12天前
- planning-with-files — 1 次, 12天前
- requirement — 1 次, 12天前
- user-flow — 1 次, 12天前
- writing-plans — 1 次, 12天前

**quality/**
- protect-secrets — 3 次, 88天前
- qa-journey — 1 次, 9天前
- say-it-plain — 2 次, 15天前

**workflow/**
- context-journal — 1 次, 15天前
- env-doctor — 3 次, 49天前
- repro-exam — 3 次, 49天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 3 個 commit（本週）, 113 個（本月） |
| **技術棧** |  Make |
...
xychart-beta
    ...
    y-axis "USD" 0 --> 2000
    bar [1928, 1188, 213, 5, 367, 1080, 294]
~~~
...
| 2026-08-03 (Mon) | 18 | 1,676 | 492.0M | $1079.73 |
| 2026-08-04 (Tue) | 5 | 579 | 108.6M | $293.67 |
| **Total** | | | **2075.4M** | **$5072.99** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| vantage-3dgs | 1,824 | 730.1M | $1641.44 |
| PTI-ARES | 1,002 | 347.0M | $855.56 |
| rivendell | 987 | 244.1M | $614.98 |
| -Users-manibari-code | 1,004 | 189.6M | $456.33 |
| Vault-Peter-Work | 756 | 134.9M | $397.81 |
| Verdandi-AutoML | 232 | 123.7M | $331.02 |
| IC-YMS | 298 | 89.2M | $225.29 |
| MingOS | 193 | 79.0M | $204.32 |
| mops-dbs | 161 | 83.3M | $190.17 |
| sales-assistant | 351 | 24.4M | $74.58 |
...
*由以下工具產生 `./bin/sk audit` — 2026-08-04 — 121 skills, 63 issue(s)*
