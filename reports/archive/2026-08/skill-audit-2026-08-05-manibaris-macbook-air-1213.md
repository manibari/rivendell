...
**agents/**
- agent-observability — 2 次修訂, 10天前
- agent-persona — 2 次修訂, 10天前

**backend/**
- imap-smtp-integration — 2 次修訂, 10天前
- markdown-file-ssot — 2 次修訂, 10天前
- oauth-token-vault — 2 次修訂, 10天前

**business/**
- customer-intel — 2 次修訂, 10天前
- investment-research — 2 次修訂, 10天前

**docs/**
- office-pptx — 4 次修訂, 9天前
- pitch-deck — 5 次修訂, 3天前
- slide-workflow — 5 次修訂, 9天前
- subsidy-writer — 3 次修訂, 8天前

**git/**
- concurrent-session-git — 2 次修訂, 10天前

**media/**
- local-media-transcribe — 2 次修訂, 2天前
- video-transcript — 5 次修訂, 13天前

**meta/**
- doc-drift-sync — 2 次修訂, 2天前
- setup-permissions — 4 次修訂, 3天前

**quality/**
- de-slopify — 5 次修訂, 3天前

**workflow/**
- autoresearch — 3 次修訂, 10天前
- gdrive-to-skills — 3 次修訂, 10天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 120天前 (2026-04-07)
- db-migration — 1 次, 146天前 (2026-03-12)
- doc-to-structured-data — 1 次, 132天前 (2026-03-26)
- docker-compose-setup — 2 次, 110天前 (2026-04-17)
- rbac-permissions — 1 次, 120天前 (2026-04-07)
- vector-search-setup — 1 次, 128天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 120天前 (2026-04-07)
- office-docx — 4 次, 119天前 (2026-04-08)
- office-pdf — 3 次, 148天前 (2026-03-10)
- office-xlsx — 3 次, 148天前 (2026-03-10)
- rfq-writer — 1 次, 119天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 149天前 (2026-03-09)
- ios-integration — 1 次, 150天前 (2026-03-08)
- swiftui-patterns — 1 次, 150天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 148天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 132天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 146天前 (2026-03-12)
- ci-pipeline — 1 次, 146天前 (2026-03-12)
- deploy — 1 次, 146天前 (2026-03-12)
- dev-process-gate — 4 次, 120天前 (2026-04-07)
- init-project — 2 次, 149天前 (2026-03-09)
- knowledge-graph — 1 次, 143天前 (2026-03-15)
- plan-check-style — 3 次, 146天前 (2026-03-12)
- session-wrap — 1 次, 113天前 (2026-04-14)
- skill-creator — 4 次, 110天前 (2026-04-17)
- skill-scout — 2 次, 98天前 (2026-04-29)
- sync-readme — 1 次, 127天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 114天前 (2026-04-13)
- large-file-refactor — 1 次, 128天前 (2026-03-30)
- qa-auto — 1 次, 143天前 (2026-03-15)
- qa-planner — 1 次, 143天前 (2026-03-15)
- qa-testing — 1 次, 148天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 143天前 (2026-03-15)
- context-recovery — 1 次, 143天前 (2026-03-15)
- settings-audit — 1 次, 133天前 (2026-03-25)

<details><summary>✅ 穩定 (67)</summary>

**agents/**
- agent-dispatch — 1 次, 13天前
- agent-headless — 1 次, 13天前
- agent-launchd — 1 次, 13天前

**backend/**
- ai-vision-extract — 1 次, 37天前
- backend-async-jobs — 3 次, 23天前
- cloudflare-tunnel-ops — 1 次, 19天前
- cloudflare-tunnel-provision — 1 次, 19天前
- firebase-backend — 3 次, 89天前
- ic-lot-normalization — 1 次, 42天前
- mcp-builder — 1 次, 13天前
- ml-eval-quality — 2 次, 23天前
- ml-model-registry — 2 次, 23天前
- odb-dfm-reference — 1 次, 42天前
- spine-auth — 2 次, 16天前
- spine-rbac — 1 次, 38天前
- spine-schema-sync — 1 次, 38天前
- spine-versioning — 1 次, 37天前
- sqlite-to-postgres — 2 次, 89天前
- telegram-bot — 1 次, 13天前
- tunnel-proxy-deploy — 2 次, 19天前

**business/**
- candidate-analysis — 1 次, 13天前
- client-kickoff-docs — 1 次, 13天前
- crm-projection — 1 次, 13天前
- jd-writer — 1 次, 13天前
- keyword-discovery — 1 次, 13天前
- material-health — 1 次, 13天前
- mops-financial-scraper — 1 次, 13天前
- presales-pipeline — 1 次, 13天前
- sales-material — 1 次, 13天前
- subsidy-scraper — 1 次, 13天前
- tender-scraper — 1 次, 13天前
- tw-company-lookup — 1 次, 13天前

**docs/**
- chart-design — 1 次, 79天前
- doc-coauthoring — 2 次, 89天前
- excalidraw-diagram — 2 次, 81天前
- gdoc-report-builder — 2 次, 89天前
- internal-comms — 2 次, 89天前
- iot-factory-report — 2 次, 89天前
- mermaid-diagram — 1 次, 82天前
- metadata-workshop — 2 次, 89天前
- slide-office-hours — 2 次, 89天前
- slide-template-extractor — 2 次, 89天前
- sow-writer — 2 次, 89天前

**frontend/**
- chimesflow-design — 1 次, 55天前

**git/**
- auto-stage — 3 次, 89天前
- resolving-merge-conflicts — 1 次, 2天前

**media/**
- subtitle-file — 1 次, 13天前
- video-clip-extract — 1 次, 13天前

**meta/**
- learnings-promotion-sprint — 1 次, 82天前
- self-improving-agent — 3 次, 81天前
- session-harvest — 3 次, 89天前
- task-brief — 1 次, 50天前
- workflow-retro — 2 次, 89天前
- writing-great-skills — 1 次, 2天前

**planning/**
- app-ops-baseline — 1 次, 13天前
- executing-plans — 1 次, 13天前
- mockup — 1 次, 13天前
- planning-with-files — 1 次, 13天前
- requirement — 1 次, 13天前
- user-flow — 1 次, 13天前
- writing-plans — 1 次, 13天前

**quality/**
- protect-secrets — 3 次, 89天前
- qa-journey — 1 次, 10天前
- say-it-plain — 2 次, 16天前

**workflow/**
- context-journal — 1 次, 16天前
- env-doctor — 3 次, 50天前
- repro-exam — 3 次, 50天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 2 個 commit（本週）, 103 個（本月） |
| **技術棧** |  Python |
| **分支** | `main` (4 total) |
| **Git** | 103 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 26 個 commit（本週）, 229 個（本月） |
| **技術棧** |  Node.js Python |
| **分支** | `next-wave-2026-05` (8 total) |
| **Git** | 1 dirty, 6 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
e8d2816 refactor(packages): move the implementation into the three packages — pti_ares becomes the compatibility layer
224e3f1 docs(plan): 06b's code batches are done; the docs batch moves to 06c
c7d3a6a refactor(deps): clear the module-level reverse dependencies — which were not the interface change I first called them
ddf3658 refactor(scripts): migrate scripts and tools — and batch 4 turns out to be dependency inversion, not renaming
1d0571c refactor(tests): migrate to the new packages — which exposed that forwarding shims break monkeypatch
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-30", "07-31", "08-01", "08-02", "08-03", "08-04", "08-05"]
    y-axis "USD" 0 --> 2350
    bar [1188, 213, 5, 367, 1089, 2281, 1011]
~~~
...
| 2026-08-05 (Wed) | 10 | 827 | 416.3M | $1011.21 |
| **Total** | | | **2808.8M** | **$6153.50** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| PTI-ARES | 3,387 | 1543.8M | $3099.50 |
| vantage-3dgs | 1,033 | 502.5M | $1102.92 |
| rivendell | 995 | 229.3M | $566.30 |
| Vault-Peter-Work | 904 | 169.0M | $479.65 |
| -Users-manibari-code | 811 | 167.2M | $411.06 |
| Verdandi-AutoML | 166 | 96.9M | $188.08 |
| mops-dbs | 69 | 25.3M | $76.15 |
| sales-assistant | 347 | 24.2M | $74.43 |
| IC-YMS | 208 | 20.7M | $73.90 |
...
*由以下工具產生 `./bin/sk audit` — 2026-08-05 — 121 skills, 62 issue(s)*
