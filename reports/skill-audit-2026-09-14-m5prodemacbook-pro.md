...
**agents/**
- agent-dispatch — 2 次修訂, 7天前
- agent-headless — 2 次修訂, 7天前
- agent-launchd — 3 次修訂, 5天前
- agent-observability — 3 次修訂, 7天前
- agent-persona — 3 次修訂, 7天前

**backend/**
- ai-vision-extract — 2 次修訂, 7天前
- audio-transcription-flow — 2 次修訂, 7天前
- backend-async-jobs — 4 次修訂, 7天前
- cloudflare-tunnel-ops — 2 次修訂, 7天前
- cloudflare-tunnel-provision — 3 次修訂, 5天前
- db-migration — 2 次修訂, 7天前
- doc-to-structured-data — 2 次修訂, 7天前
- docker-compose-setup — 3 次修訂, 7天前
- firebase-backend — 4 次修訂, 7天前
- ic-lot-normalization — 2 次修訂, 7天前
- imap-smtp-integration — 3 次修訂, 7天前
- markdown-file-ssot — 3 次修訂, 7天前
- mcp-builder — 2 次修訂, 7天前
- ml-eval-quality — 3 次修訂, 7天前
- ml-model-registry — 3 次修訂, 7天前
- oauth-token-vault — 3 次修訂, 7天前
- odb-dfm-reference — 3 次修訂, 7天前
- rbac-permissions — 2 次修訂, 7天前
- spine-auth — 3 次修訂, 7天前
- spine-rbac — 2 次修訂, 7天前
- spine-schema-sync — 2 次修訂, 7天前
- spine-versioning — 2 次修訂, 7天前
- sqlite-to-postgres — 3 次修訂, 7天前
- telegram-bot — 2 次修訂, 7天前
- tunnel-proxy-deploy — 3 次修訂, 7天前
- vector-search-setup — 2 次修訂, 7天前

**docs/**
- chart-design — 3 次修訂, 7天前
- discovery-interview — 2 次修訂, 7天前
- doc-coauthoring — 6 次修訂, 7天前
- excalidraw-diagram — 5 次修訂, 7天前
- gdoc-report-builder — 3 次修訂, 7天前
- internal-comms — 6 次修訂, 7天前
- iot-factory-report — 3 次修訂, 7天前
- mermaid-diagram — 3 次修訂, 7天前
- metadata-workshop — 3 次修訂, 7天前
- office-docx — 5 次修訂, 7天前
- office-pdf — 4 次修訂, 7天前
- office-pptx — 5 次修訂, 7天前
- office-xlsx — 4 次修訂, 7天前
- pitch-deck — 7 次修訂, 7天前
- slide-office-hours — 3 次修訂, 7天前
- slide-template-extractor — 3 次修訂, 7天前
- slide-workflow — 9 次修訂, 7天前
- sow-writer — 3 次修訂, 7天前

**frontend/**
- chimesflow-design — 2 次修訂, 7天前
- frontend-design — 3 次修訂, 7天前
- ios-integration — 2 次修訂, 7天前
- swiftui-patterns — 2 次修訂, 7天前
- ui-ux-pro-max — 4 次修訂, 7天前

**git/**
- auto-stage — 4 次修訂, 7天前
- concurrent-session-git — 3 次修訂, 7天前
- repo-rename — 2 次修訂, 7天前
- resolving-merge-conflicts — 2 次修訂, 7天前

**planning/**
- app-ops-baseline — 2 次修訂, 7天前
- executing-plans — 2 次修訂, 7天前
- mockup — 2 次修訂, 7天前
- planning-with-files — 2 次修訂, 7天前
- requirement — 2 次修訂, 7天前
- user-flow — 4 次修訂, 7天前
- writing-plans — 2 次修訂, 7天前

**qa/**
- qa-auto — 2 次修訂, 7天前
- qa-dataflow — 6 次修訂, 7天前
- qa-journey — 2 次修訂, 7天前
- qa-planner — 2 次修訂, 7天前
- qa-testing — 2 次修訂, 7天前

**quality/**
- de-slopify — 7 次修訂, 7天前
- github-repo-audit — 2 次修訂, 7天前
- large-file-refactor — 2 次修訂, 7天前
- protect-secrets — 4 次修訂, 7天前
- say-it-plain — 4 次修訂, 7天前

**sales/**
- sales-customer-intel — 2 次修訂, 11天前
- sales-material — 2 次修訂, 11天前
- tw-company-lookup — 2 次修訂, 11天前

**workflow/**
- autoresearch — 5 次修訂, 7天前
- ci-pipeline — 2 次修訂, 7天前
- claude-to-telegram — 2 次修訂, 7天前
- context-journal — 2 次修訂, 7天前
- context-recovery — 2 次修訂, 7天前
- deploy — 2 次修訂, 7天前
- dev-process-gate — 2 次修訂, 7天前
- env-doctor — 4 次修訂, 7天前
- gdrive-to-skills — 4 次修訂, 7天前
- init-project — 2 次修訂, 7天前
- plan-check-style — 2 次修訂, 7天前
- repro-exam — 4 次修訂, 7天前
- settings-audit — 2 次修訂, 7天前
- setup-permissions — 2 次修訂, 7天前
- task-brief — 3 次修訂, 7天前

<details><summary>✅ 穩定 (31)</summary>

**gov/**
- gov-rfq-writer — 1 次, 11天前
- gov-subsidy-scraper — 1 次, 11天前
- gov-subsidy-writer — 1 次, 11天前
- gov-tender-scraper — 1 次, 11天前

**hr/**
- hr-candidate-analysis — 1 次, 11天前
- hr-jd-writer — 1 次, 11天前

**invest/**
- invest-research — 1 次, 11天前
- mops-financial-scraper — 1 次, 11天前

**knowledge/**
- knowledge-graph — 1 次, 11天前
- local-media-transcribe — 1 次, 11天前
- subtitle-file — 1 次, 11天前
- video-clip-extract — 1 次, 11天前
- video-transcript — 1 次, 11天前
- yt-channel-scraper — 1 次, 11天前

**platform/**
- audit-fix — 1 次, 11天前
- doc-drift-sync — 1 次, 11天前
- learnings-promotion-sprint — 1 次, 11天前
- self-improving-agent — 1 次, 11天前
- session-harvest — 1 次, 11天前
- session-wrap — 1 次, 11天前
- skill-apply — 1 次, 11天前
- skill-creator — 1 次, 11天前
- skill-scout — 1 次, 11天前
- sync-readme — 1 次, 11天前
- workflow-retro — 1 次, 11天前
- writing-great-skills — 1 次, 11天前

**sales/**
- presales-pipeline — 1 次, 11天前
- sales-client-kickoff-docs — 1 次, 11天前
- sales-crm-projection — 1 次, 11天前
- sales-keyword-discovery — 1 次, 11天前
- sales-material-health — 1 次, 11天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 156 個 commit（本週）, 497 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `master` (1 total) |
| **Git** | 198 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
68cdff4 wip: find-access-points
9c74925 固定 IP の正体——**`100.95.11.33` は Pro だが、Pro からは届かない**
f4eb71b **ずっと緑だった検査が、一度も走っていなかった**
ed246c6 最後の実測——**ハウステンボスは 73 m 足りなかった**（線は効いている）
19175bf ハウステンボスに大村線——**線を足して埋まる穴は、これで見えている範囲では最後**
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["09-08", "09-09", "09-10", "09-11", "09-12", "09-13", "09-14"]
    y-axis "USD" 0 --> 200
    bar [122, 0, 0, 0, 0, 22, 0]
~~~
...
|---------|-----------|--------|-----------|
| Code-rivendell | 241 | 45.8M | $97.78 |
...
*由以下工具產生 `./bin/sk audit` — 2026-09-14 — 124 skills, 4 issue(s)*
