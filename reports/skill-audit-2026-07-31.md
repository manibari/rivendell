...
**agents/**
- agent-observability — 2 次修訂, 5天前
- agent-persona — 2 次修訂, 5天前

**backend/**
- imap-smtp-integration — 2 次修訂, 5天前
- markdown-file-ssot — 2 次修訂, 5天前
- oauth-token-vault — 2 次修訂, 5天前
- spine-auth — 2 次修訂, 11天前

**business/**
- customer-intel — 2 次修訂, 5天前
- investment-research — 2 次修訂, 5天前

**docs/**
- office-pptx — 4 次修訂, 4天前
- pitch-deck — 4 次修訂, 4天前
- slide-workflow — 5 次修訂, 4天前
- subsidy-writer — 3 次修訂, 3天前

**git/**
- concurrent-session-git — 2 次修訂, 5天前

**media/**
- video-transcript — 5 次修訂, 8天前

**quality/**
- de-slopify — 4 次修訂, 5天前
- say-it-plain — 2 次修訂, 11天前

**workflow/**
- autoresearch — 3 次修訂, 5天前
- gdrive-to-skills — 3 次修訂, 5天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 115天前 (2026-04-07)
- db-migration — 1 次, 141天前 (2026-03-12)
- doc-to-structured-data — 1 次, 127天前 (2026-03-26)
- docker-compose-setup — 2 次, 105天前 (2026-04-17)
- rbac-permissions — 1 次, 115天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 138天前 (2026-03-15)
- vector-search-setup — 1 次, 123天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 115天前 (2026-04-07)
- office-docx — 4 次, 114天前 (2026-04-08)
- office-pdf — 3 次, 143天前 (2026-03-10)
- office-xlsx — 3 次, 143天前 (2026-03-10)
- rfq-writer — 1 次, 114天前 (2026-04-08)

**frontend/**
- frontend-design — 2 次, 144天前 (2026-03-09)
- ios-integration — 1 次, 145天前 (2026-03-08)
- swiftui-patterns — 1 次, 145天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 143天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 127天前 (2026-03-26)

**meta/**
- audit-fix — 1 次, 141天前 (2026-03-12)
- ci-pipeline — 1 次, 141天前 (2026-03-12)
- deploy — 1 次, 141天前 (2026-03-12)
- dev-process-gate — 4 次, 115天前 (2026-04-07)
- init-project — 2 次, 144天前 (2026-03-09)
- knowledge-graph — 1 次, 138天前 (2026-03-15)
- plan-check-style — 3 次, 141天前 (2026-03-12)
- session-wrap — 1 次, 108天前 (2026-04-14)
- setup-permissions — 3 次, 141天前 (2026-03-12)
- skill-creator — 4 次, 105天前 (2026-04-17)
- skill-scout — 2 次, 93天前 (2026-04-29)
- sync-readme — 1 次, 122天前 (2026-03-31)

**quality/**
- github-repo-audit — 1 次, 109天前 (2026-04-13)
- large-file-refactor — 1 次, 123天前 (2026-03-30)
- qa-auto — 1 次, 138天前 (2026-03-15)
- qa-planner — 1 次, 138天前 (2026-03-15)
- qa-testing — 1 次, 143天前 (2026-03-10)

**workflow/**
- claude-to-telegram — 1 次, 138天前 (2026-03-15)
- context-recovery — 1 次, 138天前 (2026-03-15)
- settings-audit — 1 次, 128天前 (2026-03-25)

<details><summary>✅ 穩定 (61)</summary>

**agents/**
- agent-dispatch — 1 次, 8天前
- agent-headless — 1 次, 8天前
- agent-launchd — 1 次, 8天前

**backend/**
- ai-vision-extract — 1 次, 32天前
- backend-async-jobs — 3 次, 18天前
- firebase-backend — 3 次, 84天前
- ic-lot-normalization — 1 次, 37天前
- mcp-builder — 1 次, 8天前
- ml-eval-quality — 2 次, 18天前
- ml-model-registry — 2 次, 18天前
- odb-dfm-reference — 1 次, 37天前
- spine-rbac — 1 次, 33天前
- spine-schema-sync — 1 次, 33天前
- spine-versioning — 1 次, 32天前
- sqlite-to-postgres — 2 次, 84天前
- telegram-bot — 1 次, 8天前

**business/**
- candidate-analysis — 1 次, 8天前
- client-kickoff-docs — 1 次, 8天前
- crm-projection — 1 次, 8天前
- jd-writer — 1 次, 8天前
- keyword-discovery — 1 次, 8天前
- material-health — 1 次, 8天前
- mops-financial-scraper — 1 次, 8天前
- presales-pipeline — 1 次, 8天前
- sales-material — 1 次, 8天前
- subsidy-scraper — 1 次, 8天前
- tender-scraper — 1 次, 8天前
- tw-company-lookup — 1 次, 8天前

**docs/**
- chart-design — 1 次, 74天前
- doc-coauthoring — 2 次, 84天前
- excalidraw-diagram — 2 次, 76天前
- gdoc-report-builder — 2 次, 84天前
- internal-comms — 2 次, 84天前
- iot-factory-report — 2 次, 84天前
- mermaid-diagram — 1 次, 77天前
- metadata-workshop — 2 次, 84天前
- slide-office-hours — 2 次, 84天前
- slide-template-extractor — 2 次, 84天前
- sow-writer — 2 次, 84天前

**frontend/**
- chimesflow-design — 1 次, 50天前
...
- subtitle-file — 1 次, 8天前
- video-clip-extract — 1 次, 8天前

**meta/**
- learnings-promotion-sprint — 1 次, 77天前
- self-improving-agent — 3 次, 76天前
- session-harvest — 3 次, 84天前
- task-brief — 1 次, 45天前
- workflow-retro — 2 次, 84天前

**planning/**
- app-ops-baseline — 1 次, 8天前
- executing-plans — 1 次, 8天前
- mockup — 1 次, 8天前
- planning-with-files — 1 次, 8天前
- requirement — 1 次, 8天前
- user-flow — 1 次, 8天前
- writing-plans — 1 次, 8天前

**quality/**
- protect-secrets — 3 次, 84天前
- qa-journey — 1 次, 5天前

**workflow/**
- context-journal — 1 次, 11天前
- env-doctor — 3 次, 45天前
- repro-exam — 3 次, 45天前
...
| **技術棧** |  Node.js |
| **分支** | `feat/scan-card-qa-flow` (8 total) | 6 個 open PR |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
c420106 fix(ci): scope vitest to src/ (skip Playwright e2e) + align stale feedback test (#119)
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 14 個 commit（本週）, 56 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `master` (1 total) |
| **Git** | 5 dirty, 20 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
| **Config** | **missing** | **權限** | OK (0 rules) |
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 6 個 commit（本週）, 15 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 3829 dirty, 1 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["07-25", "07-26", "07-27", "07-28", "07-29", "07-30", "07-31"]
    y-axis "USD" 0 --> 2000
    bar [405, 1135, 457, 1879, 1928, 1188, 188]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-07-25 (Sat) | 11 | 439 | 111.3M | $404.53 |
| 2026-07-26 (Sun) | 21 | 1,708 | 424.5M | $1135.24 |
| 2026-07-27 (Mon) | 10 | 663 | 148.4M | $457.03 |
| 2026-07-28 (Tue) | 22 | 2,535 | 792.2M | $1879.02 |
| 2026-07-29 (Wed) | 24 | 2,202 | 732.6M | $1927.53 |
| 2026-07-30 (Thu) | 12 | 1,289 | 524.9M | $1187.66 |
| 2026-07-31 (Fri) | 4 | 379 | 68.1M | $188.33 |
| **Total** | | | **2802.1M** | **$7179.36** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-Vault-Peter-Work | 2,264 | 550.4M | $1286.84 |
| -Users-manibari-code-PTI-ARES | 1,393 | 514.2M | $1192.04 |
| -Users-manibari-code-vantage-3dgs | 1,061 | 403.1M | $920.33 |
| -Users-manibari-code-mops-dbs | 725 | 241.6M | $738.94 |
| -Users-manibari-code-Verdandi-AutoML | 686 | 300.9M | $728.07 |
| -Users-manibari-code-rivendell | 778 | 161.4M | $603.28 |
| -Users-manibari-code-IC-YMS | 492 | 223.5M | $556.87 |
| -Users-manibari-code-MingOS | 501 | 176.0M | $487.42 |
| -Users-manibari-code | 545 | 99.2M | $246.71 |
| -Users-manibari-code-MingOS-engine | 149 | 65.2M | $204.63 |
| -Users-manibari-code-ChimesFlow | 142 | 31.5M | $102.01 |
| -Users-manibari-code-sales-assistant | 316 | 20.8M | $64.23 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-Urd-BI | 127 | 11.3M | $26.93 |
| -Users-manibari-code-resume-pool | 36 | 3.0M | $21.07 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-31 — 116 skills, 64 issue(s)*
