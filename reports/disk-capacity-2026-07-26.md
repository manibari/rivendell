...
# Disk Capacity Report — 2026-07-26
...
used:   393G / 460G    avail: 19.3G
usage:  96% (warn ≥90%, crit ≥95%) → crit
```

## Raw JSON

```json
{"volume":"/dev/disk3s5","mount":"/System/Volumes/Data","size_gb":460,"used_gb":393,"avail_gb":19.3,"percent":96,"status":"crit","warn_threshold":90,"crit_threshold":95}
```
