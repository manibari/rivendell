...
**backend/**
- backend-async-jobs — 3 次修訂, 7天前
- ml-eval-quality — 2 次修訂, 7天前
- ml-model-registry — 2 次修訂, 7天前
- spine-auth — 2 次修訂, 0天前

**quality/**
- say-it-plain — 2 次修訂, 0天前

### ❓ 可能棄用

**backend/**
- audio-transcription-flow — 1 次, 104天前 (2026-04-07)
- db-migration — 1 次, 130天前 (2026-03-12)
- doc-to-structured-data — 1 次, 116天前 (2026-03-26)
- docker-compose-setup — 2 次, 94天前 (2026-04-17)
- imap-smtp-integration — 1 次, 118天前 (2026-03-24)
- markdown-file-ssot — 1 次, 118天前 (2026-03-24)
- oauth-token-vault — 1 次, 118天前 (2026-03-24)
- rbac-permissions — 1 次, 104天前 (2026-04-07)
- tunnel-proxy-deploy — 1 次, 127天前 (2026-03-15)
- tw-company-lookup — 2 次, 126天前 (2026-03-16)
- vector-search-setup — 1 次, 112天前 (2026-03-30)

**docs/**
- discovery-interview — 1 次, 104天前 (2026-04-07)
- mcp-builder — 3 次, 132天前 (2026-03-10)
- office-docx — 4 次, 103天前 (2026-04-08)
- office-pdf — 3 次, 132天前 (2026-03-10)
- office-pptx — 3 次, 132天前 (2026-03-10)
- office-xlsx — 3 次, 132天前 (2026-03-10)
- rfq-writer — 1 次, 103天前 (2026-04-08)
- telegram-bot — 1 次, 127天前 (2026-03-15)

**frontend/**
- frontend-design — 2 次, 133天前 (2026-03-09)
- ios-integration — 1 次, 134天前 (2026-03-08)
- swiftui-patterns — 1 次, 134天前 (2026-03-08)
- ui-ux-pro-max — 3 次, 132天前 (2026-03-10)

**git/**
- repo-rename — 1 次, 116天前 (2026-03-26)

**meta/**
- agent-persona — 1 次, 98天前 (2026-04-13)
- audit-fix — 1 次, 130天前 (2026-03-12)
- ci-pipeline — 1 次, 130天前 (2026-03-12)
- deploy — 1 次, 130天前 (2026-03-12)
- dev-process-gate — 4 次, 104天前 (2026-04-07)
- init-project — 2 次, 133天前 (2026-03-09)
- knowledge-graph — 1 次, 127天前 (2026-03-15)
- plan-check-style — 3 次, 130天前 (2026-03-12)
- session-wrap — 1 次, 97天前 (2026-04-14)
- setup-permissions — 3 次, 130天前 (2026-03-12)
- skill-creator — 4 次, 94天前 (2026-04-17)
- sync-readme — 1 次, 111天前 (2026-03-31)

**quality/**
- de-slopify — 2 次, 94天前 (2026-04-17)
- github-repo-audit — 1 次, 98天前 (2026-04-13)
- large-file-refactor — 1 次, 112天前 (2026-03-30)
- qa-auto — 1 次, 127天前 (2026-03-15)
- qa-planner — 1 次, 127天前 (2026-03-15)
- qa-testing — 1 次, 132天前 (2026-03-10)

**workflow/**
- agent-observability — 2 次, 104天前 (2026-04-07)
- candidate-analysis — 1 次, 116天前 (2026-03-26)
- claude-to-telegram — 1 次, 127天前 (2026-03-15)
- context-recovery — 1 次, 127天前 (2026-03-15)
- crm-projection — 1 次, 126天前 (2026-03-16)
- dispatching-parallel-agents — 4 次, 94天前 (2026-04-17)
- executing-plans — 3 次, 132天前 (2026-03-10)
- gdrive-to-skills — 2 次, 133天前 (2026-03-09)
- headless-agent — 6 次, 118天前 (2026-03-24)
- jd-writer — 1 次, 98天前 (2026-04-13)
- keyword-discovery — 1 次, 118天前 (2026-03-24)
- material-health — 1 次, 126天前 (2026-03-16)
- mockup — 1 次, 134天前 (2026-03-08)
- planning-with-files — 5 次, 104天前 (2026-04-07)
- requirement — 2 次, 104天前 (2026-04-07)
- settings-audit — 1 次, 117天前 (2026-03-25)
- subsidy-scraper — 1 次, 126天前 (2026-03-16)
- tender-scraper — 3 次, 118天前 (2026-03-24)
- writing-plans — 3 次, 132天前 (2026-03-10)

<details><summary>✅ 穩定 (44)</summary>

**backend/**
- ai-vision-extract — 1 次, 21天前
- firebase-backend — 3 次, 73天前
- ic-lot-normalization — 1 次, 26天前
- odb-dfm-reference — 1 次, 26天前
- spine-rbac — 1 次, 22天前
- spine-schema-sync — 1 次, 22天前
- spine-versioning — 1 次, 21天前
- sqlite-to-postgres — 2 次, 73天前

**docs/**
- chart-design — 1 次, 63天前
- doc-coauthoring — 2 次, 73天前
- excalidraw-diagram — 2 次, 65天前
- gdoc-report-builder — 2 次, 73天前
- internal-comms — 2 次, 73天前
- iot-factory-report — 2 次, 73天前
- mermaid-diagram — 1 次, 66天前
- metadata-workshop — 2 次, 73天前
- pitch-deck — 3 次, 73天前
- slide-office-hours — 2 次, 73天前
- slide-template-extractor — 2 次, 73天前
- slide-workflow — 4 次, 73天前
- sow-writer — 2 次, 73天前

**frontend/**
- chimesflow-design — 1 次, 39天前

**git/**
- auto-stage — 3 次, 73天前
- concurrent-session-git — 1 次, 33天前

**meta/**
- learnings-promotion-sprint — 1 次, 66天前
- self-improving-agent — 3 次, 65天前
- session-harvest — 3 次, 73天前
- skill-scout — 2 次, 82天前
- task-brief — 1 次, 34天前
- workflow-retro — 2 次, 73天前

**quality/**
- protect-secrets — 3 次, 73天前

**workflow/**
- app-ops-baseline — 1 次, 39天前
- autoresearch — 2 次, 73天前
- client-kickoff-docs — 2 次, 34天前
- context-journal — 1 次, 0天前
- customer-intel — 5 次, 73天前
- env-doctor — 3 次, 34天前
- investment-research — 4 次, 73天前
- launchd-agent — 6 次, 73天前
- mops-financial-scraper — 3 次, 34天前
- presales-pipeline — 3 次, 34天前
- repro-exam — 3 次, 34天前
- sales-material — 3 次, 90天前
- user-flow — 2 次, 66天前
...
| | |
|---|---|
| **狀態** | ✅ 近期有動 — 2 個 commit（本週）, 78 個（本月） |
| **技術棧** |  Node.js |
| **分支** | `fix/ocr-codex-stdin-prompt` (5 total) |
| **Git** | 1 dirty |
| **CI/CD** | CI ❌ · 部署 ✅ · Hooks ❌ |
...
```
ddf0b08 feat(game): 本地 3B provider(MLX/Qwen2.5-3B)+ provider 可切換
389bbb6 feat(game): 大臣自主決策 worker(LLM,同行為契約)
cd84c77 feat(game): 大臣擁兵自重可見性 — 監軍把關(可見性分層)
0fa2bd7 feat(game): 主畫面地圖 overlay(民亂/糧存/離心全圖染色)
298469f docs(game): M1 Phase 6 驗收 — 六階段完成,progress/plan/README 更新
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 138 個 commit（本週）, 241 個（本月） |
| **技術棧** |  Node.js Python |
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 21 個 commit（本週）, 223 個（本月） |
| **技術棧** |  Make |
| **分支** | `main` (2 total) |
| **Git** | 1 dirty, 4 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
```
d627f74 feat(phase-c): reparse-from-cache producer for raw layer (step 9)
5882dbb refactor(phase-c): raw identity by natural address, not filing_id FK
a4fa3e4 feat(phase-c): crawl_units registry schema + priority tier (SoT v3.1)
d30c746 feat(phase-c): raw_ixbrl_facts storage layer (SoT v3.1 INV-1/2)
...
xychart-beta
    ...
    y-axis "USD" 0 --> 1750
    bar [1031, 1346, 903, 1653, 1214, 954, 1535]
~~~
...
| 2026-07-20 (Mon) | 21 | 2,479 | 586.7M | $1535.14 |
| **Total** | | | **3361.6M** | **$8635.97** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| -Users-manibari-code-PTI-ARES | 5,586 | 1969.9M | $4270.48 |
| -Users-manibari-code-MingOS | 942 | 294.4M | $1064.58 |
| -Users-manibari-Vault-Peter-Work | 1,217 | 375.3M | $925.35 |
| -Users-manibari-code-rivendell | 1,061 | 227.2M | $791.19 |
| -Users-manibari-code-mops-dbs | 770 | 210.9M | $723.03 |
| -Users-manibari-code-IC-YMS | 302 | 123.5M | $435.13 |
| -Users-manibari-code-ChimesFlow | 597 | 139.9M | $347.08 |
| -Users-manibari-code-sales-assistant | 233 | 13.8M | $46.35 |
| news_stock | 28 | 603K | $40.77 |
| -Users-manibari-code-vantage-3dgs | 49 | 3.3M | $21.10 |
| -Users-manibari-code | 25 | 3.0M | $8.81 |
...
*由以下工具產生 `./bin/sk audit` — 2026-07-20 — 111 skills, 81 issue(s)*
