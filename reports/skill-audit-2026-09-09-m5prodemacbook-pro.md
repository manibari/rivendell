...
- codex/mcp-builder
- codex/telegram-bot
- codex/mops-financial-scraper
- codex/knowledge-graph
- codex/app-ops-baseline
- codex/executing-plans
- codex/mockup
- codex/planning-with-files
- codex/requirement
- codex/user-flow
- codex/writing-plans
- codex/audit-fix
- codex/doc-drift-sync
- codex/learnings-promotion-sprint
- codex/self-improving-agent
- codex/session-harvest
- codex/session-wrap
- codex/skill-creator
- codex/skill-scout
- codex/sync-readme
- codex/workflow-retro
- codex/qa-auto
- codex/qa-planner
- codex/qa-testing
- codex/presales-pipeline
- codex/sales-material
- codex/tw-company-lookup
- codex/ci-pipeline
- codex/deploy
- codex/dev-process-gate
- codex/init-project
- codex/plan-check-style
- codex/setup-permissions
...
**agents/**
- agent-dispatch — 2 次修訂, 2天前
- agent-headless — 2 次修訂, 2天前
- agent-launchd — 3 次修訂, 0天前
- agent-observability — 3 次修訂, 2天前
- agent-persona — 3 次修訂, 2天前

**backend/**
- ai-vision-extract — 2 次修訂, 2天前
- audio-transcription-flow — 2 次修訂, 2天前
- backend-async-jobs — 4 次修訂, 2天前
- cloudflare-tunnel-ops — 2 次修訂, 2天前
- cloudflare-tunnel-provision — 3 次修訂, 0天前
- db-migration — 2 次修訂, 2天前
- doc-to-structured-data — 2 次修訂, 2天前
- docker-compose-setup — 3 次修訂, 2天前
- firebase-backend — 4 次修訂, 2天前
- ic-lot-normalization — 2 次修訂, 2天前
- imap-smtp-integration — 3 次修訂, 2天前
- markdown-file-ssot — 3 次修訂, 2天前
- mcp-builder — 2 次修訂, 2天前
- ml-eval-quality — 3 次修訂, 2天前
- ml-model-registry — 3 次修訂, 2天前
- oauth-token-vault — 3 次修訂, 2天前
- odb-dfm-reference — 3 次修訂, 2天前
- rbac-permissions — 2 次修訂, 2天前
- spine-auth — 3 次修訂, 2天前
- spine-rbac — 2 次修訂, 2天前
- spine-schema-sync — 2 次修訂, 2天前
- spine-versioning — 2 次修訂, 2天前
- sqlite-to-postgres — 3 次修訂, 2天前
- telegram-bot — 2 次修訂, 2天前
- tunnel-proxy-deploy — 3 次修訂, 2天前
- vector-search-setup — 2 次修訂, 2天前

**docs/**
- chart-design — 3 次修訂, 2天前
- discovery-interview — 2 次修訂, 2天前
- doc-coauthoring — 6 次修訂, 2天前
- excalidraw-diagram — 5 次修訂, 2天前
- gdoc-report-builder — 3 次修訂, 2天前
- internal-comms — 6 次修訂, 2天前
- iot-factory-report — 3 次修訂, 2天前
- mermaid-diagram — 3 次修訂, 2天前
- metadata-workshop — 3 次修訂, 2天前
- office-docx — 5 次修訂, 2天前
- office-pdf — 4 次修訂, 2天前
- office-pptx — 5 次修訂, 2天前
- office-xlsx — 4 次修訂, 2天前
- pitch-deck — 7 次修訂, 2天前
- slide-office-hours — 3 次修訂, 2天前
- slide-template-extractor — 3 次修訂, 2天前
- slide-workflow — 9 次修訂, 2天前
- sow-writer — 3 次修訂, 2天前

**frontend/**
- chimesflow-design — 2 次修訂, 2天前
- frontend-design — 3 次修訂, 2天前
- ios-integration — 2 次修訂, 2天前
- swiftui-patterns — 2 次修訂, 2天前
- ui-ux-pro-max — 4 次修訂, 2天前

**git/**
- auto-stage — 4 次修訂, 2天前
- concurrent-session-git — 3 次修訂, 2天前
- repo-rename — 2 次修訂, 2天前
- resolving-merge-conflicts — 2 次修訂, 2天前

**planning/**
- app-ops-baseline — 2 次修訂, 2天前
- executing-plans — 2 次修訂, 2天前
- mockup — 2 次修訂, 2天前
- planning-with-files — 2 次修訂, 2天前
- requirement — 2 次修訂, 2天前
- user-flow — 4 次修訂, 2天前
- writing-plans — 2 次修訂, 2天前

**qa/**
- qa-auto — 2 次修訂, 2天前
- qa-dataflow — 6 次修訂, 2天前
- qa-journey — 2 次修訂, 2天前
- qa-planner — 2 次修訂, 2天前
- qa-testing — 2 次修訂, 2天前

**quality/**
- de-slopify — 7 次修訂, 2天前
- github-repo-audit — 2 次修訂, 2天前
- large-file-refactor — 2 次修訂, 2天前
- protect-secrets — 4 次修訂, 2天前
- say-it-plain — 4 次修訂, 2天前

**sales/**
- sales-customer-intel — 2 次修訂, 6天前
- sales-material — 2 次修訂, 6天前
- tw-company-lookup — 2 次修訂, 6天前

**workflow/**
- autoresearch — 5 次修訂, 2天前
- ci-pipeline — 2 次修訂, 2天前
- claude-to-telegram — 2 次修訂, 2天前
- context-journal — 2 次修訂, 2天前
- context-recovery — 2 次修訂, 2天前
- deploy — 2 次修訂, 2天前
- dev-process-gate — 2 次修訂, 2天前
- env-doctor — 4 次修訂, 2天前
- gdrive-to-skills — 4 次修訂, 2天前
- init-project — 2 次修訂, 2天前
- plan-check-style — 2 次修訂, 2天前
- repro-exam — 4 次修訂, 2天前
- settings-audit — 2 次修訂, 2天前
- setup-permissions — 2 次修訂, 2天前
- task-brief — 3 次修訂, 2天前

<details><summary>✅ 穩定 (31)</summary>

**gov/**
- gov-rfq-writer — 1 次, 6天前
- gov-subsidy-scraper — 1 次, 6天前
- gov-subsidy-writer — 1 次, 6天前
- gov-tender-scraper — 1 次, 6天前

**hr/**
- hr-candidate-analysis — 1 次, 6天前
- hr-jd-writer — 1 次, 6天前

**invest/**
- invest-research — 1 次, 6天前
- mops-financial-scraper — 1 次, 6天前

**knowledge/**
- knowledge-graph — 1 次, 6天前
- local-media-transcribe — 1 次, 6天前
- subtitle-file — 1 次, 6天前
- video-clip-extract — 1 次, 6天前
- video-transcript — 1 次, 6天前
- yt-channel-scraper — 1 次, 6天前

**platform/**
- audit-fix — 1 次, 6天前
- doc-drift-sync — 1 次, 6天前
- learnings-promotion-sprint — 1 次, 6天前
- self-improving-agent — 1 次, 6天前
- session-harvest — 1 次, 6天前
- session-wrap — 1 次, 6天前
- skill-apply — 1 次, 6天前
- skill-creator — 1 次, 6天前
- skill-scout — 1 次, 6天前
- sync-readme — 1 次, 6天前
- workflow-retro — 1 次, 6天前
- writing-great-skills — 1 次, 6天前

**sales/**
- presales-pipeline — 1 次, 6天前
- sales-client-kickoff-docs — 1 次, 6天前
- sales-crm-projection — 1 次, 6天前
- sales-keyword-discovery — 1 次, 6天前
- sales-material-health — 1 次, 6天前
...
```
5cfaa55 查到的停留時間不要跟「同類型」混
1f0e985 產生前端型別：AreaSuggestions / SuggestionOut / PlaceOut.is_area
dab6213 補上 AreaPicker 的 import
fbec4b6 可滑動的建議卡片：區域型地點的「你要去裡面的哪裡」
1d661a9 models/__init__.py 集中 import，否則工具腳本會炸在外鍵
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["09-03", "09-04", "09-05", "09-06", "09-07", "09-08", "09-09"]
    y-axis "USD" 0 --> 200
    bar [0, 0, 0, 19, 0, 122, 0]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-09-03 (Thu) | 0 | 0 | 0 | $0.00 |
| 2026-09-04 (Fri) | 0 | 0 | 0 | $0.00 |
| 2026-09-05 (Sat) | 0 | 0 | 0 | $0.00 |
| 2026-09-06 (Sun) | 1 | 72 | 5.1M | $19.03 |
| 2026-09-07 (Mon) | 0 | 0 | 0 | $0.00 |
| 2026-09-08 (Tue) | 3 | 189 | 43.5M | $121.74 |
| 2026-09-09 (Wed) | 1 | 0 | 0 | $0.00 |
| **Total** | | | **48.7M** | **$140.77** |
...
|---------|-----------|--------|-----------|
| Code-rivendell | 236 | 43.8M | $94.43 |
| Rightek-engineering-repos | 4 | 1.4M | $25.71 |
| Rightek | 21 | 3.5M | $20.63 |
...
*由以下工具產生 `./bin/sk audit` — 2026-09-09 — 124 skills, 40 issue(s)*
