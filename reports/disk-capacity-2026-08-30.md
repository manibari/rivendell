...
# Disk Capacity Report — 2026-08-30
...
used:   395G / 460G    avail: 29.4G
usage:  94% (warn ≥90%, crit ≥95%) → warn
```

## Raw JSON

```json
{"volume":"/dev/disk3s5","mount":"/System/Volumes/Data","size_gb":460,"used_gb":395,"avail_gb":29.4,"percent":94,"status":"warn","warn_threshold":90,"crit_threshold":95}
```
