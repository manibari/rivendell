...
| 職權層 | 角色 | 能決定什麼 · 對誰負責 | 工作 |
|---|---|---|---|
| **決策**：決定做什麼、錢往哪放、誰上車 | [9. CEO／創辦人](#9-ceo創辦人) | 方向、資源、人事；對投資人與全公司負責 | 9a 方向與優先序 · 9b 投資人募資 BP · 9c 現金與定價 · 9d 關鍵人事 |
| **營運**：決定怎麼跑、何時交、怎麼收錢 | [10. COO／營運](#10-coo營運) | 節奏、合約、請款、交付承諾；對 CEO 負責 | 10a 營運節奏 · 10b 客戶交付管理 · 10c 合約與法遵 · 10d 財務營運 |
| **市場**：讓人認識、讓人買 | [11. 行銷](#11-行銷) | 對外訊息、內容、名單；把 lead 交給業務 | 11a 定位與訊息 · 11b 內容產製 · 11c 網站與 landing page · 11d 名單與成效 |
| | [3. 業務／Presales](#3-業務presales) | 提案內容、報價（在 9c 策略內）、案子接不接的建議；對成交負責，簽約後交營運 | 3a 陌生開發到第一次拜訪 · 3b 客戶客製提案 · 3c 簽約與 kickoff · 3d 素材庫與 CRM 維護 |
| **交付**：把承諾的東西做出來 | [1. 產品開發者](#1-產品開發者) | 技術選型、實作方式；對 10b 的里程碑負責 | 1a 新產品起手 · 1b 新功能／新頁面 · 1c 後端功能／修 bug／重構 · 1d 部署與上線 · 1e iOS app |
| | [4. 顧問／報告與標案撰寫](#4-顧問報告與標案撰寫) | 文件內容與框架、投標文件；對委員或客戶老闆的閱讀負責 | 4a 政府標案 · 4b 政府補助計畫 · 4c 顧問案交付文件 · 4d 客戶資料梳理 |
| | [5. 分析師／投資研究](#5-分析師投資研究) | 方法與數字的正確性；對結論負責，不對決策負責 | 5a 投資研究 · 5b 廠務時序分析 · 5c ML／AutoML 平台 · 5d 製造領域資料 · 5e 自動迭代實驗 |
| **驗證**：獨立於做的人說「做對了嗎」 | [2. QA／驗收者](#2-qa驗收者) | 能擋出貨，不能改實作；對落差報告的真實性負責 | 2a 接手或驗收別人／AI 的 code · 2b 功能完成後的 QA · 2c 使用者旅程測試 · 2d 跨機器重現 |
| **支援**：讓前面的人做得動 | [6. 人資](#6-人資) | 招募流程、JD、公告；開缺與否由 9d 決定 | 6a 開缺 · 6b 履歷篩選 · 6c 內部公告 |
