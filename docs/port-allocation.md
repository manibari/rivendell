...
| 04 | verdandi-or | 3004 | 8004 | 5404 | — | 跑 **8011/5435** → 待遷 |
| 05 | **Verdandi-AutoML** | 3005 | 8005 | 5405 | redis 6305, minio 9005/9006 | ✅ **已改(本次)**,原 3000/8000/5432 元兇 |
...
| 10 | urd-bi | 3010 | 8010 | 5410 | — | |
| 11 | urd-etl | 3011 | 8011 | 5411 | — | 8011 待 verdandi-or 遷走後釋出 |
| 12 | urd-km | 3012 | 8012 | 5412 | — | |
...
- ✅ Verdandi-AutoML(NN=05):`docker-compose.yml` host port `3000→3005 / 8000→8005 / 5432→5405 / 6379→6305 / 9000→9005 / 9001→9006`,`NEXT_PUBLIC_API_URL→:8005`。解掉與 rivendell dashboard(3000/8000)+ native postgres(5432)的三個衝突(它本來沒在跑,純改檔零風險)。
